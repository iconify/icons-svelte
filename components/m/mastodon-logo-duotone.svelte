...
const content = `<g class="cuyn6tgcc"><path class="ig9l1obma"/><path class="f7_ko25_c"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:mastodon-logo-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
