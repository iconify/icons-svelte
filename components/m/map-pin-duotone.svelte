...
const content = `<g class="cuyn6tgcc"><path class="ta7ikz36l"/><path class="ybney4b-l"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:map-pin-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
