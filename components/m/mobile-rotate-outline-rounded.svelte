...
const content = `<path class="fmb37heqy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:mobile-rotate-outline-rounded" {...props}></Icon>
<style>
:global(.fmb37heqy) {
  fill: currentColor;
