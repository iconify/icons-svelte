...
const content = `<path class="lsjospbfy"/><path class="cbmbec0pj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:moto-migrate" {...props}></Icon>
<style>
:global(.cbmbec0pj) {
  fill: none;
  stroke: currentColor;
