...
const content = `<g class="cuyn6tgcc"><path class="lw-000x2o"/><path class="m149a-b8i"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:music-notes-simple-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
