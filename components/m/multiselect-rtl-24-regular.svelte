...
const content = `<path class="k0vpknbiv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:multiselect-rtl-24-regular" {...props}></Icon>
<style>
:global(.k0vpknbiv) {
  fill: currentColor;
