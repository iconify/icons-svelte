...
const content = `<path class="lvawp2b_s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:markunread-mailbox-rounded" {...props}></Icon>
<style>
:global(.lvawp2b_s) {
  fill: currentColor;
