...
const content = `<path class="o7b_rbczp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:military-tech-sharp" {...props}></Icon>
<style>
:global(.o7b_rbczp) {
  fill: currentColor;
