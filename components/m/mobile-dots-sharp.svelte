...
const content = `<path class="lntxbzb-s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:mobile-dots-sharp" {...props}></Icon>
<style>
:global(.lntxbzb-s) {
  fill: currentColor;
