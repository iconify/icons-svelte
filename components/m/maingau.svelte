...
const content = `<path class="yv77b9ehh"/><path class="ydqthzbbt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:maingau" {...props}></Icon>
<style>
:global(.ydqthzbbt) {
  fill: none;
  stroke: currentColor;
