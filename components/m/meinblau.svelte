...
const content = `<path class="ll0g54h-q"/><path class="xk2yctbly"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:meinblau" {...props}></Icon>
<style>
:global(.ll0g54h-q) {
  fill: none;
  stroke: currentColor;
