...
const content = `<path class="z4u17obkt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:mark-chat-unread-outline-sharp" {...props}></Icon>
<style>
:global(.z4u17obkt) {
  fill: currentColor;
