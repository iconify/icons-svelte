...
const content = `<path class="dprtwbc5b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:mark-chat-unread-outline-sharp" {...props}></Icon>
<style>
:global(.dprtwbc5b) {
  fill: currentColor;
