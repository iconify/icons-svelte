...
const content = `<path class="k1muqtbdi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:monitor-weight-loss-outline-sharp" {...props}></Icon>
<style>
:global(.k1muqtbdi) {
  fill: currentColor;
