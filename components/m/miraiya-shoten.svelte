...
const content = `<path class="od9me8bls"/><path class="unoof1b_l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:miraiya-shoten" {...props}></Icon>
<style>
:global(.od9me8bls) {
  fill: none;
  stroke: currentColor;
