...
const content = `<path class="a0bdy9y_n"/><path class="yopgwuhtd"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:marks" {...props}></Icon>
<style>
:global(.a0bdy9y_n) {
  fill: none;
  stroke: currentColor;
