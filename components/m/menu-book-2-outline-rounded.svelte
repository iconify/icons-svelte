...
const content = `<path class="kgmpxkp0v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:menu-book-2-outline-rounded" {...props}></Icon>
<style>
:global(.kgmpxkp0v) {
  fill: currentColor;
