...
const content = `<path class="n3_sh_egb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:mp-outline-sharp" {...props}></Icon>
<style>
:global(.n3_sh_egb) {
  fill: currentColor;
