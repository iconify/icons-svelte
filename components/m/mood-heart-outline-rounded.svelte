...
const content = `<path class="z-vymib-e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:mood-heart-outline-rounded" {...props}></Icon>
<style>
:global(.z-vymib-e) {
  fill: currentColor;
