...
const content = `<path class="gc2i6-s7o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:medical-services-outline" {...props}></Icon>
<style>
:global(.gc2i6-s7o) {
  fill: currentColor;
