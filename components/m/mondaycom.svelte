...
const content = `<circle class="jicwfjsyr"/><path class="bwo_1dbaq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:mondaycom" {...props}></Icon>
<style>
:global(.bwo_1dbaq) {
  fill: none;
  stroke: currentColor;
