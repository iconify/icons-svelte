...
const content = `<g class="cuyn6tgcc"><path class="shew7ccxe"/><path class="fdz9kybzq"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:music-note-simple-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
