...
const content = `<g class="cuyn6tgcc"><path class="fd61zlbnr"/><path class="nvw0febma"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:mosque-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
