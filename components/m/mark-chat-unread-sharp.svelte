...
const content = `<path class="oxxiftbjx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:mark-chat-unread-sharp" {...props}></Icon>
<style>
:global(.oxxiftbjx) {
  fill: currentColor;
