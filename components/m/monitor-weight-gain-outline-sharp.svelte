...
const content = `<path class="t0g1efb8u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:monitor-weight-gain-outline-sharp" {...props}></Icon>
<style>
:global(.t0g1efb8u) {
  fill: currentColor;
