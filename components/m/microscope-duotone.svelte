...
const content = `<g class="cuyn6tgcc"><path class="bofog85yt"/><path class="rk187kvxk"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:microscope-duotone" {...props}></Icon>
<style>
:global(.bofog85yt) {
