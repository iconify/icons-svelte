...
const content = `<path class="jt3nzbkaa"/><path class="tjy1rabhv"/><path class="g1vv27uhj"/><path class="yqdg3taaf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:minecraft-tnt" {...props}></Icon>
<style>
:global(.g1vv27uhj) {
  fill: none;
  stroke: currentColor;
