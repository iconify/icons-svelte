...
const content = `<path class="ku83jqb8i"/><path class="wza96jbes"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:merriamwebster-dictionary" {...props}></Icon>
<style>
:global(.ku83jqb8i) {
  fill: none;
  stroke: currentColor;
