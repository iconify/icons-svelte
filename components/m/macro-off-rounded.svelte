...
const content = `<path class="w331kbb8t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:macro-off-rounded" {...props}></Icon>
<style>
:global(.w331kbb8t) {
  fill: currentColor;
