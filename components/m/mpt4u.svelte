...
const content = `<path class="olij3i3hw"/><path class="t34kpl57u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:mpt4u" {...props}></Icon>
<style>
:global(.olij3i3hw) {
  fill: none;
  stroke: currentColor;
