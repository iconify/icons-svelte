...
const content = `<g class="ft5dv1b6b"><path class="hitf40b6h"/><path class="bi3l93bwc"/><path class="nnry5hxlt"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:mcb" {...props}></Icon>
<style>
:global(.bi3l93bwc) {
