...
const content = `<path class="btpo_d5uv"/><path class="wgiys0-bs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:magicplan" {...props}></Icon>
<style>
:global(.btpo_d5uv) {
  fill: none;
  stroke: currentColor;
