...
const content = `<path class="bm_2uex7w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:mark-chat-unread-outline" {...props}></Icon>
<style>
:global(.bm_2uex7w) {
  fill: currentColor;
