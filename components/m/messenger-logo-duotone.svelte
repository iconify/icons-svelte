...
const content = `<g class="cuyn6tgcc"><path class="dsr2iijaf"/><path class="lpg6w-29u"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:messenger-logo-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
