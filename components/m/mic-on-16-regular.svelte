...
const content = `<g class="ft5dv1b6b"><path class="cbuxiobpv"/><path class="satn0jbrd"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:mic-on-16-regular" {...props}></Icon>
<style>
:global(.cbuxiobpv) {
