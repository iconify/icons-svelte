...
const content = `<g class="cuyn6tgcc"><path class="y0_ykxbus"/><path class="rgif9r_kp"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:martini-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
