...
const content = `<path class="p83c-8qrt"/><path class="sct6-sb4m"/><ellipse class="q9fi66bbc"/><path class="rmz3ix-wr"/><path class="f8g_8zbqi"/><path class="ey6qptbve"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:mouse" {...props}></Icon>
<style>
:global(.ey6qptbve) {
