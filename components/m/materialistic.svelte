...
const content = `<rect class="r7hvp0biu"/><path class="gpa9x7bmz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:materialistic" {...props}></Icon>
<style>
:global(.gpa9x7bmz) {
  fill: none;
  stroke: currentColor;
