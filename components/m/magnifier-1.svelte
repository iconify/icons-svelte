...
const content = `<path class="ojer8xq3s"/><circle class="deib5z90z"/><path class="bokdrebtl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:magnifier-1" {...props}></Icon>
<style>
:global(.bokdrebtl) {
  fill: none;
  stroke: currentColor;
