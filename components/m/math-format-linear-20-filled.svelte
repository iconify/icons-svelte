...
const content = `<path class="m0a0wzb4k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:math-format-linear-20-filled" {...props}></Icon>
<style>
:global(.m0a0wzb4k) {
  fill: currentColor;
