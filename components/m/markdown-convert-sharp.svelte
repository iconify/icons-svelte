...
const content = `<path class="jcyjh8mul"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:markdown-convert-sharp" {...props}></Icon>
<style>
:global(.jcyjh8mul) {
  fill: currentColor;
