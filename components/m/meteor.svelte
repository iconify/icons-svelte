...
const content = `<path class="nyh815yds"/><path class="qw17kvb6w"/><circle class="rgewmhbbb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:meteor" {...props}></Icon>
<style>
:global(.nyh815yds) {
  fill: none;
  stroke: currentColor;
