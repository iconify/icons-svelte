...
const content = `<path class="e-3cug2sn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:meal-lunch-outline-rounded" {...props}></Icon>
<style>
:global(.e-3cug2sn) {
  fill: currentColor;
