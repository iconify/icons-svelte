...
const content = `<path class="oh_qu5s9o"/><path class="zs880gbnc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:miro-icon" {...props}></Icon>
<style>
:global(.oh_qu5s9o) {
