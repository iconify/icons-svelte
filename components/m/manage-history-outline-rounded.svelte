...
const content = `<path class="tm75bobbv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:manage-history-outline-rounded" {...props}></Icon>
<style>
:global(.tm75bobbv) {
  fill: currentColor;
