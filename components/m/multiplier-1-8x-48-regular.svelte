...
const content = `<path class="b_0v2shzn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:multiplier-1-8x-48-regular" {...props}></Icon>
<style>
:global(.b_0v2shzn) {
  fill: currentColor;
