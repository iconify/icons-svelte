...
const content = `<path class="afhptwb_j"/><path class="ypeq5ubbc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:meme-generator" {...props}></Icon>
<style>
:global(.afhptwb_j) {
  fill: none;
  stroke: currentColor;
