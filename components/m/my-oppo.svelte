...
const content = `<path class="vg2q4b41h"/><path class="pb9su1bbf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:my-oppo" {...props}></Icon>
<style>
:global(.pb9su1bbf) {
  fill: none;
  stroke: currentColor;
