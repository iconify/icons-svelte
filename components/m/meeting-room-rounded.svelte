...
const content = `<path class="fth-dmqih"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:meeting-room-rounded" {...props}></Icon>
<style>
:global(.fth-dmqih) {
  fill: currentColor;
