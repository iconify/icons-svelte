...
const content = `<path class="ic7_-fb5t"/><path class="kqdet7svm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:myexpenses" {...props}></Icon>
<style>
:global(.ic7_-fb5t) {
  fill: none;
  stroke: currentColor;
