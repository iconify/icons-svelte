...
const content = `<path class="x03xhlbbr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:mobile-off-sharp" {...props}></Icon>
<style>
:global(.x03xhlbbr) {
  fill: currentColor;
