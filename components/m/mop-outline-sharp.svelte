...
const content = `<path class="gro-9tb_k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:mop-outline-sharp" {...props}></Icon>
<style>
:global(.gro-9tb_k) {
  fill: currentColor;
