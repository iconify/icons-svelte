...
const content = `<path class="c67a9rbpx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:magic-button-outline" {...props}></Icon>
<style>
:global(.c67a9rbpx) {
  fill: currentColor;
