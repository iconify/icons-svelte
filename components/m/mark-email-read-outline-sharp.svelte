...
const content = `<path class="zv2ij86ob"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:mark-email-read-outline-sharp" {...props}></Icon>
<style>
:global(.zv2ij86ob) {
  fill: currentColor;
