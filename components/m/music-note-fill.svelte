...
const content = `<g class="nrj6p8qat"><path class="zii0zsbrt"/><path class="oolr8x1ag"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:music-note-fill" {...props}></Icon>
<style>
:global(.nrj6p8qat) {
  fill: none;
  stroke: currentColor;
