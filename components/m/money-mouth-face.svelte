...
const content = `<path class="tg31urbgg"/><path class="l2gw9-bxo"/><path class="ksont4tib"/><path class="rueeinsbh"/><path class="xs_ro4g7m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:money-mouth-face" {...props}></Icon>
<style>
:global(.ksont4tib) {
