...
const content = `<path class="ows86csrb"/><path class="qgemyi7ry"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:mygov" {...props}></Icon>
<style>
:global(.ows86csrb) {
  fill: none;
  stroke: currentColor;
