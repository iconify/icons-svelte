...
const content = `<rect class="j3s9ivbxi"/><path class="b2bp6acxk"/><path class="h-fc2g9vm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:my-ac" {...props}></Icon>
<style>
:global(.b2bp6acxk) {
  fill: none;
  stroke: currentColor;
