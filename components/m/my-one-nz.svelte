...
const content = `<circle class="cpk0fnbgt"/><path class="j42dfnbpg"/><circle class="d052l0bxx"/><path class="oh6pmp7an"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:my-one-nz" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
