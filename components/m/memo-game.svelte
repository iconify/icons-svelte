...
const content = `<path class="gqe9355-s"/><path class="rxszi2kuv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:memo-game" {...props}></Icon>
<style>
:global(.gqe9355-s) {
  fill: none;
  stroke: currentColor;
