...
const content = `<path class="xbs-8wbaw"/><circle class="kqwyhzbdq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:myslt" {...props}></Icon>
<style>
:global(.kqwyhzbdq) {
  cx: 27.137px;
  cy: 27.244px;
