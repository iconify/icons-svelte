...
const content = `<g class="cuyn6tgcc"><path class="b1sqawbzr"/><path class="wca69_z7d"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:magnifying-glass-duotone" {...props}></Icon>
<style>
:global(.b1sqawbzr) {
