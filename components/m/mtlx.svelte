...
const content = `<path clip-rule="evenodd" class="atns_ch0h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:mtlx" {...props}></Icon>
<style>
:global(.atns_ch0h) {
