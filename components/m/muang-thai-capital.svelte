...
const content = `<path class="mqjauu0cl"/><path class="lynn4incc"/><path class="gb_o8ib1w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:muang-thai-capital" {...props}></Icon>
<style>
:global(.gb_o8ib1w) {
  fill: none;
  stroke: currentColor;
