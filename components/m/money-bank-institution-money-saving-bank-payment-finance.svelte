...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline:money-bank-institution-money-saving-bank-payment-finance" {...props}></Icon>
