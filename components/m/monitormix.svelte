...
const content = `<path class="esc39qbep"/><path class="uz5sxlb-s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:monitormix" {...props}></Icon>
<style>
:global(.esc39qbep) {
  fill: none;
  stroke: currentColor;
