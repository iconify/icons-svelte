...
const content = `<path class="tk067rbdh"/><path class="w94qynlux"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:match" {...props}></Icon>
<style>
:global(.tk067rbdh) {
  fill: none;
  stroke: currentColor;
