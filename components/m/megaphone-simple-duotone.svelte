...
const content = `<g class="cuyn6tgcc"><path class="rsxxw_90u"/><path class="iueajva_z"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:megaphone-simple-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
