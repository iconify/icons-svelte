...
const content = `<path class="tnyowobhv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:mode-heat-cool-rounded" {...props}></Icon>
<style>
:global(.tnyowobhv) {
  fill: currentColor;
