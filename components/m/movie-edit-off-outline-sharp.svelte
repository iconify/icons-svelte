...
const content = `<path class="ubuob6b5l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:movie-edit-off-outline-sharp" {...props}></Icon>
<style>
:global(.ubuob6b5l) {
  fill: currentColor;
