...
const content = `<path class="yxqhu3fju"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:mobile-cancel-sharp" {...props}></Icon>
<style>
:global(.yxqhu3fju) {
  fill: currentColor;
