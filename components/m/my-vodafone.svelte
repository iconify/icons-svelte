...
const content = `<path class="mns89ywps"/><path class="ing_nnbus"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:my-vodafone" {...props}></Icon>
<style>
:global(.ing_nnbus) {
  fill: none;
  stroke: currentColor;
