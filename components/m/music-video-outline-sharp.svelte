...
const content = `<path class="ixgo1ab3s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:music-video-outline-sharp" {...props}></Icon>
<style>
:global(.ixgo1ab3s) {
  fill: currentColor;
