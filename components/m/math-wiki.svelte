...
const content = `<path class="v6qk-nn3s"/><circle class="cpk0fnbgt"/><circle class="vqogbbbht"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:math-wiki" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
