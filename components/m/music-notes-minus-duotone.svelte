...
const content = `<g class="cuyn6tgcc"><path class="lw-000x2o"/><path class="z2ho6v1zf"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:music-notes-minus-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
