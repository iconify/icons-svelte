...
const content = `<g class="cuyn6tgcc"><path class="axq-zljun"/><path class="quuxg5b7u"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:memory-duotone" {...props}></Icon>
<style>
:global(.axq-zljun) {
