...
const content = `<path class="ydqthzbbt"/><path class="t94ayej0a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:mcdonalds" {...props}></Icon>
<style>
:global(.t94ayej0a) {
  fill: none;
  stroke: currentColor;
