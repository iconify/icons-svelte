...
const content = `<ellipse class="x9p-g_bjf"/><path class="h9bugibpy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:mitidapp" {...props}></Icon>
<style>
:global(.h9bugibpy) {
  fill: none;
  stroke: currentColor;
