...
const content = `<circle class="cpk0fnbgt"/><path class="yy3q-jb_s"/><ellipse class="ib2qypbjl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:midas" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
