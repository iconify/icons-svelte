...
const content = `<circle class="yo71l7h4h"/><path class="kuce5ibgw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:mindfulnotifier" {...props}></Icon>
<style>
:global(.kuce5ibgw) {
  fill: none;
  stroke: currentColor;
