...
const content = `<path class="ol7d0nbeq"/><circle class="eezkri9di"/><circle class="i7wdi9_uf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:mufg-bank" {...props}></Icon>
<style>
:global(.eezkri9di) {
  cx: 24px;
  cy: 24px;
