...
const content = `<rect transform="rotate(27.837 12.59 19.538)" class="twcxukbrg"/><circle class="ze7r_2bzr"/><path class="hu-5mccgc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:minma-icon-pack" {...props}></Icon>
<style>
:global(.hu-5mccgc) {
  fill: none;
  stroke: currentColor;
