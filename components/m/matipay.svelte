...
const content = `<path class="z1u8efb0o"/><path class="s0nw53bsu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:matipay" {...props}></Icon>
<style>
:global(.s0nw53bsu) {
  fill: none;
  stroke: currentColor;
