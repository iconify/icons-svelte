...
const content = `<path class="uz1k6kb_i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:magnify-docked" {...props}></Icon>
<style>
:global(.uz1k6kb_i) {
  fill: currentColor;
