...
const content = `<path class="qv33t297i"/><path class="kwtoowblb"/><path class="z6xuryb4h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:microsoft-planner" {...props}></Icon>
<style>
:global(.kwtoowblb) {
  fill: none;
  stroke: currentColor;
