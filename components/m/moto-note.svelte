...
const content = `<path class="nyl2nvb1q"/><path class="eryxe-bop"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:moto-note" {...props}></Icon>
<style>
:global(.eryxe-bop) {
  fill: none;
  stroke: currentColor;
