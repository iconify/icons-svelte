...
const content = `<path class="zx5og3vdg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:missed-video-call" {...props}></Icon>
<style>
:global(.zx5og3vdg) {
  fill: currentColor;
