...
const content = `<path class="hdm3vxbtb"/><path class="ipwsvnnti"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:moneyhub" {...props}></Icon>
<style>
:global(.hdm3vxbtb) {
  fill: none;
  stroke: currentColor;
