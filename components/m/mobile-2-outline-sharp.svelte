...
const content = `<path class="l6c28kb5u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:mobile-2-outline-sharp" {...props}></Icon>
<style>
:global(.l6c28kb5u) {
  fill: currentColor;
