...
const content = `<path class="chlsoskvz"/><path class="kpgwyacyh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:mojm" {...props}></Icon>
<style>
:global(.chlsoskvz) {
  fill: none;
  stroke: currentColor;
