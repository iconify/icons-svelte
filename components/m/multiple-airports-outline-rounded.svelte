...
const content = `<path class="spen73b-z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:multiple-airports-outline-rounded" {...props}></Icon>
<style>
:global(.spen73b-z) {
  fill: currentColor;
