...
const content = `<path class="ygtssqlkg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:mark-chat-read" {...props}></Icon>
<style>
:global(.ygtssqlkg) {
  fill: currentColor;
