...
const content = `<path class="egb2mw23k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:markdown-document-outline-sharp" {...props}></Icon>
<style>
:global(.egb2mw23k) {
  fill: currentColor;
