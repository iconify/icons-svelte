...
const content = `<path class="itp0ixwcp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:manga-outline-sharp" {...props}></Icon>
<style>
:global(.itp0ixwcp) {
  fill: currentColor;
