...
const content = `<path class="g11s6ksnn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:microphone-chat-20-regular" {...props}></Icon>
<style>
:global(.g11s6ksnn) {
  fill: currentColor;
