...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline:money-safe-vault-saving-combo-payment-safe-money-combination-finance" {...props}></Icon>
