...
const content = `<path class="a-3h7n9tw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:memory-alt" {...props}></Icon>
<style>
:global(.a-3h7n9tw) {
  fill: currentColor;
