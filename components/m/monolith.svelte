...
const content = `<path class="fqdydbb7x"/><path class="fstsr3e1c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:monolith" {...props}></Icon>
<style>
:global(.fqdydbb7x) {
  fill: none;
  stroke: currentColor;
