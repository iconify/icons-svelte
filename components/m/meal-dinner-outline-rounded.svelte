...
const content = `<path class="fed_i2b8p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:meal-dinner-outline-rounded" {...props}></Icon>
<style>
:global(.fed_i2b8p) {
  fill: currentColor;
