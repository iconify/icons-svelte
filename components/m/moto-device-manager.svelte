...
const content = `<path class="gzx3r0b3p"/><path class="soki7sb7q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:moto-device-manager" {...props}></Icon>
<style>
:global(.gzx3r0b3p) {
  fill: none;
  stroke: currentColor;
