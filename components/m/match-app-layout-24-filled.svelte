...
const content = `<path class="oz6xuub3k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:match-app-layout-24-filled" {...props}></Icon>
<style>
:global(.oz6xuub3k) {
  fill: currentColor;
