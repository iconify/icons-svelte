...
const content = `<path class="so4ajfblh"/><path class="eo-57nb5g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:minecraft-axe" {...props}></Icon>
<style>
:global(.eo-57nb5g) {
  fill: none;
  stroke: currentColor;
