...
const content = `<path class="nt9tlcbih"/><path class="ydqthzbbt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:mbank" {...props}></Icon>
<style>
:global(.nt9tlcbih) {
  fill: none;
  stroke: currentColor;
