...
const content = `<path class="dg9ih6bfc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:mark-email-unread-outline" {...props}></Icon>
<style>
:global(.dg9ih6bfc) {
  fill: currentColor;
