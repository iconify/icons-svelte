...
const content = `<g class="cuyn6tgcc"><path class="ta7ikz36l"/><path class="jalmbxbzu"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:map-pin-line-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
