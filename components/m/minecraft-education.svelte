...
const content = `<path class="b4j956b4m"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:minecraft-education" {...props}></Icon>
<style>
:global(.b4j956b4m) {
  fill: none;
  stroke: currentColor;
