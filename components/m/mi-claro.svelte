...
const content = `<path class="g8y0s0bkv"/><circle class="qmv8tbb6q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:mi-claro" {...props}></Icon>
<style>
:global(.g8y0s0bkv) {
  fill: none;
  stroke: currentColor;
