...
const content = `<path class="ecm1igbdk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:microsoft-finance-and-operations" {...props}></Icon>
<style>
:global(.ecm1igbdk) {
  fill: none;
  stroke: currentColor;
