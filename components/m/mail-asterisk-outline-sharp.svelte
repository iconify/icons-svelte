...
const content = `<path class="o7r6dacaj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:mail-asterisk-outline-sharp" {...props}></Icon>
<style>
:global(.o7r6dacaj) {
  fill: currentColor;
