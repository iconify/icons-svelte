...
const content = `<path class="leaou1oux"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:mail-asterisk-outline-sharp" {...props}></Icon>
<style>
:global(.leaou1oux) {
  fill: currentColor;
