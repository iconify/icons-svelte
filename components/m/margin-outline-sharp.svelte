...
const content = `<path class="uz-ke3zem"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:margin-outline-sharp" {...props}></Icon>
<style>
:global(.uz-ke3zem) {
  fill: currentColor;
