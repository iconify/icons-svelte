...
const content = `<path class="il8k7c5xd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:map-outline-sharp" {...props}></Icon>
<style>
:global(.il8k7c5xd) {
  fill: currentColor;
