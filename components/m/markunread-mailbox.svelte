...
const content = `<path class="a01ijqyjd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:markunread-mailbox" {...props}></Icon>
<style>
:global(.a01ijqyjd) {
  fill: currentColor;
