...
const content = `<path class="ghqn-6obt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:music-note-off-1-20-filled" {...props}></Icon>
<style>
:global(.ghqn-6obt) {
  fill: currentColor;
