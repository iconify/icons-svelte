...
const content = `<path class="hzpqnlmob"/><path class="yfdopx10r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:mappls-mapmyindia" {...props}></Icon>
<style>
:global(.hzpqnlmob) {
  fill: none;
  stroke: currentColor;
