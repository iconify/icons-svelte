...
const content = `<path class="k9-123ble"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:microwave-sharp" {...props}></Icon>
<style>
:global(.k9-123ble) {
  fill: currentColor;
