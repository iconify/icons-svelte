...
const content = `<path class="cmciakbzz"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:manman" {...props}></Icon>
<style>
:global(.cmciakbzz) {
  fill: none;
  stroke: currentColor;
