...
const content = `<path class="f82fyxx5n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:mindfulness-sharp" {...props}></Icon>
<style>
:global(.f82fyxx5n) {
  fill: currentColor;
