...
const content = `<path class="zukts29ki"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:mobile-layout-sharp" {...props}></Icon>
<style>
:global(.zukts29ki) {
  fill: currentColor;
