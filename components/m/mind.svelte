...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGcnDejeXP)" clip-rule="evenodd" class="ke969g6sq"/><defs><linearGradient id="SVGcnDejeXP" x1="12" x2="12" y1="3" y2="21.001" gradientUnits="userSpaceOnUse"><stop class="m3k33db8r"/><stop offset="1" class="ucj18xb4m"/></linearGradient></defs></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:mind" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
