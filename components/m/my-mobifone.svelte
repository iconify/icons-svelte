...
const content = `<path class="g2l41wbze"/><path class="w39durt6w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:my-mobifone" {...props}></Icon>
<style>
:global(.g2l41wbze) {
  fill: none;
  stroke: currentColor;
