...
const content = `<g class="nrj6p8qat"><path class="v0renrgmb"/><path class="g9-a5bsup"/><path class="j3t1fbcok"/><path class="r2hn0nart"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:masonry-outline-regular" {...props}></Icon>
<style>
:global(.g9-a5bsup) {
