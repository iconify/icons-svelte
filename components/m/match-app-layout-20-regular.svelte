...
const content = `<path class="ze14iz8xq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:match-app-layout-20-regular" {...props}></Icon>
<style>
:global(.ze14iz8xq) {
  fill: currentColor;
