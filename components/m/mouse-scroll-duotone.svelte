...
const content = `<g class="cuyn6tgcc"><path class="m5hszsbyv"/><path class="a5e6p1bgr"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:mouse-scroll-duotone" {...props}></Icon>
<style>
:global(.a5e6p1bgr) {
