...
const content = `<path class="ly20jpbyz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:mode-fan-outline-rounded" {...props}></Icon>
<style>
:global(.ly20jpbyz) {
  fill: currentColor;
