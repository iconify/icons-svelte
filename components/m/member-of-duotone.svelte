...
const content = `<g class="cuyn6tgcc"><path class="ymfviwb7a"/><path class="lmj60_bhj"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:member-of-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
