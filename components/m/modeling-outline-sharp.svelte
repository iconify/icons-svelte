...
const content = `<path class="n3n9sklow"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:modeling-outline-sharp" {...props}></Icon>
<style>
:global(.n3n9sklow) {
  fill: currentColor;
