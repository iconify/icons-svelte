...
const content = `<path class="kf4wryaqi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:medication-outline" {...props}></Icon>
<style>
:global(.kf4wryaqi) {
  fill: currentColor;
