...
const content = `<path class="hx_t9us-o"/><circle class="akm-_sbbe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:motomarket" {...props}></Icon>
<style>
:global(.akm-_sbbe) {
  cx: 24px;
  cy: 14.27px;
