...
const content = `<path class="aj6j0vbkk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:mobile-optimized-32-filled" {...props}></Icon>
<style>
:global(.aj6j0vbkk) {
  fill: currentColor;
