...
const content = `<path class="yt57u5bum"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:multiselect-rtl-16-regular" {...props}></Icon>
<style>
:global(.yt57u5bum) {
  fill: currentColor;
