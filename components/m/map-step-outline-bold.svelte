...
const content = `<g class="s0phu2bbs"><path class="xrrcnmb6x"/><path class="c6ayt6bgs"/><path class="lv-mj3bxw"/><path class="oqq60ccjl"/><path class="e54_mjwsr"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:map-step-outline-bold" {...props}></Icon>
<style>
:global(.c6ayt6bgs) {
  d: path("M9.5 12h3");
}
