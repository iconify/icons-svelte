...
const content = `<path class="puz8m2bpe"/><path class="ps20rqrjc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:mastodon-redirect" {...props}></Icon>
<style>
:global(.ps20rqrjc) {
  fill: none;
  stroke: currentColor;
