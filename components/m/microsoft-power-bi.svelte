...
const content = `<path class="tev90cc-i"/><path class="t21ozyb5t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:microsoft-power-bi" {...props}></Icon>
<style>
:global(.t21ozyb5t) {
  fill: none;
  stroke: currentColor;
