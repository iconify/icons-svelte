...
const content = `<path class="pxyqx31qc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:mobile-hand-left-sharp" {...props}></Icon>
<style>
:global(.pxyqx31qc) {
  fill: currentColor;
