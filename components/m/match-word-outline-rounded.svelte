...
const content = `<path class="n4xt7bcag"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:match-word-outline-rounded" {...props}></Icon>
<style>
:global(.n4xt7bcag) {
  fill: currentColor;
