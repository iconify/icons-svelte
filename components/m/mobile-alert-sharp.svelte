...
const content = `<path class="ebvncqbir"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:mobile-alert-sharp" {...props}></Icon>
<style>
:global(.ebvncqbir) {
  fill: currentColor;
