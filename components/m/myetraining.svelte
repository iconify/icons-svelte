...
const content = `<path class="g0u6-cb1w"/><path class="bpnxyxnsj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:myetraining" {...props}></Icon>
<style>
:global(.bpnxyxnsj) {
  fill: none;
  stroke: currentColor;
