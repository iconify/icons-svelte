...
const content = `<path class="fmed4ibmb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:more-horizontal-24-regular" {...props}></Icon>
<style>
:global(.fmed4ibmb) {
  fill: currentColor;
