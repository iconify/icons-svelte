...
const content = `<g class="y9tr6bcfx"><path class="f5-mnfltt"/><path class="iluc3esas"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:monochrome" {...props}></Icon>
<style>
:global(.f5-mnfltt) {
