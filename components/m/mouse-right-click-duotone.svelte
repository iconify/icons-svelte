...
const content = `<g class="cuyn6tgcc"><path class="n48iy1xak"/><path class="x-cvb7bpp"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:mouse-right-click-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
