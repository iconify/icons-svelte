...
const content = `<path class="i2-_kab0m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:military-tech-outline" {...props}></Icon>
<style>
:global(.i2-_kab0m) {
  fill: currentColor;
