...
const content = `<path class="z_ytlfbzg"/><path class="r061o3bzj"/><rect class="nhxj6nbud"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:metrodroid" {...props}></Icon>
<style>
:global(.nhxj6nbud) {
  width: 6.867px;
  height: 9.134px;
