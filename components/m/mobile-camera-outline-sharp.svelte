...
const content = `<path class="xrzkgybst"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:mobile-camera-outline-sharp" {...props}></Icon>
<style>
:global(.xrzkgybst) {
  fill: currentColor;
