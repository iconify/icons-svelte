...
const content = `<path class="qa6lu_bln"/><path class="yne59-b-p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:moekey" {...props}></Icon>
<style>
:global(.qa6lu_bln) {
  fill: none;
  stroke: currentColor;
