...
const content = `<path class="w6jpzpl3w"/><path class="zvn998bvh"/><path class="utagtgbcx"/><path class="iphotbbqd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:m-banking" {...props}></Icon>
<style>
:global(.iphotbbqd) {
  fill: none;
  stroke: currentColor;
