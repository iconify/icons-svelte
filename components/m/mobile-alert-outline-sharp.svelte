...
const content = `<path class="nhbi1sclh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:mobile-alert-outline-sharp" {...props}></Icon>
<style>
:global(.nhbi1sclh) {
  fill: currentColor;
