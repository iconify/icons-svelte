...
const content = `<path class="gnv018bot"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:mobile-screensaver-outline-sharp" {...props}></Icon>
<style>
:global(.gnv018bot) {
  fill: currentColor;
