...
const content = `<path class="lwkq7ebxm"/><ellipse class="vgecuup5f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:mypostnordapp" {...props}></Icon>
<style>
:global(.lwkq7ebxm) {
  fill: none;
  stroke: currentColor;
