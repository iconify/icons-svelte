...
const content = `<path class="wy7qp4jvw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:math-format-linear-20-regular" {...props}></Icon>
<style>
:global(.wy7qp4jvw) {
  fill: currentColor;
