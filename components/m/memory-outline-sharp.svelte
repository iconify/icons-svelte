...
const content = `<path class="yilqglbuj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:memory-outline-sharp" {...props}></Icon>
<style>
:global(.yilqglbuj) {
  fill: currentColor;
