...
const content = `<path class="i9clfwm2k"/><path class="mf-dctbdg"/><path class="fgrv1urgp"/><path class="w2x7hzb9p"/><path class="fp40yyfws"/><path class="mei9k7p0m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:118-118-money" {...props}></Icon>
<style>
:global(.fgrv1urgp) {
  fill: none;
  stroke: currentColor;
