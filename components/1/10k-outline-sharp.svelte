...
const content = `<path class="h6sf1oxjo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:10k-outline-sharp" {...props}></Icon>
<style>
:global(.h6sf1oxjo) {
  fill: currentColor;
