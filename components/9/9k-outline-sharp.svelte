...
const content = `<path class="jq_nf-imc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:9k-outline-sharp" {...props}></Icon>
<style>
:global(.jq_nf-imc) {
  fill: currentColor;
