...
const content = `<path class="ef6klibtp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:9k-outline-sharp" {...props}></Icon>
<style>
:global(.ef6klibtp) {
  fill: currentColor;
