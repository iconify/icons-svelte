...
const content = `<path class="fsjvc17ke"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:3k-plus-outline-sharp" {...props}></Icon>
<style>
:global(.fsjvc17ke) {
  fill: currentColor;
