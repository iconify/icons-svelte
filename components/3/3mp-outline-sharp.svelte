...
const content = `<path class="r_qk72e4k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:3mp-outline-sharp" {...props}></Icon>
<style>
:global(.r_qk72e4k) {
  fill: currentColor;
