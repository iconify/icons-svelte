...
const content = `<path class="trwy6jdnm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:3p-outline-sharp" {...props}></Icon>
<style>
:global(.trwy6jdnm) {
  fill: currentColor;
