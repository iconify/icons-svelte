...
const content = `<g class="y9tr6bcfx"><path class="j08680byf"/><path class="itgjopbhc"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:3d-collection" {...props}></Icon>
<style>
:global(.itgjopbhc) {
