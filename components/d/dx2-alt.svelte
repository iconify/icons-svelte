...
const content = `<path class="fjq19ykyo"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:dx2-alt" {...props}></Icon>
<style>
:global(.fjq19ykyo) {
  fill: none;
  stroke: currentColor;
