...
const content = `<path class="bwtu1jp0e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:developer-board-outline-sharp" {...props}></Icon>
<style>
:global(.bwtu1jp0e) {
  fill: currentColor;
