...
const content = `<g class="ft5dv1b6b"><path class="xe0coubdn"/><path class="tyavo3n9o"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:df" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
