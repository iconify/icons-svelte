...
const content = `<path class="f9w6j4b_j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:diamond-dismiss-24-regular" {...props}></Icon>
<style>
:global(.f9w6j4b_j) {
  fill: currentColor;
