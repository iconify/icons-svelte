...
const content = `<path class="jgea5pbxe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:dictionary" {...props}></Icon>
<style>
:global(.jgea5pbxe) {
  fill: currentColor;
