...
const content = `<g class="cuyn6tgcc"><path class="ig038kb3s"/><path class="gysykrgam"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:dresser-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
