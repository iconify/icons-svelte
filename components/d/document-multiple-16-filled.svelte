...
const content = `<path class="pfo3exb4f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-multiple-16-filled" {...props}></Icon>
<style>
:global(.pfo3exb4f) {
  fill: currentColor;
