...
const content = `<path class="ji68w9r4k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:display-add-outline-rounded" {...props}></Icon>
<style>
:global(.ji68w9r4k) {
  fill: currentColor;
