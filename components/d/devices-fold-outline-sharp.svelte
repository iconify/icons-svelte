...
const content = `<path class="h65a30bxr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:devices-fold-outline-sharp" {...props}></Icon>
<style>
:global(.h65a30bxr) {
  fill: currentColor;
