...
const content = `<path class="tws9dk5mc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:device-meeting-room-bar-12-regular" {...props}></Icon>
<style>
:global(.tws9dk5mc) {
  fill: currentColor;
