...
const content = `<path class="hwn9df2lg"/><path class="phdj3eblz"/><path class="wet5n_boy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:de-3-sat" {...props}></Icon>
<style>
:global(.hwn9df2lg) {
  fill: none;
  stroke: currentColor;
