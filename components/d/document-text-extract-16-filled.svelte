...
const content = `<path class="ye8k20h_u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-text-extract-16-filled" {...props}></Icon>
<style>
:global(.ye8k20h_u) {
  fill: currentColor;
