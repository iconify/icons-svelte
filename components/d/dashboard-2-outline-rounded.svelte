...
const content = `<path class="imf6p331a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:dashboard-2-outline-rounded" {...props}></Icon>
<style>
:global(.imf6p331a) {
  fill: currentColor;
