...
const content = `<path class="sdsa7hmhl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-one-page-28-filled" {...props}></Icon>
<style>
:global(.sdsa7hmhl) {
  fill: currentColor;
