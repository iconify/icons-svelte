...
const content = `<path class="d95-krwzl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:device-meeting-room-24-filled" {...props}></Icon>
<style>
:global(.d95-krwzl) {
  fill: currentColor;
