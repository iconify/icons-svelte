...
const content = `<path class="v0wnnv3-z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:dashboard-2-edit-sharp" {...props}></Icon>
<style>
:global(.v0wnnv3-z) {
  fill: currentColor;
