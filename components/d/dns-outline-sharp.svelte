...
const content = `<path class="vzu1puw3u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:dns-outline-sharp" {...props}></Icon>
<style>
:global(.vzu1puw3u) {
  fill: currentColor;
