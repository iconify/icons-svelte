...
const content = `<path class="odhqc3eat"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:dns-outline-sharp" {...props}></Icon>
<style>
:global(.odhqc3eat) {
  fill: currentColor;
