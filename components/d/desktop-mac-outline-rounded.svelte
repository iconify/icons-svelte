...
const content = `<path class="p4qq4fbdh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:desktop-mac-outline-rounded" {...props}></Icon>
<style>
:global(.p4qq4fbdh) {
  fill: currentColor;
