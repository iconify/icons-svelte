...
const content = `<path class="iowhbcb6j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:door-arrow-right-28-filled" {...props}></Icon>
<style>
:global(.iowhbcb6j) {
  fill: currentColor;
