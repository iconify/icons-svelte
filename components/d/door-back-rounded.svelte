...
const content = `<path class="s_2c05b6t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:door-back-rounded" {...props}></Icon>
<style>
:global(.s_2c05b6t) {
  fill: currentColor;
