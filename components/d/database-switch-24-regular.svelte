...
const content = `<path class="ineuwcrvg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:database-switch-24-regular" {...props}></Icon>
<style>
:global(.ineuwcrvg) {
  fill: currentColor;
