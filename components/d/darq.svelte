...
const content = `<path class="t23erkbai"/><path class="pmfv6-bfi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:darq" {...props}></Icon>
<style>
:global(.pmfv6-bfi) {
  fill: none;
  stroke: currentColor;
