...
const content = `<g class="cuyn6tgcc"><path class="rn19rbcks"/><path class="bm63p68kt"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:dots-three-outline-vertical-duotone" {...props}></Icon>
<style>
:global(.bm63p68kt) {
