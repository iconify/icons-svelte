...
const content = `<path class="u9lgkbyee"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:dual-screen-group-20-regular" {...props}></Icon>
<style>
:global(.u9lgkbyee) {
  fill: currentColor;
