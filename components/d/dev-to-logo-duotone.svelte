...
const content = `<g class="cuyn6tgcc"><path class="tbx9n_bwu"/><path class="dd58zk-yc"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:dev-to-logo-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
