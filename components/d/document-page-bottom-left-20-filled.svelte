...
const content = `<path class="rdz_vtbcr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-page-bottom-left-20-filled" {...props}></Icon>
<style>
:global(.rdz_vtbcr) {
  fill: currentColor;
