...
const content = `<path class="i4ios3ouv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:data-thresholding-sharp" {...props}></Icon>
<style>
:global(.i4ios3ouv) {
  fill: currentColor;
