...
const content = `<path class="vbz9zjmpp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:dual-screen-status-bar-20-regular" {...props}></Icon>
<style>
:global(.vbz9zjmpp) {
  fill: currentColor;
