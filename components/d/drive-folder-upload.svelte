...
const content = `<path class="liy0afbfb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:drive-folder-upload" {...props}></Icon>
<style>
:global(.liy0afbfb) {
  fill: currentColor;
