...
const content = `<path class="q0k77uqig"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:display-add-outline" {...props}></Icon>
<style>
:global(.q0k77uqig) {
  fill: currentColor;
