...
const content = `<path class="o9buj6mkp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-one-page-32-filled" {...props}></Icon>
<style>
:global(.o9buj6mkp) {
  fill: currentColor;
