...
const content = `<path class="rzmzqyttv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:door-front-outline-rounded" {...props}></Icon>
<style>
:global(.rzmzqyttv) {
  fill: currentColor;
