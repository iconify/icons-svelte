...
const content = `<path class="xy15grbgw"/><path class="re-rqeb_o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:daum" {...props}></Icon>
<style>
:global(.re-rqeb_o) {
  fill: none;
  stroke: currentColor;
