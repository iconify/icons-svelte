...
const content = `<path class="y53kr2b4a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:door-sliding-outline-rounded" {...props}></Icon>
<style>
:global(.y53kr2b4a) {
  fill: currentColor;
