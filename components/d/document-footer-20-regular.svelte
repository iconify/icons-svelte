...
const content = `<path class="uio6rhbni"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-footer-20-regular" {...props}></Icon>
<style>
:global(.uio6rhbni) {
  fill: currentColor;
