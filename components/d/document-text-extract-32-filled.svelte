...
const content = `<path class="nfow-6bva"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-text-extract-32-filled" {...props}></Icon>
<style>
:global(.nfow-6bva) {
  fill: currentColor;
