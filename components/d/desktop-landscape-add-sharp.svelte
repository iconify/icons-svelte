...
const content = `<path class="sw9doviwb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:desktop-landscape-add-sharp" {...props}></Icon>
<style>
:global(.sw9doviwb) {
  fill: currentColor;
