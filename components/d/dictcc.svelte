...
const content = `<path class="o707_xbjc"/><path class="daj46ebyc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:dictcc" {...props}></Icon>
<style>
:global(.daj46ebyc) {
  fill: none;
  stroke: currentColor;
