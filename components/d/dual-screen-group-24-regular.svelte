...
const content = `<path class="ltop3pb7t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:dual-screen-group-24-regular" {...props}></Icon>
<style>
:global(.ltop3pb7t) {
  fill: currentColor;
