...
const content = `<path class="pef6-hbuu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:desktop-access-disabled" {...props}></Icon>
<style>
:global(.pef6-hbuu) {
  fill: currentColor;
