...
const content = `<path class="f-in62b8y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:desktop-mac-rounded" {...props}></Icon>
<style>
:global(.f-in62b8y) {
  fill: currentColor;
