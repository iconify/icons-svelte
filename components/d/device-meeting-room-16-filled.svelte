...
const content = `<path class="qhx29xhhq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:device-meeting-room-16-filled" {...props}></Icon>
<style>
:global(.qhx29xhhq) {
  fill: currentColor;
