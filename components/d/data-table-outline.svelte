...
const content = `<path class="zr57avb4e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:data-table-outline" {...props}></Icon>
<style>
:global(.zr57avb4e) {
  fill: currentColor;
