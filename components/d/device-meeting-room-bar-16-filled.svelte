...
const content = `<path class="e1s0imbqk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:device-meeting-room-bar-16-filled" {...props}></Icon>
<style>
:global(.e1s0imbqk) {
  fill: currentColor;
