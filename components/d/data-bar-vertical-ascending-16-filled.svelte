...
const content = `<path class="yhl0lr-7v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:data-bar-vertical-ascending-16-filled" {...props}></Icon>
<style>
:global(.yhl0lr-7v) {
  fill: currentColor;
