...
const content = `<path class="pdkkr7b8d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:dual-screen-pagination-20-filled" {...props}></Icon>
<style>
:global(.pdkkr7b8d) {
  fill: currentColor;
