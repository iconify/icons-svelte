...
const content = `<g class="cuyn6tgcc"><path class="ad5y8wbzs"/><path class="v3vwoj7qq"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:dots-six-duotone" {...props}></Icon>
<style>
:global(.ad5y8wbzs) {
