...
const content = `<path class="gpnt34b1b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:door-sliding-sharp" {...props}></Icon>
<style>
:global(.gpnt34b1b) {
  fill: currentColor;
