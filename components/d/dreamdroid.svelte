...
const content = `<path class="hwy-kwbhl"/><rect class="tg8vugi2c"/><path class="he77ygbtj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:dreamdroid" {...props}></Icon>
<style>
:global(.he77ygbtj) {
  fill: none;
  stroke: currentColor;
