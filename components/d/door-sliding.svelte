...
const content = `<path class="mq9elcfxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:door-sliding" {...props}></Icon>
<style>
:global(.mq9elcfxi) {
  fill: currentColor;
