...
const content = `<path class="ib6g-_bhj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:device-meeting-room-bar-20-filled" {...props}></Icon>
<style>
:global(.ib6g-_bhj) {
  fill: currentColor;
