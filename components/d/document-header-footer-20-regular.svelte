...
const content = `<path class="zmrrexedy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-header-footer-20-regular" {...props}></Icon>
<style>
:global(.zmrrexedy) {
  fill: currentColor;
