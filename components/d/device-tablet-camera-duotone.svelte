...
const content = `<g class="cuyn6tgcc"><path class="k-hmvyqnc"/><path class="r_9aubc1g"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:device-tablet-camera-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
