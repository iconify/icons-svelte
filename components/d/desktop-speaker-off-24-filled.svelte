...
const content = `<path class="dzri4tb6t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:desktop-speaker-off-24-filled" {...props}></Icon>
<style>
:global(.dzri4tb6t) {
  fill: currentColor;
