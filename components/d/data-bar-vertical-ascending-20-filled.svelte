...
const content = `<path class="kj72z7b2g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:data-bar-vertical-ascending-20-filled" {...props}></Icon>
<style>
:global(.kj72z7b2g) {
  fill: currentColor;
