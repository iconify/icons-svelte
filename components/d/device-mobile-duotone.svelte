...
const content = `<g class="cuyn6tgcc"><path class="xvqpnzzel"/><path class="rlpkcqz_n"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:device-mobile-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
