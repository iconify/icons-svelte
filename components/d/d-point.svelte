...
const content = `<path class="tgw1tmjll"/><path class="i16b5xbzm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:d-point" {...props}></Icon>
<style>
:global(.i16b5xbzm) {
  fill: none;
  stroke: currentColor;
