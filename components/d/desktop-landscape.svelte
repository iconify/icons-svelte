...
const content = `<path class="kh5ms3bsf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:desktop-landscape" {...props}></Icon>
<style>
:global(.kh5ms3bsf) {
  fill: currentColor;
