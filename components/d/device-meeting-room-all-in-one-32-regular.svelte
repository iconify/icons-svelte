...
const content = `<path class="q1kvbxbsp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:device-meeting-room-all-in-one-32-regular" {...props}></Icon>
<style>
:global(.q1kvbxbsp) {
  fill: currentColor;
