...
const content = `<path class="t-fcmxbon"/><path class="c2h-ij26t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:dito" {...props}></Icon>
<style>
:global(.c2h-ij26t) {
  fill: none;
  stroke: currentColor;
