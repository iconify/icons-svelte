...
const content = `<path class="c6s4-s56s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:door-back-outline-rounded" {...props}></Icon>
<style>
:global(.c6s4-s56s) {
  fill: currentColor;
