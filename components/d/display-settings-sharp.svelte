...
const content = `<path class="mljm14b5f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:display-settings-sharp" {...props}></Icon>
<style>
:global(.mljm14b5f) {
  fill: currentColor;
