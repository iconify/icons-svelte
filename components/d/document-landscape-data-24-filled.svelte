...
const content = `<path class="t4fp1vfbz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-landscape-data-24-filled" {...props}></Icon>
<style>
:global(.t4fp1vfbz) {
  fill: currentColor;
