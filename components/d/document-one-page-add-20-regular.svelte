...
const content = `<path class="yixutekvi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-one-page-add-20-regular" {...props}></Icon>
<style>
:global(.yixutekvi) {
  fill: currentColor;
