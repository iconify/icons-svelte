...
const content = `<path class="vs3e13rjl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:detector-alarm-sharp" {...props}></Icon>
<style>
:global(.vs3e13rjl) {
  fill: currentColor;
