...
const content = `<path class="kg0y7n6ik"/><rect class="tk1y-acic"/><path class="s4_gmnovw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:dasher" {...props}></Icon>
<style>
:global(.kg0y7n6ik) {
  fill: none;
  stroke: currentColor;
