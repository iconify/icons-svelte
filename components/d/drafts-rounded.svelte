...
const content = `<path class="uu2ikgb8c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:drafts-rounded" {...props}></Icon>
<style>
:global(.uu2ikgb8c) {
  fill: currentColor;
