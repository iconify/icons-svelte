...
const content = `<rect class="j3s9ivbxi"/><path class="cup5tmi8n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:digital-rupee-alt" {...props}></Icon>
<style>
:global(.cup5tmi8n) {
  fill: none;
  stroke: currentColor;
