...
const content = `<path class="u1dei5bih"/><path class="n50ykac5i"/><circle class="l1dutkqjb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:drinkable" {...props}></Icon>
<style>
:global(.l1dutkqjb) {
  cx: 32.345px;
  cy: 7.676px;
