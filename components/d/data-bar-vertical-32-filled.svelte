...
const content = `<path class="radu1-brl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:data-bar-vertical-32-filled" {...props}></Icon>
<style>
:global(.radu1-brl) {
  fill: currentColor;
