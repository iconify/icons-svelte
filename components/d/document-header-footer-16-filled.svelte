...
const content = `<path class="l4lsrbbaf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-header-footer-16-filled" {...props}></Icon>
<style>
:global(.l4lsrbbaf) {
  fill: currentColor;
