...
const content = `<path class="h7kuf_bxl"/><path class="b3wvv-gmt"/><path class="ktf6mc6jz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:dina" {...props}></Icon>
<style>
:global(.b3wvv-gmt) {
  fill: none;
  stroke: currentColor;
