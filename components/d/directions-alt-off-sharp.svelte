...
const content = `<path class="mgai3o1sj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:directions-alt-off-sharp" {...props}></Icon>
<style>
:global(.mgai3o1sj) {
  fill: currentColor;
