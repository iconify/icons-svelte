...
const content = `<g class="hntgybcog"><path class="k6nj2fbya"/><path class="ermdcdc5z"/><path class="rllhknboo"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:dns-ttl-outline-thin" {...props}></Icon>
<style>
:global(.ermdcdc5z) {
