...
const content = `<path class="iwj627bah"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:detector-alarm-outline-sharp" {...props}></Icon>
<style>
:global(.iwj627bah) {
  fill: currentColor;
