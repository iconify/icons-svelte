...
const content = `<path class="braq5_b9o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:detector-alarm-outline-sharp" {...props}></Icon>
<style>
:global(.braq5_b9o) {
  fill: currentColor;
