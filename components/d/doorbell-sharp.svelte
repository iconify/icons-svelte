...
const content = `<path class="tbteqomwj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:doorbell-sharp" {...props}></Icon>
<style>
:global(.tbteqomwj) {
  fill: currentColor;
