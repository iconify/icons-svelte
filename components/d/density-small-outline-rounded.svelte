...
const content = `<path class="b7vc8co0m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:density-small-outline-rounded" {...props}></Icon>
<style>
:global(.b7vc8co0m) {
  fill: currentColor;
