...
const content = `<path class="c0_p6m8by"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-landscape-split-20-regular" {...props}></Icon>
<style>
:global(.c0_p6m8by) {
  fill: currentColor;
