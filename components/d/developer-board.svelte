...
const content = `<path class="xac-jc4fv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:developer-board" {...props}></Icon>
<style>
:global(.xac-jc4fv) {
  fill: currentColor;
