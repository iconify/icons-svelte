...
const content = `<path class="n-a5vyb1j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:desktop-windows-outline-rounded" {...props}></Icon>
<style>
:global(.n-a5vyb1j) {
  fill: currentColor;
