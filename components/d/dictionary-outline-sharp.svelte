...
const content = `<path class="taj-wacoa"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:dictionary-outline-sharp" {...props}></Icon>
<style>
:global(.taj-wacoa) {
  fill: currentColor;
