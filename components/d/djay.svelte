...
const content = `<path class="xm9uzjeuh"/><path class="wuf2pcbej"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:djay" {...props}></Icon>
<style>
:global(.wuf2pcbej) {
  fill: none;
  stroke: currentColor;
