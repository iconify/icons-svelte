...
const content = `<path class="zrd9ksbqb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:delete-sweep" {...props}></Icon>
<style>
:global(.zrd9ksbqb) {
  fill: currentColor;
