...
const content = `<path class="aunk6sdsf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:date-range-sharp" {...props}></Icon>
<style>
:global(.aunk6sdsf) {
  fill: currentColor;
