...
const content = `<path class="wpvqw_yce"/><rect class="p1um_wbqu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:dkbbanking" {...props}></Icon>
<style>
:global(.p1um_wbqu) {
  width: 37px;
  height: 37px;
