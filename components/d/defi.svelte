...
const content = `<g class="ft5dv1b6b"><path class="ih8igackk"/><path class="shojkc1ho"/><path class="z4gje-kcl"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:defi" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
