...
const content = `<rect class="y73l8_gch"/><path class="lxn0znkwl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:destiny-2" {...props}></Icon>
<style>
:global(.lxn0znkwl) {
  fill: none;
  stroke: currentColor;
