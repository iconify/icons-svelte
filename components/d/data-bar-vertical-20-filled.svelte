...
const content = `<path class="pqaxqn4zt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:data-bar-vertical-20-filled" {...props}></Icon>
<style>
:global(.pqaxqn4zt) {
  fill: currentColor;
