...
const content = `<path class="kd6m6bbyb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:dashboard-2-edit" {...props}></Icon>
<style>
:global(.kd6m6bbyb) {
  fill: currentColor;
