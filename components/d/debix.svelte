...
const content = `<rect class="d9m5lacjb"/><path class="zta7oy6hj"/><path class="ygmweqbak"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:debix" {...props}></Icon>
<style>
:global(.d9m5lacjb) {
  width: 29.981px;
  height: 19.711px;
