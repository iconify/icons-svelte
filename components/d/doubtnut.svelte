...
const content = `<path class="eiaj6e7lm"/><path class="exdo44nrt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:doubtnut" {...props}></Icon>
<style>
:global(.eiaj6e7lm) {
  fill: none;
  stroke: currentColor;
