...
const content = `<path class="y0ejbk2qv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:data-usage-sparkle-24-filled" {...props}></Icon>
<style>
:global(.y0ejbk2qv) {
  fill: currentColor;
