...
const content = `<path class="dmca72itk"/><path class="q5uf-4-mu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:doc-scanner" {...props}></Icon>
<style>
:global(.dmca72itk) {
  fill: none;
  stroke: currentColor;
