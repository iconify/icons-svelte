...
const content = `<path class="aqahm-3db"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:dual-screen-group-24-filled" {...props}></Icon>
<style>
:global(.aqahm-3db) {
  fill: currentColor;
