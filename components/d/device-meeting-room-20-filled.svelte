...
const content = `<path class="w815h55ru"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:device-meeting-room-20-filled" {...props}></Icon>
<style>
:global(.w815h55ru) {
  fill: currentColor;
