...
const content = `<g class="ow19cxbsq"><path class="aqr5fpb5b"/><path class="u869bvbyw"/></g><path class="jtjzuobcm"/><path class="ohy1cbv3a"/><path class="z4x53x7hm"/><circle class="lha2zurqu"/><path class="d7p12ubiu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:dove" {...props}></Icon>
<style>
:global(.aqr5fpb5b) {
