...
const content = `<path class="kgd043bjx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-sparkle-48-regular" {...props}></Icon>
<style>
:global(.kgd043bjx) {
  fill: currentColor;
