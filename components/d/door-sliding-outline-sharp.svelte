...
const content = `<path class="ryw4k4ybv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:door-sliding-outline-sharp" {...props}></Icon>
<style>
:global(.ryw4k4ybv) {
  fill: currentColor;
