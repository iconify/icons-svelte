...
const content = `<path class="z0771rbtt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:dual-screen-pagination-20-regular" {...props}></Icon>
<style>
:global(.z0771rbtt) {
  fill: currentColor;
