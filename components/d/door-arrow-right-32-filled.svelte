...
const content = `<path class="tz9pzddwx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:door-arrow-right-32-filled" {...props}></Icon>
<style>
:global(.tz9pzddwx) {
  fill: currentColor;
