...
const content = `<path class="gegn7nugn"/><ellipse class="lp5ysqb2k"/><path class="zloj8n2ef"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:datadex" {...props}></Icon>
<style>
:global(.gegn7nugn) {
  fill: none;
  stroke: currentColor;
