...
const content = `<path class="ows2n9flm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:data-usage-sparkle-24-regular" {...props}></Icon>
<style>
:global(.ows2n9flm) {
  fill: currentColor;
