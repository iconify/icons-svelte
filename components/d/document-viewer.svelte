...
const content = `<path class="p8ft86b0n"/><path class="plp2zlboe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:document-viewer" {...props}></Icon>
<style>
:global(.p8ft86b0n) {
  fill: none;
  stroke: currentColor;
