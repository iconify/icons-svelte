...
const content = `<path class="wkc7xt41c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:dual-screen-span-20-regular" {...props}></Icon>
<style>
:global(.wkc7xt41c) {
  fill: currentColor;
