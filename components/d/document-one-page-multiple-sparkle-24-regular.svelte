...
const content = `<path class="vhczy0tuu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-one-page-multiple-sparkle-24-regular" {...props}></Icon>
<style>
:global(.vhczy0tuu) {
  fill: currentColor;
