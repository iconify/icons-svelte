...
const content = `<g class="cuyn6tgcc"><path class="dm5w4csla"/><path class="cxh4mlwli"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:dice-four-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
