...
const content = `<path class="a3edm76xc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:date-range-outline-sharp" {...props}></Icon>
<style>
:global(.a3edm76xc) {
  fill: currentColor;
