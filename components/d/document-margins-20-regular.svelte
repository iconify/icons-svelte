...
const content = `<path class="b11tk1b-y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-margins-20-regular" {...props}></Icon>
<style>
:global(.b11tk1b-y) {
  fill: currentColor;
