...
const content = `<path class="sw3ajhb_d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:door-front-rounded" {...props}></Icon>
<style>
:global(.sw3ajhb_d) {
  fill: currentColor;
