...
const content = `<path class="gt4rpkbpx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:dynamic-form-outline" {...props}></Icon>
<style>
:global(.gt4rpkbpx) {
  fill: currentColor;
