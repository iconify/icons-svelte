...
const content = `<path class="yom8oybzz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-square-20-regular" {...props}></Icon>
<style>
:global(.yom8oybzz) {
  fill: currentColor;
