...
const content = `<path class="sfk-q741q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:dialogs-outline-rounded" {...props}></Icon>
<style>
:global(.sfk-q741q) {
  fill: currentColor;
