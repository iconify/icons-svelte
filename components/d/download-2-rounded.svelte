...
const content = `<path class="pvwj_vbhp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:download-2-rounded" {...props}></Icon>
<style>
:global(.pvwj_vbhp) {
  fill: currentColor;
