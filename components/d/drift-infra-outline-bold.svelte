...
const content = `<g class="s0phu2bbs"><path class="c4my-jbpv"/><path class="eqfz7ub4f"/><path class="g4lz7ob4p"/><path class="mohx50bqq"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:drift-infra-outline-bold" {...props}></Icon>
<style>
:global(.c4my-jbpv) {
