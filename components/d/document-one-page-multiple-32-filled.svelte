...
const content = `<path class="do26vw7rw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-one-page-multiple-32-filled" {...props}></Icon>
<style>
:global(.do26vw7rw) {
  fill: currentColor;
