...
const content = `<path class="xqcqjw5aq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-one-page-24-regular" {...props}></Icon>
<style>
:global(.xqcqjw5aq) {
  fill: currentColor;
