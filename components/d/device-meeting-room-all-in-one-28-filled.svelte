...
const content = `<path class="bk8cmtbyt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:device-meeting-room-all-in-one-28-filled" {...props}></Icon>
<style>
:global(.bk8cmtbyt) {
  fill: currentColor;
