...
const content = `<path class="kspxeubzu"/><path class="n8vjl-g3u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:dellconnect" {...props}></Icon>
<style>
:global(.kspxeubzu) {
  fill: none;
  stroke: currentColor;
