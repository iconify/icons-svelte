...
const content = `<rect class="n057jqi-c"/><path class="tlytpz1ft"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:digical" {...props}></Icon>
<style>
:global(.n057jqi-c) {
  width: 39px;
  height: 27.368px;
