...
const content = `<path class="o4jg2uk1p"/><g class="y9tr6bcfx"><circle class="ojua6ji1m"/><path class="m-yry0bao"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:downdetector" {...props}></Icon>
<style>
:global(.m-yry0bao) {
