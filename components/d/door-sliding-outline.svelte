...
const content = `<path class="ax188ubua"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:door-sliding-outline" {...props}></Icon>
<style>
:global(.ax188ubua) {
  fill: currentColor;
