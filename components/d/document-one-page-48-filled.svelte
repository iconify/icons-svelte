...
const content = `<path class="ki_zdgbir"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-one-page-48-filled" {...props}></Icon>
<style>
:global(.ki_zdgbir) {
  fill: currentColor;
