...
const content = `<path class="zwuroqbyh"/><path class="dv_r6zbgv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:drama-player" {...props}></Icon>
<style>
:global(.dv_r6zbgv) {
  fill: none;
  stroke: currentColor;
