...
const content = `<path class="xhblahbjw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:device-meeting-room-all-in-one-16-regular" {...props}></Icon>
<style>
:global(.xhblahbjw) {
  fill: currentColor;
