...
const content = `<path class="em5pgnb6h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:device-meeting-room-32-filled" {...props}></Icon>
<style>
:global(.em5pgnb6h) {
  fill: currentColor;
