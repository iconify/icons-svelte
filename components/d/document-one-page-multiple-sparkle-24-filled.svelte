...
const content = `<path class="wv7d1gmmy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-one-page-multiple-sparkle-24-filled" {...props}></Icon>
<style>
:global(.wv7d1gmmy) {
  fill: currentColor;
