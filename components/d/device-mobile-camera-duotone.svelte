...
const content = `<g class="cuyn6tgcc"><path class="dfsamqbrh"/><path class="cjp4rlbqg"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:device-mobile-camera-duotone" {...props}></Icon>
<style>
:global(.cjp4rlbqg) {
