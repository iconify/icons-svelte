...
const content = `<path class="iuagg_cyv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-text-extract-24-filled" {...props}></Icon>
<style>
:global(.iuagg_cyv) {
  fill: currentColor;
