...
const content = `<path class="lhphhsbdd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:developer-guide-outline-rounded" {...props}></Icon>
<style>
:global(.lhphhsbdd) {
  fill: currentColor;
