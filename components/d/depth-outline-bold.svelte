...
const content = `<g class="s0phu2bbs"><path class="naxvjtbgo"/><path class="csk4szidm"/><path class="efg_y9-xm"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:depth-outline-bold" {...props}></Icon>
<style>
:global(.csk4szidm) {
