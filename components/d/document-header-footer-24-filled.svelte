...
const content = `<path class="xb31sabuj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-header-footer-24-filled" {...props}></Icon>
<style>
:global(.xb31sabuj) {
  fill: currentColor;
