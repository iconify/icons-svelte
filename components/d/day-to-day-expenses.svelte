...
const content = `<path class="m6vr5p7of"/><path class="v2k0_xskf"/><path class="is2vlfytl"/><path class="sn3n0eket"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:day-to-day-expenses" {...props}></Icon>
<style>
:global(.is2vlfytl) {
  fill: none;
  stroke: currentColor;
