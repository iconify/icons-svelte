...
const content = `<path class="rwzu13b9h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-header-footer-32-filled" {...props}></Icon>
<style>
:global(.rwzu13b9h) {
  fill: currentColor;
