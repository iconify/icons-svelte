...
const content = `<path class="txpx86zyv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:dining-outline-sharp" {...props}></Icon>
<style>
:global(.txpx86zyv) {
  fill: currentColor;
