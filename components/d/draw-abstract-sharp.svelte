...
const content = `<path class="qzt_fyuwo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:draw-abstract-sharp" {...props}></Icon>
<style>
:global(.qzt_fyuwo) {
  fill: currentColor;
