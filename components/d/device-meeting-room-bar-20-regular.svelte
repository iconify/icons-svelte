...
const content = `<path class="ga24l6-7k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:device-meeting-room-bar-20-regular" {...props}></Icon>
<style>
:global(.ga24l6-7k) {
  fill: currentColor;
