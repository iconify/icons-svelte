...
const content = `<path class="l8mtbua6w"/><path class="u1-iqscuv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:developerwidget" {...props}></Icon>
<style>
:global(.l8mtbua6w) {
  fill: none;
  stroke: currentColor;
