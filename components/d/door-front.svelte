...
const content = `<path class="e_d7os7ji"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:door-front" {...props}></Icon>
<style>
:global(.e_d7os7ji) {
  fill: currentColor;
