...
const content = `<path class="kna9zbbfv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:device-meeting-room-bar-24-filled" {...props}></Icon>
<style>
:global(.kna9zbbfv) {
  fill: currentColor;
