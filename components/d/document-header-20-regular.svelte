...
const content = `<path class="f8ao5omru"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-header-20-regular" {...props}></Icon>
<style>
:global(.f8ao5omru) {
  fill: currentColor;
