...
const content = `<path class="ty_zuvenm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:data-bar-vertical-16-filled" {...props}></Icon>
<style>
:global(.ty_zuvenm) {
  fill: currentColor;
