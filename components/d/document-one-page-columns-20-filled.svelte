...
const content = `<path class="espt23b9q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-one-page-columns-20-filled" {...props}></Icon>
<style>
:global(.espt23b9q) {
  fill: currentColor;
