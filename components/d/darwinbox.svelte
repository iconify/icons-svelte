...
const content = `<path class="jnekhobuv"/><path class="tiaylr0vm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:darwinbox" {...props}></Icon>
<style>
:global(.jnekhobuv) {
  fill: none;
  stroke: currentColor;
