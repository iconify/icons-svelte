...
const content = `<path class="rh_fwybzz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:dashboard-outline-rounded" {...props}></Icon>
<style>
:global(.rh_fwybzz) {
  fill: currentColor;
