...
const content = `<path class="q4r95ccqq"/><path class="bdo7nm0hx"/><path class="ulau59bpz"/><path class="psyf6_b8t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:deedum" {...props}></Icon>
<style>
:global(.bdo7nm0hx) {
  fill: none;
  stroke: currentColor;
