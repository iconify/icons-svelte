...
const content = `<path class="h5adadbye"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:developer-mode-sharp" {...props}></Icon>
<style>
:global(.h5adadbye) {
  fill: currentColor;
