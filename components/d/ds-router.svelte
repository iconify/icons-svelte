...
const content = `<rect class="k6-9_0bqv"/><path class="tx5p-xvyz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ds-router" {...props}></Icon>
<style>
:global(.k6-9_0bqv) {
  width: 37px;
  height: 16.033px;
