...
const content = `<g class="cuyn6tgcc"><path class="s4t46duts"/><path class="k_qsnmb-e"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-checkmark-24-filled" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
