...
const content = `<path class="m_rpp-0xb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:data-bar-horizontal-descending-16-regular" {...props}></Icon>
<style>
:global(.m_rpp-0xb) {
  fill: currentColor;
