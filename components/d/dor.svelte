...
const content = `<g class="ft5dv1b6b"><path class="cerwxzxwb"/><path class="qtawm8l-j"/><path class="lbzobsb_k"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:dor" {...props}></Icon>
<style>
:global(.cerwxzxwb) {
