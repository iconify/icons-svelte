...
const content = `<path class="onnqm4mxo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:device-meeting-room-all-in-one-24-filled" {...props}></Icon>
<style>
:global(.onnqm4mxo) {
  fill: currentColor;
