...
const content = `<path class="s9l-1vbki"/><path class="jm-imrb9v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:dawdle" {...props}></Icon>
<style>
:global(.jm-imrb9v) {
  fill: none;
  stroke: currentColor;
