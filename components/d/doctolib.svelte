...
const content = `<path class="wz64ey1-d"/><path class="lrw44hiik"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:doctolib" {...props}></Icon>
<style>
:global(.lrw44hiik) {
  fill: none;
  stroke: currentColor;
