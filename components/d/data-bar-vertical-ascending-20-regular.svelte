...
const content = `<path class="muf9pj3dx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:data-bar-vertical-ascending-20-regular" {...props}></Icon>
<style>
:global(.muf9pj3dx) {
  fill: currentColor;
