...
const content = `<path class="a822_8igi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:data-bar-vertical-24-filled" {...props}></Icon>
<style>
:global(.a822_8igi) {
  fill: currentColor;
