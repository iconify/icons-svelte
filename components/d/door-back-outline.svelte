...
const content = `<path class="izzi_i4lj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:door-back-outline" {...props}></Icon>
<style>
:global(.izzi_i4lj) {
  fill: currentColor;
