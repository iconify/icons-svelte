...
const content = `<path class="d9mcdccll"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:desktop-speaker-off-24-regular" {...props}></Icon>
<style>
:global(.d9mcdccll) {
  fill: currentColor;
