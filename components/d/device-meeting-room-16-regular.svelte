...
const content = `<path class="tmz-0g8qt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:device-meeting-room-16-regular" {...props}></Icon>
<style>
:global(.tmz-0g8qt) {
  fill: currentColor;
