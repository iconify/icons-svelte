...
const content = `<path class="fjhjydbct"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-percent-24-filled" {...props}></Icon>
<style>
:global(.fjhjydbct) {
  fill: currentColor;
