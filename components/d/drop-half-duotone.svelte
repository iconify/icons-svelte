...
const content = `<g class="cuyn6tgcc"><path class="kqb7ycbay"/><path class="kp_v2bbtl"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:drop-half-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
