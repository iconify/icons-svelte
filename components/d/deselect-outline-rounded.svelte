...
const content = `<path class="fka91uj_e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:deselect-outline-rounded" {...props}></Icon>
<style>
:global(.fka91uj_e) {
  fill: currentColor;
