...
const content = `<path class="a27gwn1hl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:document-one-page-48-regular" {...props}></Icon>
<style>
:global(.a27gwn1hl) {
  fill: currentColor;
