...
const content = `<path class="z9plpkile"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:battery-charging-full" {...props}></Icon>
<style>
:global(.z9plpkile) {
  fill: currentColor;
