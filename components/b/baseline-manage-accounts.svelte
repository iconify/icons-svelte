...
const content = `<circle class="jie5odout"/><path class="rm7e5-9tq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:baseline-manage-accounts" {...props}></Icon>
<style>
:global(.jie5odout) {
  cx: 10px;
  cy: 8px;
