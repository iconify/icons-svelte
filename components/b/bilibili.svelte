...
const content = `<rect class="z7w0ulbte"/><path class="wdpd2-bzu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bilibili" {...props}></Icon>
<style>
:global(.wdpd2-bzu) {
  fill: none;
  stroke: currentColor;
