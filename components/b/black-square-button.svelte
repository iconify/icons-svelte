...
const content = `<path class="xlhh65b2u"/><path class="w_pl5z8xc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:black-square-button" {...props}></Icon>
<style>
:global(.w_pl5z8xc) {
