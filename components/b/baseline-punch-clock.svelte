...
const content = `<path class="vxnzx6r9m"/><path class="hgix6k0rl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:baseline-punch-clock" {...props}></Icon>
<style>
:global(.hgix6k0rl) {
  fill: currentColor;
