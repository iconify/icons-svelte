...
const content = `<path class="ll0g54h-q"/><path class="bkoflnbzw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bbva" {...props}></Icon>
<style>
:global(.bkoflnbzw) {
  fill: none;
  stroke: currentColor;
