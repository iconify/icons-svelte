...
const content = `<path class="j98an1bqd"/><path class="d1e08d4se"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:behance" {...props}></Icon>
<style>
:global(.d1e08d4se) {
  fill: none;
  stroke: currentColor;
