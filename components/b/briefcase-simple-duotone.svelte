...
const content = `<rect class="dhg84mvyh"/><path class="krbpyacjd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:briefcase-simple-duotone" {...props}></Icon>
<style>
:global(.dhg84mvyh) {
  x: 32.008px;
  y: 72px;
