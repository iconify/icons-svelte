...
const content = `<path class="d9e1n9b9k"/><path class="ckjiq7fbv"/><path class="dhh701blb"/><path class="it9x7tbsb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:bluemix" {...props}></Icon>
<style>
:global(.ckjiq7fbv) {
