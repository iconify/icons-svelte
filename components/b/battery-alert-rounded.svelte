...
const content = `<path class="sm-t66byv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:battery-alert-rounded" {...props}></Icon>
<style>
:global(.sm-t66byv) {
  fill: currentColor;
