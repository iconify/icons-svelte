...
const content = `<g class="ft5dv1b6b"><path class="u-geydb4u"/><path class="fasox9btf"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:bump" {...props}></Icon>
<style>
:global(.fasox9btf) {
