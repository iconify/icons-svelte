...
const content = `<path class="xmiyvtbcq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:bus-alert-rounded" {...props}></Icon>
<style>
:global(.xmiyvtbcq) {
  fill: currentColor;
