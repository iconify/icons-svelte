...
const content = `<path class="wnw7ydubc"/><path class="fb1n83eix"/><path class="d1k9-3bfe"/><ellipse class="ww3rg01bl"/><path class="mwpdb81vc"/><path class="rd7nzrqar"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:basket" {...props}></Icon>
<style>
:global(.d1k9-3bfe) {
