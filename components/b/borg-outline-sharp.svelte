...
const content = `<path class="fonng8qxd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:borg-outline-sharp" {...props}></Icon>
<style>
:global(.fonng8qxd) {
  fill: currentColor;
