...
const content = `<path class="cte5vbc-h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:backpack-outline-sharp" {...props}></Icon>
<style>
:global(.cte5vbc-h) {
  fill: currentColor;
