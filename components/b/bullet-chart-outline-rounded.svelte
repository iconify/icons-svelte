...
const content = `<path class="n1qachm3w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:bullet-chart-outline-rounded" {...props}></Icon>
<style>
:global(.n1qachm3w) {
  fill: currentColor;
