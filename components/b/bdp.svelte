...
const content = `<path class="suwedhb5m"/><path class="neusq4brl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bdp" {...props}></Icon>
<style>
:global(.neusq4brl) {
  fill: none;
  stroke: currentColor;
