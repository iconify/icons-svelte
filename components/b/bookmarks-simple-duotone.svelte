...
const content = `<g class="cuyn6tgcc"><path class="k_vvsjbfj"/><path class="kdb5ic2vu"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:bookmarks-simple-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
