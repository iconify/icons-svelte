...
const content = `<g class="jeunsn1yj"><path class="a0zalnbnr"/><path class="i89r3db9q"/></g><path class="bh2i2lbuv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione:battery" {...props}></Icon>
<style>
:global(.a0zalnbnr) {
