...
const content = `<path class="flsdn8ppi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:battery-alert-outline-sharp" {...props}></Icon>
<style>
:global(.flsdn8ppi) {
  fill: currentColor;
