...
const content = `<path class="icy9zxs8u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:bid-landscape-disabled-sharp" {...props}></Icon>
<style>
:global(.icy9zxs8u) {
  fill: currentColor;
