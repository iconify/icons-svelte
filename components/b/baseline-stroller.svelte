...
const content = `<circle class="oy4or8b1j"/><circle class="ki4grwbqx"/><path class="nxc9lccad"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:baseline-stroller" {...props}></Icon>
<style>
:global(.ki4grwbqx) {
  cx: 6px;
  cy: 20px;
