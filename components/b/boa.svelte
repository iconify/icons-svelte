...
const content = `<g class="ppa-drbvn"><path clip-rule="evenodd" class="d1vei4bpn"/><path class="dkamf7b5c"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:boa" {...props}></Icon>
<style>
:global(.d1vei4bpn) {
  fill-rule: evenodd;
