...
const content = `<g class="y9tr6bcfx"><path class="ce9j0tbyn"/><path class="ipbjcbc3d"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:banco-de-la-nacion" {...props}></Icon>
<style>
:global(.ce9j0tbyn) {
