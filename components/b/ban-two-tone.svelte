...
const content = `<g class="nrj6p8qat"><path class="g2u3clbzs"/><path class="j220zebnc"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:ban-two-tone" {...props}></Icon>
<style>
:global(.g2u3clbzs) {
  fill: currentColor;
