...
const content = `<path class="pulqawl3f"/><path class="x493s0bmx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bbw-cupid" {...props}></Icon>
<style>
:global(.pulqawl3f) {
  fill: none;
  stroke: currentColor;
