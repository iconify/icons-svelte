...
const content = `<path class="u08x6moqp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:bookmark-remove" {...props}></Icon>
<style>
:global(.u08x6moqp) {
  fill: currentColor;
