...
const content = `<path class="fhkg6ozft"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:bookmark-star-outline-sharp" {...props}></Icon>
<style>
:global(.fhkg6ozft) {
  fill: currentColor;
