...
const content = `<g class="cuyn6tgcc"><path class="p2lti1bba"/><path class="v6b374utt"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:book-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
