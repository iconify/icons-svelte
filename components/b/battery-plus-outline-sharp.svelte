...
const content = `<path class="vw-1d4bod"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:battery-plus-outline-sharp" {...props}></Icon>
<style>
:global(.vw-1d4bod) {
  fill: currentColor;
