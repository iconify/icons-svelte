...
const content = `<path class="uhno83b8l"/><path class="pz1xg0bcs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:breviary" {...props}></Icon>
<style>
:global(.pz1xg0bcs) {
  fill: none;
  stroke: currentColor;
