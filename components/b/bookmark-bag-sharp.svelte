...
const content = `<path class="drzjwob1x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:bookmark-bag-sharp" {...props}></Icon>
<style>
:global(.drzjwob1x) {
  fill: currentColor;
