...
const content = `<g class="ft5dv1b6b"><path class="e0gxazd0z"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:battery-full-20-filled" {...props}></Icon>
<style>
:global(.e0gxazd0z) {
