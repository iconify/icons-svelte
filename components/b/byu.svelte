...
const content = `<path class="i9clfwm2k"/><path class="bvufnri4z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:byu" {...props}></Icon>
<style>
:global(.bvufnri4z) {
  fill: none;
  stroke: currentColor;
