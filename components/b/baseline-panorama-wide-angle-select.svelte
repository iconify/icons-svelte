...
const content = `<path class="ow_4aebsw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:baseline-panorama-wide-angle-select" {...props}></Icon>
<style>
:global(.ow_4aebsw) {
  fill: currentColor;
