...
const content = `<path class="hb_l6zfnx"/><rect class="pvua4hbxe"/><path class="aa16owblt"/><circle class="lelvoupum"/><path class="p35vusn2n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:box-box-club" {...props}></Icon>
<style>
:global(.aa16owblt) {
  fill: none;
  stroke: currentColor;
