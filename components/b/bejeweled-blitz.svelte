...
const content = `<path class="r-5e03r1b"/><path class="s4036fbre"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bejeweled-blitz" {...props}></Icon>
<style>
:global(.r-5e03r1b) {
  fill: none;
  stroke: currentColor;
