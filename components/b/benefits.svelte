...
const content = `<path class="imesovblg"/><path class="ntta8cbbk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:benefits" {...props}></Icon>
<style>
:global(.imesovblg) {
  fill: none;
  stroke: currentColor;
