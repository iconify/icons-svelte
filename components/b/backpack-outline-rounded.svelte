...
const content = `<path class="prf7zebxx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:backpack-outline-rounded" {...props}></Icon>
<style>
:global(.prf7zebxx) {
  fill: currentColor;
