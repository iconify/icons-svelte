...
const content = `<path clip-rule="evenodd" class="d451uebmu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:bookmark" {...props}></Icon>
<style>
:global(.d451uebmu) {
  fill: currentColor;
  fill-rule: evenodd;
