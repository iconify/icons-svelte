...
const content = `<circle class="cpk0fnbgt"/><circle class="ivoeacboo"/><path class="mbty1dbao"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bmw" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
