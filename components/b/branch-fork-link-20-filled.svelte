...
const content = `<path class="vwdd4mhye"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:branch-fork-link-20-filled" {...props}></Icon>
<style>
:global(.vwdd4mhye) {
  fill: currentColor;
