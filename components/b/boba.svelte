...
const content = `<g class="ft5dv1b6b"><path class="ehosi5bwm"/><path class="nhs6h7ewl"/><path class="i2l1kqn_b"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:boba" {...props}></Icon>
<style>
:global(.ehosi5bwm) {
