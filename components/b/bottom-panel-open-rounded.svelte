...
const content = `<path class="iiw_44b1a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:bottom-panel-open-rounded" {...props}></Icon>
<style>
:global(.iiw_44b1a) {
  fill: currentColor;
