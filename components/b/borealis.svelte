...
const content = `<path class="e0cm8no2t"/><path class="j-tnh2umo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:borealis" {...props}></Icon>
<style>
:global(.e0cm8no2t) {
  fill: none;
  stroke: currentColor;
