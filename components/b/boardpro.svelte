...
const content = `<path class="rf6lnmp1x"/><path class="k61_v2b4f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:boardpro" {...props}></Icon>
<style>
:global(.k61_v2b4f) {
  fill: none;
  stroke: currentColor;
