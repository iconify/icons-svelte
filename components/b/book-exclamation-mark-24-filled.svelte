...
const content = `<path class="pwqzrg1rb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:book-exclamation-mark-24-filled" {...props}></Icon>
<style>
:global(.pwqzrg1rb) {
  fill: currentColor;
