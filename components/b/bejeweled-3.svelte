...
const content = `<path class="r-5e03r1b"/><path class="o3t3fkb8h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bejeweled-3" {...props}></Icon>
<style>
:global(.o3t3fkb8h) {
  fill: none;
  stroke: currentColor;
