...
const content = `<g class="cuyn6tgcc"><path class="r6p86db6y"/><path class="lygomtrpe"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:brackets-angle-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
