...
const content = `<path class="vbkxwab_f"/><path class="a46k2-bgv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:banque-pop" {...props}></Icon>
<style>
:global(.a46k2-bgv) {
  fill: none;
  stroke: currentColor;
