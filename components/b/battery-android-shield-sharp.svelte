...
const content = `<path class="v20qbbc4w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:battery-android-shield-sharp" {...props}></Icon>
<style>
:global(.v20qbbc4w) {
  fill: currentColor;
