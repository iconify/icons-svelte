...
const content = `<path class="wypgesbac"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:bookmark-added" {...props}></Icon>
<style>
:global(.wypgesbac) {
  fill: currentColor;
