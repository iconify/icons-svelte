...
const content = `<path class="y9xasp3xy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:book-4-outline-rounded" {...props}></Icon>
<style>
:global(.y9xasp3xy) {
  fill: currentColor;
