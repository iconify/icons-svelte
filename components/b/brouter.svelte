...
const content = `<path class="tcef6hblu"/><path class="ll0g54h-q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:brouter" {...props}></Icon>
<style>
:global(.ll0g54h-q) {
  fill: none;
  stroke: currentColor;
