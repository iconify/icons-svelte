...
const content = `<g class="cuyn6tgcc"><path class="b4m0ohb_o"/><path class="ftuj3yb7h"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:bookmark-duotone" {...props}></Icon>
<style>
:global(.b4m0ohb_o) {
