...
const content = `<path class="grqal1dgo"/><path class="xnat3ksqi"/><path class="u1i3v0bdg"/><path class="aic4x5b0h"/><path class="u-8eobbrs"/><path class="u4vwr2hih"/><ellipse transform="rotate(-60 41.931 38.702)" class="fmmg_bbeh"/><path class="cec4fvbpy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto:black-cat" {...props}></Icon>
<style>
:global(.aic4x5b0h) {
