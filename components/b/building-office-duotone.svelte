...
const content = `<g class="cuyn6tgcc"><path class="dly1gu13z"/><path class="nvd1c5b7i"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:building-office-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
