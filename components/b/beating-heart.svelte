...
const content = `<path class="qit8mmblg"/><path class="m_hjp199a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:beating-heart" {...props}></Icon>
<style>
:global(.m_hjp199a) {
