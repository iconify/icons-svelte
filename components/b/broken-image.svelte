...
const content = `<path class="dsudt8rzg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:broken-image" {...props}></Icon>
<style>
:global(.dsudt8rzg) {
  fill: currentColor;
