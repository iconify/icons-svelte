...
const content = `<path class="i5ksqfbad"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:battery-android-alert" {...props}></Icon>
<style>
:global(.i5ksqfbad) {
  fill: currentColor;
