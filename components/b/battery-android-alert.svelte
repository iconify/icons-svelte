...
const content = `<path class="mzg7pwbyh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:battery-android-alert" {...props}></Icon>
<style>
:global(.mzg7pwbyh) {
  fill: currentColor;
