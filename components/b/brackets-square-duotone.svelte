...
const content = `<g class="cuyn6tgcc"><path class="bg35r-f3d"/><path class="hx4l2nb6h"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:brackets-square-duotone" {...props}></Icon>
<style>
:global(.bg35r-f3d) {
