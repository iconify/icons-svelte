...
const content = `<path class="uo47pyvli"/><path class="uii7hhahu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:btn-mobile-banking" {...props}></Icon>
<style>
:global(.uii7hhahu) {
  fill: none;
  stroke: currentColor;
