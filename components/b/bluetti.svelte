...
const content = `<path class="cuuwy51jy"/><path class="e26xfob8q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bluetti" {...props}></Icon>
<style>
:global(.cuuwy51jy) {
  fill: none;
  stroke: currentColor;
