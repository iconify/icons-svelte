...
const content = `<path class="cwbab8n4g"/><path class="v-tmesbcv"/><circle class="oh080lb6g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:best-before" {...props}></Icon>
<style>
:global(.cwbab8n4g) {
  fill: none;
  stroke: currentColor;
