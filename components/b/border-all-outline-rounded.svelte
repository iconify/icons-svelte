...
const content = `<path class="qzaol7b1i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:border-all-outline-rounded" {...props}></Icon>
<style>
:global(.qzaol7b1i) {
  fill: currentColor;
