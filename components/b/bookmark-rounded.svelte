...
const content = `<path class="zun-ajbsv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:bookmark-rounded" {...props}></Icon>
<style>
:global(.zun-ajbsv) {
  fill: currentColor;
