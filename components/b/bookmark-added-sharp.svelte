...
const content = `<path class="cjtk3rbgm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:bookmark-added-sharp" {...props}></Icon>
<style>
:global(.cjtk3rbgm) {
  fill: currentColor;
