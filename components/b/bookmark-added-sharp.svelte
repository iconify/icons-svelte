...
const content = `<path class="o4pjcuu9e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:bookmark-added-sharp" {...props}></Icon>
<style>
:global(.o4pjcuu9e) {
  fill: currentColor;
