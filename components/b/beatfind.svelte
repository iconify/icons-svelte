...
const content = `<path class="h9co-vbtt"/><path class="nah16p-ef"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:beatfind" {...props}></Icon>
<style>
:global(.h9co-vbtt) {
  fill: none;
  stroke: currentColor;
