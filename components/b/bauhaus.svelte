...
const content = `<path class="p5stu0b1p"/><path class="c-buuwbeg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bauhaus" {...props}></Icon>
<style>
:global(.c-buuwbeg) {
  fill: none;
  stroke: currentColor;
