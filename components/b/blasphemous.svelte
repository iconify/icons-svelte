...
const content = `<path class="ptwj4xbql"/><path class="y1o_ryblr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:blasphemous" {...props}></Icon>
<style>
:global(.ptwj4xbql) {
  fill: none;
  stroke: currentColor;
