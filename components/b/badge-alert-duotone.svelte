...
const content = `<g class="nrj6p8qat"><path class="g70whwsdk"/><path class="c5yb8bdcb"/><path class="pcr6xabis"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:badge-alert-duotone" {...props}></Icon>
<style>
:global(.c5yb8bdcb) {
  d: path("M12 7V13");
}
