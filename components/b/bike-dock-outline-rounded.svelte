...
const content = `<path class="nbk5nob4b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:bike-dock-outline-rounded" {...props}></Icon>
<style>
:global(.nbk5nob4b) {
  fill: currentColor;
