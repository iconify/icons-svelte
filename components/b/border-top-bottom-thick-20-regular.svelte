...
const content = `<path class="e6dd48-uv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:border-top-bottom-thick-20-regular" {...props}></Icon>
<style>
:global(.e6dd48-uv) {
  fill: currentColor;
