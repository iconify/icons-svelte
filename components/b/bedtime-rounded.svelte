...
const content = `<path class="hi44eeo5p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:bedtime-rounded" {...props}></Icon>
<style>
:global(.hi44eeo5p) {
  fill: currentColor;
