...
const content = `<path class="vpzzlzi0u"/><path class="pmgg_ib6k"/><path class="lw5hw8bls"/><path class="zkx91zb7s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:bank" {...props}></Icon>
<style>
:global(.lw5hw8bls) {
  fill: currentColor;
