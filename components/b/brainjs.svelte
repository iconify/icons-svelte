...
const content = `<path class="x5yhfcbvc"/><path class="cbnyogbhp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:brainjs" {...props}></Icon>
<style>
:global(.cbnyogbhp) {
