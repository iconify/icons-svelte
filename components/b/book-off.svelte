...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="u8n-f4bsl"/><path clip-rule="evenodd" class="p733ncasu"/><path class="xedf9ccsf"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:book-off" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
