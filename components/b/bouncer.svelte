...
const content = `<ellipse class="qds7wmb4i"/><path class="pptuahb3u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bouncer" {...props}></Icon>
<style>
:global(.pptuahb3u) {
  fill: none;
  stroke: currentColor;
