...
const content = `<path class="m3vbmlovz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:battery-alert-outline" {...props}></Icon>
<style>
:global(.m3vbmlovz) {
  fill: currentColor;
