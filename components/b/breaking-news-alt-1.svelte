...
const content = `<path class="ky90mtpxo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:breaking-news-alt-1" {...props}></Icon>
<style>
:global(.ky90mtpxo) {
  fill: currentColor;
