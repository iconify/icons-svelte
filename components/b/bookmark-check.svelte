...
const content = `<path class="cdnyycc-s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:bookmark-check" {...props}></Icon>
<style>
:global(.cdnyycc-s) {
  fill: currentColor;
