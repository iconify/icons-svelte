...
const content = `<path class="dl4pz3_8y"/><path class="hnpre0bff"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:baseline-monitor-weight" {...props}></Icon>
<style>
:global(.dl4pz3_8y) {
  fill: currentColor;
