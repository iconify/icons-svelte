...
const content = `<g class="y9tr6bcfx"><path class="gu5j8_bkv"/><path class="pqmu7hbbs"/></g><path class="pcpfodbfz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bird" {...props}></Icon>
<style>
:global(.gu5j8_bkv) {
