...
const content = `<path class="miovc8bzb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:bid-landscape-disabled" {...props}></Icon>
<style>
:global(.miovc8bzb) {
  fill: currentColor;
