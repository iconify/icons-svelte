...
const content = `<path class="blg7_1x4s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:bid-landscape-disabled" {...props}></Icon>
<style>
:global(.blg7_1x4s) {
  fill: currentColor;
