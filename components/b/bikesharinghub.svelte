...
const content = `<path class="xhug8sdiu"/><path class="ryx7xtb7k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bikesharinghub" {...props}></Icon>
<style>
:global(.ryx7xtb7k) {
  fill: none;
  stroke: currentColor;
