...
const content = `<path class="hz2wm2z3y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:back-hand-sharp" {...props}></Icon>
<style>
:global(.hz2wm2z3y) {
  fill: currentColor;
