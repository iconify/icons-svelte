...
const content = `<g class="y9tr6bcfx"><path class="a3-25dzdw"/><path class="tmn7d5txh"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bluos" {...props}></Icon>
<style>
:global(.a3-25dzdw) {
