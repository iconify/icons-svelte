...
const content = `<path class="y-9-o46-e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:battery-vert-005-rounded" {...props}></Icon>
<style>
:global(.y-9-o46-e) {
  fill: currentColor;
