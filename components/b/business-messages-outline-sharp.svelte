...
const content = `<path class="o-g2abc8e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:business-messages-outline-sharp" {...props}></Icon>
<style>
:global(.o-g2abc8e) {
  fill: currentColor;
