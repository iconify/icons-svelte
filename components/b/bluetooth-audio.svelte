...
const content = `<path class="tf-n2zbiv"/><path class="yh6d9qb0y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bluetooth-audio" {...props}></Icon>
<style>
:global(.tf-n2zbiv) {
  fill: none;
  stroke: currentColor;
