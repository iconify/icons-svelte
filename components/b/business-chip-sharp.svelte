...
const content = `<path class="zo8tfg9af"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:business-chip-sharp" {...props}></Icon>
<style>
:global(.zo8tfg9af) {
  fill: currentColor;
