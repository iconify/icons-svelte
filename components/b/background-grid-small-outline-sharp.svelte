...
const content = `<path class="afx_czbwi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:background-grid-small-outline-sharp" {...props}></Icon>
<style>
:global(.afx_czbwi) {
  fill: currentColor;
