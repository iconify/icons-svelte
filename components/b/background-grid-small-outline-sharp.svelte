...
const content = `<path class="d-01u3btk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:background-grid-small-outline-sharp" {...props}></Icon>
<style>
:global(.d-01u3btk) {
  fill: currentColor;
