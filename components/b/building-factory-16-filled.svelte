...
const content = `<path class="ac79a3-vp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:building-factory-16-filled" {...props}></Icon>
<style>
:global(.ac79a3-vp) {
  fill: currentColor;
