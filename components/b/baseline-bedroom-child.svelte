...
const content = `<path class="cxv1vo7gx"/><path class="n_lp83lns"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:baseline-bedroom-child" {...props}></Icon>
<style>
:global(.cxv1vo7gx) {
  fill: currentColor;
