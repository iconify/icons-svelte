...
const content = `<path class="ll0g54h-q"/><path class="yl-bcd0jg"/><rect class="u19-ddbuc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bdo-digital-banking" {...props}></Icon>
<style>
:global(.ll0g54h-q) {
  fill: none;
  stroke: currentColor;
