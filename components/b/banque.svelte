...
const content = `<path class="lvtrobcrs"/><circle class="bf_1ucieo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:banque" {...props}></Icon>
<style>
:global(.bf_1ucieo) {
  cx: 33.87px;
  cy: 23.86px;
