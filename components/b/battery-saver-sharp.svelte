...
const content = `<path class="vmxsmjd2w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:battery-saver-sharp" {...props}></Icon>
<style>
:global(.vmxsmjd2w) {
  fill: currentColor;
