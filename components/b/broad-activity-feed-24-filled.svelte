...
const content = `<path class="vqokf7-mr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:broad-activity-feed-24-filled" {...props}></Icon>
<style>
:global(.vqokf7-mr) {
  fill: currentColor;
