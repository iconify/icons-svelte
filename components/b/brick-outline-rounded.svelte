...
const content = `<path class="b0br--b3a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:brick-outline-rounded" {...props}></Icon>
<style>
:global(.b0br--b3a) {
  fill: currentColor;
