...
const content = `<path class="oc8kl7p6b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:beenhere-outline" {...props}></Icon>
<style>
:global(.oc8kl7p6b) {
  fill: currentColor;
