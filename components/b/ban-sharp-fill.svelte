...
const content = `<path clip-rule="evenodd" class="se4exfb1h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:ban-sharp-fill" {...props}></Icon>
<style>
:global(.se4exfb1h) {
  fill: currentColor;
  fill-rule: evenodd;
