...
const content = `<path class="wdodg2bza"/><path class="mvtve0b-c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:backgroundrestrictor" {...props}></Icon>
<style>
:global(.mvtve0b-c) {
  fill: none;
  stroke: currentColor;
