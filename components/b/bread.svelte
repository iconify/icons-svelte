...
const content = `<path class="kh1-klb1v"/><path class="bze29ccme"/><path class="rpa4wdb7n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-v1:bread" {...props}></Icon>
<style>
:global(.bze29ccme) {
