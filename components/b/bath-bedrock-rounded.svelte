...
const content = `<path class="zdzqwrobc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:bath-bedrock-rounded" {...props}></Icon>
<style>
:global(.zdzqwrobc) {
  fill: currentColor;
