...
const content = `<path class="ax5qd8b8h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:battery-warning-vertical-light" {...props}></Icon>
<style>
:global(.ax5qd8b8h) {
  fill: currentColor;
