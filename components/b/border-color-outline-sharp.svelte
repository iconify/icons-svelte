...
const content = `<path class="znahdub7k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:border-color-outline-sharp" {...props}></Icon>
<style>
:global(.znahdub7k) {
  fill: currentColor;
