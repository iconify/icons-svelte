...
const content = `<g class="cuyn6tgcc"><path class="rk2a66ahi"/><path class="bvi81v_pm"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:bookmark-simple-duotone" {...props}></Icon>
<style>
:global(.bvi81v_pm) {
