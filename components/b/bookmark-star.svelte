...
const content = `<path class="kzct7obua"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:bookmark-star" {...props}></Icon>
<style>
:global(.kzct7obua) {
  fill: currentColor;
