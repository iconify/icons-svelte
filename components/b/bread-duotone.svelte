...
const content = `<g class="cuyn6tgcc"><path class="ijgfo6b_g"/><path class="ym0o9qbap"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:bread-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
