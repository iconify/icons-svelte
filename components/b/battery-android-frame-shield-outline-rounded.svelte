...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:battery-android-frame-shield-outline-rounded" {...props}></Icon>
<style>
:global(.r3r5djbhr) {
  fill: currentColor;
