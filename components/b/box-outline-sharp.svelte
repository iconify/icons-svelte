...
const content = `<path class="tm8hxmkor"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:box-outline-sharp" {...props}></Icon>
<style>
:global(.tm8hxmkor) {
  fill: currentColor;
