...
const content = `<path class="tp1kzry-v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:border-horizontal-outline-rounded" {...props}></Icon>
<style>
:global(.tp1kzry-v) {
  fill: currentColor;
