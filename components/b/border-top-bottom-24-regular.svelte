...
const content = `<path class="auqqahv7l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:border-top-bottom-24-regular" {...props}></Icon>
<style>
:global(.auqqahv7l) {
  fill: currentColor;
