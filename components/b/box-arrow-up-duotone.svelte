...
const content = `<g class="cuyn6tgcc"><path class="q0bupis9x"/><path class="f8v0ztb7q"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:box-arrow-up-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
