...
const content = `<path class="vk7a09btd"/><path class="pqwinkapu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:batdongsancomvn" {...props}></Icon>
<style>
:global(.pqwinkapu) {
  fill: none;
  stroke: currentColor;
