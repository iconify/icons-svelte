...
const content = `<g class="cuyn6tgcc"><path class="darbm1s7t"/><path class="szbftzb1k"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:barcode-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
