...
const content = `<path class="idl483bve"/><path class="etjvf9bdt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:better-open-with" {...props}></Icon>
<style>
:global(.etjvf9bdt) {
  fill: none;
  stroke: currentColor;
