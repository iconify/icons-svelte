...
const content = `<g class="cuyn6tgcc"><path class="l5az3ob_r"/><path class="cazxgnbny"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:boot-duotone" {...props}></Icon>
<style>
:global(.cazxgnbny) {
