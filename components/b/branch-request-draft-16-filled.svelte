...
const content = `<path class="d8rmn7b6i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:branch-request-draft-16-filled" {...props}></Icon>
<style>
:global(.d8rmn7b6i) {
  fill: currentColor;
