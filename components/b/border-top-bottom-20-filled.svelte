...
const content = `<path class="h7vizdbee"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:border-top-bottom-20-filled" {...props}></Icon>
<style>
:global(.h7vizdbee) {
  fill: currentColor;
