...
const content = `<rect class="j3s9ivbxi"/><path class="d2bilk8zh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:br-radio" {...props}></Icon>
<style>
:global(.d2bilk8zh) {
  fill: none;
  stroke: currentColor;
