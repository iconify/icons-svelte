...
const content = `<path class="s71jptzak"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:barcode-scanner-32-regular" {...props}></Icon>
<style>
:global(.s71jptzak) {
  fill: currentColor;
