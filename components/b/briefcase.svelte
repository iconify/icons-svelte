...
const content = `<path class="rhsn0wbko"/><path class="ztuy1v-kr"/><path class="sg_70qblk"/><path class="bg6jcfbfn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:briefcase" {...props}></Icon>
<style>
:global(.bg6jcfbfn) {
