...
const content = `<g class="cuyn6tgcc"><path class="wx8r9vk7p"/><path class="o0fahq_ov"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:beer-stein-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
