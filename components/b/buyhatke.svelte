...
const content = `<path class="xgtl3pawe"/><path class="ef534u9yc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:buyhatke" {...props}></Icon>
<style>
:global(.ef534u9yc) {
  fill: none;
  stroke: currentColor;
