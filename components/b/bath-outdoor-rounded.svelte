...
const content = `<path class="b8dqujmye"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:bath-outdoor-rounded" {...props}></Icon>
<style>
:global(.b8dqujmye) {
  fill: currentColor;
