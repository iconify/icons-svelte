...
const content = `<circle class="uob9racrf"/><path class="qd5h3b0tj"/><circle class="qf_qmdb8f"/><path class="enn7qbbny"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:blinkit" {...props}></Icon>
<style>
:global(.enn7qbbny) {
  fill: none;
  stroke: currentColor;
