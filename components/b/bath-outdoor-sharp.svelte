...
const content = `<path class="uwv5lmb5r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:bath-outdoor-sharp" {...props}></Icon>
<style>
:global(.uwv5lmb5r) {
  fill: currentColor;
