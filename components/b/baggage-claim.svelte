...
const content = `<path class="r9rioofmx"/><path class="h0xxz-bnu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:baggage-claim" {...props}></Icon>
<style>
:global(.h0xxz-bnu) {
