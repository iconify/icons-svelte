...
const content = `<rect class="j_uy_nubt"/><path class="v79yq5cld"/><path class="gx3mbybcg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:backgrounds" {...props}></Icon>
<style>
:global(.gx3mbybcg) {
  fill: none;
  stroke: currentColor;
