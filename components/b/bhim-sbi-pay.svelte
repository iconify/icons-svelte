...
const content = `<path class="v1q_ybc_s"/><path class="thr82xbla"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bhim-sbi-pay" {...props}></Icon>
<style>
:global(.thr82xbla) {
  fill: none;
  stroke: currentColor;
