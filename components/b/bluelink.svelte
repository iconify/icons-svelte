...
const content = `<path class="l9jiucztn"/><path class="ak0c6bb7j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bluelink" {...props}></Icon>
<style>
:global(.ak0c6bb7j) {
  fill: none;
  stroke: currentColor;
