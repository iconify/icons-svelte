...
const content = `<path class="bmdiq6b8t clr-i-solid--badged clr-i-solid-path-1--badged"/><path class="clr-i-solid--badged clr-i-solid-path-2--badged wajy9d3qq"/><path class="clr-i-solid--badged clr-i-solid-path-3--badged xh8-ubb1t"/><path class="a3cp5cbqe clr-i-solid--badged clr-i-solid-path-4--badged"/><circle class="clr-i-badge clr-i-solid--badged clr-i-solid-path-5--badged lmf0ecbhq"/><path class="m2o3sh-9c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="clarity:backup-solid-badged" {...props}></Icon>
