...
const content = `<path class="f5j_qdwkr"/><path class="vdqhtdbey"/><path class="r0hr0xiwf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:baseline-type-specimen" {...props}></Icon>
<style>
:global(.f5j_qdwkr) {
  fill: currentColor;
