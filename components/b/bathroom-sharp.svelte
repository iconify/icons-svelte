...
const content = `<path class="jm45iqb4d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:bathroom-sharp" {...props}></Icon>
<style>
:global(.jm45iqb4d) {
  fill: currentColor;
