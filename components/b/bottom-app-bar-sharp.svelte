...
const content = `<path class="oy93_mbgh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:bottom-app-bar-sharp" {...props}></Icon>
<style>
:global(.oy93_mbgh) {
  fill: currentColor;
