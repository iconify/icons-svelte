...
const content = `<circle class="cpk0fnbgt"/><path class="wekj5cr_p"/><path class="h7tc8zbhj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:breezy-weather" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
