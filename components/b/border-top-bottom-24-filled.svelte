...
const content = `<path class="eau1vob4t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:border-top-bottom-24-filled" {...props}></Icon>
<style>
:global(.eau1vob4t) {
  fill: currentColor;
