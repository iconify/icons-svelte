...
const content = `<path class="c0e58lauk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:branch-request-draft-16-regular" {...props}></Icon>
<style>
:global(.c0e58lauk) {
  fill: currentColor;
