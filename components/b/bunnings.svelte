...
const content = `<path class="ofzyvez0d"/><path class="xo8g68b8w"/><path class="i2adz_b_i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bunnings" {...props}></Icon>
<style>
:global(.i2adz_b_i) {
  fill: none;
  stroke: currentColor;
