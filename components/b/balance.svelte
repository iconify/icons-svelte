...
const content = `<path class="j08qdz_wq"/><path class="w45wl8b8l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:balance" {...props}></Icon>
<style>
:global(.j08qdz_wq) {
  fill: none;
  stroke: currentColor;
