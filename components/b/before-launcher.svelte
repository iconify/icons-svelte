...
const content = `<path class="i9clfwm2k"/><rect class="ggh4i7b-n"/><path class="c799x4wqx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:before-launcher" {...props}></Icon>
<style>
:global(.c799x4wqx) {
  fill: none;
  stroke: currentColor;
