...
const content = `<path class="i9clfwm2k"/><path class="cgvl2qbve"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bunq" {...props}></Icon>
<style>
:global(.cgvl2qbve) {
  fill: none;
  stroke: currentColor;
