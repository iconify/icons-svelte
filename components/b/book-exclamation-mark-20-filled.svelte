...
const content = `<path class="vxmro_bfz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:book-exclamation-mark-20-filled" {...props}></Icon>
<style>
:global(.vxmro_bfz) {
  fill: currentColor;
