...
const content = `<path class="ye9grnq2a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:battery-charging-full-outline" {...props}></Icon>
<style>
:global(.ye9grnq2a) {
  fill: currentColor;
