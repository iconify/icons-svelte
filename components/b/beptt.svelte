...
const content = `<path class="dydm1yddd"/><path class="xugblft2y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:beptt" {...props}></Icon>
<style>
:global(.dydm1yddd) {
  fill: none;
  stroke: currentColor;
