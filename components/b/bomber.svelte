...
const content = `<circle class="hch7o7t6p"/><path class="y2re3xb7o"/><path class="roi0e5bol"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bomber" {...props}></Icon>
<style>
:global(.hch7o7t6p) {
  cx: 12.396px;
  cy: 11.265px;
