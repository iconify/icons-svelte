...
const content = `<path class="r47vw7x-m"/><path class="tejjblb7l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:blockbuster" {...props}></Icon>
<style>
:global(.r47vw7x-m) {
  fill: none;
  stroke: currentColor;
