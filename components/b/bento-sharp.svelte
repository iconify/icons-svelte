...
const content = `<path class="jpi9sq6vn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:bento-sharp" {...props}></Icon>
<style>
:global(.jpi9sq6vn) {
  fill: currentColor;
