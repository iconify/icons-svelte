...
const content = `<path class="ff63g1btx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:bookmark-multiple-28-filled" {...props}></Icon>
<style>
:global(.ff63g1btx) {
  fill: currentColor;
