...
const content = `<path class="ekjkq-a8p"/><path class="hzpqnlmob"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bluewallet" {...props}></Icon>
<style>
:global(.ekjkq-a8p) {
  fill: none;
  stroke: currentColor;
