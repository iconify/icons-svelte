...
const content = `<path class="usv6s579o"/><path class="jcfc8_bai"/><circle class="zl285sv_h"/><path class="i9clfwm2k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:bolt" {...props}></Icon>
<style>
:global(.i9clfwm2k) {
  fill: none;
  stroke: currentColor;
