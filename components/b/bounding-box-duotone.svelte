...
const content = `<g class="cuyn6tgcc"><path class="yhaio6bog"/><path class="ufhc5vbof"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:bounding-box-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
