...
const content = `<g class="y9tr6bcfx"><path class="cimmok02t"/><path class="bukvn6bwo"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:blinkist" {...props}></Icon>
<style>
:global(.bukvn6bwo) {
