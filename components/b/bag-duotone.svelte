...
const content = `<g class="cuyn6tgcc"><path class="g-ywktbyg"/><path class="o_zh-lbhb"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:bag-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
