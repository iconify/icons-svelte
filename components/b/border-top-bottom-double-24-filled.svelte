...
const content = `<path class="uasfyh6se"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:border-top-bottom-double-24-filled" {...props}></Icon>
<style>
:global(.uasfyh6se) {
  fill: currentColor;
