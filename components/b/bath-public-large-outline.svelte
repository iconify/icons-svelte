...
const content = `<path class="gl-sx22se"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:bath-public-large-outline" {...props}></Icon>
<style>
:global(.gl-sx22se) {
  fill: currentColor;
