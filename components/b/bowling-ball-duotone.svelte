...
const content = `<g class="cuyn6tgcc"><path class="goeug6bgp"/><path class="b5u9f6b6g"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:bowling-ball-duotone" {...props}></Icon>
<style>
:global(.b5u9f6b6g) {
