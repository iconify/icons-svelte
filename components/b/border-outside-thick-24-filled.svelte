...
const content = `<path class="euav2xb2c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:border-outside-thick-24-filled" {...props}></Icon>
<style>
:global(.euav2xb2c) {
  fill: currentColor;
