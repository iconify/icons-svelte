...
const content = `<g class="cuyn6tgcc"><path class="d3awdabtr"/><path class="itid1cpnn"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:book-open-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
