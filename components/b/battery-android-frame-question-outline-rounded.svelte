...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:battery-android-frame-question-outline-rounded" {...props}></Icon>
<style>
:global(.c69m57bwi) {
  fill: currentColor;
