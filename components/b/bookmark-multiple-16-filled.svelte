...
const content = `<path class="m2ab_-u8v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:bookmark-multiple-16-filled" {...props}></Icon>
<style>
:global(.m2ab_-u8v) {
  fill: currentColor;
