...
const content = `<path class="npey2pbdm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:border-top-bottom-double-20-filled" {...props}></Icon>
<style>
:global(.npey2pbdm) {
  fill: currentColor;
