...
const content = `<path class="fu01bdbwc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:border-left-right-24-filled" {...props}></Icon>
<style>
:global(.fu01bdbwc) {
  fill: currentColor;
