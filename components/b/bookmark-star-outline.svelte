...
const content = `<path class="a1fekdbee"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:bookmark-star-outline" {...props}></Icon>
<style>
:global(.a1fekdbee) {
  fill: currentColor;
