...
const content = `<path class="ch3q6acad"/><path class="kzcui6qau"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:baseline-receipt-long" {...props}></Icon>
<style>
:global(.ch3q6acad) {
  fill: currentColor;
