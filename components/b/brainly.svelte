...
const content = `<circle class="cpk0fnbgt"/><path class="bqoyu-bdo"/><path class="rm2xfpbmt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:brainly" {...props}></Icon>
<style>
:global(.bqoyu-bdo) {
  fill: none;
  stroke: currentColor;
