...
const content = `<path class="vwpm8vb0f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:battery-android-alert-outline-sharp" {...props}></Icon>
<style>
:global(.vwpm8vb0f) {
  fill: currentColor;
