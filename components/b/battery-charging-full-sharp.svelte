...
const content = `<path class="chvg1-b7r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:battery-charging-full-sharp" {...props}></Icon>
<style>
:global(.chvg1-b7r) {
  fill: currentColor;
