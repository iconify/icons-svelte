...
const content = `<path class="uc-m8cerw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:books-movies-and-music" {...props}></Icon>
<style>
:global(.uc-m8cerw) {
  fill: currentColor;
