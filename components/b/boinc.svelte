...
const content = `<circle class="j5c5phb-q"/><path class="coqgi-ato"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:boinc" {...props}></Icon>
<style>
:global(.coqgi-ato) {
  fill: none;
  stroke: currentColor;
