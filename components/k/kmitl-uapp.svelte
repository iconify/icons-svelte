...
const content = `<rect class="j3s9ivbxi"/><path class="ib6klufup"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:kmitl-uapp" {...props}></Icon>
<style>
:global(.ib6klufup) {
  fill: none;
  stroke: currentColor;
