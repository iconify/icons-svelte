...
const content = `<path class="s9g8yp8ww"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:keyboard-off-sharp" {...props}></Icon>
<style>
:global(.s9g8yp8ww) {
  fill: currentColor;
