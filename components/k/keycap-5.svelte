...
const content = `<path class="x-kz1kb7j"/><path class="rhsa7ftfb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:keycap-5" {...props}></Icon>
<style>
:global(.rhsa7ftfb) {
