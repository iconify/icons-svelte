...
const content = `<path class="bincbmbma"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:keyboard-previous-language-rounded" {...props}></Icon>
<style>
:global(.bincbmbma) {
  fill: currentColor;
