...
const content = `<path clip-rule="evenodd" class="d785swbja"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:kit" {...props}></Icon>
<style>
:global(.d785swbja) {
