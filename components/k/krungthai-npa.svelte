...
const content = `<path class="f41futk8u"/><path class="hwr0mfb8f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:krungthai-npa" {...props}></Icon>
<style>
:global(.f41futk8u) {
  fill: none;
  stroke: currentColor;
