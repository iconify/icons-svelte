...
const content = `<path class="x-kz1kb7j"/><path class="ztry2tbjb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:keycap-8" {...props}></Icon>
<style>
:global(.x-kz1kb7j) {
