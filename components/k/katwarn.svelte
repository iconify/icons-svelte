...
const content = `<path class="uk4nzubsu"/><path class="pvbtn6bep"/><path class="ru5i80b0l"/><path class="zkwwtgdij"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:katwarn" {...props}></Icon>
<style>
:global(.pvbtn6bep) {
  fill: none;
  stroke: currentColor;
