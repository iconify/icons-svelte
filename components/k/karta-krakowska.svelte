...
const content = `<rect class="c_6m8lged"/><path class="yg-9ti7st"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:karta-krakowska" {...props}></Icon>
<style>
:global(.c_6m8lged) {
  width: 31.569px;
  height: 39px;
