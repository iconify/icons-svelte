...
const content = `<path class="lu19sgbfz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:key-visualizer-outline-rounded" {...props}></Icon>
<style>
:global(.lu19sgbfz) {
  fill: currentColor;
