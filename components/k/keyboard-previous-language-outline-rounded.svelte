...
const content = `<path class="dm7_7hb-e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:keyboard-previous-language-outline-rounded" {...props}></Icon>
<style>
:global(.dm7_7hb-e) {
  fill: currentColor;
