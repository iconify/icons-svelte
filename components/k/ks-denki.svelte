...
const content = `<rect class="j3s9ivbxi"/><path class="eattbgk7w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ks-denki" {...props}></Icon>
<style>
:global(.eattbgk7w) {
  fill: none;
  stroke: currentColor;
