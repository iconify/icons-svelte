...
const content = `<circle class="cpk0fnbgt"/><path class="el75ncb2q"/><path class="roojr0b8y"/><path class="bjbc3jj9o"/><path class="rmev1v27u"/><path class="b8bihp3qf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:kindle" {...props}></Icon>
<style>
:global(.b8bihp3qf) {
  fill: none;
  stroke: currentColor;
