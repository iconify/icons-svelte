...
const content = `<path class="at25pwb0b"/><path class="fm2wp9buj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:kiri-engine" {...props}></Icon>
<style>
:global(.at25pwb0b) {
  fill: none;
  stroke: currentColor;
