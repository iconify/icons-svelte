...
const content = `<path class="o4tza2vqs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:keyboard-shift-uppercase-16-filled" {...props}></Icon>
<style>
:global(.o4tza2vqs) {
  fill: currentColor;
