...
const content = `<path class="rl1cpz9vl"/><path class="f_xx2xjft"/><path class="tkdfkgv2l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione:keycap-4" {...props}></Icon>
<style>
:global(.f_xx2xjft) {
