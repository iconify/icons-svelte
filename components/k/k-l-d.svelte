...
const content = `<path class="he0znwbih"/><path class="z1906ln_o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:k-l-d" {...props}></Icon>
<style>
:global(.he0znwbih) {
  fill: none;
  stroke: currentColor;
