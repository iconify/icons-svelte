...
const content = `<g class="hntgybcog"><path class="o72p0hsyz"/><path class="v7xfanbfw"/><path class="d8gf8fboh"/><path class="nt94z-wbn"/><path class="zo05kh48x"/><path class="vqk_j23jd"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:keypoint-outline-thin" {...props}></Icon>
<style>
:global(.d8gf8fboh) {
