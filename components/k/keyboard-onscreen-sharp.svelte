...
const content = `<path class="agteejbpd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:keyboard-onscreen-sharp" {...props}></Icon>
<style>
:global(.agteejbpd) {
  fill: currentColor;
