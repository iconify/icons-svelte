...
const content = `<path class="i9clfwm2k"/><path class="fm2yrpb6w"/><path class="kp_c18bzy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:kry" {...props}></Icon>
<style>
:global(.fm2yrpb6w) {
  fill: none;
  stroke: currentColor;
