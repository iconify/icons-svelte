...
const content = `<path class="frx7lxugn"/><path class="l-1vzccjz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-v1:keycap-pound" {...props}></Icon>
<style>
:global(.frx7lxugn) {
