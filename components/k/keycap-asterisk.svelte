...
const content = `<path class="zfv041b7s"/><path class="q-4dr8lpl"/><path class="x-zolsxqj"/><path class="dw6p3mbpy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:keycap-asterisk" {...props}></Icon>
<style>
:global(.dw6p3mbpy) {
