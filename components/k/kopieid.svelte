...
const content = `<path class="kqo9pjw0y"/><path class="kn3t3ub7n"/><path class="fvblabqye"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:kopieid" {...props}></Icon>
<style>
:global(.fvblabqye) {
  fill: none;
  stroke: currentColor;
