...
const content = `<path class="oiij83bmv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:king-bed-outline" {...props}></Icon>
<style>
:global(.oiij83bmv) {
  fill: currentColor;
