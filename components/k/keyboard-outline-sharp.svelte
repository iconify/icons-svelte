...
const content = `<path class="wk-vvwbwp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:keyboard-outline-sharp" {...props}></Icon>
<style>
:global(.wk-vvwbwp) {
  fill: currentColor;
