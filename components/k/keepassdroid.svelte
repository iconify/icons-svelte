...
const content = `<rect class="nmm0v__ki"/><path class="n2jo2drpr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:keepassdroid" {...props}></Icon>
<style>
:global(.n2jo2drpr) {
  fill: none;
  stroke: currentColor;
