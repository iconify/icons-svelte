...
const content = `<path class="d66aksb9k"/><path class="o7-8gcc3o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ks-one" {...props}></Icon>
<style>
:global(.d66aksb9k) {
  fill: none;
  stroke: currentColor;
