...
const content = `<path class="ktmvnvfmg"/><circle class="a9uw-0c0k"/><circle class="kc4botbkc"/><path class="wj3d1650z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:kpn-voicemail" {...props}></Icon>
<style>
:global(.a9uw-0c0k) {
  cx: 16px;
  cy: 24px;
