...
const content = `<path class="rb3hxw7fu"/><path class="fb_wvxbai"/><path class="x1vz2wbml"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:kemal" {...props}></Icon>
<style>
:global(.fb_wvxbai) {
