...
const content = `<path class="aoqtpqbyy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:keyboard-lock-off-rounded" {...props}></Icon>
<style>
:global(.aoqtpqbyy) {
  fill: currentColor;
