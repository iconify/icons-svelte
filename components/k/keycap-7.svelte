...
const content = `<path class="rl1cpz9vl"/><path class="f_xx2xjft"/><path class="udv99-kvf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione:keycap-7" {...props}></Icon>
<style>
:global(.f_xx2xjft) {
