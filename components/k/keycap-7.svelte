...
const content = `<path class="x-kz1kb7j"/><path class="xf2k4pabt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:keycap-7" {...props}></Icon>
<style>
:global(.x-kz1kb7j) {
