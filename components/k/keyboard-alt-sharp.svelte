...
const content = `<path class="ptod-efkp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:keyboard-alt-sharp" {...props}></Icon>
<style>
:global(.ptod-efkp) {
  fill: currentColor;
