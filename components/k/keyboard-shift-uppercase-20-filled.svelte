...
const content = `<path class="ab7xasouh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:keyboard-shift-uppercase-20-filled" {...props}></Icon>
<style>
:global(.ab7xasouh) {
  fill: currentColor;
