...
const content = `<path class="oxanjgb9s"/><circle class="mcp-v6b2m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:kik" {...props}></Icon>
<style>
:global(.mcp-v6b2m) {
  cx: 39.02px;
  cy: 23.97px;
