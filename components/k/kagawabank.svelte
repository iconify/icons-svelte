...
const content = `<path class="iaep_qpkv"/><path class="x-blltjjm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:kagawabank" {...props}></Icon>
<style>
:global(.iaep_qpkv) {
  fill: none;
  stroke: currentColor;
