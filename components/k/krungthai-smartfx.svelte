...
const content = `<path class="j7cturlfb"/><path class="i1cv7w5zz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:krungthai-smartfx" {...props}></Icon>
<style>
:global(.i1cv7w5zz) {
  fill: none;
  stroke: currentColor;
