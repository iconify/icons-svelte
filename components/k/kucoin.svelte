...
const content = `<path class="dlgw5zbbk"/><circle class="klynq8bxx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:kucoin" {...props}></Icon>
<style>
:global(.dlgw5zbbk) {
  fill: none;
  stroke: currentColor;
