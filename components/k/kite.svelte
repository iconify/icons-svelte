...
const content = `<path class="wgrqprbcl"/><path class="biuq55b7k"/><path class="z6zmptb1f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:kite" {...props}></Icon>
<style>
:global(.biuq55b7k) {
  fill: none;
  stroke: currentColor;
