...
const content = `<path class="hqenocc6m"/><path class="msnwsi3ix"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:kanade" {...props}></Icon>
<style>
:global(.hqenocc6m) {
  fill: none;
  stroke: currentColor;
