...
const content = `<g clip-rule="evenodd" class="r4qc_abod"><path class="h0dqwzvmd"/><path class="i_anfsynt"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:kukai" {...props}></Icon>
<style>
:global(.h0dqwzvmd) {
