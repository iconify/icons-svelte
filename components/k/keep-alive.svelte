...
const content = `<circle class="cpk0fnbgt"/><path class="a-an3qb4k"/><path class="xycfew9_a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:keep-alive" {...props}></Icon>
<style>
:global(.a-an3qb4k) {
  fill: none;
  stroke: currentColor;
