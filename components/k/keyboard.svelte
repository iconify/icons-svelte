...
const content = `<path class="efo94ybnw"/><path class="zvvb_i8_p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:keyboard" {...props}></Icon>
<style>
:global(.efo94ybnw) {
