...
const content = `<path class="vih9kjbnv"/><path class="bqt1v9bkz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:kanadrill" {...props}></Icon>
<style>
:global(.bqt1v9bkz) {
  fill: none;
  stroke: currentColor;
