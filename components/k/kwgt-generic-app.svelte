...
const content = `<rect class="mr_n4foyj"/><path class="bwv6xqbzd"/><circle class="cpk0fnbgt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:kwgt-generic-app" {...props}></Icon>
<style>
:global(.bwv6xqbzd) {
  fill: none;
  stroke: currentColor;
