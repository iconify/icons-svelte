...
const content = `<path class="bsb696bit"/><path class="oc--z5bfw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-feed" {...props}></Icon>
<style>
:global(.bsb696bit) {
  fill: currentColor;
