...
const content = `<path class="j0da_7b-n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-direction-vertical-16-regular" {...props}></Icon>
<style>
:global(.j0da_7b-n) {
  fill: currentColor;
