...
const content = `<path class="hzwc5xbkd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-indent-increase-rtl-20-filled" {...props}></Icon>
<style>
:global(.hzwc5xbkd) {
  fill: currentColor;
