...
const content = `<path class="t28rvibve"/><path class="avx2h7b8c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:thumbs-down-light-skin-tone" {...props}></Icon>
<style>
:global(.avx2h7b8c) {
