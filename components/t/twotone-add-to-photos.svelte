...
const content = `<path class="uhatzk4ug"/><path class="z0j1u_b4v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-add-to-photos" {...props}></Icon>
<style>
:global(.uhatzk4ug) {
  fill: currentColor;
