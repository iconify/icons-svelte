...
const content = `<path class="qo5tz79ai"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-list-roman-numeral-uppercase-20-regular" {...props}></Icon>
<style>
:global(.qo5tz79ai) {
  fill: currentColor;
