...
const content = `<path class="t0ubz-6tv"/><path class="bohqmuuzi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:tinder" {...props}></Icon>
<style>
:global(.bohqmuuzi) {
  fill: none;
  stroke: currentColor;
