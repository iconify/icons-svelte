...
const content = `<path class="q4yyqiknw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:tab-close-inactive-sharp" {...props}></Icon>
<style>
:global(.q4yyqiknw) {
  fill: currentColor;
