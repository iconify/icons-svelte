...
const content = `<path class="ar0fscbgm"/><path class="vkj7lzbzl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:travelers" {...props}></Icon>
<style>
:global(.ar0fscbgm) {
  fill: none;
  stroke: currentColor;
