...
const content = `<path class="xsu7-eb_z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-position-square-right-24-regular" {...props}></Icon>
<style>
:global(.xsu7-eb_z) {
  fill: currentColor;
