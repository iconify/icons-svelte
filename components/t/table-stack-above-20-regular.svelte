...
const content = `<path class="la19sgb-f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-stack-above-20-regular" {...props}></Icon>
<style>
:global(.la19sgb-f) {
  fill: currentColor;
