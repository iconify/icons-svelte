...
const content = `<path class="uamsnub5f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:tooltip-2-outline" {...props}></Icon>
<style>
:global(.uamsnub5f) {
  fill: currentColor;
