...
const content = `<path class="f0mvouz6n"/><path class="ypqsb7blw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-compare" {...props}></Icon>
<style>
:global(.f0mvouz6n) {
  fill: currentColor;
