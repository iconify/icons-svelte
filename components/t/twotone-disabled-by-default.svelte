...
const content = `<path class="vk51p2b_k"/><path class="yl-m5bb0o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-disabled-by-default" {...props}></Icon>
<style>
:global(.vk51p2b_k) {
  fill: currentColor;
