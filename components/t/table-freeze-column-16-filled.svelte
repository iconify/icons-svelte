...
const content = `<path class="hdiacfb2j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-freeze-column-16-filled" {...props}></Icon>
<style>
:global(.hdiacfb2j) {
  fill: currentColor;
