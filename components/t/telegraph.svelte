...
const content = `<path class="lyjerxb5t"/><path class="tnglfgpxc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:telegraph" {...props}></Icon>
<style>
:global(.lyjerxb5t) {
  fill: none;
  stroke: currentColor;
