...
const content = `<path class="y0eedabcd"/><path class="e0bns547u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-web" {...props}></Icon>
<style>
:global(.e0bns547u) {
  fill: currentColor;
