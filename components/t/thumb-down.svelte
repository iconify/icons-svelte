...
const content = `<path class="pst2j3mwl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:thumb-down" {...props}></Icon>
<style>
:global(.pst2j3mwl) {
  fill: currentColor;
