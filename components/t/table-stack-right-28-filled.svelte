...
const content = `<path class="tn7bbkcbo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-stack-right-28-filled" {...props}></Icon>
<style>
:global(.tn7bbkcbo) {
  fill: currentColor;
