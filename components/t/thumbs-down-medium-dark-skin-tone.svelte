...
const content = `<path class="laa_v2bdg"/><path class="b8_ok0bzh"/><path class="hkscoqh_w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:thumbs-down-medium-dark-skin-tone" {...props}></Icon>
<style>
:global(.b8_ok0bzh) {
