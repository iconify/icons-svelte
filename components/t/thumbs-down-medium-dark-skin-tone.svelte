...
const content = `<path class="eicm4wbet"/><path class="j1-vq3bvs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:thumbs-down-medium-dark-skin-tone" {...props}></Icon>
<style>
:global(.eicm4wbet) {
