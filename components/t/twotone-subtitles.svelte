...
const content = `<path class="pga7ir71c"/><path class="b5y5erbyq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-subtitles" {...props}></Icon>
<style>
:global(.b5y5erbyq) {
  fill: currentColor;
