...
const content = `<path class="ml0a2-i4e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:timer-5-shutter-outline-rounded" {...props}></Icon>
<style>
:global(.ml0a2-i4e) {
  fill: currentColor;
