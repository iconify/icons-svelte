...
const content = `<path class="db5byrb5x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:table-restaurant" {...props}></Icon>
<style>
:global(.db5byrb5x) {
  fill: currentColor;
