...
const content = `<path class="hyvw0tbhy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:trackpad-input-3-sharp" {...props}></Icon>
<style>
:global(.hyvw0tbhy) {
  fill: currentColor;
