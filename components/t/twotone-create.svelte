...
const content = `<path class="j2ltg6v_y"/><path class="n8nwebbin"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-create" {...props}></Icon>
<style>
:global(.j2ltg6v_y) {
  fill: currentColor;
