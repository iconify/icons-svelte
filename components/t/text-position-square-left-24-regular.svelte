...
const content = `<path class="h-gmahbpw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-position-square-left-24-regular" {...props}></Icon>
<style>
:global(.h-gmahbpw) {
  fill: currentColor;
