...
const content = `<path class="mzq_7zbob"/><rect class="j3s9ivbxi"/><path class="usy8zkb4p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:termux-gui" {...props}></Icon>
<style>
:global(.j3s9ivbxi) {
  width: 37px;
  height: 37px;
