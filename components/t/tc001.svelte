...
const content = `<path class="vm8gvh4cw"/><path class="v__n0ccyy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:tc001" {...props}></Icon>
<style>
:global(.v__n0ccyy) {
  fill: none;
  stroke: currentColor;
