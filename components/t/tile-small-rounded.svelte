...
const content = `<path class="yeg7hcdtq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:tile-small-rounded" {...props}></Icon>
<style>
:global(.yeg7hcdtq) {
  fill: currentColor;
