...
const content = `<path class="rik8jgqcq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:tilt-arrow-down-outline" {...props}></Icon>
<style>
:global(.rik8jgqcq) {
  fill: currentColor;
