...
const content = `<g class="gp_8x1bzb"><path class="l-k3q4bdh"/><path class="zjsv9h-ou"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:type-outline-sharp-two-tone" {...props}></Icon>
<style>
:global(.gp_8x1bzb) {
  fill: none;
  stroke: currentColor;
