...
const content = `<path class="mmd2itbjp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-line-spacing-20-filled" {...props}></Icon>
<style>
:global(.mmd2itbjp) {
  fill: currentColor;
