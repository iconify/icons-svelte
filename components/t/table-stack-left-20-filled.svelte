...
const content = `<path class="u2v5mch-o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-stack-left-20-filled" {...props}></Icon>
<style>
:global(.u2v5mch-o) {
  fill: currentColor;
