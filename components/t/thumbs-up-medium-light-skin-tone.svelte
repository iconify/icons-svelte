...
const content = `<path class="l--a6emcy"/><path class="c8j0y8qyc"/><path class="g5yv0f4sh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:thumbs-up-medium-light-skin-tone" {...props}></Icon>
<style>
:global(.c8j0y8qyc) {
