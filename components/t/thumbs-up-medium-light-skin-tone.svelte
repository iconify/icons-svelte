...
const content = `<path class="sorfnjb-c"/><path class="k7l0neb3z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:thumbs-up-medium-light-skin-tone" {...props}></Icon>
<style>
:global(.k7l0neb3z) {
