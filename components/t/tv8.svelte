...
const content = `<path class="ubmk71hef"/><path class="poapep6nt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:tv8" {...props}></Icon>
<style>
:global(.poapep6nt) {
  fill: none;
  stroke: currentColor;
