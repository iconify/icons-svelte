...
const content = `<path class="b21ssyjie"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-insert-row-28-filled" {...props}></Icon>
<style>
:global(.b21ssyjie) {
  fill: currentColor;
