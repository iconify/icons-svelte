...
const content = `<path class="um9mw3b1t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:tab-close-outline-sharp" {...props}></Icon>
<style>
:global(.um9mw3b1t) {
  fill: currentColor;
