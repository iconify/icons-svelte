...
const content = `<g class="ft5dv1b6b"><path class="mumfproca"/><path class="gxphmyebj"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:the-background" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
