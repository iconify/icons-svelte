...
const content = `<g class="nrj6p8qat"><path class="a0ltxiykj"/><path class="bjrfcyy_s"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:table-rows-add-below-fill" {...props}></Icon>
<style>
:global(.a0ltxiykj) {
  fill: currentColor;
