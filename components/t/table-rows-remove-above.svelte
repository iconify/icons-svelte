...
const content = `<path class="vwp2m741k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:table-rows-remove-above" {...props}></Icon>
<style>
:global(.vwp2m741k) {
  fill: none;
  stroke: currentColor;
