...
const content = `<path class="a_bjycczh"/><path class="omxym_x9d"/><circle class="smh8hwt4g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:tetherfi" {...props}></Icon>
<style>
:global(.a_bjycczh) {
  fill: none;
  stroke: currentColor;
