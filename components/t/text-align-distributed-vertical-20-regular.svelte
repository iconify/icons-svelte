...
const content = `<path class="o8a3xbzbf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-distributed-vertical-20-regular" {...props}></Icon>
<style>
:global(.o8a3xbzbf) {
  fill: currentColor;
