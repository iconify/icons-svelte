...
const content = `<path class="l14kt8brg"/><path class="xq9oxjbzl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-library-add" {...props}></Icon>
<style>
:global(.l14kt8brg) {
  fill: currentColor;
