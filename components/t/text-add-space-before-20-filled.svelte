...
const content = `<path class="d3_64l21g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-add-space-before-20-filled" {...props}></Icon>
<style>
:global(.d3_64l21g) {
  fill: currentColor;
