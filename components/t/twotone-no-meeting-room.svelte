...
const content = `<path class="uk6pgp5ea"/><path class="ahu_lhsun"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-no-meeting-room" {...props}></Icon>
<style>
:global(.ahu_lhsun) {
  fill: currentColor;
