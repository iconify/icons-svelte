...
const content = `<g class="cuyn6tgcc"><path class="wlhj98i7n"/><path class="zpu3aabln"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:train-regional-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
