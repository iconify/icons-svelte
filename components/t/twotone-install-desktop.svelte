...
const content = `<path class="tk03i7b2p"/><path class="hc_fmdbkf"/><path class="es0f9lbiz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-install-desktop" {...props}></Icon>
<style>
:global(.es0f9lbiz) {
  fill: currentColor;
