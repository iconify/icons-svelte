...
const content = `<path class="aej0b95ng"/><path class="xfnmmy-sw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:tandem" {...props}></Icon>
<style>
:global(.aej0b95ng) {
  fill: none;
  stroke: currentColor;
