...
const content = `<path class="b44oqnv_e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:temperature-degree-fahrenheit-16-filled" {...props}></Icon>
<style>
:global(.b44oqnv_e) {
  fill: currentColor;
