...
const content = `<path class="sn8kgzbvj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-position-square-right-24-filled" {...props}></Icon>
<style>
:global(.sn8kgzbvj) {
  fill: currentColor;
