...
const content = `<path class="o0ogwz7vi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-center-rotate-90-16-regular" {...props}></Icon>
<style>
:global(.o0ogwz7vi) {
  fill: currentColor;
