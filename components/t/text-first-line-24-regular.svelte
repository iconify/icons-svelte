...
const content = `<path class="ac0xocc7n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-first-line-24-regular" {...props}></Icon>
<style>
:global(.ac0xocc7n) {
  fill: currentColor;
