...
const content = `<g class="cuyn6tgcc"><path class="wjbcr2bed"/><path class="jef7mubbk"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:tree-evergreen-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
