...
const content = `<path class="cw8g03oyv"/><path class="nu6j1gsic"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-carpenter" {...props}></Icon>
<style>
:global(.cw8g03oyv) {
  fill: currentColor;
