...
const content = `<path class="lxblhacsi"/><path class="mnybmzb7r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-view-module" {...props}></Icon>
<style>
:global(.lxblhacsi) {
  fill: currentColor;
