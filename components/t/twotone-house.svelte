...
const content = `<path class="vnbc2pbdq"/><path class="xndakwhbn"/><path class="b0j4q4x6s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-house" {...props}></Icon>
<style>
:global(.b0j4q4x6s) {
  fill: currentColor;
