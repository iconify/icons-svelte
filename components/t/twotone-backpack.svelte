...
const content = `<path class="iu2v3vrqi"/><path class="m6y3wntcn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-backpack" {...props}></Icon>
<style>
:global(.iu2v3vrqi) {
  fill: currentColor;
