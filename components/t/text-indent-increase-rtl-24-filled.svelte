...
const content = `<path class="l20dm4p0u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-indent-increase-rtl-24-filled" {...props}></Icon>
<style>
:global(.l20dm4p0u) {
  fill: currentColor;
