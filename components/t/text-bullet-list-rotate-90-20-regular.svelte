...
const content = `<path class="sii2j5bvp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-bullet-list-rotate-90-20-regular" {...props}></Icon>
<style>
:global(.sii2j5bvp) {
  fill: currentColor;
