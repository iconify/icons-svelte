...
const content = `<path class="qj-2rnbdj"/><path class="fku3whdut"/><path class="bn6ebpb5p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-view-timeline" {...props}></Icon>
<style>
:global(.bn6ebpb5p) {
  fill: currentColor;
