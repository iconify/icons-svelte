...
const content = `<path class="zu0d4xbjc"/><path class="gil2ri6ee"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-settings-input-composite" {...props}></Icon>
<style>
:global(.gil2ri6ee) {
  fill: currentColor;
