...
const content = `<path class="q71t33byz"/><path class="o5ckdcw5z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-fiber-manual-record" {...props}></Icon>
<style>
:global(.o5ckdcw5z) {
  fill: currentColor;
