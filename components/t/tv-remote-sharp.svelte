...
const content = `<path class="oy9a-8eub"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:tv-remote-sharp" {...props}></Icon>
<style>
:global(.oy9a-8eub) {
  fill: currentColor;
