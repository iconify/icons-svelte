...
const content = `<path class="i0i3b7qiq"/><path class="joi93l_zg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:timejot" {...props}></Icon>
<style>
:global(.i0i3b7qiq) {
  fill: none;
  stroke: currentColor;
