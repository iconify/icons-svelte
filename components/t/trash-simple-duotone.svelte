...
const content = `<g class="cuyn6tgcc"><path class="n3eg_ob3b"/><path class="qr-0lllzy"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:trash-simple-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
