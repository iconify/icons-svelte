...
const content = `<path clip-rule="evenodd" class="q3i5zubvm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:tablet-sharp-fill" {...props}></Icon>
<style>
:global(.q3i5zubvm) {
  fill: currentColor;
  fill-rule: evenodd;
