...
const content = `<path class="s_ci_5b3w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-indent-decrease-rtl-20-regular" {...props}></Icon>
<style>
:global(.s_ci_5b3w) {
  fill: currentColor;
