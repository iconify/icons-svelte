...
const content = `<path class="rjgbvp0zx"/><path class="sdtrjc_hj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-thumb-down-off-alt" {...props}></Icon>
<style>
:global(.rjgbvp0zx) {
  fill: currentColor;
