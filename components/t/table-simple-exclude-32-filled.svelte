...
const content = `<path class="nihrfwb9j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-simple-exclude-32-filled" {...props}></Icon>
<style>
:global(.nihrfwb9j) {
  fill: currentColor;
