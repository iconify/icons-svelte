...
const content = `<path class="c5iy1lbov"/><path class="rb5qyabay"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-nature" {...props}></Icon>
<style>
:global(.c5iy1lbov) {
  fill: currentColor;
