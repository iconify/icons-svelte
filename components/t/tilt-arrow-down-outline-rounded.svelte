...
const content = `<path class="z3hf4rbdl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:tilt-arrow-down-outline-rounded" {...props}></Icon>
<style>
:global(.z3hf4rbdl) {
  fill: currentColor;
