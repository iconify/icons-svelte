...
const content = `<path class="h57b8lb2b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-justify-rotate-90-20-filled" {...props}></Icon>
<style>
:global(.h57b8lb2b) {
  fill: currentColor;
