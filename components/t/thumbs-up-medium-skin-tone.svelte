...
const content = `<path class="g31uxmb4u"/><path class="djxntsvqe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:thumbs-up-medium-skin-tone" {...props}></Icon>
<style>
:global(.djxntsvqe) {
