...
const content = `<path class="q1whvubfo"/><path class="ugyv_7axz"/><path class="z-uclyb9v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:thumbs-up-medium-skin-tone" {...props}></Icon>
<style>
:global(.q1whvubfo) {
