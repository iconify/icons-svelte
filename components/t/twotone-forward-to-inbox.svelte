...
const content = `<path class="skb7dmcsb"/><path class="xhf6nqb8b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-forward-to-inbox" {...props}></Icon>
<style>
:global(.skb7dmcsb) {
  fill: currentColor;
