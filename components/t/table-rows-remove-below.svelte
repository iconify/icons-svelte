...
const content = `<path class="n_2q03tkq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:table-rows-remove-below" {...props}></Icon>
<style>
:global(.n_2q03tkq) {
  fill: none;
  stroke: currentColor;
