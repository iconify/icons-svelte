...
const content = `<path class="m2suk0b3d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-center-rotate-270-16-regular" {...props}></Icon>
<style>
:global(.m2suk0b3d) {
  fill: currentColor;
