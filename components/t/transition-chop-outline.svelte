...
const content = `<path class="csmfzh7xg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:transition-chop-outline" {...props}></Icon>
<style>
:global(.csmfzh7xg) {
  fill: currentColor;
