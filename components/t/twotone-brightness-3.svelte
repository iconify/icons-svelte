...
const content = `<path class="yuaj1zxbd"/><path class="vy2urf6aa"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-brightness-3" {...props}></Icon>
<style>
:global(.vy2urf6aa) {
  fill: currentColor;
