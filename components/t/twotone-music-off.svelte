...
const content = `<circle class="e1gvbqbwd"/><path class="j2j2_ximq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-music-off" {...props}></Icon>
<style>
:global(.e1gvbqbwd) {
  cx: 10px;
  cy: 17px;
