...
const content = `<path class="dpd831bbz"/><path class="i1ibl_m3k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-sensor-door" {...props}></Icon>
<style>
:global(.dpd831bbz) {
  fill: currentColor;
