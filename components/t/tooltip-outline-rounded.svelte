...
const content = `<path class="s6gin3efo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:tooltip-outline-rounded" {...props}></Icon>
<style>
:global(.s6gin3efo) {
  fill: currentColor;
