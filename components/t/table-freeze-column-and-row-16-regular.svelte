...
const content = `<path class="n2zg2v3cj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-freeze-column-and-row-16-regular" {...props}></Icon>
<style>
:global(.n2zg2v3cj) {
  fill: currentColor;
