...
const content = `<path class="c8261z8yo"/><path class="l0l_jrk-l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-image-aspect-ratio" {...props}></Icon>
<style>
:global(.c8261z8yo) {
  fill: currentColor;
