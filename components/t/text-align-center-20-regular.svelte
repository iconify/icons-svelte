...
const content = `<path class="p3uty2vzs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-center-20-regular" {...props}></Icon>
<style>
:global(.p3uty2vzs) {
  fill: currentColor;
