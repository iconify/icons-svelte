...
const content = `<g class="nrj6p8qat"><path class="klji_pbxt"/><path class="yxry87b1q"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:table-columns-add-before-fill" {...props}></Icon>
<style>
:global(.klji_pbxt) {
  fill: currentColor;
