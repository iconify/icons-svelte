...
const content = `<g class="cuyn6tgcc"><path class="mdm4t5b9e"/><path class="cv7j4gi0w"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:tent-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
