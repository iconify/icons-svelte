...
const content = `<circle class="q1j8406-g"/><path class="pzmu2vb1d"/><path class="mix23tbmg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-people-alt" {...props}></Icon>
<style>
:global(.mix23tbmg) {
  fill: currentColor;
