...
const content = `<path class="yjvgawq-l"/><path class="n-a5_nnow"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:thumbs-down-dark-skin-tone" {...props}></Icon>
<style>
:global(.n-a5_nnow) {
