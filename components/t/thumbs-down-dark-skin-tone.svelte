...
const content = `<path class="c8-aw_bok"/><path class="sg-g33bkv"/><path class="unnujmbjz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:thumbs-down-dark-skin-tone" {...props}></Icon>
<style>
:global(.c8-aw_bok) {
