...
const content = `<path class="trxgcp64o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-add-space-after-24-filled" {...props}></Icon>
<style>
:global(.trxgcp64o) {
  fill: currentColor;
