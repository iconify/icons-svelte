...
const content = `<path class="ewm-8ebfh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-bullet-list-rtl-24-filled" {...props}></Icon>
<style>
:global(.ewm-8ebfh) {
  fill: currentColor;
