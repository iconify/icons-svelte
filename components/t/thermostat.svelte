...
const content = `<path class="yj03ovbop"/><circle class="ytzydabje"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:thermostat" {...props}></Icon>
<style>
:global(.yj03ovbop) {
  fill: none;
  stroke: currentColor;
