...
const content = `<path class="lknwpzbyb"/><path class="ksh9gwbey"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-power-off" {...props}></Icon>
<style>
:global(.ksh9gwbey) {
  fill: currentColor;
