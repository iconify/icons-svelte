...
const content = `<path class="haut_8-pk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:table-columns-remove-before" {...props}></Icon>
<style>
:global(.haut_8-pk) {
  fill: none;
  stroke: currentColor;
