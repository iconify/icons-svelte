...
const content = `<path class="u7cvfs4re"/><path class="shutdsxyx"/><path class="uddaamz9l"/><path class="c017-acuz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-punch-clock" {...props}></Icon>
<style>
:global(.c017-acuz) {
  fill: currentColor;
