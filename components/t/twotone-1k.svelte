...
const content = `<path class="tsoojkbzk"/><path class="bn6ebpb5p"/><path class="dw9wdnb0s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-1k" {...props}></Icon>
<style>
:global(.bn6ebpb5p) {
  fill: currentColor;
