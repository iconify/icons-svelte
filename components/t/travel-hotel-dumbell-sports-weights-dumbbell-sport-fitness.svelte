...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline:travel-hotel-dumbell-sports-weights-dumbbell-sport-fitness" {...props}></Icon>
