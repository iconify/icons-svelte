...
const content = `<path class="bzofz6bts"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:toys-and-games-outline-rounded" {...props}></Icon>
<style>
:global(.bzofz6bts) {
  fill: currentColor;
