...
const content = `<path class="sosoq7ilw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:tap-and-play-outline-sharp" {...props}></Icon>
<style>
:global(.sosoq7ilw) {
  fill: currentColor;
