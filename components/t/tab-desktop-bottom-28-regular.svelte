...
const content = `<path class="kqsp7es3u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:tab-desktop-bottom-28-regular" {...props}></Icon>
<style>
:global(.kqsp7es3u) {
  fill: currentColor;
