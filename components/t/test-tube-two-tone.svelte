...
const content = `<g class="nrj6p8qat"><path class="hf5oswbse"/><path class="cqf64201r"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:test-tube-two-tone" {...props}></Icon>
<style>
:global(.cqf64201r) {
