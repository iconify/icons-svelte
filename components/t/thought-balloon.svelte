...
const content = `<path class="k_beisbaf"/><circle class="cr-j2kthz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:thought-balloon" {...props}></Icon>
<style>
:global(.cr-j2kthz) {
  cx: 4px;
  cy: 31px;
