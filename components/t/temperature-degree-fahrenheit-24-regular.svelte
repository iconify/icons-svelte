...
const content = `<path class="cxwchbc6b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:temperature-degree-fahrenheit-24-regular" {...props}></Icon>
<style>
:global(.cxwchbc6b) {
  fill: currentColor;
