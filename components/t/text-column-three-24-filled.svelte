...
const content = `<path class="kshy1fbnb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-column-three-24-filled" {...props}></Icon>
<style>
:global(.kshy1fbnb) {
  fill: currentColor;
