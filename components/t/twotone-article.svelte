...
const content = `<path class="f87q51b3k"/><path class="xt3-er4en"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-article" {...props}></Icon>
<style>
:global(.f87q51b3k) {
  fill: currentColor;
