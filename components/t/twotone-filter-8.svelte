...
const content = `<path class="x2ujl0b7j"/><path class="z_zt7pbqu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-filter-8" {...props}></Icon>
<style>
:global(.x2ujl0b7j) {
  fill: currentColor;
