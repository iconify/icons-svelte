...
const content = `<path class="gbxe_4b1d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:textbox-align-top-24-filled" {...props}></Icon>
<style>
:global(.gbxe_4b1d) {
  fill: currentColor;
