...
const content = `<g class="cuyn6tgcc"><path class="auyu_sbjl"/><path class="mi6jgbbxi"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:tip-jar-duotone" {...props}></Icon>
<style>
:global(.auyu_sbjl) {
