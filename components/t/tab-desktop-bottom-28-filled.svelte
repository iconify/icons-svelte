...
const content = `<path class="uwgu6g34z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:tab-desktop-bottom-28-filled" {...props}></Icon>
<style>
:global(.uwgu6g34z) {
  fill: currentColor;
