...
const content = `<g class="ft5dv1b6b"><path class="a_h5xczwj"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-direction-ltr-ac-20-regular" {...props}></Icon>
<style>
:global(.a_h5xczwj) {
