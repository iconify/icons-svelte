...
const content = `<path class="nb7en1f4g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:theaters-outline-rounded" {...props}></Icon>
<style>
:global(.nb7en1f4g) {
  fill: currentColor;
