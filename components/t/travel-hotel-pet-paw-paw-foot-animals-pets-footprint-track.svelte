...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline:travel-hotel-pet-paw-paw-foot-animals-pets-footprint-track" {...props}></Icon>
