...
const content = `<path class="rfmoaqbwi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-description-rtl-24-filled" {...props}></Icon>
<style>
:global(.rfmoaqbwi) {
  fill: currentColor;
