...
const content = `<path class="sln-7obqv"/><path class="qvbfq_bwu"/><path class="iq5-4acyl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:tesla" {...props}></Icon>
<style>
:global(.iq5-4acyl) {
  fill: none;
  stroke: currentColor;
