...
const content = `<path class="d7rr54bom"/><path class="uq_1l1ylz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-stop-circle" {...props}></Icon>
<style>
:global(.d7rr54bom) {
  fill: currentColor;
