...
const content = `<path class="mzq_7zbob"/><rect class="j3s9ivbxi"/><path class="d7dshub9g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:termux-widget" {...props}></Icon>
<style>
:global(.d7dshub9g) {
  fill: none;
  stroke: currentColor;
