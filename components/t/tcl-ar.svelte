...
const content = `<path class="axnv55z3w"/><path class="u7l7z_b0s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:tcl-ar" {...props}></Icon>
<style>
:global(.axnv55z3w) {
  fill: none;
  stroke: currentColor;
