...
const content = `<path class="b3iohhc1k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-distributed-24-filled" {...props}></Icon>
<style>
:global(.b3iohhc1k) {
  fill: currentColor;
