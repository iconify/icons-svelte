...
const content = `<path class="ff4h24buj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:table-columns-merge-next" {...props}></Icon>
<style>
:global(.ff4h24buj) {
  fill: none;
  stroke: currentColor;
