...
const content = `<path class="kiz25xq6j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-number-list-rtl-rotate-90-28-regular" {...props}></Icon>
<style>
:global(.kiz25xq6j) {
  fill: currentColor;
