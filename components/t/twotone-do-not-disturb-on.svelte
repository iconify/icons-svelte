...
const content = `<path class="t8730ebtl"/><path class="iqccs38dr"/><path class="zsfw75g9a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-do-not-disturb-on" {...props}></Icon>
<style>
:global(.iqccs38dr) {
  fill: currentColor;
