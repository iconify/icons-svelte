...
const content = `<path class="r507gdb3p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-cells-merge-20-filled" {...props}></Icon>
<style>
:global(.r507gdb3p) {
  fill: currentColor;
