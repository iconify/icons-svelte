...
const content = `<path class="snrn6ub4c"/><circle class="bcofmaczm"/><circle class="xci3rjb6a"/><circle class="ff9qsyb5f"/><path class="vtpojk0cy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:threema" {...props}></Icon>
<style>
:global(.bcofmaczm) {
  cx: 13.63px;
  cy: 40.6px;
