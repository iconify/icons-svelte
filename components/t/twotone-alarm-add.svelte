...
const content = `<path class="ossfmhh8l"/><path class="ry0paq2ln"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-alarm-add" {...props}></Icon>
<style>
:global(.ossfmhh8l) {
  fill: currentColor;
