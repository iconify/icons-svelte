...
const content = `<path class="m5amwccvb"/><path class="k_tlm7b0u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-movie" {...props}></Icon>
<style>
:global(.k_tlm7b0u) {
  fill: currentColor;
