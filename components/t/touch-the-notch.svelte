...
const content = `<path class="bt-_gdbmz"/><circle class="hnp-a-bsc"/><rect class="k1qs_h7jn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:touch-the-notch" {...props}></Icon>
<style>
:global(.bt-_gdbmz) {
  fill: none;
  stroke: currentColor;
