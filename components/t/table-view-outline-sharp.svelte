...
const content = `<path class="uk873ibdp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:table-view-outline-sharp" {...props}></Icon>
<style>
:global(.uk873ibdp) {
  fill: currentColor;
