...
const content = `<path class="x6ar14zbh"/><path class="w4z6_roih"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-email" {...props}></Icon>
<style>
:global(.w4z6_roih) {
  fill: currentColor;
