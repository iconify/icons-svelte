...
const content = `<path class="rad_5bc5u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-direction-horizontal-right-16-filled" {...props}></Icon>
<style>
:global(.rad_5bc5u) {
  fill: currentColor;
