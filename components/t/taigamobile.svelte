...
const content = `<path class="ac0ojac8n"/><path class="iue_2tb8v"/><path class="bw57xzbza"/><path class="b15-y6saw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:taigamobile" {...props}></Icon>
<style>
:global(.ac0ojac8n) {
  fill: none;
  stroke: currentColor;
