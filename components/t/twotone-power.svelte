...
const content = `<path class="ztslz9_ph"/><path class="a7sknrbmc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-power" {...props}></Icon>
<style>
:global(.a7sknrbmc) {
  fill: currentColor;
