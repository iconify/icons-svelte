...
const content = `<path class="i4y70wd6o"/><path class="tdz8smb6t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:tu-dortmund" {...props}></Icon>
<style>
:global(.i4y70wd6o) {
  fill: none;
  stroke: currentColor;
