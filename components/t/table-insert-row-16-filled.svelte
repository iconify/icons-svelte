...
const content = `<path class="wo86m6jfi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-insert-row-16-filled" {...props}></Icon>
<style>
:global(.wo86m6jfi) {
  fill: currentColor;
