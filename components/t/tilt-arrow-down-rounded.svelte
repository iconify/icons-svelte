...
const content = `<path class="urm968ixf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:tilt-arrow-down-rounded" {...props}></Icon>
<style>
:global(.urm968ixf) {
  fill: currentColor;
