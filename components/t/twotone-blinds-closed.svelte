...
const content = `<path class="r0a4t0mcp"/><path class="o30dfpb3f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-blinds-closed" {...props}></Icon>
<style>
:global(.o30dfpb3f) {
  fill: currentColor;
