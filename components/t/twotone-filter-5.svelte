...
const content = `<path class="voibrgb2b"/><path class="drlt2yhyn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-filter-5" {...props}></Icon>
<style>
:global(.drlt2yhyn) {
  fill: currentColor;
