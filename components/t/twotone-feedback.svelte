...
const content = `<path class="risb1mboy"/><path class="h7s2wmxip"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-feedback" {...props}></Icon>
<style>
:global(.h7s2wmxip) {
  fill: currentColor;
