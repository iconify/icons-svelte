...
const content = `<path class="y81xvibdf"/><path class="xtll3pikn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-mode" {...props}></Icon>
<style>
:global(.xtll3pikn) {
  fill: currentColor;
