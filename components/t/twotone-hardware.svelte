...
const content = `<path class="l-0vgvbnv"/><path class="e03rrvbdu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-hardware" {...props}></Icon>
<style>
:global(.e03rrvbdu) {
  fill: currentColor;
