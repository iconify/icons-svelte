...
const content = `<path class="wjm179syi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-insert-column-20-filled" {...props}></Icon>
<style>
:global(.wjm179syi) {
  fill: currentColor;
