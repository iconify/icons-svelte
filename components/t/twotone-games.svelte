...
const content = `<path class="ztyre86cb"/><path class="k7ookzc3k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-games" {...props}></Icon>
<style>
:global(.k7ookzc3k) {
  fill: currentColor;
