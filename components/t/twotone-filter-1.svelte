...
const content = `<path class="l7i_10bdq"/><path class="laeym5-if"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-filter-1" {...props}></Icon>
<style>
:global(.l7i_10bdq) {
  fill: currentColor;
