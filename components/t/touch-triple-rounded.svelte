...
const content = `<path class="nwow0-bea"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:touch-triple-rounded" {...props}></Icon>
<style>
:global(.nwow0-bea) {
  fill: currentColor;
