...
const content = `<circle class="cpk0fnbgt"/><path class="d9olisb_u"/><path class="p9cs7gxnr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:trakt-alt" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
