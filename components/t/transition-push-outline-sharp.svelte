...
const content = `<path class="hr-619ytb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:transition-push-outline-sharp" {...props}></Icon>
<style>
:global(.hr-619ytb) {
  fill: currentColor;
