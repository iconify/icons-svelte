...
const content = `<circle class="u40lczbbd"/><circle class="jmkjaobdd"/><circle class="n-1wyuzcv"/><path class="kzcbzlbge"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-workspaces" {...props}></Icon>
<style>
:global(.jmkjaobdd) {
  cx: 12px;
  cy: 7px;
