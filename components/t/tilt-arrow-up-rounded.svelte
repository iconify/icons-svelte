...
const content = `<path class="x2x58tbrr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:tilt-arrow-up-rounded" {...props}></Icon>
<style>
:global(.x2x58tbrr) {
  fill: currentColor;
