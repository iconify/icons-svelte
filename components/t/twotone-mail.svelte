...
const content = `<path class="y5h7g2bhi"/><path class="s5uyc6bty"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-mail" {...props}></Icon>
<style>
:global(.s5uyc6bty) {
  fill: currentColor;
