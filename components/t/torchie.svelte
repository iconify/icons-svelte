...
const content = `<path class="i3d3hvbvy"/><circle class="rct93mrgj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:torchie" {...props}></Icon>
<style>
:global(.i3d3hvbvy) {
  fill: none;
  stroke: currentColor;
