...
const content = `<path class="eeidbccgn"/><path class="j00g07b8x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-photo-camera-back" {...props}></Icon>
<style>
:global(.eeidbccgn) {
  fill: currentColor;
