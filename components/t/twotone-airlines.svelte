...
const content = `<path class="oq-ty827q"/><path class="ubjs4q5ge"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-airlines" {...props}></Icon>
<style>
:global(.oq-ty827q) {
  fill: currentColor;
