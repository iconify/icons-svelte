...
const content = `<path class="tit30sb8b"/><path class="q6qb_qz6a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-king-bed" {...props}></Icon>
<style>
:global(.q6qb_qz6a) {
  fill: currentColor;
