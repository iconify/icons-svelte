...
const content = `<path class="od7ixls0z"/><path class="hilcnhbxs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:timecap" {...props}></Icon>
<style>
:global(.hilcnhbxs) {
  fill: none;
  stroke: currentColor;
