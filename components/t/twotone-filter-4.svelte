...
const content = `<path class="xzcxutbmj"/><path class="khfwpopyv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-filter-4" {...props}></Icon>
<style>
:global(.khfwpopyv) {
  fill: currentColor;
