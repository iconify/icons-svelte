...
const content = `<path class="lv5b60b3j"/><path class="a0j8iq9rl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:typescript-icon" {...props}></Icon>
<style>
:global(.a0j8iq9rl) {
