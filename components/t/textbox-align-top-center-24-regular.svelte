...
const content = `<path class="clr52ac5q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:textbox-align-top-center-24-regular" {...props}></Icon>
<style>
:global(.clr52ac5q) {
  fill: currentColor;
