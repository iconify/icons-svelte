...
const content = `<path class="hrja6r4yb"/><path class="jpy-7jb7w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ttl-manager" {...props}></Icon>
<style>
:global(.hrja6r4yb) {
  fill: none;
  stroke: currentColor;
