...
const content = `<path class="hthzk1a1g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-bullet-list-ltr-90-20-regular" {...props}></Icon>
<style>
:global(.hthzk1a1g) {
  fill: currentColor;
