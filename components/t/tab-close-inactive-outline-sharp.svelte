...
const content = `<path class="mjjn0qblx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:tab-close-inactive-outline-sharp" {...props}></Icon>
<style>
:global(.mjjn0qblx) {
  fill: currentColor;
