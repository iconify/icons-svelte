...
const content = `<path class="l9kyzcblv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-left-rotate-270-20-filled" {...props}></Icon>
<style>
:global(.l9kyzcblv) {
  fill: currentColor;
