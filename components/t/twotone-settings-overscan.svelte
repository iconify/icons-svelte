...
const content = `<path class="nk1rzkh0j"/><path class="el9scfbak"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-settings-overscan" {...props}></Icon>
<style>
:global(.el9scfbak) {
  fill: currentColor;
