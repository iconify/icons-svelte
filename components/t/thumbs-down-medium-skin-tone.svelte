...
const content = `<path class="mkejss80c"/><path class="zzdgi5brt"/><path class="qi4fd8zxs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:thumbs-down-medium-skin-tone" {...props}></Icon>
<style>
:global(.mkejss80c) {
