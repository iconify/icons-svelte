...
const content = `<path class="c2_6ztbjd"/><path class="xlpoq6bnn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:thumbs-down-medium-skin-tone" {...props}></Icon>
<style>
:global(.c2_6ztbjd) {
