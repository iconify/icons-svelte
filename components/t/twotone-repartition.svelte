...
const content = `<path class="gy9esjbwp"/><path class="kxegz227v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-repartition" {...props}></Icon>
<style>
:global(.gy9esjbwp) {
  fill: currentColor;
