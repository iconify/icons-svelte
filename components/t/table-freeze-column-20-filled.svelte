...
const content = `<path class="c64588blm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-freeze-column-20-filled" {...props}></Icon>
<style>
:global(.c64588blm) {
  fill: currentColor;
