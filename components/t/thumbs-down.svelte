...
const content = `<path class="gdjg03u_n"/><path class="x34t_8avn"/><path class="o-1t_5iad"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:thumbs-down" {...props}></Icon>
<style>
:global(.gdjg03u_n) {
