...
const content = `<path class="csbsbw9le"/><path class="kwm5krbid"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:thumbs-down" {...props}></Icon>
<style>
:global(.csbsbw9le) {
