...
const content = `<path class="ryt9rccao"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-left-rotate-270-24-regular" {...props}></Icon>
<style>
:global(.ryt9rccao) {
  fill: currentColor;
