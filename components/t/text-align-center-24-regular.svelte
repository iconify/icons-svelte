...
const content = `<path class="f1qoyit8o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-center-24-regular" {...props}></Icon>
<style>
:global(.f1qoyit8o) {
  fill: currentColor;
