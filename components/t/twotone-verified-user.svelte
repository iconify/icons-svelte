...
const content = `<path class="r94bso3my"/><path class="hrhe-eb_m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-verified-user" {...props}></Icon>
<style>
:global(.hrhe-eb_m) {
  fill: currentColor;
