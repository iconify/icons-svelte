...
const content = `<path class="jyu1_qhvj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-right-20-regular" {...props}></Icon>
<style>
:global(.jyu1_qhvj) {
  fill: currentColor;
