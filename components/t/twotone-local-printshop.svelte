...
const content = `<path class="q60dec7pi"/><path class="qouoi6xyv"/><circle class="ts7gutx-e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-local-printshop" {...props}></Icon>
<style>
:global(.q60dec7pi) {
  fill: currentColor;
