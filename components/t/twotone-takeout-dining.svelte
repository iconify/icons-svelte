...
const content = `<path class="z1768obpb"/><path class="hi8a36bia"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-takeout-dining" {...props}></Icon>
<style>
:global(.hi8a36bia) {
  fill: currentColor;
