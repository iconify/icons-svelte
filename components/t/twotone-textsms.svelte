...
const content = `<path class="iia19nbcm"/><path class="ghzgggx8v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-textsms" {...props}></Icon>
<style>
:global(.ghzgggx8v) {
  fill: currentColor;
