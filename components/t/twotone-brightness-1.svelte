...
const content = `<path class="y8fvd828h"/><path class="xivdv8u9v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-brightness-1" {...props}></Icon>
<style>
:global(.xivdv8u9v) {
  fill: currentColor;
