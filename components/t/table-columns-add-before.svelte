...
const content = `<path class="dzwvp6lgu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:table-columns-add-before" {...props}></Icon>
<style>
:global(.dzwvp6lgu) {
  fill: none;
  stroke: currentColor;
