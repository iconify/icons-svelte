...
const content = `<path class="h8dm5kbdf"/><path class="ppo1ivb-f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-comments-disabled" {...props}></Icon>
<style>
:global(.h8dm5kbdf) {
  fill: currentColor;
