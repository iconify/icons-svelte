...
const content = `<path class="wfj78cbtw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:textbox-align-middle-20-filled" {...props}></Icon>
<style>
:global(.wfj78cbtw) {
  fill: currentColor;
