...
const content = `<path class="f3ops2dtz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-simple-checkmark-16-regular" {...props}></Icon>
<style>
:global(.f3ops2dtz) {
  fill: currentColor;
