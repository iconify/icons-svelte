...
const content = `<path class="bab9eo8pu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-center-16-filled" {...props}></Icon>
<style>
:global(.bab9eo8pu) {
  fill: currentColor;
