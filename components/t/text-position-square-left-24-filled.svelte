...
const content = `<path class="el66hz51u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-position-square-left-24-filled" {...props}></Icon>
<style>
:global(.el66hz51u) {
  fill: currentColor;
