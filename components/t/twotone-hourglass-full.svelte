...
const content = `<path class="smjt46b7k"/><path class="jtowclbnw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-hourglass-full" {...props}></Icon>
<style>
:global(.jtowclbnw) {
  fill: currentColor;
