...
const content = `<path class="hflxfiftp"/><path class="jnpp5-1xm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-check-box" {...props}></Icon>
<style>
:global(.hflxfiftp) {
  fill: currentColor;
