...
const content = `<path class="u8_jzvbir"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-stack-left-16-regular" {...props}></Icon>
<style>
:global(.u8_jzvbir) {
  fill: currentColor;
