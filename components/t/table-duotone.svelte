...
const content = `<g class="cuyn6tgcc"><path class="j98gnfblg"/><path class="cx736y5fz"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:table-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
