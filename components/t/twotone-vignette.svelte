...
const content = `<path class="krriyyb6t"/><path class="pwwbv9bwx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-vignette" {...props}></Icon>
<style>
:global(.krriyyb6t) {
  fill: currentColor;
