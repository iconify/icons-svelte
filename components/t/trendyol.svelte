...
const content = `<path class="i9clfwm2k"/><path class="b9h8_k21c"/><path class="t5k0or6lb"/><rect class="ty_qnh7mo"/><path class="qu188cbsw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:trendyol" {...props}></Icon>
<style>
:global(.b9h8_k21c) {
  fill: none;
  stroke: currentColor;
