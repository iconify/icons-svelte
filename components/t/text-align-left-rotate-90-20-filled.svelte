...
const content = `<path class="gahc6ac5f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-left-rotate-90-20-filled" {...props}></Icon>
<style>
:global(.gahc6ac5f) {
  fill: currentColor;
