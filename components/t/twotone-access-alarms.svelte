...
const content = `<path class="za4nees9e"/><path class="uepr53bpm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-access-alarms" {...props}></Icon>
<style>
:global(.uepr53bpm) {
  fill: currentColor;
