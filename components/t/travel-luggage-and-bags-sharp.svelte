...
const content = `<path class="qv4fs4baz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:travel-luggage-and-bags-sharp" {...props}></Icon>
<style>
:global(.qv4fs4baz) {
  fill: currentColor;
