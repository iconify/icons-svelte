...
const content = `<path class="g2wj9jbhp"/><path class="yzc9wx7vo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:t-connect" {...props}></Icon>
<style>
:global(.g2wj9jbhp) {
  fill: none;
  stroke: currentColor;
