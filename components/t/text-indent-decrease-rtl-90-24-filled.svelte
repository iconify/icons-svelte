...
const content = `<path class="ea8j5f56r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-indent-decrease-rtl-90-24-filled" {...props}></Icon>
<style>
:global(.ea8j5f56r) {
  fill: currentColor;
