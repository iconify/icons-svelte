...
const content = `<path class="nre7l_kxl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:tsv-outline-sharp" {...props}></Icon>
<style>
:global(.nre7l_kxl) {
  fill: currentColor;
