...
const content = `<path class="u8fmzqkta"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:traffic-outline-sharp" {...props}></Icon>
<style>
:global(.u8fmzqkta) {
  fill: currentColor;
