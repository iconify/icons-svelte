...
const content = `<path class="qy4iinbsy"/><path class="ltgnblbty"/><path class="zgefe1_jv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:tremotesf" {...props}></Icon>
<style>
:global(.ltgnblbty) {
  fill: none;
  stroke: currentColor;
