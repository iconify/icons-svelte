...
const content = `<path class="li1nu-b4u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:tire-repair" {...props}></Icon>
<style>
:global(.li1nu-b4u) {
  fill: currentColor;
