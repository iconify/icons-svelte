...
const content = `<path class="vee4d2bko"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-direction-rotate-315-right-20-filled" {...props}></Icon>
<style>
:global(.vee4d2bko) {
  fill: currentColor;
