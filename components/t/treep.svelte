...
const content = `<path class="m2i8ngakm"/><circle class="xlvr0_jyn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:treep" {...props}></Icon>
<style>
:global(.m2i8ngakm) {
  fill: none;
  stroke: currentColor;
