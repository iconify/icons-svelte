...
const content = `<path class="fdl-abw2c"/><path class="fazbtmbtq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-star-rate" {...props}></Icon>
<style>
:global(.fazbtmbtq) {
  fill: currentColor;
