...
const content = `<path class="myb007wry"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:temperature-degree-fahrenheit-20-filled" {...props}></Icon>
<style>
:global(.myb007wry) {
  fill: currentColor;
