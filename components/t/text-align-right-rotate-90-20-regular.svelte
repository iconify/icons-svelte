...
const content = `<path class="fbt13dros"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-right-rotate-90-20-regular" {...props}></Icon>
<style>
:global(.fbt13dros) {
  fill: currentColor;
