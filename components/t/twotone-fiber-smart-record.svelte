...
const content = `<path class="es3n8fbcj"/><path class="i9engv9tk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-fiber-smart-record" {...props}></Icon>
<style>
:global(.es3n8fbcj) {
  fill: currentColor;
