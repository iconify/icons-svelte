...
const content = `<path class="boy-gselm"/><path class="dzgn6ewoj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-headset" {...props}></Icon>
<style>
:global(.boy-gselm) {
  fill: currentColor;
