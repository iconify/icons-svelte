...
const content = `<path class="oc2iyjbmh"/><path class="wlo72rtoq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:thumbs-up-medium-dark-skin-tone" {...props}></Icon>
<style>
:global(.oc2iyjbmh) {
