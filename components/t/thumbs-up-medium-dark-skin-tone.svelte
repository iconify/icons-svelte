...
const content = `<path class="vt4jxcbrz"/><path class="a589bpcos"/><path class="y68aqib5i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:thumbs-up-medium-dark-skin-tone" {...props}></Icon>
<style>
:global(.a589bpcos) {
