...
const content = `<path class="u-aul108h"/><path class="fqk9an3xc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:twire" {...props}></Icon>
<style>
:global(.fqk9an3xc) {
  fill: none;
  stroke: currentColor;
