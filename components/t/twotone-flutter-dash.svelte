...
const content = `<path class="e9e_-b2gz"/><path class="f4qhgriyt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-flutter-dash" {...props}></Icon>
<style>
:global(.e9e_-b2gz) {
  fill: currentColor;
