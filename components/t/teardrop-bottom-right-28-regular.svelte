...
const content = `<path class="ckh412box"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:teardrop-bottom-right-28-regular" {...props}></Icon>
<style>
:global(.ckh412box) {
  fill: currentColor;
