...
const content = `<path class="csm1l_10m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-left-rotate-270-16-filled" {...props}></Icon>
<style>
:global(.csm1l_10m) {
  fill: currentColor;
