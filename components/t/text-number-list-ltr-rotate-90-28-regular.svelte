...
const content = `<path class="dr3gqzb1u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-number-list-ltr-rotate-90-28-regular" {...props}></Icon>
<style>
:global(.dr3gqzb1u) {
  fill: currentColor;
