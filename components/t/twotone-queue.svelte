...
const content = `<path class="k0ydp6tsa"/><path class="zsy-ixbxr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-queue" {...props}></Icon>
<style>
:global(.k0ydp6tsa) {
  fill: currentColor;
