...
const content = `<path class="oclmyxbtu"/><path class="luckh9b7v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-filter" {...props}></Icon>
<style>
:global(.luckh9b7v) {
  fill: currentColor;
