...
const content = `<path class="zvn00-b9s"/><path class="m5unsyqjw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-announcement" {...props}></Icon>
<style>
:global(.m5unsyqjw) {
  fill: currentColor;
