...
const content = `<path class="mzj1ag7qe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:textbox-align-middle-16-regular" {...props}></Icon>
<style>
:global(.mzj1ag7qe) {
  fill: currentColor;
