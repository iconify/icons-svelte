...
const content = `<path class="w9bencb8t"/><path class="dbcmre8io"/><path class="y_5gu2b4c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-view-cozy" {...props}></Icon>
<style>
:global(.dbcmre8io) {
  fill: currentColor;
