...
const content = `<path class="p5ena08_y"/><path class="jv-1_ac6g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-library-books" {...props}></Icon>
<style>
:global(.jv-1_ac6g) {
  fill: currentColor;
