...
const content = `<path class="nysjy7oac"/><path class="ko-qp_e8c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-turned-in" {...props}></Icon>
<style>
:global(.ko-qp_e8c) {
  fill: currentColor;
