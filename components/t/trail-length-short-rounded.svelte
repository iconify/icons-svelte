...
const content = `<path class="pz3edcb4l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:trail-length-short-rounded" {...props}></Icon>
<style>
:global(.pz3edcb4l) {
  fill: currentColor;
