...
const content = `<path class="dma6ujfzh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:textbox-align-top-rotate-90-24-filled" {...props}></Icon>
<style>
:global(.dma6ujfzh) {
  fill: currentColor;
