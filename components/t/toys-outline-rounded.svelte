...
const content = `<path class="wtdxjgf_t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:toys-outline-rounded" {...props}></Icon>
<style>
:global(.wtdxjgf_t) {
  fill: currentColor;
