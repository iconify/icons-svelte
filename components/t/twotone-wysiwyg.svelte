...
const content = `<path class="g779bhyyl"/><path class="b16evob_q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-wysiwyg" {...props}></Icon>
<style>
:global(.b16evob_q) {
  fill: currentColor;
