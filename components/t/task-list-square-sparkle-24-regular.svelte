...
const content = `<path class="k874ccorx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:task-list-square-sparkle-24-regular" {...props}></Icon>
<style>
:global(.k874ccorx) {
  fill: currentColor;
