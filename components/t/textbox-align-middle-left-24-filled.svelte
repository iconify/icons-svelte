...
const content = `<path class="ka-1jlb6p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:textbox-align-middle-left-24-filled" {...props}></Icon>
<style>
:global(.ka-1jlb6p) {
  fill: currentColor;
