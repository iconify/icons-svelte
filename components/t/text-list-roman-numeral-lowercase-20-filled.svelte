...
const content = `<path class="fy7m4so-r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-list-roman-numeral-lowercase-20-filled" {...props}></Icon>
<style>
:global(.fy7m4so-r) {
  fill: currentColor;
