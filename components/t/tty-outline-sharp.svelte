...
const content = `<path class="m71qieb0x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:tty-outline-sharp" {...props}></Icon>
<style>
:global(.m71qieb0x) {
  fill: currentColor;
