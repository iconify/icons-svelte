...
const content = `<path class="vp58h1xyx"/><path class="zbvaiin2w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-folder" {...props}></Icon>
<style>
:global(.vp58h1xyx) {
  fill: currentColor;
