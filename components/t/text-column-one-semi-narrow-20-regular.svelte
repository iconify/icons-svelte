...
const content = `<path class="wzrho1btu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-column-one-semi-narrow-20-regular" {...props}></Icon>
<style>
:global(.wzrho1btu) {
  fill: currentColor;
