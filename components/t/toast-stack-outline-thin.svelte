...
const content = `<g class="hntgybcog"><path class="c-bzonblr"/><path class="kqaa63eeo"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:toast-stack-outline-thin" {...props}></Icon>
<style>
:global(.c-bzonblr) {
