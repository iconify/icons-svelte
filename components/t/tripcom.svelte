...
const content = `<path class="i9clfwm2k"/><path class="xd_pobuoo"/><circle class="o-lr__gog"/><path class="uhftlef-f"/><circle class="v6742bhrz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:tripcom" {...props}></Icon>
<style>
:global(.i9clfwm2k) {
  fill: none;
  stroke: currentColor;
