...
const content = `<path class="j2ltg6v_y"/><path class="x_q-jmb8o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-edit" {...props}></Icon>
<style>
:global(.j2ltg6v_y) {
  fill: currentColor;
