...
const content = `<path class="vzn1g-bax"/><path class="u7uaweemf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-arrow-drop-down-circle" {...props}></Icon>
<style>
:global(.u7uaweemf) {
  fill: currentColor;
