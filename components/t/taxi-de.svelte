...
const content = `<path class="y3ond4ags"/><circle class="joi22b4wa"/><path class="chza5_bcj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:taxi-de" {...props}></Icon>
<style>
:global(.chza5_bcj) {
  fill: none;
  stroke: currentColor;
