...
const content = `<g class="nrj6p8qat"><path class="m5elujb-l"/><path class="wfvx-jtqi"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:table-columns-merge-previous-fill" {...props}></Icon>
<style>
:global(.m5elujb-l) {
  fill: currentColor;
