...
const content = `<path class="x06ohzb0c"/><path class="w4xdj_4_t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-phonelink-ring" {...props}></Icon>
<style>
:global(.w4xdj_4_t) {
  fill: currentColor;
