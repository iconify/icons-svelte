...
const content = `<path class="pm1kgrbpr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:text-snippet-outline" {...props}></Icon>
<style>
:global(.pm1kgrbpr) {
  fill: currentColor;
