...
const content = `<g class="nrj6p8qat"><path class="is1bv_axc"/><path class="ys58egb0o"/><path class="gn7q9ebir"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:terraform-outline-regular" {...props}></Icon>
<style>
:global(.gn7q9ebir) {
