...
const content = `<path class="w5uwxotbk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-cells-split-28-filled" {...props}></Icon>
<style>
:global(.w5uwxotbk) {
  fill: currentColor;
