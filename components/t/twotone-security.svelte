...
const content = `<path class="w8p0zpbvo"/><path class="e1y19lbhc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-security" {...props}></Icon>
<style>
:global(.e1y19lbhc) {
  fill: currentColor;
