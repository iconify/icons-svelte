...
const content = `<path class="ni2caqtou"/><path class="tugrwzb8k"/><path class="c6gxa0bde"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-medication" {...props}></Icon>
<style>
:global(.c6gxa0bde) {
  fill: currentColor;
