...
const content = `<path class="fy172ublp"/><path class="osdc55s5s"/><path class="na6192bed"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:thumbs-down-medium-light-skin-tone" {...props}></Icon>
<style>
:global(.fy172ublp) {
