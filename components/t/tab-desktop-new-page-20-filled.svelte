...
const content = `<path class="iagij1b6k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:tab-desktop-new-page-20-filled" {...props}></Icon>
<style>
:global(.iagij1b6k) {
  fill: currentColor;
