...
const content = `<path class="k0uie3_se"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:table-sign-outline-sharp" {...props}></Icon>
<style>
:global(.k0uie3_se) {
  fill: currentColor;
