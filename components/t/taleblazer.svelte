...
const content = `<circle class="gi7-35bac"/><path class="fqrt0ffjl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:taleblazer" {...props}></Icon>
<style>
:global(.fqrt0ffjl) {
  fill: none;
  stroke: currentColor;
