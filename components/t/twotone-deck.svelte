...
const content = `<path class="huqsl3b9n"/><path class="c5ffibcpj"/><path class="z6k6deb5g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-deck" {...props}></Icon>
<style>
:global(.c5ffibcpj) {
  fill: currentColor;
