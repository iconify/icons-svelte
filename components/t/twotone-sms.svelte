...
const content = `<path class="g7xuwmbww"/><path class="pa_snqvsz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-sms" {...props}></Icon>
<style>
:global(.g7xuwmbww) {
  fill: currentColor;
