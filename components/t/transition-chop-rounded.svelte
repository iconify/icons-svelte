...
const content = `<path class="oesd2wcff"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:transition-chop-rounded" {...props}></Icon>
<style>
:global(.oesd2wcff) {
  fill: currentColor;
