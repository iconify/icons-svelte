...
const content = `<path class="efwv48xoh"/><path class="f2kwm5bvx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-night-shelter" {...props}></Icon>
<style>
:global(.efwv48xoh) {
  fill: currentColor;
