...
const content = `<path class="m3_8-70xs"/><path class="fii22wc0c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-window" {...props}></Icon>
<style>
:global(.fii22wc0c) {
  fill: currentColor;
