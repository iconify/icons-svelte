...
const content = `<path class="bin3-2lxw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:tablet-android-rounded" {...props}></Icon>
<style>
:global(.bin3-2lxw) {
  fill: currentColor;
