...
const content = `<path class="wyr14fb2d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-bottom-row-28-filled" {...props}></Icon>
<style>
:global(.wyr14fb2d) {
  fill: currentColor;
