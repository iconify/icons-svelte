...
const content = `<path class="qnkewkj1u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-add-space-before-24-regular" {...props}></Icon>
<style>
:global(.qnkewkj1u) {
  fill: currentColor;
