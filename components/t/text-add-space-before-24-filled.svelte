...
const content = `<path class="owkkribch"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-add-space-before-24-filled" {...props}></Icon>
<style>
:global(.owkkribch) {
  fill: currentColor;
