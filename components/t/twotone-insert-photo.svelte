...
const content = `<path class="x9ph6yocg"/><path class="o8t0p-bds"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-insert-photo" {...props}></Icon>
<style>
:global(.o8t0p-bds) {
  fill: currentColor;
