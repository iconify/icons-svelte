...
const content = `<path class="ojd2690ja"/><path class="m_cixygoo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-local-cafe" {...props}></Icon>
<style>
:global(.m_cixygoo) {
  fill: currentColor;
