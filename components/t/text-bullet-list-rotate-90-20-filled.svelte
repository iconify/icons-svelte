...
const content = `<path class="pcd_s6dns"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-bullet-list-rotate-90-20-filled" {...props}></Icon>
<style>
:global(.pcd_s6dns) {
  fill: currentColor;
