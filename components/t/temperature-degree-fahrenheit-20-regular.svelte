...
const content = `<path class="t-j3u3b9j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:temperature-degree-fahrenheit-20-regular" {...props}></Icon>
<style>
:global(.t-j3u3b9j) {
  fill: currentColor;
