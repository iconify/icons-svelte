...
const content = `<path class="mxwt4tbpw"/><path class="ni1ltcqyw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-flashlight-off" {...props}></Icon>
<style>
:global(.mxwt4tbpw) {
  fill: currentColor;
