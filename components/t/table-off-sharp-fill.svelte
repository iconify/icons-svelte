...
const content = `<g class="gp_8x1bzb"><path class="dsifhwy8h"/><path class="e97nbxzic"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:table-off-sharp-fill" {...props}></Icon>
<style>
:global(.dsifhwy8h) {
  fill: currentColor;
