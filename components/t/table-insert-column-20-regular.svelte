...
const content = `<path class="wxaw9vb0z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-insert-column-20-regular" {...props}></Icon>
<style>
:global(.wxaw9vb0z) {
  fill: currentColor;
