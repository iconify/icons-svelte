...
const content = `<path class="f_g0gtf_l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-paragraph-direction-left-16-regular" {...props}></Icon>
<style>
:global(.f_g0gtf_l) {
  fill: currentColor;
