...
const content = `<path class="eqzfm-ugy"/><path class="z-58rk_mc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-cast-connected" {...props}></Icon>
<style>
:global(.eqzfm-ugy) {
  fill: currentColor;
