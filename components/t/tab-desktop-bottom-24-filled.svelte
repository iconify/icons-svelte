...
const content = `<path class="rbyyi6xqy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:tab-desktop-bottom-24-filled" {...props}></Icon>
<style>
:global(.rbyyi6xqy) {
  fill: currentColor;
