...
const content = `<path class="qhzn6vd_z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:teardrop-bottom-right-24-regular" {...props}></Icon>
<style>
:global(.qhzn6vd_z) {
  fill: currentColor;
