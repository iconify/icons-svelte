...
const content = `<path class="va1dd-bps"/><path class="t9tohgx0q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-dns" {...props}></Icon>
<style>
:global(.t9tohgx0q) {
  fill: currentColor;
