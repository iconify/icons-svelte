...
const content = `<path class="kb0bzubrw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-cells-merge-28-filled" {...props}></Icon>
<style>
:global(.kb0bzubrw) {
  fill: currentColor;
