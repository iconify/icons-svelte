...
const content = `<path class="xpnxdt7xy"/><path class="qua8wlbzm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-task" {...props}></Icon>
<style>
:global(.qua8wlbzm) {
  fill: currentColor;
