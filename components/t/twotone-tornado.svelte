...
const content = `<path class="ml2oxo-eg"/><path class="f039ccs1z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-tornado" {...props}></Icon>
<style>
:global(.f039ccs1z) {
  fill: currentColor;
