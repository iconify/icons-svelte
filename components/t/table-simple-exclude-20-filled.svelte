...
const content = `<path class="vhcpikybp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-simple-exclude-20-filled" {...props}></Icon>
<style>
:global(.vhcpikybp) {
  fill: currentColor;
