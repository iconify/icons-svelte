...
const content = `<path class="t55tb3btj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:terminal-emulator-nethunter" {...props}></Icon>
<style>
:global(.t55tb3btj) {
  fill: none;
  stroke: currentColor;
