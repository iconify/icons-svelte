...
const content = `<path class="uigiw4bzv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-bullet-list-rtl-20-regular" {...props}></Icon>
<style>
:global(.uigiw4bzv) {
  fill: currentColor;
