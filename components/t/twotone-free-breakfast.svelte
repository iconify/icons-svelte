...
const content = `<path class="rx8amib4z"/><path class="hd9cndbxz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-free-breakfast" {...props}></Icon>
<style>
:global(.hd9cndbxz) {
  fill: currentColor;
