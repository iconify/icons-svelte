...
const content = `<path class="ll0g54h-q"/><path class="nc5-e2bvq"/><path class="zrqnfo19m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:tfl-oyster" {...props}></Icon>
<style>
:global(.ll0g54h-q) {
  fill: none;
  stroke: currentColor;
