...
const content = `<path class="f9x_6ibju"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:tv-signin-outline-sharp" {...props}></Icon>
<style>
:global(.f9x_6ibju) {
  fill: currentColor;
