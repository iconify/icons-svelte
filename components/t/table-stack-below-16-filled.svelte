...
const content = `<path class="r8e--nbuc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-stack-below-16-filled" {...props}></Icon>
<style>
:global(.r8e--nbuc) {
  fill: currentColor;
