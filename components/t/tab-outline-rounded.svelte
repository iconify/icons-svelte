...
const content = `<path class="fjij08tig"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:tab-outline-rounded" {...props}></Icon>
<style>
:global(.fjij08tig) {
  fill: currentColor;
