...
const content = `<path class="xxiqy3mmh"/><path class="hi3nt2zxt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-loupe" {...props}></Icon>
<style>
:global(.hi3nt2zxt) {
  fill: currentColor;
