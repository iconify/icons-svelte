...
const content = `<path class="bnfk03bpe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-indent-increase-rtl-90-24-regular" {...props}></Icon>
<style>
:global(.bnfk03bpe) {
  fill: currentColor;
