...
const content = `<path class="y2gz8uilm"/><path class="b-4-fre7y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-calendar-view-month" {...props}></Icon>
<style>
:global(.b-4-fre7y) {
  fill: currentColor;
