...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:text-select-move-forward-character-outline-sharp" {...props}></Icon>
<style>
:global(.d1dcf-bga) {
  fill: currentColor;
