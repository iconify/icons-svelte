...
const content = `<path class="wgkx2gz-z"/><path class="levvep35i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-water-damage" {...props}></Icon>
<style>
:global(.levvep35i) {
  fill: currentColor;
