...
const content = `<path class="gmh1acb-q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-first-line-20-regular" {...props}></Icon>
<style>
:global(.gmh1acb-q) {
  fill: currentColor;
