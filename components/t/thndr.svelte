...
const content = `<path class="ozg0ggbju"/><path class="n74y6fbqo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:thndr" {...props}></Icon>
<style>
:global(.n74y6fbqo) {
  fill: none;
  stroke: currentColor;
