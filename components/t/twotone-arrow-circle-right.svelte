...
const content = `<path class="dyjz-ovza"/><path class="zv2ew-btn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-arrow-circle-right" {...props}></Icon>
<style>
:global(.dyjz-ovza) {
  fill: currentColor;
