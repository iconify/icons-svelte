...
const content = `<path class="ch-hh4-za"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-indent-decrease-rtl-16-filled" {...props}></Icon>
<style>
:global(.ch-hh4-za) {
  fill: currentColor;
