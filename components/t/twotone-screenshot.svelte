...
const content = `<path class="gtc0wbgux"/><path class="be625c6pp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-screenshot" {...props}></Icon>
<style>
:global(.be625c6pp) {
  fill: currentColor;
