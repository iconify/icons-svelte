...
const content = `<path class="oj1p_xbyo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-simple-exclude-24-filled" {...props}></Icon>
<style>
:global(.oj1p_xbyo) {
  fill: currentColor;
