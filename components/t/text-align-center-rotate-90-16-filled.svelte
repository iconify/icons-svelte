...
const content = `<path class="jjin3rytl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-center-rotate-90-16-filled" {...props}></Icon>
<style>
:global(.jjin3rytl) {
  fill: currentColor;
