...
const content = `<path class="y3w-di7bv"/><path class="ef7wevc0y"/><path class="hfqxcj39v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione:tongue" {...props}></Icon>
<style>
:global(.ef7wevc0y) {
