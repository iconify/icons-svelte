...
const content = `<path class="po7f_rbfj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-freeze-column-and-row-28-filled" {...props}></Icon>
<style>
:global(.po7f_rbfj) {
  fill: currentColor;
