...
const content = `<path class="dne5ugbxs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:tablet-mac-outline-sharp" {...props}></Icon>
<style>
:global(.dne5ugbxs) {
  fill: currentColor;
