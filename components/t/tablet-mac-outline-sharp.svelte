...
const content = `<path class="td2hv8lfp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:tablet-mac-outline-sharp" {...props}></Icon>
<style>
:global(.td2hv8lfp) {
  fill: currentColor;
