...
const content = `<path class="dnaugbolp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:tv-displays" {...props}></Icon>
<style>
:global(.dnaugbolp) {
  fill: currentColor;
