...
const content = `<path class="t0l8rmt8u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:two-pager-outline" {...props}></Icon>
<style>
:global(.t0l8rmt8u) {
  fill: currentColor;
