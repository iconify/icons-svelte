...
const content = `<path class="ssy0l0p5m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-justify-rotate-270-24-regular" {...props}></Icon>
<style>
:global(.ssy0l0p5m) {
  fill: currentColor;
