...
const content = `<path class="iehq34blm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-grammar-lightning-24-regular" {...props}></Icon>
<style>
:global(.iehq34blm) {
  fill: currentColor;
