...
const content = `<path class="f6myxeyln"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-simple-exclude-48-filled" {...props}></Icon>
<style>
:global(.f6myxeyln) {
  fill: currentColor;
