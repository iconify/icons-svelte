...
const content = `<path class="s3scr0bqb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-insert-row-20-filled" {...props}></Icon>
<style>
:global(.s3scr0bqb) {
  fill: currentColor;
