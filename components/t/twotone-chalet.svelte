...
const content = `<path class="hzhf2g_bz"/><path class="attd3zbbd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-chalet" {...props}></Icon>
<style>
:global(.attd3zbbd) {
  fill: currentColor;
