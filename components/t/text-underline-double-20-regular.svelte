...
const content = `<path class="fc92gfbtu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-underline-double-20-regular" {...props}></Icon>
<style>
:global(.fc92gfbtu) {
  fill: currentColor;
