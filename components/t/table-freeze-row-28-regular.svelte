...
const content = `<path class="um_piro9r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-freeze-row-28-regular" {...props}></Icon>
<style>
:global(.um_piro9r) {
  fill: currentColor;
