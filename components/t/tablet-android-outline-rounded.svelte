...
const content = `<path class="y7l6iouvx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:tablet-android-outline-rounded" {...props}></Icon>
<style>
:global(.y7l6iouvx) {
  fill: currentColor;
