...
const content = `<circle class="ihwennzfv"/><path class="w5qkwcbsp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-center-focus-strong" {...props}></Icon>
<style>
:global(.ihwennzfv) {
  cx: 12px;
  cy: 12px;
