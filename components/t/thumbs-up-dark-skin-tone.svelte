...
const content = `<path class="vo36mjbuc"/><path class="z6-_q_bfy"/><path class="avohgtmqz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:thumbs-up-dark-skin-tone" {...props}></Icon>
<style>
:global(.avohgtmqz) {
