...
const content = `<path class="gkeq8mmmw"/><path class="pv-g2z2xt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:thumbs-up-dark-skin-tone" {...props}></Icon>
<style>
:global(.gkeq8mmmw) {
