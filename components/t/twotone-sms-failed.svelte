...
const content = `<path class="risb1mboy"/><path class="tz6qxzbup"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-sms-failed" {...props}></Icon>
<style>
:global(.risb1mboy) {
  fill: currentColor;
