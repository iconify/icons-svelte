...
const content = `<path class="k36li8bag"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:tornado-rounded" {...props}></Icon>
<style>
:global(.k36li8bag) {
  fill: currentColor;
