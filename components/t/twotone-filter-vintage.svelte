...
const content = `<path class="zk_mu1iro"/><path class="viedxdj4w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-filter-vintage" {...props}></Icon>
<style>
:global(.viedxdj4w) {
  fill: currentColor;
