...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:text-select-move-back-character-outline-sharp" {...props}></Icon>
<style>
:global(.tj9crcjpg) {
  fill: currentColor;
