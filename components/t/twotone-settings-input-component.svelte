...
const content = `<path class="nleslac0f"/><path class="gil2ri6ee"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-settings-input-component" {...props}></Icon>
<style>
:global(.gil2ri6ee) {
  fill: currentColor;
