...
const content = `<path class="gj67v-bgv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-indent-increase-rtl-rotate-270-24-regular" {...props}></Icon>
<style>
:global(.gj67v-bgv) {
  fill: currentColor;
