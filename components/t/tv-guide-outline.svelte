...
const content = `<path class="pp0v0nb_u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:tv-guide-outline" {...props}></Icon>
<style>
:global(.pp0v0nb_u) {
  fill: currentColor;
