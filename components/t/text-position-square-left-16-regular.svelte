...
const content = `<path class="z5b7j00zl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-position-square-left-16-regular" {...props}></Icon>
<style>
:global(.z5b7j00zl) {
  fill: currentColor;
