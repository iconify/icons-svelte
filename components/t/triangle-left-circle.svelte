...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="b51rv_6hx"/><path class="hdxpysbbn"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:triangle-left-circle" {...props}></Icon>
<style>
:global(.b51rv_6hx) {
