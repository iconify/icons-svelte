...
const content = `<path class="tcsqnzlvq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:transportation-rounded" {...props}></Icon>
<style>
:global(.tcsqnzlvq) {
  fill: currentColor;
