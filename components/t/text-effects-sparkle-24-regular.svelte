...
const content = `<path class="oorefikoi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-effects-sparkle-24-regular" {...props}></Icon>
<style>
:global(.oorefikoi) {
  fill: currentColor;
