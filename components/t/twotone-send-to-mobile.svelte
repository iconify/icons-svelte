...
const content = `<path class="be625c6pp"/><path class="d7-8-q3yy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-send-to-mobile" {...props}></Icon>
<style>
:global(.be625c6pp) {
  fill: currentColor;
