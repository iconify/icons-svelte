...
const content = `<g class="cuyn6tgcc"><path class="cvrng-eig"/><path class="t0rs26nql"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:treasure-chest-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
