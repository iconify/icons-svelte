...
const content = `<rect class="j3s9ivbxi"/><path class="af4z2c6jn"/><circle class="ozuud_mbl"/><path class="q35ido4fh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:tenor" {...props}></Icon>
<style>
:global(.af4z2c6jn) {
  fill: none;
  stroke: currentColor;
