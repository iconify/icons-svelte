...
const content = `<path class="x8m_zvv2f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-distributed-evenly-20-regular" {...props}></Icon>
<style>
:global(.x8m_zvv2f) {
  fill: currentColor;
