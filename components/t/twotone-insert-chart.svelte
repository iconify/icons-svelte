...
const content = `<path class="lphnu4tod"/><path class="izswi-b0m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-insert-chart" {...props}></Icon>
<style>
:global(.izswi-b0m) {
  fill: currentColor;
