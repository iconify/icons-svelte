...
const content = `<path class="bpxfz-b9u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-align-distributed-evenly-24-filled" {...props}></Icon>
<style>
:global(.bpxfz-b9u) {
  fill: currentColor;
