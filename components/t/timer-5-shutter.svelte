...
const content = `<path class="g2cb7ox5r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:timer-5-shutter" {...props}></Icon>
<style>
:global(.g2cb7ox5r) {
  fill: currentColor;
