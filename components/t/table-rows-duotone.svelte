...
const content = `<g class="nrj6p8qat"><path class="dl2nz2boo"/><path class="jfp2fyuan"/><path class="onntuwhvq"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:table-rows-duotone" {...props}></Icon>
<style>
:global(.dl2nz2boo) {
  fill: currentColor;
