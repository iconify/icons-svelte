...
const content = `<path class="hkkq5ibbg"/><path class="g7txtqepp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-edgesensor-low" {...props}></Icon>
<style>
:global(.g7txtqepp) {
  fill: currentColor;
