...
const content = `<path class="zoa7y9b5h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-simple-checkmark-28-filled" {...props}></Icon>
<style>
:global(.zoa7y9b5h) {
  fill: currentColor;
