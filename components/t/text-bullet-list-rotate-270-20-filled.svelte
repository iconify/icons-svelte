...
const content = `<path class="ej3ebwj-x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-bullet-list-rotate-270-20-filled" {...props}></Icon>
<style>
:global(.ej3ebwj-x) {
  fill: currentColor;
