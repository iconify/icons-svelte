...
const content = `<path class="n-2bnugxq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-continuous-20-regular" {...props}></Icon>
<style>
:global(.n-2bnugxq) {
  fill: currentColor;
