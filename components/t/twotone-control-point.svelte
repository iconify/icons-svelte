...
const content = `<path class="ilwcq469z"/><path class="w7hqkr36m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-control-point" {...props}></Icon>
<style>
:global(.ilwcq469z) {
  fill: currentColor;
