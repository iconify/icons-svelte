...
const content = `<path class="ytpo3r7ao"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-column-one-24-regular" {...props}></Icon>
<style>
:global(.ytpo3r7ao) {
  fill: currentColor;
