...
const content = `<path class="lmw5srbfz"/><path class="hnbyaobjq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-camera-rear" {...props}></Icon>
<style>
:global(.hnbyaobjq) {
  fill: currentColor;
