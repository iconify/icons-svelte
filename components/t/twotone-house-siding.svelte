...
const content = `<path class="duodb9bcc"/><path class="lhtwx-qnt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-house-siding" {...props}></Icon>
<style>
:global(.duodb9bcc) {
  fill: currentColor;
