...
const content = `<path class="fk0umbd_j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:triangle-circle-rounded" {...props}></Icon>
<style>
:global(.fk0umbd_j) {
  fill: currentColor;
