...
const content = `<path class="da_7bo6mw"/><path class="jbzus25sp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-view-agenda" {...props}></Icon>
<style>
:global(.da_7bo6mw) {
  fill: currentColor;
