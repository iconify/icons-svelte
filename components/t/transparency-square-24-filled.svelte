...
const content = `<path class="ga7pjgavt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:transparency-square-24-filled" {...props}></Icon>
<style>
:global(.ga7pjgavt) {
  fill: currentColor;
