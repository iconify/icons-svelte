...
const content = `<path class="f3p3f5byp"/><path class="m2ppizb7d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-scanner" {...props}></Icon>
<style>
:global(.f3p3f5byp) {
  fill: currentColor;
