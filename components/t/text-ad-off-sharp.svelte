...
const content = `<path class="pq_bt8b2w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:text-ad-off-sharp" {...props}></Icon>
<style>
:global(.pq_bt8b2w) {
  fill: currentColor;
