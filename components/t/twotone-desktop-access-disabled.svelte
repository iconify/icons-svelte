...
const content = `<path class="zmdfmibkl"/><path class="a7zx9bcad"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-desktop-access-disabled" {...props}></Icon>
<style>
:global(.a7zx9bcad) {
  fill: currentColor;
