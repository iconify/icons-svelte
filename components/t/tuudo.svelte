...
const content = `<rect class="j3s9ivbxi"/><rect class="fvfizpb2v"/><path class="egeijobri"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:tuudo" {...props}></Icon>
<style>
:global(.egeijobri) {
  fill: none;
  stroke: currentColor;
