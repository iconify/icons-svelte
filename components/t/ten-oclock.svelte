...
const content = `<circle class="yqfvb1bwf"/><circle class="f934iu1fb"/><path class="mbt1d-r9l"/><path class="th4vr_ono"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:ten-oclock" {...props}></Icon>
<style>
:global(.f934iu1fb) {
  cx: 18px;
  cy: 18px;
