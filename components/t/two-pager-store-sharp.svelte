...
const content = `<path class="cod4p0xdc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:two-pager-store-sharp" {...props}></Icon>
<style>
:global(.cod4p0xdc) {
  fill: currentColor;
