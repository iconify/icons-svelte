...
const content = `<g class="ft5dv1b6b"><path class="nrspho85i"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-direction-rtl-ac-20-regular" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
