...
const content = `<path class="iybr7jbzg"/><path class="yijkhnboc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:thumbs-up" {...props}></Icon>
<style>
:global(.iybr7jbzg) {
