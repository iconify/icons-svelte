...
const content = `<circle class="bxvk51bxs"/><path class="x0m3q7bnn"/><path class="x1ose62_x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-person-outline" {...props}></Icon>
<style>
:global(.bxvk51bxs) {
  cx: 12px;
  cy: 8px;
