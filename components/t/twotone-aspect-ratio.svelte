...
const content = `<path class="yt6d95b1h"/><path class="uhkw9ub4l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-aspect-ratio" {...props}></Icon>
<style>
:global(.uhkw9ub4l) {
  fill: currentColor;
