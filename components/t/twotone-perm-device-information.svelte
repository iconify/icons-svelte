...
const content = `<path class="xt493fbfh"/><path class="tsopokftc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-perm-device-information" {...props}></Icon>
<style>
:global(.tsopokftc) {
  fill: currentColor;
