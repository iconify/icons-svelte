...
const content = `<path class="pcascibmi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-column-one-narrow-24-filled" {...props}></Icon>
<style>
:global(.pcascibmi) {
  fill: currentColor;
