...
const content = `<path class="oqb-2rj1d"/><path class="u5mqrp2ht"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:textnow" {...props}></Icon>
<style>
:global(.oqb-2rj1d) {
  fill: none;
  stroke: currentColor;
