...
const content = `<path class="vcb7b5bey"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:textbox-align-top-center-24-filled" {...props}></Icon>
<style>
:global(.vcb7b5bey) {
  fill: currentColor;
