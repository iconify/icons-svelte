...
const content = `<path class="b3mrhzbrr"/><path class="wbwprrr2i"/><circle class="ma3uvpb1j"/><circle class="mael1on_b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:taskade" {...props}></Icon>
<style>
:global(.b3mrhzbrr) {
  fill: none;
  stroke: currentColor;
