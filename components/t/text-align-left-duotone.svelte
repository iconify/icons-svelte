...
const content = `<g class="cuyn6tgcc"><path class="gx19hbcgr"/><path class="rvs1v25bx"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:text-align-left-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
