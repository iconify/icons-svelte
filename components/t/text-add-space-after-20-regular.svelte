...
const content = `<path class="pwy1q8bob"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-add-space-after-20-regular" {...props}></Icon>
<style>
:global(.pwy1q8bob) {
  fill: currentColor;
