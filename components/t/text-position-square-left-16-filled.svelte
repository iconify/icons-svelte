...
const content = `<path class="lhar-tiyx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-position-square-left-16-filled" {...props}></Icon>
<style>
:global(.lhar-tiyx) {
  fill: currentColor;
