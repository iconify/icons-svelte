...
const content = `<path class="pa8b_dbve"/><circle class="pt5rcacfu"/><path class="k7wssybtm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:togozip" {...props}></Icon>
<style>
:global(.k7wssybtm) {
  fill: none;
  stroke: currentColor;
