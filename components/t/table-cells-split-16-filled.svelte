...
const content = `<path class="fqxa3jboj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-cells-split-16-filled" {...props}></Icon>
<style>
:global(.fqxa3jboj) {
  fill: currentColor;
