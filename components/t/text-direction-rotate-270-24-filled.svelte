...
const content = `<g class="ft5dv1b6b"><path class="f46-klg7a"/><path class="c0ikd4l8m"/><path class="oe0t26bsk"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-direction-rotate-270-24-filled" {...props}></Icon>
<style>
:global(.c0ikd4l8m) {
