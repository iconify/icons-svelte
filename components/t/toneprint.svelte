...
const content = `<path class="joiomubtv"/><circle class="xsqzccc6b"/><path class="je3hzdbmn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:toneprint" {...props}></Icon>
<style>
:global(.je3hzdbmn) {
  fill: none;
  stroke: currentColor;
