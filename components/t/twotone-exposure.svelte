...
const content = `<path class="wcdzo3bqj"/><path class="n0h5acsgt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-exposure" {...props}></Icon>
<style>
:global(.n0h5acsgt) {
  fill: currentColor;
