...
const content = `<path class="ng1l55bdm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:thumbs-up-double-sharp" {...props}></Icon>
<style>
:global(.ng1l55bdm) {
  fill: currentColor;
