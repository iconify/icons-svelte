...
const content = `<path class="chasltphm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-direction-rotate-45-right-20-filled" {...props}></Icon>
<style>
:global(.chasltphm) {
  fill: currentColor;
