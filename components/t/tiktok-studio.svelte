...
const content = `<path class="sk39hpfej"/><path class="xaknajbiv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:tiktok-studio" {...props}></Icon>
<style>
:global(.sk39hpfej) {
  fill: none;
  stroke: currentColor;
