...
const content = `<path class="esp1fw_xh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:tablet-android-outline" {...props}></Icon>
<style>
:global(.esp1fw_xh) {
  fill: currentColor;
