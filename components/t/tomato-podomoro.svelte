...
const content = `<path class="p6yqtkbpv"/><path class="oy3dzt2la"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:tomato-podomoro" {...props}></Icon>
<style>
:global(.oy3dzt2la) {
  fill: none;
  stroke: currentColor;
