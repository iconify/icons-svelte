...
const content = `<path class="dc7qbyyfr"/><path class="n04rw0art"/><path class="algj_t5zg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-video-camera-back" {...props}></Icon>
<style>
:global(.algj_t5zg) {
  fill: currentColor;
