...
const content = `<path class="a9opj7bek"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:text-quote-opening-16-regular" {...props}></Icon>
<style>
:global(.a9opj7bek) {
  fill: currentColor;
