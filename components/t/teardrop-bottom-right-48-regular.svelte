...
const content = `<path class="quqil3bdw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:teardrop-bottom-right-48-regular" {...props}></Icon>
<style>
:global(.quqil3bdw) {
  fill: currentColor;
