...
const content = `<path class="t5v_n6_hn"/><path class="q-udmo56r"/><path class="cz59495ro"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-dining" {...props}></Icon>
<style>
:global(.cz59495ro) {
  fill: currentColor;
