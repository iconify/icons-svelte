...
const content = `<g class="cuyn6tgcc"><path class="vhi7jelbu"/><path class="s6jpjt5ij"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:text-aa-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
