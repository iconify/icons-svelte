...
const content = `<path class="c_ov7_mor"/><path class="oqxs_owrp"/><path class="y5xj61uqq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-backup-table" {...props}></Icon>
<style>
:global(.c_ov7_mor) {
  fill: currentColor;
