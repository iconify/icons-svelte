...
const content = `<path class="j60g64bkg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:textbox-align-middle-rotate-90-20-filled" {...props}></Icon>
<style>
:global(.j60g64bkg) {
  fill: currentColor;
