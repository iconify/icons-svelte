...
const content = `<path class="ciancablb"/><path class="rpmsubbwt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-request-page" {...props}></Icon>
<style>
:global(.ciancablb) {
  fill: currentColor;
