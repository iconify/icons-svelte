...
const content = `<g class="cuyn6tgcc"><path class="skgvgti8z"/><path class="elyihdc9x"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:tag-simple-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
