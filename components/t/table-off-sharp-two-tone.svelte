...
const content = `<g class="gp_8x1bzb"><path class="f_xf7xbbf"/><path class="z8dkv3pos"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:table-off-sharp-two-tone" {...props}></Icon>
<style>
:global(.f_xf7xbbf) {
  fill: currentColor;
