...
const content = `<path class="mjdihcqsl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:table-simple-exclude-16-filled" {...props}></Icon>
<style>
:global(.mjdihcqsl) {
  fill: currentColor;
