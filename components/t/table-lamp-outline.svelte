...
const content = `<path class="gz7mk7rht"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:table-lamp-outline" {...props}></Icon>
<style>
:global(.gz7mk7rht) {
  fill: currentColor;
