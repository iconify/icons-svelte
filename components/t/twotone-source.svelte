...
const content = `<path class="cqlhzm2ve"/><path class="anjhu2okj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-source" {...props}></Icon>
<style>
:global(.anjhu2okj) {
  fill: currentColor;
