...
const content = `<path class="oel92qgar"/><path class="rglo-m2bg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-forest" {...props}></Icon>
<style>
:global(.oel92qgar) {
  fill: currentColor;
