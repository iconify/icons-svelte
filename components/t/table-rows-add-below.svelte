...
const content = `<path class="ah9mup3dd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:table-rows-add-below" {...props}></Icon>
<style>
:global(.ah9mup3dd) {
  fill: none;
  stroke: currentColor;
