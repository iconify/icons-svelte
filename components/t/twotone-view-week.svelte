...
const content = `<path class="otm-6-ouq"/><path class="yxpl29b3q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-view-week" {...props}></Icon>
<style>
:global(.otm-6-ouq) {
  fill: currentColor;
