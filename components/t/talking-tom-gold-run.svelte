...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:talking-tom-gold-run" {...props}></Icon>
<style>
:global(.b0oi0kbls) {
  d: path("M42.257 31.66a1.07 1.07 0 0 0-.486-.457c.198-.117.364-.278.488-.468m-9.555-10.423c-.145-1.282-1.226-2.796-.422-3.664c2.968-3.204 1.471-8.697-.072-10.178c-.518-.497-1.446-.374-2.496-.089l-3.576.97c-3.219.874-3.36-1.079-10.119-.506c-6.063.514-7.245 3.198-10.268 3.356M26.84 34.38c-4.999 2.685-9.86 2.695-13.626 1.59c-3.427-1.006-6.074-2.112-7.475-3.433");
}

:global(.bs5t2vbwm) {
  d: path("M31.973 16.694c-1.602-1.54-2.883-3.954-3.802-5.505c-.445-.751-.339-2.087.373-2.594c.822-.586 2.247-1.62 3.4-2.225m-26.2 29.31l6.059 2.197c-1.732 1.259-2.55 2.684-3.709 4.04m6.749-5.397c-.45 2.389 1.649 4.345 3.265 5.653m5.453-6.284c.319 1.002.627 2.144.542 3.056l-2.136-.25c-.826-.096-.848-.297-1.21-.447c-.485.385-1.194.498-2.068.555c-1.061.07-1.025.532-1.494.807c-.887-.891-1.071-1.832-1.153-2.78");
}

:global(.e67ietbjq) {
  d: path("M23.512 42.055c1.422-2.252 1.708-4.895 1.322-5.429c.01-.406-.201-.638-.367-.903m-9.723 2.679c-.752.998-1.42 2.398-1.897 3.852m5.487-19.867c-1.117.182-2.64.349-2.32 1.457c.168.584 2.008.84 3.218.582c1.09-.233 1.846-.793 2.165-1.65c.223-.6-1.36-.668-3.063-.39m.716 3.621c-3.85.622-6.438.48-7.164.367c-1.5-.233-1.92.664-1.26 1.809c1.596 2.768 4.279 5.4 9.585 4.678c4.152-.564 6.472-3.664 7.28-6.32c.53-1.746-.03-3.141-2.213-2.252c-.974.397-2.378 1.096-6.228 1.718");
}
...
:global(.mdi1fp2fu) {
  d: path("M8.512 22.85c-.313-1.179-.226-2.212.118-3.089c.06-.152.31-.641.41-.79c1.062-1.608 3.202-2.135 5.236-1.03m6.699 1.054c.166 1.312 1.276 2.788 1.874 2.523c2.12-.939 3.848-1.637 6.055-.897c.337.113.588 0 .619-.426c.234-3.275-2.407-6.42-4.84-6.39c-2.612.032-4.066 2.347-3.708 5.19");
}
...
:global(.mt-4qtb7l) {
  ...
  d: path("M25.48 16.121c-.148.043-.954.858-.954.858m-11.076.745c-.148.044-1.162.984-1.162.984");
}

:global(.o6_wnbjzc) {
  d: path("m42.256 22.176l-1.839-1.32l-7.642-.288c-1.632-.062-2.185 1.062-2.442 1.962l-4.005 14.01l.183 4.335l11.885.858l1.298-5.683m1.702-7.45l.86-3.764m-6.068 12.519l2.208 4.378");
}

:global(.o6302bbbl) {
  d: path("m40.417 20.856l-4.229 16.499l-9.62-.659");
}
