...
const content = `<g class="cuyn6tgcc"><path class="l9vj7fb-l"/><path class="iocscn9qe"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:text-outdent-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
