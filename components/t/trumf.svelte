...
const content = `<path class="y4osi0ynf"/><path class="d92wl78-v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:trumf" {...props}></Icon>
<style>
:global(.d92wl78-v) {
  fill: none;
  stroke: currentColor;
