...
const content = `<g class="cuyn6tgcc"><path class="g-ywktbyg"/><path class="cqzdq_bwy"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:television-simple-duotone" {...props}></Icon>
<style>
:global(.cqzdq_bwy) {
