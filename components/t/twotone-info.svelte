...
const content = `<path class="tt9018b-q"/><path class="v3gcz7byk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-info" {...props}></Icon>
<style>
:global(.tt9018b-q) {
  fill: currentColor;
