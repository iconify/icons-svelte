...
const content = `<path class="aawwy1ben"/><path class="cwsudwtri"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:twotone-web-stories" {...props}></Icon>
<style>
:global(.aawwy1ben) {
  fill: currentColor;
  d: path("M4 4h9v16H4z");
