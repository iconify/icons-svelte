...
const content = `<path class="oagjj4b-u"/><circle class="d3xi7hono"/><path class="owf1w_bwr"/><path class="f6_7b22_l"/><path class="wtoegrbgv"/><path class="orx8z1bik"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-proton-29" {...props}></Icon>
<style>
:global(.d3xi7hono) {
  cx: 25.869px;
  cy: 23.91px;
