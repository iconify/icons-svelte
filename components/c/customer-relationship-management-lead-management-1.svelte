...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline-ultimate:customer-relationship-management-lead-management-1" {...props}></Icon>
