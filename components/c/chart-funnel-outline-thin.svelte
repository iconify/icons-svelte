...
const content = `<g class="hntgybcog"><path class="mvnsiebhs"/><path class="i-508daov"/><path class="y31d99bmp"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:chart-funnel-outline-thin" {...props}></Icon>
<style>
:global(.hntgybcog) {
  fill: none;
  stroke: currentColor;
