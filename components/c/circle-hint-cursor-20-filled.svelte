...
const content = `<path class="c2kkfqb8d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:circle-hint-cursor-20-filled" {...props}></Icon>
<style>
:global(.c2kkfqb8d) {
  fill: currentColor;
