...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="openmoji:couple-with-heart-man-man-dark-skin-tone-medium-light-skin-tone" {...props}></Icon>
