...
const content = `<path class="ygt-sj6nc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:chat-display-outline" {...props}></Icon>
<style>
:global(.ygt-sj6nc) {
  fill: currentColor;
