...
const content = `<path class="v_9os6wva"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:credit-card-off-sharp" {...props}></Icon>
<style>
:global(.v_9os6wva) {
  fill: currentColor;
