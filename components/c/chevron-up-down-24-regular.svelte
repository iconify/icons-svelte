...
const content = `<path class="oxd_bnbqy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:chevron-up-down-24-regular" {...props}></Icon>
<style>
:global(.oxd_bnbqy) {
  fill: currentColor;
