...
const content = `<path class="b79e12b4e"/><path class="nqya38mpm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:camscanner" {...props}></Icon>
<style>
:global(.b79e12b4e) {
  fill: none;
  stroke: currentColor;
