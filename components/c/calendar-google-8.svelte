...
const content = `<path class="a-9gr4b8k"/><path class="uph4zqc9i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-google-8" {...props}></Icon>
<style>
:global(.a-9gr4b8k) {
  fill: none;
  stroke: currentColor;
