...
const content = `<path class="xm0c1ubgx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:calendar-work-week-28-regular" {...props}></Icon>
<style>
:global(.xm0c1ubgx) {
  fill: currentColor;
