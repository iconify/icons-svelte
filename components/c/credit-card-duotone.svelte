...
const content = `<g class="cuyn6tgcc"><path class="txk7dfbxr"/><path class="r5n8sobdl"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:credit-card-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
