...
const content = `<g class="ft5dv1b6b"><path class="cz_xd6byi"/><path class="xgjrm1brk"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:cho" {...props}></Icon>
<style>
:global(.cz_xd6byi) {
