...
const content = `<path class="hr579cbgy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:clear-formatting-16-filled" {...props}></Icon>
<style>
:global(.hr579cbgy) {
  fill: currentColor;
