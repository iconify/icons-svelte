...
const content = `<path class="wso-iqbhz"/><circle class="lt-9jcbov"/><circle class="p8915rvyx"/><path class="gt2r76bag"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:confirmtkt" {...props}></Icon>
<style>
:global(.gt2r76bag) {
  fill: none;
  stroke: currentColor;
