...
const content = `<path class="kt5bgh6hw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:cake-outline-sharp" {...props}></Icon>
<style>
:global(.kt5bgh6hw) {
  fill: currentColor;
