...
const content = `<g class="s0phu2bbs"><path class="k_7o4ab9h"/><path class="mdkrhrb3l"/><path class="kywk80fso"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:call-stack-outline-bold" {...props}></Icon>
<style>
:global(.k_7o4ab9h) {
