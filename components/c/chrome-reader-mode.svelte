...
const content = `<path class="wy2s2dr-f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:chrome-reader-mode" {...props}></Icon>
<style>
:global(.wy2s2dr-f) {
  fill: currentColor;
