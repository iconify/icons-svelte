...
const content = `<path class="curxw_44s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:conveyor-belt-outline-sharp" {...props}></Icon>
<style>
:global(.curxw_44s) {
  fill: currentColor;
