...
const content = `<path class="k0uev3chd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:calendar-view-month-sharp" {...props}></Icon>
<style>
:global(.k0uev3chd) {
  fill: currentColor;
