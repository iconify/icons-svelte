...
const content = `<path clip-rule="evenodd" class="h29zzibek"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:circle-arrow-up-left-sharp-fill" {...props}></Icon>
<style>
:global(.h29zzibek) {
  fill: currentColor;
  fill-rule: evenodd;
