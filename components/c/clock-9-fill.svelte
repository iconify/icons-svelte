...
const content = `<path clip-rule="evenodd" class="e-itrpxnv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:clock-9-fill" {...props}></Icon>
<style>
:global(.e-itrpxnv) {
  fill: currentColor;
  fill-rule: evenodd;
