...
const content = `<path class="wg01cpb5d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:call-to-action-rounded" {...props}></Icon>
<style>
:global(.wg01cpb5d) {
  fill: currentColor;
