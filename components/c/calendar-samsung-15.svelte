...
const content = `<path class="plk5clgsr"/><path class="kzykk8swa"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-samsung-15" {...props}></Icon>
<style>
:global(.kzykk8swa) {
  fill: none;
  stroke: currentColor;
