...
const content = `<circle class="jdg0jlbes"/><path class="zlr7jzbzx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:closca-water" {...props}></Icon>
<style>
:global(.jdg0jlbes) {
  cx: 24px;
  cy: 24px;
