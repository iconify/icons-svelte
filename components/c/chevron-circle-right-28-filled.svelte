...
const content = `<path class="vvyw_dluq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:chevron-circle-right-28-filled" {...props}></Icon>
<style>
:global(.vvyw_dluq) {
  fill: currentColor;
