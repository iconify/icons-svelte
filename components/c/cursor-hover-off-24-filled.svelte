...
const content = `<path class="t_s8nt5od"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:cursor-hover-off-24-filled" {...props}></Icon>
<style>
:global(.t_s8nt5od) {
  fill: currentColor;
