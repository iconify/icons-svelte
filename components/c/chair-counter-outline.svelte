...
const content = `<path class="p3mk4bhem"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:chair-counter-outline" {...props}></Icon>
<style>
:global(.p3mk4bhem) {
  fill: currentColor;
