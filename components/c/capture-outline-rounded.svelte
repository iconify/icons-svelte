...
const content = `<path class="l_pul4_7b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:capture-outline-rounded" {...props}></Icon>
<style>
:global(.l_pul4_7b) {
  fill: currentColor;
