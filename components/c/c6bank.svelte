...
const content = `<path class="c2xrbabwq"/><path class="qpysxwb4r"/><circle class="f1hqm04ka"/><path class="mbdj46rha"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:c6bank" {...props}></Icon>
<style>
:global(.c2xrbabwq) {
  fill: none;
  stroke: currentColor;
