...
const content = `<path class="l68dfto6w"/><path class="uph4zqc9i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-google-18" {...props}></Icon>
<style>
:global(.l68dfto6w) {
  fill: none;
  stroke: currentColor;
