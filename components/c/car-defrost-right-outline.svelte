...
const content = `<path class="dd0jl1o7h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:car-defrost-right-outline" {...props}></Icon>
<style>
:global(.dd0jl1o7h) {
  fill: currentColor;
