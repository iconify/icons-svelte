...
const content = `<path class="niypo6vhc"/><path class="ypdw5t99k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cube-escape" {...props}></Icon>
<style>
:global(.niypo6vhc) {
  fill: none;
  stroke: currentColor;
