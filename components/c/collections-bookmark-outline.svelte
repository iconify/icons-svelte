...
const content = `<path class="pxde7lbyh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:collections-bookmark-outline" {...props}></Icon>
<style>
:global(.pxde7lbyh) {
  fill: currentColor;
