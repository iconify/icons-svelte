...
const content = `<circle class="p-o8v9z-u"/><path class="a73vasbwb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:club-america" {...props}></Icon>
<style>
:global(.a73vasbwb) {
  fill: none;
  stroke: currentColor;
