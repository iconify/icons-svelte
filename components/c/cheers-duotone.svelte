...
const content = `<g class="cuyn6tgcc"><path class="mrh1pyfoy"/><path class="r9c2dobrp"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:cheers-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
