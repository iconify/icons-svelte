...
const content = `<path class="m8t1gzhon"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:conference-room-20-regular" {...props}></Icon>
<style>
:global(.m8t1gzhon) {
  fill: currentColor;
