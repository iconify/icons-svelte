...
const content = `<path class="n9a9_3mix"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:chevron-circle-down-48-filled" {...props}></Icon>
<style>
:global(.n9a9_3mix) {
  fill: currentColor;
