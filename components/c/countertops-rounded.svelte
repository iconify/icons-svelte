...
const content = `<path class="fvn3v575x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:countertops-rounded" {...props}></Icon>
<style>
:global(.fvn3v575x) {
  fill: currentColor;
