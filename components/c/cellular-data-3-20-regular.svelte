...
const content = `<path class="k7pox-bxs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:cellular-data-3-20-regular" {...props}></Icon>
<style>
:global(.k7pox-bxs) {
  fill: currentColor;
