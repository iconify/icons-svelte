...
const content = `<path class="s5hanmbcg"/><path class="c9ti-0ven"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:chatous" {...props}></Icon>
<style>
:global(.c9ti-0ven) {
  fill: none;
  stroke: currentColor;
