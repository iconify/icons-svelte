...
const content = `<path class="n4hfftuom"/><path class="w03dykbfs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cartoon-network" {...props}></Icon>
<style>
:global(.n4hfftuom) {
  fill: none;
  stroke: currentColor;
