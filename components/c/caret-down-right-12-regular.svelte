...
const content = `<path class="es3spcc6v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:caret-down-right-12-regular" {...props}></Icon>
<style>
:global(.es3spcc6v) {
  fill: currentColor;
