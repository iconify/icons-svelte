...
const content = `<path class="acxudccyi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:chevron-circle-down-20-regular" {...props}></Icon>
<style>
:global(.acxudccyi) {
  fill: currentColor;
