...
const content = `<path class="vmq_6b8gy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:car-defrost-low-right-outline-sharp" {...props}></Icon>
<style>
:global(.vmq_6b8gy) {
  fill: currentColor;
