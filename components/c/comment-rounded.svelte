...
const content = `<path class="n7h3w9j8b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:comment-rounded" {...props}></Icon>
<style>
:global(.n7h3w9j8b) {
  fill: currentColor;
