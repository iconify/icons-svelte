...
const content = `<path class="v35ne3b2j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:chess-knight-sharp" {...props}></Icon>
<style>
:global(.v35ne3b2j) {
  fill: currentColor;
