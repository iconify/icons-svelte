...
const content = `<path class="bsi6igw_i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:comments-disabled-sharp" {...props}></Icon>
<style>
:global(.bsi6igw_i) {
  fill: currentColor;
