...
const content = `<path class="ugg4ue1la"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:chevron-double-down-20-filled" {...props}></Icon>
<style>
:global(.ugg4ue1la) {
  fill: currentColor;
