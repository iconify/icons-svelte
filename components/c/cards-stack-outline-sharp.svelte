...
const content = `<path class="mvxocipwf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:cards-stack-outline-sharp" {...props}></Icon>
<style>
:global(.mvxocipwf) {
  fill: currentColor;
