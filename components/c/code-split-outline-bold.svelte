...
const content = `<g class="s0phu2bbs"><path class="wf6zu9b6f"/><path class="rj_yrybsf"/><path class="zghf_z23i"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:code-split-outline-bold" {...props}></Icon>
<style>
:global(.rj_yrybsf) {
