...
const content = `<path class="tg31urbgg"/><ellipse class="yc03psz8h"/><ellipse class="ki_opobqm"/><path class="ny_cz1bhw"/><path class="gc88f_biy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:crying-face" {...props}></Icon>
<style>
:global(.gc88f_biy) {
