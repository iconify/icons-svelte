...
const content = `<path class="n6_dmbdgl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:chevron-double-left-16-filled" {...props}></Icon>
<style>
:global(.n6_dmbdgl) {
  fill: currentColor;
