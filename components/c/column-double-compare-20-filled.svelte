...
const content = `<path class="c6jy1cc3o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:column-double-compare-20-filled" {...props}></Icon>
<style>
:global(.c6jy1cc3o) {
  fill: currentColor;
