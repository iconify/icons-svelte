...
const content = `<path class="v0llvsb4h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:calendar-checkmark-sparkle-28-filled" {...props}></Icon>
<style>
:global(.v0llvsb4h) {
  fill: currentColor;
