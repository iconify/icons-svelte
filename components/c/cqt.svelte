...
const content = `<g class="ft5dv1b6b"><path class="vsmmv9bxw"/><path class="fi-crqzat"/><path class="iy_mo-0ab"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:cqt" {...props}></Icon>
<style>
:global(.fi-crqzat) {
