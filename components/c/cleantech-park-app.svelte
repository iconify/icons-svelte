...
const content = `<rect class="j3s9ivbxi"/><path class="iok20bc7l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cleantech-park-app" {...props}></Icon>
<style>
:global(.iok20bc7l) {
  fill: none;
  stroke: currentColor;
