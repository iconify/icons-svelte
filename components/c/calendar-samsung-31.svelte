...
const content = `<path class="fd56s_bhv"/><path class="kzykk8swa"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-samsung-31" {...props}></Icon>
<style>
:global(.fd56s_bhv) {
  fill: none;
  stroke: currentColor;
