...
const content = `<path class="jbc81qqnm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:call-log-sharp" {...props}></Icon>
<style>
:global(.jbc81qqnm) {
  fill: currentColor;
