...
const content = `<path class="gn0_o_bad"/><path class="opagpfb4b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:chessbook" {...props}></Icon>
<style>
:global(.gn0_o_bad) {
  fill: none;
  stroke: currentColor;
