...
const content = `<path class="pp3u_dw1y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:car-defrost-low-right-outline-rounded" {...props}></Icon>
<style>
:global(.pp3u_dw1y) {
  fill: currentColor;
