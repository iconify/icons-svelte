...
const content = `<path class="txfg9kbbc"/><path class="noot_hb_q"/><circle class="a8xomf_of"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cifra-club" {...props}></Icon>
<style>
:global(.a8xomf_of) {
  cx: 18.584px;
  cy: 29.159px;
