...
const content = `<g class="cuyn6tgcc"><path class="w82lklnus"/><path class="s2fupcc_m"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:cloud-rain-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
