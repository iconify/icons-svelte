...
const content = `<path class="js1shp33h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:car-defrost-mid-left-outline" {...props}></Icon>
<style>
:global(.js1shp33h) {
  fill: currentColor;
