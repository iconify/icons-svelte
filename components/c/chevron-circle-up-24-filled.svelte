...
const content = `<path class="g8xg5kx6r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:chevron-circle-up-24-filled" {...props}></Icon>
<style>
:global(.g8xg5kx6r) {
  fill: currentColor;
