...
const content = `<path clip-rule="evenodd" class="g3b6p42rc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:circle-record-sharp-fill" {...props}></Icon>
<style>
:global(.g3b6p42rc) {
  fill: currentColor;
  fill-rule: evenodd;
