...
const content = `<g class="cuyn6tgcc"><path class="w2eoxkb9b"/><path class="sux8s4bsg"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:computer-tower-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
