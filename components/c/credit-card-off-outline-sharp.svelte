...
const content = `<path class="b25o5pbhy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:credit-card-off-outline-sharp" {...props}></Icon>
<style>
:global(.b25o5pbhy) {
  fill: currentColor;
