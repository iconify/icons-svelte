...
const content = `<g class="cuyn6tgcc"><path class="s3dv576sc"/><path class="xo5gd6bon"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:code-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
