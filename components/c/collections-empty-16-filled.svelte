...
const content = `<path class="uh3o6d06a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:collections-empty-16-filled" {...props}></Icon>
<style>
:global(.uh3o6d06a) {
  fill: currentColor;
