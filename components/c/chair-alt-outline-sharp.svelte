...
const content = `<path class="e5u5vi06c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:chair-alt-outline-sharp" {...props}></Icon>
<style>
:global(.e5u5vi06c) {
  fill: currentColor;
