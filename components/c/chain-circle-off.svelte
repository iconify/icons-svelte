...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="bfkdn5b6p"/><path clip-rule="evenodd" class="vvmz4aczs"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:chain-circle-off" {...props}></Icon>
<style>
:global(.bfkdn5b6p) {
  fill-rule: evenodd;
