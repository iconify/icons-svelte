...
const content = `<rect class="j3s9ivbxi"/><path class="h7c49zb-p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cnet" {...props}></Icon>
<style>
:global(.h7c49zb-p) {
  fill: none;
  stroke: currentColor;
