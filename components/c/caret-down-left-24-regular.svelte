...
const content = `<g class="ft5dv1b6b"><path class="l2nusvbpn"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:caret-down-left-24-regular" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
