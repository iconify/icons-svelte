...
const content = `<path class="dqq8d26-w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:car-crash-rounded" {...props}></Icon>
<style>
:global(.dqq8d26-w) {
  fill: currentColor;
