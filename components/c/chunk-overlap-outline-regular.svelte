...
const content = `<g class="nrj6p8qat"><path class="jw0risdcq"/><path class="j6xe62btt"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:chunk-overlap-outline-regular" {...props}></Icon>
<style>
:global(.j6xe62btt) {
