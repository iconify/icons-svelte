...
const content = `<path class="a3753fb2t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:camera-roll-sharp" {...props}></Icon>
<style>
:global(.a3753fb2t) {
  fill: currentColor;
