...
const content = `<path class="dk4np3w6b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:controller-gen-outline-sharp" {...props}></Icon>
<style>
:global(.dk4np3w6b) {
  fill: currentColor;
