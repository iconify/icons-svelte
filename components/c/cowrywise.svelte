...
const content = `<path class="zz52fwbrr"/><circle class="oqn3le1se"/><path class="y1ebrztoe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cowrywise" {...props}></Icon>
<style>
:global(.oqn3le1se) {
  cx: 24px;
  cy: 24px;
