...
const content = `<path class="wt5zytcfs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:calendar-multiple-32-regular" {...props}></Icon>
<style>
:global(.wt5zytcfs) {
  fill: currentColor;
