...
const content = `<path class="mtlsdybvx"/><path class="bag4m3bbr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-tuta-27" {...props}></Icon>
<style>
:global(.bag4m3bbr) {
  fill: none;
  stroke: currentColor;
