...
const content = `<path class="lqafnjb9j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:counter-7-rounded" {...props}></Icon>
<style>
:global(.lqafnjb9j) {
  fill: currentColor;
