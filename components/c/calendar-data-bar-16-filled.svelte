...
const content = `<path class="qqg4p5x8j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:calendar-data-bar-16-filled" {...props}></Icon>
<style>
:global(.qqg4p5x8j) {
  fill: currentColor;
