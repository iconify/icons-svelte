...
const content = `<path class="i4bh10b1o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:clipboard-brush-24-regular" {...props}></Icon>
<style>
:global(.i4bh10b1o) {
  fill: currentColor;
