...
const content = `<path class="lmgc3mwek"/><path class="qlj57ib7s"/><path class="n9xa13bam"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cplusplus" {...props}></Icon>
<style>
:global(.lmgc3mwek) {
  fill: none;
  stroke: currentColor;
