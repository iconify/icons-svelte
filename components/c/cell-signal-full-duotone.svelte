...
const content = `<g class="cuyn6tgcc"><path class="qnpr_mqnd"/><path class="oqj5vw0ip"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:cell-signal-full-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
