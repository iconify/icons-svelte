...
const content = `<path class="r7a2sbl1z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:check-box-outline-rounded" {...props}></Icon>
<style>
:global(.r7a2sbl1z) {
  fill: currentColor;
