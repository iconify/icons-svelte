...
const content = `<g class="cuyn6tgcc"><path class="k8fiy6bnz"/><path class="p0khxqb6k"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:checkmark-off" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
