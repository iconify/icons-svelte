...
const content = `<path class="z8mb4fb7j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:chevron-circle-up-24-regular" {...props}></Icon>
<style>
:global(.z8mb4fb7j) {
  fill: currentColor;
