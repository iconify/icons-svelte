...
const content = `<path class="px5nr8biq"/><path class="to1br1oyj"/><path class="ud3po1bpk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cz-smart-youq" {...props}></Icon>
<style>
:global(.px5nr8biq) {
  fill: none;
  stroke: currentColor;
