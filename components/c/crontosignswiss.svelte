...
const content = `<rect class="j3s9ivbxi"/><path class="enff-muad"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:crontosignswiss" {...props}></Icon>
<style>
:global(.enff-muad) {
  fill: none;
  stroke: currentColor;
