...
const content = `<circle class="x46hm6qgx"/><path class="vjr1nfd0t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:comparify" {...props}></Icon>
<style>
:global(.vjr1nfd0t) {
  fill: none;
  stroke: currentColor;
