...
const content = `<path class="h8jwz9bct"/><path class="efrpdw-8e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:caffeine" {...props}></Icon>
<style>
:global(.efrpdw-8e) {
  fill: none;
  stroke: currentColor;
