...
const content = `<path class="ykh736f8w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:checkmark-starburst-28-regular" {...props}></Icon>
<style>
:global(.ykh736f8w) {
  fill: currentColor;
