...
const content = `<path class="d1kyr4b8c"/><path class="v1ac39bgt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:capcut" {...props}></Icon>
<style>
:global(.d1kyr4b8c) {
  fill: none;
  stroke: currentColor;
