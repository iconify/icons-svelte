...
const content = `<path class="nugmjccfm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:cards-star-sharp" {...props}></Icon>
<style>
:global(.nugmjccfm) {
  fill: currentColor;
