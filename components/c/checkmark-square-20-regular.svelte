...
const content = `<path class="np45m775e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:checkmark-square-20-regular" {...props}></Icon>
<style>
:global(.np45m775e) {
  fill: currentColor;
