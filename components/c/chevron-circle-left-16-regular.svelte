...
const content = `<path class="za_yzf_ka"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:chevron-circle-left-16-regular" {...props}></Icon>
<style>
:global(.za_yzf_ka) {
  fill: currentColor;
