...
const content = `<g class="nrj6p8qat"><path class="tx_ah59as"/><path class="ssv0ocbou"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:circle-arrow-up" {...props}></Icon>
<style>
:global(.nrj6p8qat) {
  fill: none;
  stroke: currentColor;
