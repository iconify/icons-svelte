...
const content = `<g class="cuyn6tgcc"><path class="azo1_fb6a"/><path class="ja9inubrw"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:cell-signal-medium-duotone" {...props}></Icon>
<style>
:global(.azo1_fb6a) {
