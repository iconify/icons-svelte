...
const content = `<path class="y32h17ewg"/><path class="nqjli_o-y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cuberite" {...props}></Icon>
<style>
:global(.nqjli_o-y) {
  fill: none;
  stroke: currentColor;
