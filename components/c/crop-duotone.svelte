...
const content = `<g class="cuyn6tgcc"><path class="kzooy8bcn"/><path class="e3oqakbxm"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:crop-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
