...
const content = `<path class="ntbmhzmyu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:copy-all-outline-sharp" {...props}></Icon>
<style>
:global(.ntbmhzmyu) {
  fill: currentColor;
