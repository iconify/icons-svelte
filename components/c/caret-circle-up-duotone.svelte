...
const content = `<g class="cuyn6tgcc"><path class="goeug6bgp"/><path class="am-er3bwp"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:caret-circle-up-duotone" {...props}></Icon>
<style>
:global(.am-er3bwp) {
