...
const content = `<path class="h0fmojvaq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:create-new-folder" {...props}></Icon>
<style>
:global(.h0fmojvaq) {
  fill: currentColor;
