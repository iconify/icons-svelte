...
const content = `<g class="cuyn6tgcc"><path class="kg11x1baa"/><path class="fs1zubkjx"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:city-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
