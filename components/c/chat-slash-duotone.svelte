...
const content = `<g class="cuyn6tgcc"><path class="eehe-vbdj"/><path class="dv33tobbq"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:chat-slash-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
