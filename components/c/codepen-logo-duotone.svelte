...
const content = `<g class="cuyn6tgcc"><path class="s3o49dbyz"/><path class="iv4mqhbzv"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:codepen-logo-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
