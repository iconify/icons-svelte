...
const content = `<path class="ei55_30-a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:circle-hint-cursor-16-filled" {...props}></Icon>
<style>
:global(.ei55_30-a) {
  fill: currentColor;
