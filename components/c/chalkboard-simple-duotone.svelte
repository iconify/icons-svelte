...
const content = `<g class="cuyn6tgcc"><path class="ichedkb1s"/><path class="bfpmfx_0h"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:chalkboard-simple-duotone" {...props}></Icon>
<style>
:global(.bfpmfx_0h) {
