...
const content = `<g class="cuyn6tgcc"><path class="ner24ccnr"/><path class="zc-tu8brc"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:circle-three-quarter-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
