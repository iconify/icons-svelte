...
const content = `<path class="tjo9chbud"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:contact-page-outline-sharp" {...props}></Icon>
<style>
:global(.tjo9chbud) {
  fill: currentColor;
