...
const content = `<path class="qr9jmhbjt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:carry-on-bag-sharp" {...props}></Icon>
<style>
:global(.qr9jmhbjt) {
  fill: currentColor;
