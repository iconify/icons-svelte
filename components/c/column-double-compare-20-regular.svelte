...
const content = `<path class="f7i1m_bye"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:column-double-compare-20-regular" {...props}></Icon>
<style>
:global(.f7i1m_bye) {
  fill: currentColor;
