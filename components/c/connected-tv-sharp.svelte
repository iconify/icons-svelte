...
const content = `<path class="hniii2byp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:connected-tv-sharp" {...props}></Icon>
<style>
:global(.hniii2byp) {
  fill: currentColor;
