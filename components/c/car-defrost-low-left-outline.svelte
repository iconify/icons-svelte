...
const content = `<path class="ouneogkhu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:car-defrost-low-left-outline" {...props}></Icon>
<style>
:global(.ouneogkhu) {
  fill: currentColor;
