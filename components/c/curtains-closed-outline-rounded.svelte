...
const content = `<path class="vrg0d27nz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:curtains-closed-outline-rounded" {...props}></Icon>
<style>
:global(.vrg0d27nz) {
  fill: currentColor;
