...
const content = `<path class="gzcz85ryy"/><path class="kzykk8swa"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-samsung-10" {...props}></Icon>
<style>
:global(.gzcz85ryy) {
  fill: none;
  stroke: currentColor;
