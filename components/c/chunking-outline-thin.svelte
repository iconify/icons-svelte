...
const content = `<g class="hntgybcog"><path class="z81xltbwu"/><path class="kmd_30j9x"/><path class="u0acwebrq"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:chunking-outline-thin" {...props}></Icon>
<style>
:global(.hntgybcog) {
  fill: none;
  stroke: currentColor;
