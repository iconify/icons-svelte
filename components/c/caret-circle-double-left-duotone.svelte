...
const content = `<g class="cuyn6tgcc"><path class="c9epvhehk"/><path class="objntsb1d"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:caret-circle-double-left-duotone" {...props}></Icon>
<style>
:global(.c9epvhehk) {
