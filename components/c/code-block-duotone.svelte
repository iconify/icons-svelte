...
const content = `<g class="cuyn6tgcc"><path class="q6wgcrb0r"/><path class="c58mofbrx"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:code-block-duotone" {...props}></Icon>
<style>
:global(.c58mofbrx) {
