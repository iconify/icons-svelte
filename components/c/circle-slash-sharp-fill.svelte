...
const content = `<path class="q8zsfrlau"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:circle-slash-sharp-fill" {...props}></Icon>
<style>
:global(.q8zsfrlau) {
  fill: currentColor;
