...
const content = `<path class="h0uzszbqu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:chat-display-outline-sharp" {...props}></Icon>
<style>
:global(.h0uzszbqu) {
  fill: currentColor;
