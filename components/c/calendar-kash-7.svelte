...
const content = `<path class="drnmmwb2v"/><g class="to-5kdesz"><path class="wfpy3gbmy"/><path class="lw4f_pt4y"/><path class="is-ytvijl"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-kash-7" {...props}></Icon>
<style>
:global(.drnmmwb2v) {
  fill: none;
  stroke: currentColor;
