...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="openmoji:couple-with-heart-man-man-medium-dark-skin-tone-dark-skin-tone" {...props}></Icon>
