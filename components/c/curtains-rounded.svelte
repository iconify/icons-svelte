...
const content = `<path class="jmmv9lh6p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:curtains-rounded" {...props}></Icon>
<style>
:global(.jmmv9lh6p) {
  fill: currentColor;
