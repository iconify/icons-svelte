...
const content = `<path class="lcl8jcc6l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:calendar-data-bar-20-regular" {...props}></Icon>
<style>
:global(.lcl8jcc6l) {
  fill: currentColor;
