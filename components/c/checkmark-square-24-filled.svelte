...
const content = `<path class="y59j2bbay"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:checkmark-square-24-filled" {...props}></Icon>
<style>
:global(.y59j2bbay) {
  fill: currentColor;
