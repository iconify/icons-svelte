...
const content = `<path class="o3tmhjbzt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:closed-caption-sharp" {...props}></Icon>
<style>
:global(.o3tmhjbzt) {
  fill: currentColor;
