...
const content = `<g class="y9tr6bcfx"><circle class="x5hwmfx5f"/><path class="m4wtvmses"/></g><path class="kzykk8swa"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-samsung-6" {...props}></Icon>
<style>
:global(.kzykk8swa) {
  fill: none;
  stroke: currentColor;
