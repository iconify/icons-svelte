...
const content = `<g class="cuyn6tgcc"><path class="f979qth3u"/><path class="i9z26v4id"/><path class="d50iifbha"/><path class="nyant1n6t"/><path class="jmsqj3nfg"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:contract" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
