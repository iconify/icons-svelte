...
const content = `<path class="dea_308ib"/><path class="ysmy1pbbg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:coppel" {...props}></Icon>
<style>
:global(.dea_308ib) {
  fill: none;
  stroke: currentColor;
