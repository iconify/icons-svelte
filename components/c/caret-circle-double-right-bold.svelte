...
const content = `<path class="cl2d54bvf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:caret-circle-double-right-bold" {...props}></Icon>
<style>
:global(.cl2d54bvf) {
  fill: currentColor;
