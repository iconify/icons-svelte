...
const content = `<path class="z307q5d3s"/><path class="kzykk8swa"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-samsung-2" {...props}></Icon>
<style>
:global(.kzykk8swa) {
  fill: none;
  stroke: currentColor;
