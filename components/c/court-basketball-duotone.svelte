...
const content = `<g class="cuyn6tgcc"><path class="oef7tzbvy"/><path class="khmmaj2bz"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:court-basketball-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
