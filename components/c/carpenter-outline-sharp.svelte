...
const content = `<path class="zx2gamkmb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:carpenter-outline-sharp" {...props}></Icon>
<style>
:global(.zx2gamkmb) {
  fill: currentColor;
