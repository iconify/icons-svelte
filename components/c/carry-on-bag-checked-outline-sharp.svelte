...
const content = `<path class="g-kbmubef"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:carry-on-bag-checked-outline-sharp" {...props}></Icon>
<style>
:global(.g-kbmubef) {
  fill: currentColor;
