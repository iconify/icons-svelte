...
const content = `<path class="p6nj0gbhk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:colorize-sharp" {...props}></Icon>
<style>
:global(.p6nj0gbhk) {
  fill: currentColor;
