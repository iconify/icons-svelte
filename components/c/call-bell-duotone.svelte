...
const content = `<g class="cuyn6tgcc"><path class="fux4j1bdo"/><path class="c8hbx8ktz"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:call-bell-duotone" {...props}></Icon>
<style>
:global(.c8hbx8ktz) {
