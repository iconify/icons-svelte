...
const content = `<path class="q0h2be1dg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:contract-up-right-16-regular" {...props}></Icon>
<style>
:global(.q0h2be1dg) {
  fill: currentColor;
