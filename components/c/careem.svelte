...
const content = `<path class="w_sr_5beu"/><path class="moqc0136m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:careem" {...props}></Icon>
<style>
:global(.moqc0136m) {
  fill: none;
  stroke: currentColor;
