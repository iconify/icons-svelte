...
const content = `<g class="cuyn6tgcc"><path class="fw_-f4u_a"/><path class="pi1a0qw0k"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:clock-counter-clockwise-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
