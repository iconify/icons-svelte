...
const content = `<circle class="ugn0xccey"/><path class="a64-9bb6c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:cirrus-ci" {...props}></Icon>
<style>
:global(.a64-9bb6c) {
