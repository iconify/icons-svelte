...
const content = `<path class="vh9y_o5gw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:comic-bubble-sharp" {...props}></Icon>
<style>
:global(.vh9y_o5gw) {
  fill: currentColor;
