...
const content = `<path class="a078x0b7t"/><path class="gatc2ib0i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cell" {...props}></Icon>
<style>
:global(.a078x0b7t) {
  fill: none;
  stroke: currentColor;
