...
const content = `<path class="s3xw3800t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:checked-bag-sharp" {...props}></Icon>
<style>
:global(.s3xw3800t) {
  fill: currentColor;
