...
const content = `<path class="jsx79jlqy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:calendar-work-week-16-filled" {...props}></Icon>
<style>
:global(.jsx79jlqy) {
  fill: currentColor;
