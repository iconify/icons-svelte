...
const content = `<path class="qy6tbdcoz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:calendar-multiple-28-filled" {...props}></Icon>
<style>
:global(.qy6tbdcoz) {
  fill: currentColor;
