...
const content = `<path class="wzep2mb4x"/><path class="fpobxw57u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cluster" {...props}></Icon>
<style>
:global(.fpobxw57u) {
  fill: none;
  stroke: currentColor;
