...
const content = `<path class="nx6m9xzzt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:comment-arrow-right-12-regular" {...props}></Icon>
<style>
:global(.nx6m9xzzt) {
  fill: currentColor;
