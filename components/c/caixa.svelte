...
const content = `<path class="fg5m_sbwl"/><path class="luym16ghs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:caixa" {...props}></Icon>
<style>
:global(.fg5m_sbwl) {
  fill: none;
  stroke: currentColor;
