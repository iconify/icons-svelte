...
const content = `<g class="ft5dv1b6b"><path clip-rule="evenodd" class="spzqy-zum"/><path class="ci5--jakz"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:cnd" {...props}></Icon>
<style>
:global(.ci5--jakz) {
