...
const content = `<path class="rysd-czrp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:color-fill-accent-24-regular" {...props}></Icon>
<style>
:global(.rysd-czrp) {
  fill: currentColor;
