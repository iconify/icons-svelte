...
const content = `<path class="p-wpmgbmr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:camera-indoor-outline" {...props}></Icon>
<style>
:global(.p-wpmgbmr) {
  fill: currentColor;
