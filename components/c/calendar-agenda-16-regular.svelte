...
const content = `<path class="wvjas_bht"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:calendar-agenda-16-regular" {...props}></Icon>
<style>
:global(.wvjas_bht) {
  fill: currentColor;
