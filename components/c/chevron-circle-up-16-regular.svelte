...
const content = `<path class="q3qmhmbuz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:chevron-circle-up-16-regular" {...props}></Icon>
<style>
:global(.q3qmhmbuz) {
  fill: currentColor;
