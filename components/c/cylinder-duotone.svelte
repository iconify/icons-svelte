...
const content = `<g class="cuyn6tgcc"><path class="q5_g9rhpq"/><path class="lp1p32dvr"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:cylinder-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
