...
const content = `<path class="c5_khnbvh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:call-quality-sharp" {...props}></Icon>
<style>
:global(.c5_khnbvh) {
  fill: currentColor;
