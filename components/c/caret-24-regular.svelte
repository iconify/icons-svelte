...
const content = `<g class="ft5dv1b6b"><path class="h6lt34bnk"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:caret-24-regular" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
