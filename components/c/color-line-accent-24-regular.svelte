...
const content = `<path class="n9j63_brm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:color-line-accent-24-regular" {...props}></Icon>
<style>
:global(.n9j63_brm) {
  fill: currentColor;
