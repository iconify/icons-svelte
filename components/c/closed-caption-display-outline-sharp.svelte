...
const content = `<path class="nsybbqpzd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:closed-caption-display-outline-sharp" {...props}></Icon>
<style>
:global(.nsybbqpzd) {
  fill: currentColor;
