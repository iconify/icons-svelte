...
const content = `<g class="s0phu2bbs"><path class="iwoy52b7h"/><path class="um6qav7po"/><path class="xbz5-ab-d"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:catalog-outline-bold" {...props}></Icon>
<style>
:global(.iwoy52b7h) {
