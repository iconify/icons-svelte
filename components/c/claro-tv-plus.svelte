...
const content = `<path class="uo47pyvli"/><path class="kfa82dbcu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:claro-tv-plus" {...props}></Icon>
<style>
:global(.kfa82dbcu) {
  fill: none;
  stroke: currentColor;
