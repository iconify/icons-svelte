...
const content = `<g class="cuyn6tgcc"><path class="j8d929y8z"/><path class="ocxgd0zse"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:cooking-pot-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
