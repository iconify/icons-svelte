...
const content = `<path class="ktk6gccah"/><circle class="aa1fubkfk"/><path class="enprvj7ia"/><path class="a20wjfbqt"/><path class="em9p6bbsk"/><circle class="k4z7zsbhp"/><path class="x9-08hboo"/><ellipse class="th36ljp4u"/><ellipse class="c0r1mprhk"/><circle class="l88jk5e_i"/><ellipse class="z5-m0w6oe"/><ellipse class="c4wggnvns"/><path class="c73598djz"/><circle class="eyeshdcsx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="openmoji:clown-face" {...props}></Icon>
