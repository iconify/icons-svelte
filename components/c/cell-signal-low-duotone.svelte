...
const content = `<g class="cuyn6tgcc"><path class="mjggzcciw"/><path class="hghlb21nm"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:cell-signal-low-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
