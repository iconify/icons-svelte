...
const content = `<path class="zli615bex"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:car-mirror-heat-outline" {...props}></Icon>
<style>
:global(.zli615bex) {
  fill: currentColor;
