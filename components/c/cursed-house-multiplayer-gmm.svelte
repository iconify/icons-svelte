...
const content = `<rect class="j3s9ivbxi"/><path class="cg45gs_bk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cursed-house-multiplayer-gmm" {...props}></Icon>
<style>
:global(.cg45gs_bk) {
  fill: none;
  stroke: currentColor;
