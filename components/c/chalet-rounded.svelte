...
const content = `<path class="yjh04tbjp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:chalet-rounded" {...props}></Icon>
<style>
:global(.yjh04tbjp) {
  fill: currentColor;
