...
const content = `<path class="w-yla-b9z"/><path class="wtoegrbgv"/><path class="orx8z1bik"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-proton-11" {...props}></Icon>
<style>
:global(.orx8z1bik) {
  fill: none;
  stroke: currentColor;
