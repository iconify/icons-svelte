...
const content = `<path class="wl_lfobic"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:co-present-sharp" {...props}></Icon>
<style>
:global(.wl_lfobic) {
  fill: currentColor;
