...
const content = `<g class="cuyn6tgcc"><path class="d-lzeh97n"/><path class="c424ysbwk"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:circuitry-duotone" {...props}></Icon>
<style>
:global(.c424ysbwk) {
