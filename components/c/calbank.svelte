...
const content = `<path class="w--xm_23t"/><path class="kyibch0sy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calbank" {...props}></Icon>
<style>
:global(.kyibch0sy) {
  fill: none;
  stroke: currentColor;
