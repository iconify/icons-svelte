...
const content = `<path class="c318t1bpg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:create-new-folder-outline" {...props}></Icon>
<style>
:global(.c318t1bpg) {
  fill: currentColor;
