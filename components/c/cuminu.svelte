...
const content = `<g class="ft5dv1b6b"><path class="dkc-a_bls"/><path class="owm-dkonu"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:cuminu" {...props}></Icon>
<style>
:global(.dkc-a_bls) {
