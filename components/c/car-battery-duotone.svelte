...
const content = `<g class="cuyn6tgcc"><path class="f__qf_bkp"/><path class="gvm3i4_6j"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:car-battery-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
