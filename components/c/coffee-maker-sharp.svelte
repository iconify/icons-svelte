...
const content = `<path class="itc3kac9j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:coffee-maker-sharp" {...props}></Icon>
<style>
:global(.itc3kac9j) {
  fill: currentColor;
