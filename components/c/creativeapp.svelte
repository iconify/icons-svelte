...
const content = `<path class="xbs20zasg"/><path class="l1td_-n9x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:creativeapp" {...props}></Icon>
<style>
:global(.l1td_-n9x) {
  fill: none;
  stroke: currentColor;
