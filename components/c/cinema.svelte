...
const content = `<circle class="bgatx5byk"/><path class="tpay_zhmp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione:cinema" {...props}></Icon>
<style>
:global(.bgatx5byk) {
  cx: 32px;
  cy: 32px;
