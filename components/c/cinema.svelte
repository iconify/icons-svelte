...
const content = `<path class="xm9uzjeuh"/><path class="osihubb-o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cinema" {...props}></Icon>
<style>
:global(.osihubb-o) {
  fill: none;
  stroke: currentColor;
