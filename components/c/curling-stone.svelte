...
const content = `<path class="ov8egm-xs"/><path class="ml7g-npdq"/><path class="l34burw7n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:curling-stone" {...props}></Icon>
<style>
:global(.l34burw7n) {
