...
const content = `<path class="r8mc1nboz"/><g class="to-5kdesz"><path class="wfpy3gbmy"/><path class="lw4f_pt4y"/><path class="is-ytvijl"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-kash-1" {...props}></Icon>
<style>
:global(.is-ytvijl) {
