...
const content = `<path class="hamrq5b7i"/><path class="e5o1ud2fq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:crrowd" {...props}></Icon>
<style>
:global(.e5o1ud2fq) {
  fill: none;
  stroke: currentColor;
