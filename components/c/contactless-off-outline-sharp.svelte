...
const content = `<path class="lq_wzab2k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:contactless-off-outline-sharp" {...props}></Icon>
<style>
:global(.lq_wzab2k) {
  fill: currentColor;
