...
const content = `<path class="g8d31d3mk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:comment-multiple-20-regular" {...props}></Icon>
<style>
:global(.g8d31d3mk) {
  fill: currentColor;
