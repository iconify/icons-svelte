...
const content = `<g class="cuyn6tgcc"><path class="bcs589bmv"/><path class="cmzh35bwp"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:chart-bar-horizontal-duotone" {...props}></Icon>
<style>
:global(.bcs589bmv) {
