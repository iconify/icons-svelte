...
const content = `<path class="r5k5zbchv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:content-view-gallery-20-filled" {...props}></Icon>
<style>
:global(.r5k5zbchv) {
  fill: currentColor;
