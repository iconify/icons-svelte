...
const content = `<g class="s0phu2bbs"><path class="z81xltbwu"/><path class="kmd_30j9x"/><path class="u0acwebrq"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:chunking-outline-bold" {...props}></Icon>
<style>
:global(.kmd_30j9x) {
