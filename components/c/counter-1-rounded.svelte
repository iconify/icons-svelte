...
const content = `<path class="gu7rfybun"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:counter-1-rounded" {...props}></Icon>
<style>
:global(.gu7rfybun) {
  fill: currentColor;
