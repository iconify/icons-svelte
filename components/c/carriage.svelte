...
const content = `<path class="f_gzbdbiw"/><path class="djwvpxblr"/><path class="vlt4cfb3z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:carriage" {...props}></Icon>
<style>
:global(.djwvpxblr) {
  fill: none;
  stroke: currentColor;
