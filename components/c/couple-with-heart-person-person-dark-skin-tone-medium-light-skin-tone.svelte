...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="openmoji:couple-with-heart-person-person-dark-skin-tone-medium-light-skin-tone" {...props}></Icon>
