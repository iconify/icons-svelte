...
const content = `<path class="f3nhs11_x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:confirmation-number-sharp" {...props}></Icon>
<style>
:global(.f3nhs11_x) {
  fill: currentColor;
