...
const content = `<path class="p4gyktypv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:cellular-data-2-24-regular" {...props}></Icon>
<style>
:global(.p4gyktypv) {
  fill: currentColor;
