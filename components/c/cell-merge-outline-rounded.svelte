...
const content = `<path class="hn14-abjq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:cell-merge-outline-rounded" {...props}></Icon>
<style>
:global(.hn14-abjq) {
  fill: currentColor;
