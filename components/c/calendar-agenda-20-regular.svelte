...
const content = `<path class="ce9gb4aev"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:calendar-agenda-20-regular" {...props}></Icon>
<style>
:global(.ce9gb4aev) {
  fill: currentColor;
