...
const content = `<ellipse class="btrycxbbl"/><path class="k105bobch"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-v1:confounded-face" {...props}></Icon>
<style>
:global(.btrycxbbl) {
  cx: 32.05px;
  cy: 32px;
