...
const content = `<path class="yf5n_wa-z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:calendar-template-32-filled" {...props}></Icon>
<style>
:global(.yf5n_wa-z) {
  fill: currentColor;
