...
const content = `<g class="cuyn6tgcc"><path class="x13iog92h"/><path class="tu0cx0btk"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:circles-three-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
