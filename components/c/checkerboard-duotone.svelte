...
const content = `<g class="cuyn6tgcc"><path class="q2c83-bsa"/><path class="qt-qwoqaj"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:checkerboard-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
