...
const content = `<path class="hzp3k-4mt"/><path class="d1leh5biw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:canta" {...props}></Icon>
<style>
:global(.d1leh5biw) {
  fill: none;
  stroke: currentColor;
