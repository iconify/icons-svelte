...
const content = `<path class="eo1diqb7k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:cast-warning-rounded" {...props}></Icon>
<style>
:global(.eo1diqb7k) {
  fill: currentColor;
