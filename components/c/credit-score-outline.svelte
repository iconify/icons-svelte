...
const content = `<path class="gkgimf6ed"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:credit-score-outline" {...props}></Icon>
<style>
:global(.gkgimf6ed) {
  fill: currentColor;
