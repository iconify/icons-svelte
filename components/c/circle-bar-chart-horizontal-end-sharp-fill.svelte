...
const content = `<path clip-rule="evenodd" class="rx2t-v_0o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:circle-bar-chart-horizontal-end-sharp-fill" {...props}></Icon>
<style>
:global(.rx2t-v_0o) {
  fill: currentColor;
  fill-rule: evenodd;
