...
const content = `<path class="quy6y6bas"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:calendar-multiple-32-filled" {...props}></Icon>
<style>
:global(.quy6y6bas) {
  fill: currentColor;
