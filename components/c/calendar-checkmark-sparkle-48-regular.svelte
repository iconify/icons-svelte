...
const content = `<path class="ti1otyu1w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:calendar-checkmark-sparkle-48-regular" {...props}></Icon>
<style>
:global(.ti1otyu1w) {
  fill: currentColor;
