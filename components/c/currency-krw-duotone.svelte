...
const content = `<g class="cuyn6tgcc"><path class="il-azebki"/><path class="z-p2nqf_g"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:currency-krw-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
