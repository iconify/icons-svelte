...
const content = `<path class="d5juaqbox"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:circle-multiple-hint-checkmark-24-regular" {...props}></Icon>
<style>
:global(.d5juaqbox) {
  fill: currentColor;
