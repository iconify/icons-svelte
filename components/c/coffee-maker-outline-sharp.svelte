...
const content = `<path class="m6akav83o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:coffee-maker-outline-sharp" {...props}></Icon>
<style>
:global(.m6akav83o) {
  fill: currentColor;
