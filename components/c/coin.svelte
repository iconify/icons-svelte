...
const content = `<circle class="cpg91nbpu"/><path class="kw2k3r6mi"/><circle class="ao5mk6bfn"/><circle class="v0vrs3bht"/><path class="vuhfccb3a"/><path class="uciju7b_p"/><path class="w88m5mmck"/><path class="h_jhecbux"/><path class="uota-xl3w"/><path class="bs558gbvp"/><path class="d5i5a_55j"/><path class="a_3afacoh"/><path class="ddw-hibta"/><path class="kf1o_mbes"/><path class="k-nzyktbp"/><path class="anp5etaav"/><path class="jggqe6bek"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto:coin" {...props}></Icon>
<style>
:global(.a_3afacoh) {
  fill: var(--svg-color--fff176, #fff176);
  d: path("m64.05 11.31l1.28 3.93h4.13l-3.34 2.43l1.28 3.93l-3.35-2.43l-3.34 2.43l1.28-3.93l-3.35-2.43h4.14zM38.6 92.21l-1.27 3.93h-4.14l3.35 2.43l-1.28 3.93l3.34-2.43l3.35 2.43l-1.28-3.93l3.34-2.43h-4.13zM21.54 70.14l-1.27 3.93h-4.14l3.35 2.43l-1.28 3.93L21.54 78l3.35 2.43l-1.28-3.93l3.34-2.43h-4.13zm.47-27.81l-1.27 3.93H16.6l3.35 2.43l-1.28 3.93l3.34-2.43l3.35 2.43l-1.28-3.93l3.34-2.43h-4.13zm15.98-22.57l-1.28 3.93h-4.13l3.34 2.43l-1.28 3.93l3.35-2.43l3.34 2.43l-1.28-3.93l3.35-2.43h-4.14z");
}

:global(.anp5etaav) {
  fill: var(--svg-color--f2bc1a, #f2bc1a);
  d: path("M87.84 44.33L64 30.8L40.16 44.33z");
}
...
:global(.bs558gbvp) {
  fill: var(--svg-color--fff176, #fff176);
  d: path("m64.05 100.4l1.28 3.93h4.13l-3.34 2.43l1.28 3.93l-3.35-2.43l-3.34 2.43l1.28-3.93l-3.35-2.43h4.14z");
}
