...
const content = `<path class="j3dlqv_-j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:car-tag-outline-rounded" {...props}></Icon>
<style>
:global(.j3dlqv_-j) {
  fill: currentColor;
