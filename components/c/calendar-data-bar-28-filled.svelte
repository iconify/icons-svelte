...
const content = `<path class="p97af6brg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:calendar-data-bar-28-filled" {...props}></Icon>
<style>
:global(.p97af6brg) {
  fill: currentColor;
