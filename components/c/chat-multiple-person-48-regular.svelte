...
const content = `<path class="d9kol1i1j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:chat-multiple-person-48-regular" {...props}></Icon>
<style>
:global(.d9kol1i1j) {
  fill: currentColor;
