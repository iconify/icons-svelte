...
const content = `<g class="y9tr6bcfx"><path class="yc0z4gbce"/><circle class="dl1nz7bnu"/><path class="wqlw0ybgx"/></g><path class="kzykk8swa"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-samsung-26" {...props}></Icon>
<style>
:global(.dl1nz7bnu) {
  cx: 31.205px;
  cy: 30.667px;
