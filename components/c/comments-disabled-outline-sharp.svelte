...
const content = `<path class="h1l7_tbrg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:comments-disabled-outline-sharp" {...props}></Icon>
<style>
:global(.h1l7_tbrg) {
  fill: currentColor;
