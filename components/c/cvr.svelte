...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGicbtJcZQ)" class="kz2b3cc6c"/><path class="prz54qb_m"/><path class="bgw0ubc0a"/><defs><linearGradient id="SVGicbtJcZQ" x1="5.683" x2="19.843" y1="5.536" y2="8.591" gradientUnits="userSpaceOnUse"><stop class="um75g3mrw"/><stop offset="1" class="ac0zekbzm"/></linearGradient></defs></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:cvr" {...props}></Icon>
<style>
:global(.ac0zekbzm) {
