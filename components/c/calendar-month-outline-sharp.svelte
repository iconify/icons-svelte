...
const content = `<path class="n4sv95bpm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:calendar-month-outline-sharp" {...props}></Icon>
<style>
:global(.n4sv95bpm) {
  fill: currentColor;
