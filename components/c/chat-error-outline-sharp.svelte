...
const content = `<path class="yt-i88b1i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:chat-error-outline-sharp" {...props}></Icon>
<style>
:global(.yt-i88b1i) {
  fill: currentColor;
