...
const content = `<g class="y9tr6bcfx"><path class="fptplk14x"/><path class="fkkf-acvy"/></g><path class="kzykk8swa"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-samsung-3" {...props}></Icon>
<style>
:global(.fkkf-acvy) {
