...
const content = `<path class="cveld1krg"/><path class="qnyeb7xtw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cdiscount" {...props}></Icon>
<style>
:global(.cveld1krg) {
  fill: none;
  stroke: currentColor;
