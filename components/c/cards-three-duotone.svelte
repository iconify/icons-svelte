...
const content = `<g class="cuyn6tgcc"><path class="jqh0w2bvq"/><path class="xbwbyrbdo"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:cards-three-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
