...
const content = `<path class="bjajeibii"/><path class="kzykk8swa"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-samsung-17" {...props}></Icon>
<style>
:global(.bjajeibii) {
  fill: none;
  stroke: currentColor;
