...
const content = `<path class="cjcet_bia"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:clipboard-number-123-20-regular" {...props}></Icon>
<style>
:global(.cjcet_bia) {
  fill: currentColor;
