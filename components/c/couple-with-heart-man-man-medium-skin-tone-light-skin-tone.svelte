...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="openmoji:couple-with-heart-man-man-medium-skin-tone-light-skin-tone" {...props}></Icon>
