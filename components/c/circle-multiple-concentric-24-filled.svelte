...
const content = `<path class="t818sf2kr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:circle-multiple-concentric-24-filled" {...props}></Icon>
<style>
:global(.t818sf2kr) {
  fill: currentColor;
