...
const content = `<path class="o5bqewb8t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:chevron-circle-down-24-filled" {...props}></Icon>
<style>
:global(.o5bqewb8t) {
  fill: currentColor;
