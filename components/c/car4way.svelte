...
const content = `<path class="ymg-yz19h"/><path class="fu2n1db4z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:car4way" {...props}></Icon>
<style>
:global(.fu2n1db4z) {
  fill: none;
  stroke: currentColor;
