...
const content = `<path class="mpiw9vq1r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:child-hat-outline-rounded" {...props}></Icon>
<style>
:global(.mpiw9vq1r) {
  fill: currentColor;
