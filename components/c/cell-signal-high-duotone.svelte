...
const content = `<g class="cuyn6tgcc"><path class="a8ab7i8-f"/><path class="s_lt-3iwq"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:cell-signal-high-duotone" {...props}></Icon>
<style>
:global(.a8ab7i8-f) {
