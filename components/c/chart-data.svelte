...
const content = `<path class="ge5cpibpx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:chart-data" {...props}></Icon>
<style>
:global(.ge5cpibpx) {
  fill: currentColor;
