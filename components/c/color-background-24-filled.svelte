...
const content = `<path class="yfzgmbbiw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:color-background-24-filled" {...props}></Icon>
<style>
:global(.yfzgmbbiw) {
  fill: currentColor;
