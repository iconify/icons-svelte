...
const content = `<path clip-rule="evenodd" class="g1b6u2bgo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:clock-8-sharp-fill" {...props}></Icon>
<style>
:global(.g1b6u2bgo) {
  fill: currentColor;
  fill-rule: evenodd;
