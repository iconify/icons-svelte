...
const content = `<g class="cuyn6tgcc"><path class="araa3kb4w"/><path class="banuk0v-f"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:currency-eth-duotone" {...props}></Icon>
<style>
:global(.araa3kb4w) {
