...
const content = `<defs><linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="ssvg-id-codepicnica"><stop offset="0%" class="xbzk7bbso"/><stop offset="100%" class="a0ao3sb3j"/></linearGradient></defs><path fill="url(#ssvg-id-codepicnica)" class="h3zp9ftjy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:codepicnic" {...props}></Icon>
<style>
:global(.a0ao3sb3j) {
