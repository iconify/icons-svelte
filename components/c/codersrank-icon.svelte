...
const content = `<path class="bv-25ybft"/><path class="vg6lr0neq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:codersrank-icon" {...props}></Icon>
<style>
:global(.bv-25ybft) {
