...
const content = `<path class="omj-5wbve"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:cast-warning-outline-rounded" {...props}></Icon>
<style>
:global(.omj-5wbve) {
  fill: currentColor;
