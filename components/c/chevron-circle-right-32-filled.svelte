...
const content = `<path class="t-hbj0bls"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:chevron-circle-right-32-filled" {...props}></Icon>
<style>
:global(.t-hbj0bls) {
  fill: currentColor;
