...
const content = `<g class="cuyn6tgcc"><path class="co49_nbhh"/><path class="z2ur62bkp"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:caret-double-up-duotone" {...props}></Icon>
<style>
:global(.co49_nbhh) {
