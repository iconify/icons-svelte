...
const content = `<g class="nrj6p8qat"><path class="yqndomb-o"/><path class="grybcac8z"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:copy-two-tone" {...props}></Icon>
<style>
:global(.grybcac8z) {
