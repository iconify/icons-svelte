...
const content = `<g class="y9tr6bcfx"><path class="xz876jhmw"/><path class="f1-l2h5bz"/></g><path class="gdpz_rbbn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-fossify-18" {...props}></Icon>
<style>
:global(.f1-l2h5bz) {
