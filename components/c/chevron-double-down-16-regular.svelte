...
const content = `<path class="i65yfwb6u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:chevron-double-down-16-regular" {...props}></Icon>
<style>
:global(.i65yfwb6u) {
  fill: currentColor;
