...
const content = `<g class="cuyn6tgcc"><path class="huaroj7an"/><path class="au7gntbgx"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:columns-plus-right-duotone" {...props}></Icon>
<style>
:global(.au7gntbgx) {
