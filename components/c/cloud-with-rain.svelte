...
const content = `<path class="rpcivmwfx"/><path class="fy1h_eb0w"/><path class="ho-wbbbps"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:cloud-with-rain" {...props}></Icon>
<style>
:global(.fy1h_eb0w) {
