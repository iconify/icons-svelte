...
const content = `<path class="dj5g3zbtv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:car-defrost-low-left-outline-rounded" {...props}></Icon>
<style>
:global(.dj5g3zbtv) {
  fill: currentColor;
