...
const content = `<path class="vggm8t0us"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:chevron-circle-right-32-regular" {...props}></Icon>
<style>
:global(.vggm8t0us) {
  fill: currentColor;
