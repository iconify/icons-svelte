...
const content = `<path class="i27o8kbqm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:calculate-outline-rounded" {...props}></Icon>
<style>
:global(.i27o8kbqm) {
  fill: currentColor;
