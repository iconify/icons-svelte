...
const content = `<path class="xgn_xbcik"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:chevron-circle-up-20-regular" {...props}></Icon>
<style>
:global(.xgn_xbcik) {
  fill: currentColor;
