...
const content = `<path class="wj0e81goz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:checkmark-underline-circle-20-filled" {...props}></Icon>
<style>
:global(.wj0e81goz) {
  fill: currentColor;
