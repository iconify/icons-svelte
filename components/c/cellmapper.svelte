...
const content = `<path class="hmyp92ols"/><path class="mxfx3ghnl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cellmapper" {...props}></Icon>
<style>
:global(.hmyp92ols) {
  fill: none;
  stroke: currentColor;
