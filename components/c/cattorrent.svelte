...
const content = `<path class="sjrro1bxo"/><path class="g6k3p2dzf"/><path class="u7oy0tboj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cattorrent" {...props}></Icon>
<style>
:global(.g6k3p2dzf) {
  fill: none;
  stroke: currentColor;
