...
const content = `<path class="yqitu1e2z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:calendar-week-start-28-regular" {...props}></Icon>
<style>
:global(.yqitu1e2z) {
  fill: currentColor;
