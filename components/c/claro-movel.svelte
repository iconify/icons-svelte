...
const content = `<path class="uo47pyvli"/><rect class="zff1mybez"/><path class="pple9cc9v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:claro-movel" {...props}></Icon>
<style>
:global(.pple9cc9v) {
  fill: none;
  stroke: currentColor;
