...
const content = `<path class="yb-48bcwq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:contract-up-right-16-filled" {...props}></Icon>
<style>
:global(.yb-48bcwq) {
  fill: currentColor;
