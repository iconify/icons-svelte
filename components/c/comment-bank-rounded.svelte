...
const content = `<path class="tm19hljcx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:comment-bank-rounded" {...props}></Icon>
<style>
:global(.tm19hljcx) {
  fill: currentColor;
