...
const content = `<path class="zktndxb_r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:chevron-double-up-16-regular" {...props}></Icon>
<style>
:global(.zktndxb_r) {
  fill: currentColor;
