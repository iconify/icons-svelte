...
const content = `<path class="qu6efgbwl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:comic-bubble-rounded" {...props}></Icon>
<style>
:global(.qu6efgbwl) {
  fill: currentColor;
