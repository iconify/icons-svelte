...
const content = `<ellipse class="jn8xd0bjj"/><ellipse class="zijb_ev9b"/><path class="xrl4zg5gr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:chroma" {...props}></Icon>
<style>
:global(.jn8xd0bjj) {
  cx: 170.667px;
  cy: 81.92px;
