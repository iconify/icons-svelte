...
const content = `<g class="nrj6p8qat"><path class="bp-w5nx6c"/><path class="tqo-4zbwk"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:calendar-arrow-up-two-tone" {...props}></Icon>
<style>
:global(.bp-w5nx6c) {
  fill: currentColor;
