...
const content = `<g class="cuyn6tgcc"><path class="xv2ntjbkh"/><path class="v0x406m6t"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:coat-hanger-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
