...
const content = `<path clip-rule="evenodd" class="fznh9xlik"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:cweb" {...props}></Icon>
<style>
:global(.fznh9xlik) {
