...
const content = `<g class="cuyn6tgcc"><path class="no0njmbpm"/><path class="p5uaauunv"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:currency-dollar-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
