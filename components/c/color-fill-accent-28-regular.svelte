...
const content = `<path class="a6zgpz0gz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:color-fill-accent-28-regular" {...props}></Icon>
<style>
:global(.a6zgpz0gz) {
  fill: currentColor;
