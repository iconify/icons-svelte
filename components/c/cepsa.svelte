...
const content = `<path class="rxhn-ez-p"/><path class="pbxx3mb5n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cepsa" {...props}></Icon>
<style>
:global(.pbxx3mb5n) {
  fill: none;
  stroke: currentColor;
