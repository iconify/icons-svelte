...
const content = `<path class="dh6wu2g0w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:checkmark-circle-28-filled" {...props}></Icon>
<style>
:global(.dh6wu2g0w) {
  fill: currentColor;
