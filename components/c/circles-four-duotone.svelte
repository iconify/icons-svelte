...
const content = `<g class="cuyn6tgcc"><path class="mcxt5qbbb"/><path class="vsjcm7a_a"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:circles-four-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
