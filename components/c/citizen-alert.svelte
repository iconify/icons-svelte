...
const content = `<path class="h0e39rbxh"/><circle class="vly33-bpl"/><path class="vmdnxxbou"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:citizen-alert" {...props}></Icon>
<style>
:global(.h0e39rbxh) {
  fill: none;
  stroke: currentColor;
