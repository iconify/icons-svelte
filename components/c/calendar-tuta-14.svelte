...
const content = `<path class="tg5l10-fj"/><path class="bag4m3bbr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-tuta-14" {...props}></Icon>
<style>
:global(.bag4m3bbr) {
  fill: none;
  stroke: currentColor;
