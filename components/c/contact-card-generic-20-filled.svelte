...
const content = `<path class="lf-jgybhl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:contact-card-generic-20-filled" {...props}></Icon>
<style>
:global(.lf-jgybhl) {
  fill: currentColor;
