...
const content = `<g class="cuyn6tgcc"><path class="n_-6a96al"/><path class="d8m65ybkx"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:chalkboard-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
