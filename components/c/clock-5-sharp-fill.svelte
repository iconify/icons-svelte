...
const content = `<path clip-rule="evenodd" class="dbs1q3kot"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:clock-5-sharp-fill" {...props}></Icon>
<style>
:global(.dbs1q3kot) {
  fill: currentColor;
  fill-rule: evenodd;
