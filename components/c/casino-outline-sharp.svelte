...
const content = `<path class="bm6c5lbie"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:casino-outline-sharp" {...props}></Icon>
<style>
:global(.bm6c5lbie) {
  fill: currentColor;
