...
const content = `<path clip-rule="evenodd" class="pq3zhxbjs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:circle-plus-sharp-fill" {...props}></Icon>
<style>
:global(.pq3zhxbjs) {
  fill: currentColor;
  fill-rule: evenodd;
