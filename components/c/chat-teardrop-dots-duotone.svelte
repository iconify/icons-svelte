...
const content = `<g class="cuyn6tgcc"><path class="djzh0xbac"/><path class="yv8zi835m"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:chat-teardrop-dots-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
