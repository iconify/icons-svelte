...
const content = `<path class="wm6vw6b5m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:chat-paste-go-2-outline-sharp" {...props}></Icon>
<style>
:global(.wm6vw6b5m) {
  fill: currentColor;
