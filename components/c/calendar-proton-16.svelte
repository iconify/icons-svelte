...
const content = `<path class="my8bybbld"/><circle class="c9zwiftad"/><path class="aw2p_4ety"/><path class="f6_7b22_l"/><path class="wtoegrbgv"/><path class="orx8z1bik"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-proton-16" {...props}></Icon>
<style>
:global(.aw2p_4ety) {
  fill: none;
  stroke: currentColor;
