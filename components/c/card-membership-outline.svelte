...
const content = `<path class="i3en5pbuw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:card-membership-outline" {...props}></Icon>
<style>
:global(.i3en5pbuw) {
  fill: currentColor;
