...
const content = `<g class="nrj6p8qat"><path class="x9emg4bdv"/><path class="ml-hxubcc"/><path class="p7564zb6u"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:chart-candlestick-duotone" {...props}></Icon>
<style>
:global(.ml-hxubcc) {
  fill: currentColor;
