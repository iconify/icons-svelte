...
const content = `<path class="bobm09brk"/><path class="n_8t9vgln"/><path class="hvs6ejb5n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:cross-browser-testing" {...props}></Icon>
<style>
:global(.bobm09brk) {
