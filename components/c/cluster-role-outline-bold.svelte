...
const content = `<g class="s0phu2bbs"><path class="yhswpf2nj"/><path class="qarcjib7d"/><path class="z1gyoabnz"/><path class="u7cagdche"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:cluster-role-outline-bold" {...props}></Icon>
<style>
:global(.qarcjib7d) {
