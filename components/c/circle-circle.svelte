...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="wrvhr5_3l"/><path class="hdxpysbbn"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:circle-circle" {...props}></Icon>
<style>
:global(.hdxpysbbn) {
