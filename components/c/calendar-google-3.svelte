...
const content = `<path class="n1jkg3bus"/><path class="uph4zqc9i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-google-3" {...props}></Icon>
<style>
:global(.n1jkg3bus) {
  fill: none;
  stroke: currentColor;
