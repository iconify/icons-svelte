...
const content = `<g class="cuyn6tgcc"><path class="c9epvhehk"/><path class="gwl3h8bbe"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:caret-circle-double-down-duotone" {...props}></Icon>
<style>
:global(.c9epvhehk) {
