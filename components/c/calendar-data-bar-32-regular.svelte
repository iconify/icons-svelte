...
const content = `<path class="svufz5bvf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:calendar-data-bar-32-regular" {...props}></Icon>
<style>
:global(.svufz5bvf) {
  fill: currentColor;
