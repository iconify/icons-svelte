...
const content = `<path class="p62syfb_z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:center-horizontal-20-regular" {...props}></Icon>
<style>
:global(.p62syfb_z) {
  fill: currentColor;
