...
const content = `<path class="rno497bbr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:car-defrost-mid-right-outline-sharp" {...props}></Icon>
<style>
:global(.rno497bbr) {
  fill: currentColor;
