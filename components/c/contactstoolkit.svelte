...
const content = `<circle class="cpk0fnbgt"/><path class="a_m2c6btx"/><path class="snlqakb_k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:contactstoolkit" {...props}></Icon>
<style>
:global(.a_m2c6btx) {
  fill: none;
  stroke: currentColor;
