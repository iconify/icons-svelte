...
const content = `<path class="b-nlkacko"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:color-line-accent-20-regular" {...props}></Icon>
<style>
:global(.b-nlkacko) {
  fill: currentColor;
