...
const content = `<path class="hnnb155mp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:circle-square-dashed" {...props}></Icon>
<style>
:global(.hnnb155mp) {
  fill: none;
  stroke: currentColor;
