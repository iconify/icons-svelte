...
const content = `<path class="v8dzjm-0s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:checkmark-circle-16-regular" {...props}></Icon>
<style>
:global(.v8dzjm-0s) {
  fill: currentColor;
