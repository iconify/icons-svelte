...
const content = `<path class="oagjj4b-u"/><circle class="gvast2brf"/><path class="ejt0h4euu"/><path class="f6_7b22_l"/><path class="wtoegrbgv"/><path class="orx8z1bik"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-proton-26" {...props}></Icon>
<style>
:global(.ejt0h4euu) {
  fill: none;
  stroke: currentColor;
