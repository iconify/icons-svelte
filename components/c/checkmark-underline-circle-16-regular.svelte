...
const content = `<path class="p1oobpb1y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:checkmark-underline-circle-16-regular" {...props}></Icon>
<style>
:global(.p1oobpb1y) {
  fill: currentColor;
