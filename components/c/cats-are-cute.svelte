...
const content = `<path class="idub5_bti"/><circle class="s3w1n1g0y"/><circle class="zvt_ibb6n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cats-are-cute" {...props}></Icon>
<style>
:global(.idub5_bti) {
  fill: none;
  stroke: currentColor;
