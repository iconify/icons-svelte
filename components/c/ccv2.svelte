...
const content = `<g class="txuu59dhn"><path class="dg81a1wqs"/><path class="wu9uhhbeh"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:ccv2" {...props}></Icon>
<style>
:global(.dg81a1wqs) {
