...
const content = `<path class="c0sfd9r7m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:comment-multiple-16-filled" {...props}></Icon>
<style>
:global(.c0sfd9r7m) {
  fill: currentColor;
