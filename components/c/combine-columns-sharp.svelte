...
const content = `<path class="kvzglcbbh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:combine-columns-sharp" {...props}></Icon>
<style>
:global(.kvzglcbbh) {
  fill: currentColor;
