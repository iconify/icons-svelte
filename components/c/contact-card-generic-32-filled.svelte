...
const content = `<path class="mnz4r2bxd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:contact-card-generic-32-filled" {...props}></Icon>
<style>
:global(.mnz4r2bxd) {
  fill: currentColor;
