...
const content = `<path class="ireuv1nhg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:coronavirus-outline-sharp" {...props}></Icon>
<style>
:global(.ireuv1nhg) {
  fill: currentColor;
