...
const content = `<g class="cuyn6tgcc"><path class="qw6jawu4c"/><path class="zwebrxihd"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:crane-tower-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
