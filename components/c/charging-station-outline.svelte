...
const content = `<path class="vo-zkjgoz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:charging-station-outline" {...props}></Icon>
<style>
:global(.vo-zkjgoz) {
  fill: currentColor;
