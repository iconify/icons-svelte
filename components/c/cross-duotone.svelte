...
const content = `<g class="cuyn6tgcc"><path class="pqv59_5yz"/><path class="ou0sbkn-q"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:cross-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
