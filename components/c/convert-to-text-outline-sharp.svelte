...
const content = `<path class="f8r6q7bis"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:convert-to-text-outline-sharp" {...props}></Icon>
<style>
:global(.f8r6q7bis) {
  fill: currentColor;
