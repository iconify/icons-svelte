...
const content = `<path class="u7p09eb7o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:clipboard-text-ltr-16-filled" {...props}></Icon>
<style>
:global(.u7p09eb7o) {
  fill: currentColor;
