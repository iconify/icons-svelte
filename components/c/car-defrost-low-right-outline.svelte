...
const content = `<path class="lcmjkfbsb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:car-defrost-low-right-outline" {...props}></Icon>
<style>
:global(.lcmjkfbsb) {
  fill: currentColor;
