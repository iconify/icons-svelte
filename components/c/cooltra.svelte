...
const content = `<path class="wd2mp0w4t"/><path class="vk1u2cbqq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:cooltra" {...props}></Icon>
<style>
:global(.vk1u2cbqq) {
  fill: none;
  stroke: currentColor;
