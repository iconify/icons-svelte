...
const content = `<path class="gs5mo7_io"/><path class="uph4zqc9i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:calendar-google-15" {...props}></Icon>
<style>
:global(.gs5mo7_io) {
  fill: none;
  stroke: currentColor;
