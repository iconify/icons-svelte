...
const content = `<g class="cuyn6tgcc"><path class="kqhcrb1bm"/><path class="yo2ji5b_y"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:church-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
