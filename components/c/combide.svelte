...
const content = `<path class="oz7aabb5w"/><circle class="r49ybnb-i"/><path class="d3smpob8y"/><path class="cy-d7_i0l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:combide" {...props}></Icon>
<style>
:global(.cy-d7_i0l) {
  fill: none;
  stroke: currentColor;
