...
const content = `<path class="z27c6nbre"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:zone-person-alert-outline-rounded" {...props}></Icon>
<style>
:global(.z27c6nbre) {
  fill: currentColor;
