...
const content = `<path class="r4h1y5b9l"/><path class="dsupx9ycw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:zip-file" {...props}></Icon>
<style>
:global(.dsupx9ycw) {
  fill: none;
  stroke: currentColor;
