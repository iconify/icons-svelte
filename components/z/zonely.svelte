...
const content = `<path class="ewfqgnljx"/><path class="tedbs0qgd"/><path class="t9tzg47ih"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:zonely" {...props}></Icon>
<style>
:global(.ewfqgnljx) {
  fill: none;
  stroke: currentColor;
