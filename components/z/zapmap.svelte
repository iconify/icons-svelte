...
const content = `<path class="urp09cban"/><path class="fs8rrqmfr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:zapmap" {...props}></Icon>
<style>
:global(.fs8rrqmfr) {
  fill: none;
  stroke: currentColor;
