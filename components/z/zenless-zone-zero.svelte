...
const content = `<path class="z50rzkfwf"/><path class="t63jxq9oz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:zenless-zone-zero" {...props}></Icon>
<style>
:global(.t63jxq9oz) {
  fill: none;
  stroke: currentColor;
