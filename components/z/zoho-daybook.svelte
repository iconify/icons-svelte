...
const content = `<path class="x0p0eqbyv"/><path class="r32gd66qb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:zoho-daybook" {...props}></Icon>
<style>
:global(.r32gd66qb) {
  fill: none;
  stroke: currentColor;
