...
const content = `<path class="rleb26osq"/><path class="petlldqnx"/><path class="nt3__rg0q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:zdfmediathek" {...props}></Icon>
<style>
:global(.nt3__rg0q) {
  fill: none;
  stroke: currentColor;
