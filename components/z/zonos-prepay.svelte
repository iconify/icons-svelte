...
const content = `<circle class="gh9tvsntj"/><path class="leie8bb-w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:zonos-prepay" {...props}></Icon>
<style>
:global(.gh9tvsntj) {
  cx: 24px;
  cy: 25.216px;
