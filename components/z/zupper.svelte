...
const content = `<path class="ngzrp4bbu"/><path class="nbd6fq2dc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:zupper" {...props}></Icon>
<style>
:global(.nbd6fq2dc) {
  fill: none;
  stroke: currentColor;
