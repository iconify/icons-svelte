...
const content = `<path class="p6sdmzp2w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:right-panel-close-rounded" {...props}></Icon>
<style>
:global(.p6sdmzp2w) {
  fill: currentColor;
