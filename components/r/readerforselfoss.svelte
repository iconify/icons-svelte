...
const content = `<path class="k449gabri"/><path class="cub-dbc7r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:readerforselfoss" {...props}></Icon>
<style>
:global(.cub-dbc7r) {
  fill: none;
  stroke: currentColor;
