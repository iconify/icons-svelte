...
const content = `<path class="oc58d8bnr"/><path class="dxx0-ftqn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:recorder" {...props}></Icon>
<style>
:global(.dxx0-ftqn) {
  fill: none;
  stroke: currentColor;
