...
const content = `<g class="y9tr6bcfx"><path class="uv2rgzbpd"/><path class="wmyv7nb9n"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:rakuten-card" {...props}></Icon>
<style>
:global(.uv2rgzbpd) {
