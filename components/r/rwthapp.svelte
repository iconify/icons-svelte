...
const content = `<path class="cy-d7_i0l"/><path class="xm5ekukqc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:rwthapp" {...props}></Icon>
<style>
:global(.cy-d7_i0l) {
  fill: none;
  stroke: currentColor;
