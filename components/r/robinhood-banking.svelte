...
const content = `<path class="z20c8hbnk"/><path class="yorf2eboh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:robinhood-banking" {...props}></Icon>
<style>
:global(.yorf2eboh) {
  fill: none;
  stroke: currentColor;
