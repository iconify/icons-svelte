...
const content = `<path class="vwn2g2p8o"/><path class="he9u3dlsp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:resso" {...props}></Icon>
<style>
:global(.he9u3dlsp) {
  fill: none;
  stroke: currentColor;
