...
const content = `<path class="cvhg2fe3c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:re-order-dots-horizontal-16-filled" {...props}></Icon>
<style>
:global(.cvhg2fe3c) {
  fill: currentColor;
