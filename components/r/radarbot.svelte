...
const content = `<path class="ioli74dmx"/><path class="ouij8hbjj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:radarbot" {...props}></Icon>
<style>
:global(.ioli74dmx) {
  fill: none;
  stroke: currentColor;
