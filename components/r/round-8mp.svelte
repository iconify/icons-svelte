...
const content = `<path class="k4n51fjcs"/><path class="qxsuyevex"/><path class="npg5m2b3p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-8mp" {...props}></Icon>
<style>
:global(.k4n51fjcs) {
  fill: currentColor;
