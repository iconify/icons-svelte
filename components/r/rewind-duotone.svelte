...
const content = `<g class="cuyn6tgcc"><path class="f_dihdcpw"/><path class="y2xhkkbij"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:rewind-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
