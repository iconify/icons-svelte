...
const content = `<path class="y_5gu2b4c"/><path class="hdeeh2bec"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-music-video" {...props}></Icon>
<style>
:global(.hdeeh2bec) {
  fill: currentColor;
