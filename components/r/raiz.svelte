...
const content = `<path class="fqeoerb0a"/><path class="ju7d3eg9i"/><path class="p6okz8yaq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:raiz" {...props}></Icon>
<style>
:global(.fqeoerb0a) {
  fill: none;
  stroke: currentColor;
