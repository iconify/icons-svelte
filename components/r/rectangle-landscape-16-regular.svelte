...
const content = `<path class="t4kwhtbqz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:rectangle-landscape-16-regular" {...props}></Icon>
<style>
:global(.t4kwhtbqz) {
  fill: currentColor;
