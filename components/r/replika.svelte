...
const content = `<path class="bg-jjcb7q"/><path class="k6mosu51y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:replika" {...props}></Icon>
<style>
:global(.bg-jjcb7q) {
  fill: none;
  stroke: currentColor;
