...
const content = `<circle class="ov-wf5bce"/><path class="nku2io5ym"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-mark-unread-chat-alt" {...props}></Icon>
<style>
:global(.nku2io5ym) {
  fill: currentColor;
