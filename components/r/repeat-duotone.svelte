...
const content = `<g class="cuyn6tgcc"><path class="cw5fhcbxr"/><path class="p1u3de06b"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:repeat-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
