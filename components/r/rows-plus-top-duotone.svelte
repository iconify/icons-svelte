...
const content = `<g class="cuyn6tgcc"><path class="p6-wodb_m"/><path class="t2nbx65ge"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:rows-plus-top-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
