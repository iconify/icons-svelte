...
const content = `<path class="ws5w723dm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:rectangle-landscape-sync-28-filled" {...props}></Icon>
<style>
:global(.ws5w723dm) {
  fill: currentColor;
