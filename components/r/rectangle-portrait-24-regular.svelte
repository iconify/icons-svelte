...
const content = `<path class="bbl5v4b-v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:rectangle-portrait-24-regular" {...props}></Icon>
<style>
:global(.bbl5v4b-v) {
  fill: currentColor;
