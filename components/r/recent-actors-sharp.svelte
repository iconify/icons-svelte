...
const content = `<path class="xacjxxb8f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:recent-actors-sharp" {...props}></Icon>
<style>
:global(.xacjxxb8f) {
  fill: currentColor;
