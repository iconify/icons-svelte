...
const content = `<path class="r6xlfhjah"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:room-service-rounded" {...props}></Icon>
<style>
:global(.r6xlfhjah) {
  fill: currentColor;
