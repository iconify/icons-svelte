...
const content = `<path class="z_fifccue"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:room-preferences-rounded" {...props}></Icon>
<style>
:global(.z_fifccue) {
  fill: currentColor;
