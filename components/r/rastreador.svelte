...
const content = `<path class="kdxk90b1c"/><circle class="yl7l7dbcw"/><path class="l4q1frb3f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:rastreador" {...props}></Icon>
<style>
:global(.kdxk90b1c) {
  fill: none;
  stroke: currentColor;
