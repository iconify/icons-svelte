...
const content = `<path class="zf4ig0bra"/><path class="mu0-yrbhy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-keyboard-double-arrow-left" {...props}></Icon>
<style>
:global(.mu0-yrbhy) {
  fill: currentColor;
