...
const content = `<path class="x5es36not"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:remove-from-queue-rounded" {...props}></Icon>
<style>
:global(.x5es36not) {
  fill: currentColor;
