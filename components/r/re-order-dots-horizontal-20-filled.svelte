...
const content = `<path class="sou8m4_qb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:re-order-dots-horizontal-20-filled" {...props}></Icon>
<style>
:global(.sou8m4_qb) {
  fill: currentColor;
