...
const content = `<circle class="yfz3w9lrl"/><path class="wwckf8xog"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-emoji-people" {...props}></Icon>
<style>
:global(.wwckf8xog) {
  fill: currentColor;
