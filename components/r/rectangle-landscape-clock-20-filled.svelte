...
const content = `<path class="eiv_6bm1d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:rectangle-landscape-clock-20-filled" {...props}></Icon>
<style>
:global(.eiv_6bm1d) {
  fill: currentColor;
