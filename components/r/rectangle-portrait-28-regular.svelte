...
const content = `<path class="aed4abibp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:rectangle-portrait-28-regular" {...props}></Icon>
<style>
:global(.aed4abibp) {
  fill: currentColor;
