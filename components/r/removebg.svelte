...
const content = `<path class="epinpev5q"/><path class="jfd4yf9cp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:removebg" {...props}></Icon>
<style>
:global(.epinpev5q) {
  fill: none;
  stroke: currentColor;
