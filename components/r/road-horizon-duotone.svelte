...
const content = `<g class="cuyn6tgcc"><path class="hj92v93cl"/><path class="bun19obru"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:road-horizon-duotone" {...props}></Icon>
<style>
:global(.bun19obru) {
