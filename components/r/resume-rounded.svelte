...
const content = `<path class="p9fnthlmf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:resume-rounded" {...props}></Icon>
<style>
:global(.p9fnthlmf) {
  fill: currentColor;
