...
const content = `<path class="euokmho5h"/><path class="feui3y4kq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-install-mobile" {...props}></Icon>
<style>
:global(.euokmho5h) {
  fill: currentColor;
