...
const content = `<path class="dqu-t7q6k"/><path class="e0_f694sv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:raindrop" {...props}></Icon>
<style>
:global(.dqu-t7q6k) {
  fill: none;
  stroke: currentColor;
