...
const content = `<path class="tzz05bbsl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-v1:red-triangle-pointed-down" {...props}></Icon>
<style>
:global(.tzz05bbsl) {
