...
const content = `<path class="iu2tfx4av"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:radio-button-off-16-regular" {...props}></Icon>
<style>
:global(.iu2tfx4av) {
  fill: currentColor;
