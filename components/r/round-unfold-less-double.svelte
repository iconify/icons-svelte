...
const content = `<path class="sr9vzvb9j"/><path class="a9e9jwbsv"/><path class="t-_3xbcdm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-unfold-less-double" {...props}></Icon>
<style>
:global(.a9e9jwbsv) {
  fill: currentColor;
