...
const content = `<circle class="vhr2lj4be"/><circle class="ifds6hbbc"/><path class="hr66c9but"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-child-care" {...props}></Icon>
<style>
:global(.hr66c9but) {
  fill: currentColor;
