...
const content = `<path class="aibtjkgta"/><path class="ou0c1xbyq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-signal-wifi-3-bar" {...props}></Icon>
<style>
:global(.aibtjkgta) {
  fill: currentColor;
