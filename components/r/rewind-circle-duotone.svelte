...
const content = `<g class="cuyn6tgcc"><path class="fxwgbbbhw"/><path class="w_fb6ebfm"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:rewind-circle-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
