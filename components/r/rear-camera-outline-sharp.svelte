...
const content = `<path class="p9q8jttqu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:rear-camera-outline-sharp" {...props}></Icon>
<style>
:global(.p9q8jttqu) {
  fill: currentColor;
