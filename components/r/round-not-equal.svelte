...
const content = `<path class="wlxuxlbuw"/><path class="eae5qyb6x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-not-equal" {...props}></Icon>
<style>
:global(.eae5qyb6x) {
  fill: currentColor;
