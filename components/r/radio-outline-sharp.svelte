...
const content = `<path class="hkoj8rz-p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:radio-outline-sharp" {...props}></Icon>
<style>
:global(.hkoj8rz-p) {
  fill: currentColor;
