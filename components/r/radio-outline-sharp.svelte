...
const content = `<path class="k65qu_b7u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:radio-outline-sharp" {...props}></Icon>
<style>
:global(.k65qu_b7u) {
  fill: currentColor;
