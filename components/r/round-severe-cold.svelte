...
const content = `<path class="ygtr4nagv"/><circle class="fu2vv6bvy"/><path class="f61y-nmdv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-severe-cold" {...props}></Icon>
<style>
:global(.f61y-nmdv) {
  fill: currentColor;
