...
const content = `<path class="gaf43-bgl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:radiology-outline-sharp" {...props}></Icon>
<style>
:global(.gaf43-bgl) {
  fill: currentColor;
