...
const content = `<path class="twhn4hk-e"/><path class="w1_lg0bfb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:reversocontext" {...props}></Icon>
<style>
:global(.twhn4hk-e) {
  fill: none;
  stroke: currentColor;
