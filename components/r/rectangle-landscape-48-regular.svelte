...
const content = `<path class="emjte3brn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:rectangle-landscape-48-regular" {...props}></Icon>
<style>
:global(.emjte3brn) {
  fill: currentColor;
