...
const content = `<path class="wa2kbpblj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:rule-folder-outline-sharp" {...props}></Icon>
<style>
:global(.wa2kbpblj) {
  fill: currentColor;
