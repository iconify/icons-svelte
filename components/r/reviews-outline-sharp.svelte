...
const content = `<path class="ym9rrrhax"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:reviews-outline-sharp" {...props}></Icon>
<style>
:global(.ym9rrrhax) {
  fill: currentColor;
