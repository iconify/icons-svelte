...
const content = `<g class="cuyn6tgcc"><path class="tm3vqw7ob"/><path class="tqg-chbho"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:rectangle-dashed-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
