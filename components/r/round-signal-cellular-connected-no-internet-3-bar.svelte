...
const content = `<path class="djyw7_hwy"/><path class="grelk2bzp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-signal-cellular-connected-no-internet-3-bar" {...props}></Icon>
<style>
:global(.djyw7_hwy) {
  fill: currentColor;
