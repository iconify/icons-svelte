...
const content = `<path class="ehyvx_nni"/><circle class="u1l7rqbek"/><path class="kuunmhbmt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-category" {...props}></Icon>
<style>
:global(.ehyvx_nni) {
  fill: currentColor;
