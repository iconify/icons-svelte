...
const content = `<path class="o44zqbc7e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:rate-review-outline-sharp" {...props}></Icon>
<style>
:global(.o44zqbc7e) {
  fill: currentColor;
