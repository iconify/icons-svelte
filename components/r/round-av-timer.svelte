...
const content = `<circle class="oclompb7u"/><circle class="qa-1pv6bo"/><circle class="on4fre1ek"/><path class="ah3klqb7l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-av-timer" {...props}></Icon>
<style>
:global(.ah3klqb7l) {
  fill: currentColor;
