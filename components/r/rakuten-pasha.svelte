...
const content = `<rect class="j3s9ivbxi"/><path class="g8a0gd22y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:rakuten-pasha" {...props}></Icon>
<style>
:global(.g8a0gd22y) {
  fill: none;
  stroke: currentColor;
