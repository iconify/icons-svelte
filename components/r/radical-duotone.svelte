...
const content = `<g class="cuyn6tgcc"><path class="jgc6q1bjw"/><path class="yr--26plj"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:radical-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
