...
const content = `<path class="vrtp_n06l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:rear-camera-sharp" {...props}></Icon>
<style>
:global(.vrtp_n06l) {
  fill: currentColor;
