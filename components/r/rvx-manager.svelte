...
const content = `<path class="kr2ugpbzl"/><path class="vfnnonl1y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:rvx-manager" {...props}></Icon>
<style>
:global(.kr2ugpbzl) {
  fill: none;
  stroke: currentColor;
