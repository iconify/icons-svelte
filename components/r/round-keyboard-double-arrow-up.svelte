...
const content = `<path class="qazv1sbxh"/><path class="g8u8afb3q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-keyboard-double-arrow-up" {...props}></Icon>
<style>
:global(.g8u8afb3q) {
  fill: currentColor;
