...
const content = `<path class="snt29pbpn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:re-order-dots-vertical-20-filled" {...props}></Icon>
<style>
:global(.snt29pbpn) {
  fill: currentColor;
