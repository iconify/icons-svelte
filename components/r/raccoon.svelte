...
const content = `<path class="kjq6plbmp"/><path class="u-zpw7usr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:raccoon" {...props}></Icon>
<style>
:global(.kjq6plbmp) {
  fill: none;
  stroke: currentColor;
