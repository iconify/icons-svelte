...
const content = `<path class="j4nc8gbnr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:rest-area-outline-rounded" {...props}></Icon>
<style>
:global(.j4nc8gbnr) {
  fill: currentColor;
