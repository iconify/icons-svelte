...
const content = `<path class="yycx2-b7r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:request-quote-outline" {...props}></Icon>
<style>
:global(.yycx2-b7r) {
  fill: currentColor;
