...
const content = `<path class="uxg417b5h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:rectangle-landscape-off-20-filled" {...props}></Icon>
<style>
:global(.uxg417b5h) {
  fill: currentColor;
