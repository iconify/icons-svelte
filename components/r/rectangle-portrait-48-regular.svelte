...
const content = `<path class="um2akwbne"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:rectangle-portrait-48-regular" {...props}></Icon>
<style>
:global(.um2akwbne) {
  fill: currentColor;
