...
const content = `<path class="jy-pcqb1o"/><path class="pywi5nbeq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-less-than-equal" {...props}></Icon>
<style>
:global(.jy-pcqb1o) {
  fill: currentColor;
  fill-rule: evenodd;
