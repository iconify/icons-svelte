...
const content = `<path class="sampidniq"/><path class="ap5hrwbfl"/><path class="ltpzstbqo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:refactor" {...props}></Icon>
<style>
:global(.ap5hrwbfl) {
