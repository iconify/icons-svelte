...
const content = `<path class="sj0-uvi8j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:rectangle-portrait-16-regular" {...props}></Icon>
<style>
:global(.sj0-uvi8j) {
  fill: currentColor;
