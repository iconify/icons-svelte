...
const content = `<path class="k7-yw7ceq"/><path class="n6xqvubeo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:react" {...props}></Icon>
<style>
:global(.k7-yw7ceq) {
  fill: none;
  stroke: currentColor;
