...
const content = `<path class="sz4jefb0k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:re-order-dots-horizontal-16-regular" {...props}></Icon>
<style>
:global(.sz4jefb0k) {
  fill: currentColor;
