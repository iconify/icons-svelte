...
const content = `<path class="jj14nlb_m"/><path class="is8pklbyp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-screenshot-monitor" {...props}></Icon>
<style>
:global(.is8pklbyp) {
  fill: currentColor;
