...
const content = `<path clip-rule="evenodd" class="b72vf8bkn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:ruler" {...props}></Icon>
<style>
:global(.b72vf8bkn) {
  fill: currentColor;
  fill-rule: evenodd;
