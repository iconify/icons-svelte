...
const content = `<path class="qz70wpbng"/><path class="hedjc1bfn"/><path class="ydpyqdqbh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:rxdb" {...props}></Icon>
<style>
:global(.hedjc1bfn) {
