...
const content = `<path class="djyw7_hwy"/><path class="tp3b3pqrg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-signal-cellular-connected-no-internet-1-bar" {...props}></Icon>
<style>
:global(.djyw7_hwy) {
  fill: currentColor;
