...
const content = `<path class="ycmsskeoh"/><circle class="dwd7gsbro"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:rapido" {...props}></Icon>
<style>
:global(.dwd7gsbro) {
  cx: 23.876px;
  cy: 10.209px;
