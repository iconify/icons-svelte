...
const content = `<g class="cuyn6tgcc"><path class="v-4as6dea"/><path class="m1g_51bur"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:replit-logo-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
