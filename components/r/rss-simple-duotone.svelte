...
const content = `<g class="cuyn6tgcc"><path class="xmm7cscja"/><path class="ivf5ys14p"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:rss-simple-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
