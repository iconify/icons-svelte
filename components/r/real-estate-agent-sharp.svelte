...
const content = `<path class="ghflirbpv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:real-estate-agent-sharp" {...props}></Icon>
<style>
:global(.ghflirbpv) {
  fill: currentColor;
