...
const content = `<path class="l8rbx6b0g"/><path class="udzun7pox"/><path class="y8vg0rmdh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-add-chart" {...props}></Icon>
<style>
:global(.l8rbx6b0g) {
  fill: currentColor;
