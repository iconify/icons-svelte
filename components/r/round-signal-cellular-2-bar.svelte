...
const content = `<path class="ld-sdrbtn"/><path class="avs9u3b-n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-signal-cellular-2-bar" {...props}></Icon>
<style>
:global(.avs9u3b-n) {
  fill: currentColor;
