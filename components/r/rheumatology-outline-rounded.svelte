...
const content = `<path class="lljukxggz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:rheumatology-outline-rounded" {...props}></Icon>
<style>
:global(.lljukxggz) {
  fill: currentColor;
