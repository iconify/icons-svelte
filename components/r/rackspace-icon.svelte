...
const content = `<path class="tofpnqb0b"/><path class="fnkqajb8n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:rackspace-icon" {...props}></Icon>
<style>
:global(.fnkqajb8n) {
