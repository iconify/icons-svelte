...
const content = `<path class="uxut_gb8n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:roller-shades-outline-rounded" {...props}></Icon>
<style>
:global(.uxut_gb8n) {
  fill: currentColor;
