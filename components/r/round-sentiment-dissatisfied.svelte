...
const content = `<circle class="mmn7xsb7v"/><circle class="an0_1xo_x"/><path class="rf7omh2gs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-sentiment-dissatisfied" {...props}></Icon>
<style>
:global(.an0_1xo_x) {
  cx: 8.5px;
  cy: 9.5px;
