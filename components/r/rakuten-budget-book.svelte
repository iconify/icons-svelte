...
const content = `<path class="tdq-1rbyp"/><path class="i4w8zbcnr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:rakuten-budget-book" {...props}></Icon>
<style>
:global(.i4w8zbcnr) {
  fill: none;
  stroke: currentColor;
