...
const content = `<path class="hxfwwt9-h"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:russian-railway-passengers" {...props}></Icon>
<style>
:global(.hxfwwt9-h) {
  fill: none;
  stroke: currentColor;
