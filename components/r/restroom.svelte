...
const content = `<circle class="bgatx5byk"/><path class="cyhgp7ttu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione:restroom" {...props}></Icon>
<style>
:global(.bgatx5byk) {
  cx: 32px;
  cy: 32px;
