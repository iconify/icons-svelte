...
const content = `<circle class="ymsmxbbjn"/><path class="l7d0m6oan"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:reminder-pro" {...props}></Icon>
<style>
:global(.l7d0m6oan) {
  fill: none;
  stroke: currentColor;
