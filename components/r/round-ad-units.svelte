...
const content = `<path class="ijscneb5v"/><path class="sdaqhjbwe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-ad-units" {...props}></Icon>
<style>
:global(.ijscneb5v) {
  fill: currentColor;
