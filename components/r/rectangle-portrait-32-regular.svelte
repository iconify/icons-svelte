...
const content = `<path class="fa_3chbbr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:rectangle-portrait-32-regular" {...props}></Icon>
<style>
:global(.fa_3chbbr) {
  fill: currentColor;
