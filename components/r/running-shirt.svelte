...
const content = `<path class="a4cwevgfi"/><path class="mtuv_-rwz"/><path class="u3v_qjblv"/><path class="y-20f5bpf"/><path class="dnzhfqbqg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto:running-shirt" {...props}></Icon>
<style>
:global(.a4cwevgfi) {
