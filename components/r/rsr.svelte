...
const content = `<path clip-rule="evenodd" class="bic4nxb5d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:rsr" {...props}></Icon>
<style>
:global(.bic4nxb5d) {
