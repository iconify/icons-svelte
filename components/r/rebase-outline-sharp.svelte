...
const content = `<path class="v924spb8u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:rebase-outline-sharp" {...props}></Icon>
<style>
:global(.v924spb8u) {
  fill: currentColor;
