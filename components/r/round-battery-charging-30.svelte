...
const content = `<path class="saedzwcuy"/><path class="wdec4xb5v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-battery-charging-30" {...props}></Icon>
<style>
:global(.saedzwcuy) {
  fill: currentColor;
