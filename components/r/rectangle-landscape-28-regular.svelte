...
const content = `<path class="bxuwnrbxj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:rectangle-landscape-28-regular" {...props}></Icon>
<style>
:global(.bxuwnrbxj) {
  fill: currentColor;
