...
const content = `<path class="rp37qvbds"/><circle class="su3kdjb3z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:round-sports-martial-arts" {...props}></Icon>
<style>
:global(.rp37qvbds) {
  fill: currentColor;
