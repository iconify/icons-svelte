...
const content = `<circle class="cpk0fnbgt"/><path class="jhjiipb7u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:radisson-hotels" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
