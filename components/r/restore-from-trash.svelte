...
const content = `<path class="dj7bd5cyx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:restore-from-trash" {...props}></Icon>
<style>
:global(.dj7bd5cyx) {
  fill: currentColor;
