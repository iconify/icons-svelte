...
const content = `<path class="ol3fcyb3h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:railway-alert-outline-rounded" {...props}></Icon>
<style>
:global(.ol3fcyb3h) {
  fill: currentColor;
