...
const content = `<path class="d7cinenrr"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:qobuz-alt" {...props}></Icon>
<style>
:global(.d7cinenrr) {
  fill: none;
  stroke: currentColor;
