...
const content = `<rect class="j3s9ivbxi"/><path class="k9qilfq4d"/><circle class="bazrd6r_s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:quizizz" {...props}></Icon>
<style>
:global(.bazrd6r_s) {
  cx: 33.83px;
  cy: 31.348px;
