...
const content = `<path class="o3yvlublj"/><path class="i6ittvbqb"/><path class="fozqmbbmk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:qnb-finansbank" {...props}></Icon>
<style>
:global(.fozqmbbmk) {
  fill: none;
  stroke: currentColor;
