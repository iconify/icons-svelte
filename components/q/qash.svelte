...
const content = `<g class="oihi3-0ya"><path class="bj-1h2r_m"/><path clip-rule="evenodd" class="eeoy6wece"/><path class="pguiu0b7m"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:qash" {...props}></Icon>
<style>
:global(.bj-1h2r_m) {
