...
const content = `<g class="cuyn6tgcc"><path class="e5rjrxept"/><path class="qr1nbh0hk"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:quotes-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
