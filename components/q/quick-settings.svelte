...
const content = `<path class="ivkffdcvn"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:quick-settings" {...props}></Icon>
<style>
:global(.ivkffdcvn) {
  fill: none;
  stroke: currentColor;
