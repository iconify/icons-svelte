...
const content = `<g class="n1lsf0bnc"><path class="xsfn84bsi"/><ellipse class="n910ocbpr"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:question-mark" {...props}></Icon>
<style>
:global(.n1lsf0bnc) {
  fill: currentColor;
  fill-rule: evenodd;
