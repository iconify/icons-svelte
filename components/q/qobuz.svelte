...
const content = `<path class="lyvtvlboq"/><circle class="e-kpfd57i"/><path class="dfshu4big"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:qobuz" {...props}></Icon>
<style>
:global(.dfshu4big) {
  fill: none;
  stroke: currentColor;
