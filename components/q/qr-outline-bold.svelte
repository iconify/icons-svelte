...
const content = `<g class="s0phu2bbs"><path class="dngdujbqm"/><path class="nc3tobbpg"/><path class="pdc4gobyf"/><path class="j2hnp9b4t"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:qr-outline-bold" {...props}></Icon>
<style>
:global(.dngdujbqm) {
