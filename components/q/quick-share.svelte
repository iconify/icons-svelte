...
const content = `<path class="k7r71z2lo"/><path class="h7fuim3pz"/><path class="kdl5xr1nf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:quick-share" {...props}></Icon>
<style>
:global(.h7fuim3pz) {
  fill: none;
  stroke: currentColor;
