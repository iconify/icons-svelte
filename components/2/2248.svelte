...
const content = `<rect class="qy8a8dzsd"/><rect class="ieznx5rfm"/><rect class="cm_xiujcg"/><rect class="n7959htri"/><path class="h2jxpc_0j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:2248" {...props}></Icon>
<style>
:global(.cm_xiujcg) {
  width: 18.5px;
  height: 18.5px;
