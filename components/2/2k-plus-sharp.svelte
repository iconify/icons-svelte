...
const content = `<path class="c2qudgb9q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:2k-plus-sharp" {...props}></Icon>
<style>
:global(.c2qudgb9q) {
  fill: currentColor;
