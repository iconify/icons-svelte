...
const content = `<path class="b56bih3bq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:2k-outline-sharp" {...props}></Icon>
<style>
:global(.b56bih3bq) {
  fill: currentColor;
