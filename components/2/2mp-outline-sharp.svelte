...
const content = `<path class="na_k5v7cb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:2mp-outline-sharp" {...props}></Icon>
<style>
:global(.na_k5v7cb) {
  fill: currentColor;
