...
const content = `<path class="toteye1lm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:22mp-outline-rounded" {...props}></Icon>
<style>
:global(.toteye1lm) {
  fill: currentColor;
