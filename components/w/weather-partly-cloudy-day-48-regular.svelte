...
const content = `<path class="ipp_z9fuy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:weather-partly-cloudy-day-48-regular" {...props}></Icon>
<style>
:global(.ipp_z9fuy) {
  fill: currentColor;
