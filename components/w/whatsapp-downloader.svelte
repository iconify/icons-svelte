...
const content = `<path class="uvixfrc4b"/><path class="s3i65fbrt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:whatsapp-downloader" {...props}></Icon>
<style>
:global(.s3i65fbrt) {
  fill: none;
  stroke: currentColor;
