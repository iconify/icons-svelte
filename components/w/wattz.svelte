...
const content = `<path class="o02v14bot"/><path class="r6w12sqhk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:wattz" {...props}></Icon>
<style>
:global(.o02v14bot) {
  fill: none;
  stroke: currentColor;
