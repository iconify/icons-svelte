...
const content = `<path class="aq-1w6b7c"/><path class="mjy37qbaf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:wyze" {...props}></Icon>
<style>
:global(.aq-1w6b7c) {
  fill: none;
  stroke: currentColor;
