...
const content = `<ellipse class="c38riwbjj"/><path class="fjrkz_o5i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:wifi-master" {...props}></Icon>
<style>
:global(.c38riwbjj) {
  cx: 23.144px;
  cy: 34.192px;
