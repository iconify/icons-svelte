...
const content = `<path class="o0qzs8b8b"/><path class="lk_ofhc7o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:white-haired" {...props}></Icon>
<style>
:global(.lk_ofhc7o) {
