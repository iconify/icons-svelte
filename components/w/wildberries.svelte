...
const content = `<path class="f7b-77l6g"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:wildberries" {...props}></Icon>
<style>
:global(.f7b-77l6g) {
  fill: none;
  stroke: currentColor;
