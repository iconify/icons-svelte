...
const content = `<path class="zu__41y8y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:weather-snowflake-48-filled" {...props}></Icon>
<style>
:global(.zu__41y8y) {
  fill: currentColor;
