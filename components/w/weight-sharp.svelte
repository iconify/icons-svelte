...
const content = `<path class="e1078ebcv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:weight-sharp" {...props}></Icon>
<style>
:global(.e1078ebcv) {
  fill: currentColor;
