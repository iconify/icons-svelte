...
const content = `<path class="rl53icbth"/><path class="pt3rbpbhz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:whm" {...props}></Icon>
<style>
:global(.pt3rbpbhz) {
  fill: none;
  stroke: currentColor;
