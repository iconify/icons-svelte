...
const content = `<g class="ft5dv1b6b"><path class="qtz4vobwn"/><path class="zayvkm-ap"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:wallet-3" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
