...
const content = `<g class="cuyn6tgcc"><path class="f7maylbtg"/><path class="fistrqrmp"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:wifi-medium-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
