...
const content = `<path class="t7ndo8bua"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:weather-humidity-16-regular" {...props}></Icon>
<style>
:global(.t7ndo8bua) {
  fill: currentColor;
