...
const content = `<path class="tqy4f6blt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:window-sensor-outline-rounded" {...props}></Icon>
<style>
:global(.tqy4f6blt) {
  fill: currentColor;
