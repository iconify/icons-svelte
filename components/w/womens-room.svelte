...
const content = `<circle class="qm7pesb5s"/><path class="nj1ra4hnw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione:womens-room" {...props}></Icon>
<style>
:global(.nj1ra4hnw) {
