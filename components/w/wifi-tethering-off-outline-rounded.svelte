...
const content = `<path class="airlv_bjx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:wifi-tethering-off-outline-rounded" {...props}></Icon>
<style>
:global(.airlv_bjx) {
  fill: currentColor;
