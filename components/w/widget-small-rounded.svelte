...
const content = `<path class="d-b68qtug"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:widget-small-rounded" {...props}></Icon>
<style>
:global(.d-b68qtug) {
  fill: currentColor;
