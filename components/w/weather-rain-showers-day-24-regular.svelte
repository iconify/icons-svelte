...
const content = `<path class="fmhfbgb7y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:weather-rain-showers-day-24-regular" {...props}></Icon>
<style>
:global(.fmhfbgb7y) {
  fill: currentColor;
