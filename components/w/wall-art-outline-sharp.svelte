...
const content = `<path class="k7bo6ri7k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:wall-art-outline-sharp" {...props}></Icon>
<style>
:global(.k7bo6ri7k) {
  fill: currentColor;
