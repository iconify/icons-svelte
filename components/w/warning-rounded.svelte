...
const content = `<path class="q_qnh9p1s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:warning-rounded" {...props}></Icon>
<style>
:global(.q_qnh9p1s) {
  fill: currentColor;
