...
const content = `<circle class="k6_0lbdph"/><path class="a56mlhbab"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:walli" {...props}></Icon>
<style>
:global(.a56mlhbab) {
  fill: none;
  stroke: currentColor;
