...
const content = `<g class="cuyn6tgcc"><path class="rfnq94b5c"/><path class="wnae0myhe"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:warning-diamond-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
