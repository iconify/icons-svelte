...
const content = `<path class="z4u1xcb3z"/><path class="azk3aacae"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:wiz-v2" {...props}></Icon>
<style>
:global(.azk3aacae) {
  fill: none;
  stroke: currentColor;
