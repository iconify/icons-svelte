...
const content = `<path class="a0ekw-bss"/><path class="ps-0dvqzj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:wifiprivacy" {...props}></Icon>
<style>
:global(.a0ekw-bss) {
  fill: none;
  stroke: currentColor;
