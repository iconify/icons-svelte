...
const content = `<path class="b57zwgb2i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:window-column-one-fourth-left-focus-top-20-filled" {...props}></Icon>
<style>
:global(.b57zwgb2i) {
  fill: currentColor;
