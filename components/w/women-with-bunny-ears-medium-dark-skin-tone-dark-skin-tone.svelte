...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="openmoji:women-with-bunny-ears-medium-dark-skin-tone-dark-skin-tone" {...props}></Icon>
