...
const content = `<path class="bjgka0ble"/><path class="krw_26buu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:weechat" {...props}></Icon>
<style>
:global(.bjgka0ble) {
  fill: none;
  stroke: currentColor;
