...
const content = `<path class="a7hynv3sw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:watch-vibration-outline-rounded" {...props}></Icon>
<style>
:global(.a7hynv3sw) {
  fill: currentColor;
