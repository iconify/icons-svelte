...
const content = `<path class="w4mozhb4g"/><path class="kx5_bsvkh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:webnovel" {...props}></Icon>
<style>
:global(.kx5_bsvkh) {
  fill: none;
  stroke: currentColor;
