...
const content = `<path class="d544jwb8b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:wheat-rounded" {...props}></Icon>
<style>
:global(.d544jwb8b) {
  fill: currentColor;
