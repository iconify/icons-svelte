...
const content = `<path class="u_ytm3g1o"/><path class="t3z2nm55w"/><path class="pws1evbsh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:womans-sandal" {...props}></Icon>
<style>
:global(.pws1evbsh) {
