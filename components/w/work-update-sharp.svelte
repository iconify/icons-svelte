...
const content = `<path class="b2d4rpb9y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:work-update-sharp" {...props}></Icon>
<style>
:global(.b2d4rpb9y) {
  fill: currentColor;
