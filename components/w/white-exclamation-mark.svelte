...
const content = `<path class="dj38i64xy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:white-exclamation-mark" {...props}></Icon>
<style>
:global(.dj38i64xy) {
  fill: currentColor;
