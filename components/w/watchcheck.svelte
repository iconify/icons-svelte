...
const content = `<circle class="l6cd208_p"/><circle class="rr907xbun"/><path class="pb_3h3b6c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:watchcheck" {...props}></Icon>
<style>
:global(.l6cd208_p) {
  cx: 24px;
  cy: 24px;
