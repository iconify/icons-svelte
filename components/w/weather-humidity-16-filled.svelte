...
const content = `<path class="dr2o35bsw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:weather-humidity-16-filled" {...props}></Icon>
<style>
:global(.dr2o35bsw) {
  fill: currentColor;
