...
const content = `<path class="g-wyb1b6d"/><path class="i9clfwm2k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:wx" {...props}></Icon>
<style>
:global(.g-wyb1b6d) {
  fill: none;
  stroke: currentColor;
