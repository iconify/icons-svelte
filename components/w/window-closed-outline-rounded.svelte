...
const content = `<path class="y--ir4bwh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:window-closed-outline-rounded" {...props}></Icon>
<style>
:global(.y--ir4bwh) {
  fill: currentColor;
