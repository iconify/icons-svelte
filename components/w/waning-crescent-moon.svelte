...
const content = `<path class="jiskflbtw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:waning-crescent-moon" {...props}></Icon>
<style>
:global(.jiskflbtw) {
  fill: currentColor;
