...
const content = `<path class="m925t9vbs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:wb-twilight-2-outline-rounded" {...props}></Icon>
<style>
:global(.m925t9vbs) {
  fill: currentColor;
