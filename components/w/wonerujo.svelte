...
const content = `<path class="qo-8tebjf"/><circle class="unndf0b4b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:wonerujo" {...props}></Icon>
<style>
:global(.qo-8tebjf) {
  fill: none;
  stroke: currentColor;
