...
const content = `<path class="uw0b0cctn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:weather-thunderstorm-48-regular" {...props}></Icon>
<style>
:global(.uw0b0cctn) {
  fill: currentColor;
