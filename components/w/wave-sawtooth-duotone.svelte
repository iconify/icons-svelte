...
const content = `<g class="cuyn6tgcc"><path class="f_1c03m3a"/><path class="ihpk138tc"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:wave-sawtooth-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
