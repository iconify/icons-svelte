...
const content = `<path class="n9dzpdb3p"/><path class="vgbd-8bnj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:walp" {...props}></Icon>
<style>
:global(.n9dzpdb3p) {
  fill: none;
  stroke: currentColor;
