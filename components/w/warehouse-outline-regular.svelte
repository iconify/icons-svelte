...
const content = `<g class="nrj6p8qat"><path class="e77gki8ci"/><path class="jr8d9xc7c"/><path class="gfzbj7b6z"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:warehouse-outline-regular" {...props}></Icon>
<style>
:global(.e77gki8ci) {
