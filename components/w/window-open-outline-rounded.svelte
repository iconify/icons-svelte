...
const content = `<path class="iooqab4ft"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:window-open-outline-rounded" {...props}></Icon>
<style>
:global(.iooqab4ft) {
  fill: currentColor;
