...
const content = `<path class="nf04p9bnl"/><path class="qil8x6a3g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:white-square-button" {...props}></Icon>
<style>
:global(.nf04p9bnl) {
