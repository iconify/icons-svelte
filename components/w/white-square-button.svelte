...
const content = `<path class="anjk6vp9h"/><path class="ywl6mzbvx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-v1:white-square-button" {...props}></Icon>
<style>
:global(.anjk6vp9h) {
