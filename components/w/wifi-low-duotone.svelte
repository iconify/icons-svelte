...
const content = `<g class="cuyn6tgcc"><path class="vwaq_1b8y"/><path class="k21wg3vnj"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:wifi-low-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
