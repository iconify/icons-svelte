...
const content = `<path class="ox9d30b6o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:wallpaper-slideshow-outline-rounded" {...props}></Icon>
<style>
:global(.ox9d30b6o) {
  fill: currentColor;
