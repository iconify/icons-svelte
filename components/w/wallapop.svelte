...
const content = `<path class="ryo6sk8sf"/><path class="pjt4e4gom"/><path class="i-mhd5brq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:wallapop" {...props}></Icon>
<style>
:global(.i-mhd5brq) {
  fill: none;
  stroke: currentColor;
