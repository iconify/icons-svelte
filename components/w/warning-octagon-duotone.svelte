...
const content = `<g class="cuyn6tgcc"><path class="sz04-kb9c"/><path class="ppei2-bdz"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:warning-octagon-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
