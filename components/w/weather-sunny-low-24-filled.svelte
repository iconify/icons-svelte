...
const content = `<path class="n36w9gwvv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:weather-sunny-low-24-filled" {...props}></Icon>
<style>
:global(.n36w9gwvv) {
  fill: currentColor;
