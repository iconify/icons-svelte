...
const content = `<path clip-rule="evenodd" class="vpdg-m3pr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:wnxm" {...props}></Icon>
<style>
:global(.vpdg-m3pr) {
