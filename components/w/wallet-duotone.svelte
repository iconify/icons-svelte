...
const content = `<g class="cuyn6tgcc"><path class="x-35p0bti"/><path class="k3qla2b8y"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:wallet-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
