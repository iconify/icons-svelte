...
const content = `<path class="n2_tg_ent"/><path class="zg2602bba"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:waiputv" {...props}></Icon>
<style>
:global(.n2_tg_ent) {
  fill: none;
  stroke: currentColor;
