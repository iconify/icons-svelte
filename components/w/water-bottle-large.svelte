...
const content = `<path class="rfrqrxbut"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:water-bottle-large" {...props}></Icon>
<style>
:global(.rfrqrxbut) {
  fill: currentColor;
