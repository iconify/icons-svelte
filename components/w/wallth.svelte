...
const content = `<path class="evt5dacue"/><path class="qhjym7y1b"/><path class="ruh9b3wzi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:wallth" {...props}></Icon>
<style>
:global(.evt5dacue) {
  fill: none;
  stroke: currentColor;
