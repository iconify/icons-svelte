...
const content = `<rect transform="rotate(-45 24 24)" class="bma4tqtkq"/><path class="aa7tjib5b"/><rect class="jhy659bcz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:word-search" {...props}></Icon>
<style>
:global(.aa7tjib5b) {
  fill: none;
  stroke: currentColor;
