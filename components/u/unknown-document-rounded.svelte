...
const content = `<path class="h1cm9yanw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:unknown-document-rounded" {...props}></Icon>
<style>
:global(.h1cm9yanw) {
  fill: currentColor;
