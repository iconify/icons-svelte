...
const content = `<g class="cuyn6tgcc"><path class="vu-xkxsfg"/><path class="dfzkxi56c"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:unite-square-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
