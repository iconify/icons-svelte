...
const content = `<g class="cuyn6tgcc"><path class="erewjjzdk"/><path class="pweevdm9z"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:user-circle-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
