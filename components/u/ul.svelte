...
const content = `<path class="iw6b3io2g"/><path class="eywf4ljxn"/><circle class="jjfinzbny"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ul" {...props}></Icon>
<style>
:global(.eywf4ljxn) {
  fill: none;
  stroke: currentColor;
