...
const content = `<path class="d8b5u8b2h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:unknown-document-outline-rounded" {...props}></Icon>
<style>
:global(.d8b5u8b2h) {
  fill: currentColor;
