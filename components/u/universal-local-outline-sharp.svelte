...
const content = `<path class="xfz-79w3n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:universal-local-outline-sharp" {...props}></Icon>
<style>
:global(.xfz-79w3n) {
  fill: currentColor;
