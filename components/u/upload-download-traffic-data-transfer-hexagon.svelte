...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline-cyber-color:upload-download-traffic-data-transfer-hexagon" {...props}></Icon>
