...
const content = `<path class="uzfkh3eza"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:urology-outline" {...props}></Icon>
<style>
:global(.uzfkh3eza) {
  fill: currentColor;
