...
const content = `<path class="kwc-w7bqw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:urology-rounded" {...props}></Icon>
<style>
:global(.kwc-w7bqw) {
  fill: currentColor;
