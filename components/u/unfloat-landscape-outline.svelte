...
const content = `<path class="rr-9qozlo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:unfloat-landscape-outline" {...props}></Icon>
<style>
:global(.rr-9qozlo) {
  fill: currentColor;
