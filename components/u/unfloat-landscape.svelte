...
const content = `<path class="bgub7db-p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:unfloat-landscape" {...props}></Icon>
<style>
:global(.bgub7db-p) {
  fill: currentColor;
