...
const content = `<path class="i9clfwm2k"/><path class="i6q9o78ed"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:urban-company" {...props}></Icon>
<style>
:global(.i6q9o78ed) {
  fill: none;
  stroke: currentColor;
