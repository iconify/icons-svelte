...
const content = `<path class="cfx1vlbcq"/><path class="xp6yr-5ia"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:unitv" {...props}></Icon>
<style>
:global(.cfx1vlbcq) {
  fill: none;
  stroke: currentColor;
