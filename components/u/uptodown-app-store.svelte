...
const content = `<path class="d5j_obc0p"/><path class="cozznacza"/><path class="dbiwf2acp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:uptodown-app-store" {...props}></Icon>
<style>
:global(.cozznacza) {
  fill: none;
  stroke: currentColor;
