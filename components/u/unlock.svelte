...
const content = `<path class="lmloc1fyb"/><circle class="e0avqs3gr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:unlock" {...props}></Icon>
<style>
:global(.e0avqs3gr) {
  cx: 23.992px;
  cy: 31.554px;
