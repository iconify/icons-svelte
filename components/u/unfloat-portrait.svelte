...
const content = `<path class="jp3z59ejt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:unfloat-portrait" {...props}></Icon>
<style>
:global(.jp3z59ejt) {
  fill: currentColor;
