...
const content = `<path class="o8c4onbwa"/><path class="u8b-x2b7j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ukg-ready" {...props}></Icon>
<style>
:global(.o8c4onbwa) {
  fill: none;
  stroke: currentColor;
