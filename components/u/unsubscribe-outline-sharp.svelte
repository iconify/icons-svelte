...
const content = `<path class="qo3lg3b9d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:unsubscribe-outline-sharp" {...props}></Icon>
<style>
:global(.qo3lg3b9d) {
  fill: currentColor;
