...
const content = `<path class="szqu4ibwh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:upi-pay-outline-sharp" {...props}></Icon>
<style>
:global(.szqu4ibwh) {
  fill: currentColor;
