...
const content = `<path class="r4kl-cc5o"/><circle class="nqc7ndjui"/><path class="g2wj9jbhp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:uala" {...props}></Icon>
<style>
:global(.g2wj9jbhp) {
  fill: none;
  stroke: currentColor;
