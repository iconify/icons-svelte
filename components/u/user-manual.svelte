...
const content = `<path class="o707_xbjc"/><ellipse class="ddtuthbsi"/><path class="mj8t2sbyw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:user-manual" {...props}></Icon>
<style>
:global(.ddtuthbsi) {
  cx: 25.531px;
  cy: 33.668px;
