...
const content = `<ellipse class="tcn_94byt"/><path class="eproapr6m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:unab" {...props}></Icon>
<style>
:global(.eproapr6m) {
  fill: none;
  stroke: currentColor;
