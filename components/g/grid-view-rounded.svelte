...
const content = `<path class="f5jpchb1h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:grid-view-rounded" {...props}></Icon>
<style>
:global(.f5jpchb1h) {
  fill: currentColor;
