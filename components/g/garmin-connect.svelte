...
const content = `<path class="s15gkwbmm"/><circle class="c8c-a65gx"/><path class="e0bq4ty8h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:garmin-connect" {...props}></Icon>
<style>
:global(.c8c-a65gx) {
  cx: 9.5px;
  cy: 9.433px;
