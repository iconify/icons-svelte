...
const content = `<path class="ay1xvbcfq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:general-device-rounded" {...props}></Icon>
<style>
:global(.ay1xvbcfq) {
  fill: currentColor;
