...
const content = `<path class="srctq433q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:glance-horizontal-sparkles-24-regular" {...props}></Icon>
<style>
:global(.srctq433q) {
  fill: currentColor;
