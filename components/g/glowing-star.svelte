...
const content = `<path class="ucudjabue"/><path class="orb3ktbqz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:glowing-star" {...props}></Icon>
<style>
:global(.orb3ktbqz) {
