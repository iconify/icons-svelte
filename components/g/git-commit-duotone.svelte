...
const content = `<g class="cuyn6tgcc"><path class="hocvxubud"/><path class="musdk_b8a"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:git-commit-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
