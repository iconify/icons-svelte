...
const content = `<g class="cuyn6tgcc"><path class="t9ive9nng"/><path class="vs9_nqxys"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:gear-six-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
