...
const content = `<g class="cuyn6tgcc"><path class="z7jh16tru"/><path class="eb0-jrb4u"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:git-fork-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
