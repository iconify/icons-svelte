...
const content = `<path class="dslwa_brv"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:gh-drivers" {...props}></Icon>
<style>
:global(.dslwa_brv) {
  fill: none;
  stroke: currentColor;
