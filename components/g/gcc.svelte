...
const content = `<path class="f4tndo65j"/><circle class="n49fgtbiw"/><path class="m6w8_dgkj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:gcc" {...props}></Icon>
<style>
:global(.f4tndo65j) {
  fill: none;
  stroke: currentColor;
