...
const content = `<path class="zg6wy8b6o"/><path class="smzzc3gep"/><path class="eco_o5bqm"/><circle class="qj1atcbnp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:google-tag-manager" {...props}></Icon>
<style>
:global(.eco_o5bqm) {
