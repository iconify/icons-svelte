...
const content = `<path class="c3cbbpb2c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:gradient-outline-sharp" {...props}></Icon>
<style>
:global(.c3cbbpb2c) {
  fill: currentColor;
