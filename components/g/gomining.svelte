...
const content = `<path class="cwu3zabwn"/><path class="z985_ebil"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:gomining" {...props}></Icon>
<style>
:global(.cwu3zabwn) {
  fill: none;
  stroke: currentColor;
