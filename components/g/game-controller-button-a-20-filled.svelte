...
const content = `<path class="smqvw0tbv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:game-controller-button-a-20-filled" {...props}></Icon>
<style>
:global(.smqvw0tbv) {
  fill: currentColor;
