...
const content = `<g class="cuyn6tgcc"><path class="b5en88b-p"/><path class="qqtoxtt2f"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:gps-duotone" {...props}></Icon>
<style>
:global(.b5en88b-p) {
