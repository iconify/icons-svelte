...
const content = `<g class="gp_8x1bzb"><path class="x_imrmb6u"/><path class="duuhr1boc"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:git-refresh-sharp-fill" {...props}></Icon>
<style>
:global(.duuhr1boc) {
  fill: currentColor;
