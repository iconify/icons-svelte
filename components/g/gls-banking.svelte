...
const content = `<path class="i_jf7mnwu"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:gls-banking" {...props}></Icon>
<style>
:global(.i_jf7mnwu) {
  fill: none;
  stroke: currentColor;
