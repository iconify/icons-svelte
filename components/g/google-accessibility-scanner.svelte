...
const content = `<path class="br_t-3bcp"/><path class="bzyf0rinb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:google-accessibility-scanner" {...props}></Icon>
<style>
:global(.br_t-3bcp) {
  fill: none;
  stroke: currentColor;
