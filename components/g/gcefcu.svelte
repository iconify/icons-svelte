...
const content = `<circle class="cpk0fnbgt"/><path class="kmkm8rb6q"/><circle class="qr2izdbms"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:gcefcu" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
