...
const content = `<path class="ymbb50waj"/><path class="e4qtth3dx"/><path class="f57guc38g"/><path class="tvo6zqqty"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto:gear" {...props}></Icon>
<style>
:global(.e4qtth3dx) {
