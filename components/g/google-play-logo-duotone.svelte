...
const content = `<g class="cuyn6tgcc"><path class="vtjmi6vih"/><path class="ngxw9yb4h"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:google-play-logo-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
