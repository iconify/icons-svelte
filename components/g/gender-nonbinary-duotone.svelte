...
const content = `<g class="cuyn6tgcc"><path class="d2iqf0bkm"/><path class="wirltez2f"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:gender-nonbinary-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
