...
const content = `<g class="cuyn6tgcc"><path class="sa1-ijbgc"/><path class="g-c9tbcwj"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:google-podcasts-logo-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
