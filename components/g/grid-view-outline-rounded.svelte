...
const content = `<path class="m-bsjqqyw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:grid-view-outline-rounded" {...props}></Icon>
<style>
:global(.m-bsjqqyw) {
  fill: currentColor;
