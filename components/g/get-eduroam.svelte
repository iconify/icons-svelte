...
const content = `<path class="dv3f3f-ja"/><path class="sip3msb4n"/><path class="ue-vqvvgs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:get-eduroam" {...props}></Icon>
<style>
:global(.dv3f3f-ja) {
  fill: none;
  stroke: currentColor;
