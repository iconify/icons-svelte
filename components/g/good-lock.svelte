...
const content = `<path class="ot61p6b2v"/><path class="aeyj5hbyg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:good-lock" {...props}></Icon>
<style>
:global(.aeyj5hbyg) {
  fill: none;
  stroke: currentColor;
