...
const content = `<path class="pk8ez2szh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:grid-on-sharp" {...props}></Icon>
<style>
:global(.pk8ez2szh) {
  fill: currentColor;
