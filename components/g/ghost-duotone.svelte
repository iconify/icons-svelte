...
const content = `<g class="cuyn6tgcc"><path class="wywhu68lw"/><path class="irm2yu_8r"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:ghost-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
