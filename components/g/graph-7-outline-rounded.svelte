...
const content = `<path class="aqfiu5bkz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:graph-7-outline-rounded" {...props}></Icon>
<style>
:global(.aqfiu5bkz) {
  fill: currentColor;
