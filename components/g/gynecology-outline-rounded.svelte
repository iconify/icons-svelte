...
const content = `<path class="dfovy9bkj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:gynecology-outline-rounded" {...props}></Icon>
<style>
:global(.dfovy9bkj) {
  fill: currentColor;
