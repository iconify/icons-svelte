...
const content = `<g class="cuyn6tgcc"><path class="v0oc5-bka"/><path class="o2h9qa1og"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:google-cardboard-logo-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
