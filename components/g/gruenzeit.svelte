...
const content = `<path class="mprj_rbvu"/><path class="b6-3sgc-z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:gruenzeit" {...props}></Icon>
<style>
:global(.b6-3sgc-z) {
  fill: none;
  stroke: currentColor;
