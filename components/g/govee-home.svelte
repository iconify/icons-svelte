...
const content = `<path class="a1ra9wdwn"/><circle class="qvld11nnw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:govee-home" {...props}></Icon>
<style>
:global(.a1ra9wdwn) {
  fill: none;
  stroke: currentColor;
