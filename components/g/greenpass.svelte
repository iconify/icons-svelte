...
const content = `<circle class="rh3on3bki"/><path class="bk-ghe5uh"/><path class="m-ziipbfq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:greenpass" {...props}></Icon>
<style>
:global(.bk-ghe5uh) {
  fill: none;
  stroke: currentColor;
