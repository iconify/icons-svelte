...
const content = `<path class="hlzdh5bnl"/><path class="l--83c_hl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:giphy" {...props}></Icon>
<style>
:global(.hlzdh5bnl) {
  fill: none;
  stroke: currentColor;
