...
const content = `<path class="hj0hggnop"/><path class="dl4qm6a2g"/><circle class="l06vbrlyb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:greaderpro" {...props}></Icon>
<style>
:global(.dl4qm6a2g) {
  fill: none;
  stroke: currentColor;
