...
const content = `<path clip-rule="evenodd" class="elqhvcgnq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:grid-2x3-fill" {...props}></Icon>
<style>
:global(.elqhvcgnq) {
  fill: currentColor;
  fill-rule: evenodd;
