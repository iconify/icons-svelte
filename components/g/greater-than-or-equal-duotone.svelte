...
const content = `<g class="cuyn6tgcc"><path class="qryme2b9c"/><path class="azttkhd5p"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:greater-than-or-equal-duotone" {...props}></Icon>
<style>
:global(.azttkhd5p) {
