...
const content = `<mask id="ipSGobletOne0"><g class="ft5dv1b6b"><g clip-path="url(#ipSGobletOne1)" class="a4i2bbc8w"><path class="l9up7cgwq"/><path class="tbtmy19aj"/><ellipse transform="rotate(-45 14 14)" class="x3o8e895h"/><ellipse transform="rotate(-45 38 38)" class="bl4gd2e5a"/></g><defs><clipPath id="ipSGobletOne1"><path class="v0m5xdb6q"/></clipPath></defs></g></mask><path mask="url(#ipSGobletOne0)" class="bl95smbeo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="icon-park-solid:goblet-one" {...props}></Icon>
