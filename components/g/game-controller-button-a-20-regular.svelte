...
const content = `<path class="i12gxccgb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:game-controller-button-a-20-regular" {...props}></Icon>
<style>
:global(.i12gxccgb) {
  fill: currentColor;
