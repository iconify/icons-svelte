...
const content = `<path class="una6_bc7o"/><path class="fedimeb6c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:gouvcheck" {...props}></Icon>
<style>
:global(.fedimeb6c) {
  fill: none;
  stroke: currentColor;
