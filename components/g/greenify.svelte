...
const content = `<path class="ieq_ms4qu"/><path class="w9vkvebrw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:greenify" {...props}></Icon>
<style>
:global(.ieq_ms4qu) {
  fill: none;
  stroke: currentColor;
