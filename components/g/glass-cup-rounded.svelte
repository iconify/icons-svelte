...
const content = `<path class="du2wotb0v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:glass-cup-rounded" {...props}></Icon>
<style>
:global(.du2wotb0v) {
  fill: currentColor;
