...
const content = `<path class="vxqt6j_pk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:glass-cup-outline" {...props}></Icon>
<style>
:global(.vxqt6j_pk) {
  fill: currentColor;
