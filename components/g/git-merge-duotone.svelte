...
const content = `<g class="cuyn6tgcc"><path class="oc6btbc2m"/><path class="tym2560jc"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:git-merge-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
