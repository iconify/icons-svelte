...
const content = `<path class="sin2o3-ud"/><path class="mn-lf3bbr"/><ellipse class="o8eqntbty"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:google-ads" {...props}></Icon>
<style>
:global(.mn-lf3bbr) {
