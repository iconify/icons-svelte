...
const content = `<path class="r4h1y5b9l"/><path class="hgdtb5boj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:google-keep-alt" {...props}></Icon>
<style>
:global(.hgdtb5boj) {
  fill: none;
  stroke: currentColor;
