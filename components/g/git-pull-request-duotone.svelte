...
const content = `<g class="cuyn6tgcc"><path class="jpkkcubpb"/><path class="dtszc2wtf"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:git-pull-request-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
