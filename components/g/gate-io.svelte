...
const content = `<g class="ft5dv1b6b"><path class="r7dgjpwoc"/><path class="ihxun8b5f"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:gate-io" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
