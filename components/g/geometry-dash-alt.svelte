...
const content = `<path class="hjsq5-bmv"/><path class="ybm6tc1eu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:geometry-dash-alt" {...props}></Icon>
<style>
:global(.hjsq5-bmv) {
  fill: none;
  stroke: currentColor;
