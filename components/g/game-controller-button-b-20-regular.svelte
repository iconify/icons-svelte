...
const content = `<path class="aw8q1b6_f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:game-controller-button-b-20-regular" {...props}></Icon>
<style>
:global(.aw8q1b6_f) {
  fill: currentColor;
