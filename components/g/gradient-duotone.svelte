...
const content = `<g class="cuyn6tgcc"><path class="lweh22bhv"/><path class="bdwjz89zc"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:gradient-duotone" {...props}></Icon>
<style>
:global(.bdwjz89zc) {
