...
const content = `<path class="ly5-nfbju"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:glance-horizontal-sparkle-32-regular" {...props}></Icon>
<style>
:global(.ly5-nfbju) {
  fill: currentColor;
