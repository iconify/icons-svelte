...
const content = `<rect class="j3s9ivbxi"/><path class="c3crd5bjb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:godaddy-studio" {...props}></Icon>
<style>
:global(.c3crd5bjb) {
  fill: none;
  stroke: currentColor;
