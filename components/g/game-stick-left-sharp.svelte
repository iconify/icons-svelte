...
const content = `<path class="c982v1boz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:game-stick-left-sharp" {...props}></Icon>
<style>
:global(.c982v1boz) {
  fill: currentColor;
