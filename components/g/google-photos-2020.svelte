...
const content = `<path class="kwv-sky3u"/><path class="mun7k9bos"/><path class="yqtf-wbdb"/><path class="y4m1ju25n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:google-photos-2020" {...props}></Icon>
<style>
:global(.kwv-sky3u) {
