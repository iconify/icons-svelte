...
const content = `<g class="nrj6p8qat"><path class="ikio23b7i"/><path class="mfbgkhbgh"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:git-pull-request-closed-duotone" {...props}></Icon>
<style>
:global(.ikio23b7i) {
  fill: currentColor;
