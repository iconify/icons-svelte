...
const content = `<path class="tst0wnb9n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:game-controller-button-b-20-filled" {...props}></Icon>
<style>
:global(.tst0wnb9n) {
  fill: currentColor;
