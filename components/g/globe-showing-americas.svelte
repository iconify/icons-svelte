...
const content = `<radialGradient id="SVGhIP1SrTb" cx="43.972" cy="29.066" r="90.951" gradientTransform="matrix(.6257 .78 -.5815 .4665 33.359 -18.792)" gradientUnits="userSpaceOnUse"><stop offset=".506" class="wpmpngbvi"/><stop offset=".767" class="g7p2hz6hz"/><stop offset=".962" class="xu4tyr24l"/><stop offset="1" class="hn27f9fxh"/></radialGradient><path fill="url(#SVGhIP1SrTb)" class="c-k73qv3r"/><path class="gx12swqsn"/><path class="e8w9t9x0d"/><path class="pj7k0ku3d"/><radialGradient id="SVG07HtNbsM" cx="4.93" cy="38.972" r="40.299" gradientTransform="rotate(-11.309 83.101 31.234)scale(1 .6028)" gradientUnits="userSpaceOnUse"><stop offset=".344" class="ssf_eac5w"/><stop offset=".996" class="z4vel9b5f"/></radialGradient><path fill="url(#SVG07HtNbsM)" class="jv84vcbgj"/><radialGradient id="SVG5N31hdyn" cx="42.188" cy="107.573" r="31.591" gradientUnits="userSpaceOnUse"><stop offset=".723" class="ssf_eac5w"/><stop offset="1" class="z4vel9b5f"/></radialGradient><path fill="url(#SVG5N31hdyn)" class="oasq7xb5c"/><radialGradient id="SVGecKYdbAO" cx="62.919" cy="134.216" r="22.682" gradientUnits="userSpaceOnUse"><stop offset=".403" class="ssf_eac5w"/><stop offset="1" class="z4vel9b5f"/></radialGradient><path fill="url(#SVGecKYdbAO)" class="zpce_54jt"/><path class="ofe8to8ye"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto:globe-showing-americas" {...props}></Icon>
<style>
:global(.c-k73qv3r) {
...
:global(.gx12swqsn) {
  ...
  d: path("M63.03 4.48s-.45 1.27 2.17 2.07s4.01.85 5.88 1.71c1.87.85 2.99 2.19 5.66 3.58s3.58 1.71 4.06.75c.22-.43-.69-2.35-.69-2.35s.43-1.82-.21-2.46c-.54-.54-3.52-1.75-4.59-2.18c-1-.4-4.59-.84-6.31-.95c-4.22-.26-5.97-.17-5.97-.17");
}
