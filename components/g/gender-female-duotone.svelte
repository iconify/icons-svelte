...
const content = `<g class="cuyn6tgcc"><path class="z6sapp8iw"/><path class="ku9cvcb-q"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:gender-female-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
