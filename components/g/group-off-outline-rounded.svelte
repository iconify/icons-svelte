...
const content = `<path class="m4lk493hd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:group-off-outline-rounded" {...props}></Icon>
<style>
:global(.m4lk493hd) {
  fill: currentColor;
