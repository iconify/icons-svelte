...
const content = `<g class="cuyn6tgcc"><path class="q5jsyf-yl"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:grab-handle-circle-off" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
