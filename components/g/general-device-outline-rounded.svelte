...
const content = `<path class="xjpdmtbby"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:general-device-outline-rounded" {...props}></Icon>
<style>
:global(.xjpdmtbby) {
  fill: currentColor;
