...
const content = `<path class="szxk_4b_m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:game-controller-button-y-20-filled" {...props}></Icon>
<style>
:global(.szxk_4b_m) {
  fill: currentColor;
