...
const content = `<path class="lbq1b4uwe"/><path class="p6bvpmbag"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:glitch-lab" {...props}></Icon>
<style>
:global(.lbq1b4uwe) {
  fill: none;
  stroke: currentColor;
