...
const content = `<path class="k12vj8bcb"/><path class="r1mwgkhqq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:gf-scanner" {...props}></Icon>
<style>
:global(.k12vj8bcb) {
  fill: none;
  stroke: currentColor;
