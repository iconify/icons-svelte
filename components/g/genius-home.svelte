...
const content = `<path class="jd30kzb4d"/><path class="enu2os6mz"/><path class="oy1at9bux"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:genius-home" {...props}></Icon>
<style>
:global(.enu2os6mz) {
  fill: none;
  stroke: currentColor;
