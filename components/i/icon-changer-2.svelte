...
const content = `<path class="wj5jh2bfj"/><path class="crtpp2b8c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:icon-changer-2" {...props}></Icon>
<style>
:global(.crtpp2b8c) {
  fill: none;
  stroke: currentColor;
