...
const content = `<path class="q_zerwb7i"/><path class="mbnnlvbuv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:incharge" {...props}></Icon>
<style>
:global(.mbnnlvbuv) {
  fill: none;
  stroke: currentColor;
