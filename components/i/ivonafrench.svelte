...
const content = `<path class="gwiga8bef"/><circle class="smomcxbck"/><path class="wub75ebwi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ivonafrench" {...props}></Icon>
<style>
:global(.gwiga8bef) {
  fill: none;
  stroke: currentColor;
