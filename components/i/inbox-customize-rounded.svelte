...
const content = `<path class="qw3sqznmm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:inbox-customize-rounded" {...props}></Icon>
<style>
:global(.qw3sqznmm) {
  fill: currentColor;
