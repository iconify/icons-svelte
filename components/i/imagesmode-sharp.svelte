...
const content = `<path class="pg625ob2u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:imagesmode-sharp" {...props}></Icon>
<style>
:global(.pg625ob2u) {
  fill: currentColor;
