...
const content = `<path class="kwp9qzk7x"/><path class="kyv34hvrz"/><path class="irwaa-gat"/><path class="z8s-cbcjc"/><path transform="rotate(134.999 347.405 341.317)" class="l207muwix"/><path transform="rotate(134.999 170.67 164.582)" class="h1eaah13l"/><path transform="rotate(45.001 347.406 164.562)" class="lditbo9ix"/><path transform="rotate(45.009 170.67 341.27)" class="kb9dgq7bv"/><path class="b4vep7srq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ion:ios-sunny-outline" {...props}></Icon>
