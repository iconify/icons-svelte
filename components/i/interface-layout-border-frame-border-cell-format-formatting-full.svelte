...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline:interface-layout-border-frame-border-cell-format-formatting-full" {...props}></Icon>
