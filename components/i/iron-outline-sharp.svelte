...
const content = `<path class="swb-7yaqg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:iron-outline-sharp" {...props}></Icon>
<style>
:global(.swb-7yaqg) {
  fill: currentColor;
