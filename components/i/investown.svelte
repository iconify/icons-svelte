...
const content = `<path class="x9qq5tb_v"/><path class="r8bdnu2rh"/><path class="b7s7gxbaz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:investown" {...props}></Icon>
<style>
:global(.b7s7gxbaz) {
  fill: none;
  stroke: currentColor;
