...
const content = `<path class="pg1hbdb2y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:iframe-outline-rounded" {...props}></Icon>
<style>
:global(.pg1hbdb2y) {
  fill: currentColor;
