...
const content = `<g class="cuyn6tgcc"><path class="g8olfbbww"/><path class="yyv8yb0kl"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:infinity-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
