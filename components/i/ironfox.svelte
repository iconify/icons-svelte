...
const content = `<path class="towxurb4q"/><path class="lu6u-kvte"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ironfox" {...props}></Icon>
<style>
:global(.lu6u-kvte) {
  fill: none;
  stroke: currentColor;
