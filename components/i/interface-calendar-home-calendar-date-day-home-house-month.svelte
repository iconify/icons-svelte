...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline:interface-calendar-home-calendar-date-day-home-house-month" {...props}></Icon>
