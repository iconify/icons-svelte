...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline:interface-edit-cut-coupon-cut-discount-price-prices-scissors" {...props}></Icon>
