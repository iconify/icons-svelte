...
const content = `<path class="hzpqnlmob"/><path class="msycuzbnc"/><circle class="stc1_f3um"/><path class="qzy3-t8hf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:inventory" {...props}></Icon>
<style>
:global(.hzpqnlmob) {
  fill: none;
  stroke: currentColor;
