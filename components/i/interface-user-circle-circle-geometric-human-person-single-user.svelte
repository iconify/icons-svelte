...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline:interface-user-circle-circle-geometric-human-person-single-user" {...props}></Icon>
