...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline:interface-home-5-door-entrance-home-house-map-roof-round-window" {...props}></Icon>
