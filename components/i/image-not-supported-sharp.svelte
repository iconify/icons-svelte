...
const content = `<path class="es2s7mbhu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:image-not-supported-sharp" {...props}></Icon>
<style>
:global(.es2s7mbhu) {
  fill: currentColor;
