...
const content = `<path class="qe2d1lhtt"/><path class="nu-bbtm7q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:iptv-pro" {...props}></Icon>
<style>
:global(.nu-bbtm7q) {
  fill: none;
  stroke: currentColor;
