...
const content = `<path class="xoefvzb2r"/><path class="a66ffrb2r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:indoormap" {...props}></Icon>
<style>
:global(.a66ffrb2r) {
  fill: none;
  stroke: currentColor;
