...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline:interface-login-dial-pad-finger-password-dial-pad-dot-finger" {...props}></Icon>
