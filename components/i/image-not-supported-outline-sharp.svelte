...
const content = `<path class="yfhx0dbem"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:image-not-supported-outline-sharp" {...props}></Icon>
<style>
:global(.yfhx0dbem) {
  fill: currentColor;
