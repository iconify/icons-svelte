...
const content = `<path class="kwuk5fbma"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:image-arrow-up-sharp" {...props}></Icon>
<style>
:global(.kwuk5fbma) {
  fill: currentColor;
