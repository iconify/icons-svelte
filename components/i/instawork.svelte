...
const content = `<path class="zg388nf3w"/><path class="i_dcz75ne"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:instawork" {...props}></Icon>
<style>
:global(.i_dcz75ne) {
  fill: none;
  stroke: currentColor;
