...
const content = `<path class="j4f_vyjwg"/><path class="h7iu_pbpp"/><path class="la3o1kijh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ind-money" {...props}></Icon>
<style>
:global(.h7iu_pbpp) {
  fill: none;
  stroke: currentColor;
