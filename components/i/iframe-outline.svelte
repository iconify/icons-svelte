...
const content = `<path class="grli47bwr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:iframe-outline" {...props}></Icon>
<style>
:global(.grli47bwr) {
  fill: currentColor;
