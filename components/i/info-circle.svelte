...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="it5wk5bgi"/><path class="hksrydaxc"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:info-circle" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
