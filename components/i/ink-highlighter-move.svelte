...
const content = `<path class="gsghrtc6s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:ink-highlighter-move" {...props}></Icon>
<style>
:global(.gsghrtc6s) {
  fill: currentColor;
