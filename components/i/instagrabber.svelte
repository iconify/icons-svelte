...
const content = `<path class="d51z-jb4w"/><path class="i9clfwm2k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:instagrabber" {...props}></Icon>
<style>
:global(.d51z-jb4w) {
  fill: none;
  stroke: currentColor;
