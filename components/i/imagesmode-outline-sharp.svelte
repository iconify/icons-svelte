...
const content = `<path class="zolefn94h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:imagesmode-outline-sharp" {...props}></Icon>
<style>
:global(.zolefn94h) {
  fill: currentColor;
