...
const content = `<circle class="f9k1ombqm"/><path class="xdw89jbjg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:iclicker" {...props}></Icon>
<style>
:global(.f9k1ombqm) {
  cx: 25.132px;
  cy: 24.073px;
