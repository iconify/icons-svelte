...
const content = `<g class="y9tr6bcfx"><path class="cys61rbnf"/><path class="bx_mfcbkw"/><path class="qtcmuw83j"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:izipay-ya" {...props}></Icon>
<style>
:global(.bx_mfcbkw) {
