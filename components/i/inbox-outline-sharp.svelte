...
const content = `<path class="ctbwzcbzr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:inbox-outline-sharp" {...props}></Icon>
<style>
:global(.ctbwzcbzr) {
  fill: currentColor;
