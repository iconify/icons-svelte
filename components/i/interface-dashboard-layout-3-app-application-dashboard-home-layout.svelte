...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline:interface-dashboard-layout-3-app-application-dashboard-home-layout" {...props}></Icon>
