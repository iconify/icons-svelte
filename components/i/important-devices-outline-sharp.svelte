...
const content = `<path class="trp-8m0cm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:important-devices-outline-sharp" {...props}></Icon>
<style>
:global(.trp-8m0cm) {
  fill: currentColor;
