...
const content = `<path class="i7u6rk80i"/><path class="fmyh_4b_e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:intesa" {...props}></Icon>
<style>
:global(.fmyh_4b_e) {
  fill: none;
  stroke: currentColor;
