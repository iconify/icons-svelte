...
const content = `<path class="t-7cs6bqh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:inactive-order-outline-rounded" {...props}></Icon>
<style>
:global(.t-7cs6bqh) {
  fill: currentColor;
