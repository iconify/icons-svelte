...
const content = `<path class="h5hfcc4ra"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:interests-outline-rounded" {...props}></Icon>
<style>
:global(.h5hfcc4ra) {
  fill: currentColor;
