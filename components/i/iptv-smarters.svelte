...
const content = `<path class="imcxvgbdh"/><circle class="vnl304pwq"/><circle class="zh-t3dbfy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:iptv-smarters" {...props}></Icon>
<style>
:global(.imcxvgbdh) {
  fill: none;
  stroke: currentColor;
