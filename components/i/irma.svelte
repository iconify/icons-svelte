...
const content = `<path class="l46gm38lo"/><rect transform="rotate(-20 24 24)" class="zw4jolb0i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:irma" {...props}></Icon>
<style>
:global(.l46gm38lo) {
  fill: none;
  stroke: currentColor;
