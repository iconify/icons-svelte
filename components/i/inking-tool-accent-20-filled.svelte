...
const content = `<path class="fs9uqkhnz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:inking-tool-accent-20-filled" {...props}></Icon>
<style>
:global(.fs9uqkhnz) {
  fill: currentColor;
