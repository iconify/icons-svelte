...
const content = `<g class="cuyn6tgcc"><path class="rc97xqumw"/><path class="pe4tfab0m"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:ice-cream-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
