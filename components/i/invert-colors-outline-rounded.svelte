...
const content = `<path class="o131c0bjj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:invert-colors-outline-rounded" {...props}></Icon>
<style>
:global(.o131c0bjj) {
  fill: currentColor;
