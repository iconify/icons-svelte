...
const content = `<path class="w5aqk7j0m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:ink-eraser-outline" {...props}></Icon>
<style>
:global(.w5aqk7j0m) {
  fill: currentColor;
