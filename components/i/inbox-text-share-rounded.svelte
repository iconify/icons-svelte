...
const content = `<path class="dba6xwb3h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:inbox-text-share-rounded" {...props}></Icon>
<style>
:global(.dba6xwb3h) {
  fill: currentColor;
