...
const content = `<path class="xp5e9ab-j"/><path class="ydqthzbbt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:investing" {...props}></Icon>
<style>
:global(.xp5e9ab-j) {
  fill: none;
  stroke: currentColor;
