...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="carbon:ibm-openshift-container-platform-on-vpc-for-regulated-industries" {...props}></Icon>
