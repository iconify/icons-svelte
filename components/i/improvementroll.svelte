...
const content = `<path class="hy_hf-l-e"/><path class="prf5x8ker"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:improvementroll" {...props}></Icon>
<style>
:global(.hy_hf-l-e) {
  fill: none;
  stroke: currentColor;
