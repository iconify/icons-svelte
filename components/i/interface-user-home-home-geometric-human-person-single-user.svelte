...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline:interface-user-home-home-geometric-human-person-single-user" {...props}></Icon>
