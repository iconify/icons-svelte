...
const content = `<path class="qu85lsg2y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:image-arrow-up-outline" {...props}></Icon>
<style>
:global(.qu85lsg2y) {
  fill: currentColor;
