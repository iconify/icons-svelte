...
const content = `<path class="tykk0ub4m"/><rect class="uhx3m_1tm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:irplus" {...props}></Icon>
<style>
:global(.tykk0ub4m) {
  fill: none;
  stroke: currentColor;
