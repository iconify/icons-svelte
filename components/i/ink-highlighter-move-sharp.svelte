...
const content = `<path class="jlq6grolz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:ink-highlighter-move-sharp" {...props}></Icon>
<style>
:global(.jlq6grolz) {
  fill: currentColor;
