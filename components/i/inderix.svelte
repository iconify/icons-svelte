...
const content = `<path class="z-omvwblu"/><path class="l4wx5wbli"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:inderix" {...props}></Icon>
<style>
:global(.l4wx5wbli) {
  fill: none;
  stroke: currentColor;
