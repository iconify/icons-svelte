...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline:interface-edit-scissors-clipboard-copy-cut-paste-right-scissors" {...props}></Icon>
