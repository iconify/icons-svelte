...
const content = `<path class="r9titsq5j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:integration-instructions-sharp" {...props}></Icon>
<style>
:global(.r9titsq5j) {
  fill: currentColor;
