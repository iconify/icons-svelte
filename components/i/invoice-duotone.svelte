...
const content = `<g class="cuyn6tgcc"><path class="qemz5voez"/><path class="i8s_v0bny"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:invoice-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
