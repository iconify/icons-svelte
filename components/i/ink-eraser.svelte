...
const content = `<path class="l7-qwb5gj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:ink-eraser" {...props}></Icon>
<style>
:global(.l7-qwb5gj) {
  fill: currentColor;
