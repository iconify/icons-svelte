...
const content = `<path class="wxqs_e-zq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:inking-tool-accent-16-filled" {...props}></Icon>
<style>
:global(.wxqs_e-zq) {
  fill: currentColor;
