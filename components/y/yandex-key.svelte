...
const content = `<circle class="kzzswhivh"/><path class="mur63navn"/><path class="p-9otq8au"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:yandex-key" {...props}></Icon>
<style>
:global(.kzzswhivh) {
  cx: 15.09px;
  cy: 15.804px;
