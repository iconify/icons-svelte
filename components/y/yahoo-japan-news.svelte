...
const content = `<path class="tgv_ez0ki"/><path class="b6zxprzis"/><path class="doi4yihjp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:yahoo-japan-news" {...props}></Icon>
<style>
:global(.b6zxprzis) {
  fill: none;
  stroke: currentColor;
