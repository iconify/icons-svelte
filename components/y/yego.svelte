...
const content = `<circle class="cpk0fnbgt"/><path class="aj5u4vpba"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:yego" {...props}></Icon>
<style>
:global(.aj5u4vpba) {
  fill: none;
  stroke: currentColor;
