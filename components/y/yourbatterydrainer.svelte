...
const content = `<path class="tphcpek5w"/><path class="cje6x84oj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:yourbatterydrainer" {...props}></Icon>
<style>
:global(.cje6x84oj) {
  fill: none;
  stroke: currentColor;
