...
const content = `<path class="zc315jb9p"/><path class="aw7t_dxaj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:youtube-kids" {...props}></Icon>
<style>
:global(.aw7t_dxaj) {
  fill: none;
  stroke: currentColor;
