...
const content = `<path class="jbavqlbef"/><path class="plsh0ebyj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:yamaps" {...props}></Icon>
<style>
:global(.jbavqlbef) {
  fill: none;
  stroke: currentColor;
