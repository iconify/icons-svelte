...
const content = `<path class="sncg7sb8d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:yoshoku-sharp" {...props}></Icon>
<style>
:global(.sncg7sb8d) {
  fill: currentColor;
