...
const content = `<path class="ukj_7hb7x"/><path class="oazw04shg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:yasnac" {...props}></Icon>
<style>
:global(.oazw04shg) {
  fill: none;
  stroke: currentColor;
