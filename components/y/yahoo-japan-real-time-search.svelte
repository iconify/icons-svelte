...
const content = `<path class="xxb8wg1wi"/><circle class="zl9eo9b9a"/><path class="zllurnbjw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:yahoo-japan-real-time-search" {...props}></Icon>
<style>
:global(.xxb8wg1wi) {
  fill: none;
  stroke: currentColor;
