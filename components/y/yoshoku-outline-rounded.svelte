...
const content = `<path class="hqgisofcs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:yoshoku-outline-rounded" {...props}></Icon>
<style>
:global(.hqgisofcs) {
  fill: currentColor;
