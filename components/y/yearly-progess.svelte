...
const content = `<path class="obvjt6pao"/><path class="yeedo2bpq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:yearly-progess" {...props}></Icon>
<style>
:global(.obvjt6pao) {
  fill: none;
  stroke: currentColor;
