...
const content = `<path class="r1rtqtb8u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:youtube-activity-outline-rounded" {...props}></Icon>
<style>
:global(.r1rtqtb8u) {
  fill: currentColor;
