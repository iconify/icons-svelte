...
const content = `<circle class="cpk0fnbgt"/><path class="s-76gmbrm"/><circle class="xakrkvy8r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:8-ball-pool" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
