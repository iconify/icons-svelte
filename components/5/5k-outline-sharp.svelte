...
const content = `<path class="x_t-icb-r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:5k-outline-sharp" {...props}></Icon>
<style>
:global(.x_t-icb-r) {
  fill: currentColor;
