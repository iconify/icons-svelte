...
const content = `<path class="twe5jnb1s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:5k-outline-sharp" {...props}></Icon>
<style>
:global(.twe5jnb1s) {
  fill: currentColor;
