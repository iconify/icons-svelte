...
const content = `<rect class="j3s9ivbxi"/><path class="aksyo68gn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:585" {...props}></Icon>
<style>
:global(.aksyo68gn) {
  fill: none;
  stroke: currentColor;
