...
const content = `<g class="cuyn6tgcc"><path class="v548xfd_q"/><path class="cvhomyb2y"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:picnic-table-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
