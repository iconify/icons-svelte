...
const content = `<path class="gb2mlgi3z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:presence-available-12-regular" {...props}></Icon>
<style>
:global(.gb2mlgi3z) {
  fill: currentColor;
