...
const content = `<path class="fcj6w9z4f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-left-contract-28-regular" {...props}></Icon>
<style>
:global(.fcj6w9z4f) {
  fill: currentColor;
