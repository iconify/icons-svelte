...
const content = `<path class="a078x0b7t"/><path class="lchl0kb6s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:phone-manager" {...props}></Icon>
<style>
:global(.a078x0b7t) {
  fill: none;
  stroke: currentColor;
