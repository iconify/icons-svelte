...
const content = `<path class="c0ilkxbne"/><rect class="rqjs0ub5j"/><path class="kq4yk7byt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:paper-loop" {...props}></Icon>
<style>
:global(.c0ilkxbne) {
  fill: none;
  stroke: currentColor;
