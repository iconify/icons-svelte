...
const content = `<path class="o0n8xlfmn"/><path class="vassfmi2r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:packer" {...props}></Icon>
<style>
:global(.o0n8xlfmn) {
