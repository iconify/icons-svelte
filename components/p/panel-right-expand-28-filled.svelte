...
const content = `<path class="avq8d8n2x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-right-expand-28-filled" {...props}></Icon>
<style>
:global(.avq8d8n2x) {
  fill: currentColor;
