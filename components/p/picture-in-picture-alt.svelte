...
const content = `<path class="r1b3btb1r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:picture-in-picture-alt" {...props}></Icon>
<style>
:global(.r1b3btb1r) {
  fill: currentColor;
