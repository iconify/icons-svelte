...
const content = `<path class="ewdx-lbiu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-left-header-32-regular" {...props}></Icon>
<style>
:global(.ewdx-lbiu) {
  fill: currentColor;
