...
const content = `<circle class="cpk0fnbgt"/><path class="o8dd-fbld"/><circle class="c_lx_rsko"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:publix" {...props}></Icon>
<style>
:global(.c_lx_rsko) {
  cx: 24.914px;
  cy: 22.824px;
