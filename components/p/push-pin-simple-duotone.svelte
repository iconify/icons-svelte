...
const content = `<g class="cuyn6tgcc"><path class="bielgac6k"/><path class="foby0lafx"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:push-pin-simple-duotone" {...props}></Icon>
<style>
:global(.bielgac6k) {
