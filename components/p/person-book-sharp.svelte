...
const content = `<path class="ywiv5dbbh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:person-book-sharp" {...props}></Icon>
<style>
:global(.ywiv5dbbh) {
  fill: currentColor;
