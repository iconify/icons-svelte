...
const content = `<path class="pes9wibry"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:person-book-sharp" {...props}></Icon>
<style>
:global(.pes9wibry) {
  fill: currentColor;
