...
const content = `<path class="vlhhykc5z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:picture-in-picture-alt-outline-rounded" {...props}></Icon>
<style>
:global(.vlhhykc5z) {
  fill: currentColor;
