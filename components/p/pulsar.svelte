...
const content = `<path class="c81uvk15l"/><path class="c67k2x1kl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:pulsar" {...props}></Icon>
<style>
:global(.c67k2x1kl) {
  fill: none;
  stroke: currentColor;
