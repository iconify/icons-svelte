...
const content = `<circle class="l6px8ybyh"/><circle class="dqy_2gbug"/><path class="pt44n8bwu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:paradise-lust" {...props}></Icon>
<style>
:global(.dqy_2gbug) {
  cx: 24px;
  cy: 23.966px;
