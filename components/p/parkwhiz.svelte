...
const content = `<path class="uj375ccgj"/><path class="ua9z7g1kr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:parkwhiz" {...props}></Icon>
<style>
:global(.ua9z7g1kr) {
  fill: none;
  stroke: currentColor;
