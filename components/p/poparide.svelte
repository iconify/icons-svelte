...
const content = `<circle class="cpk0fnbgt"/><path class="m7gj4lbhf"/><path class="bp6dzleet"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:poparide" {...props}></Icon>
<style>
:global(.bp6dzleet) {
  fill: none;
  stroke: currentColor;
