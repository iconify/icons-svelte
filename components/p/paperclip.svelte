...
const content = `<path class="rqljtw4kw"/><g class="o5g7cackv"><path class="w2qo7jbfm"/><path class="hf_xb58_f"/></g><path class="o317slx4s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto:paperclip" {...props}></Icon>
<style>
:global(.hf_xb58_f) {
