...
const content = `<path class="u7r7s7jqb"/><path class="ikusahp9a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:pound-symbol" {...props}></Icon>
<style>
:global(.ikusahp9a) {
  fill: currentColor;
