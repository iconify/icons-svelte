...
const content = `<path class="a1ctqd8ji"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:print-sharp" {...props}></Icon>
<style>
:global(.a1ctqd8ji) {
  fill: currentColor;
