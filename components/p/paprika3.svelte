...
const content = `<path class="wyxtkdbez"/><path class="fidw94vsy"/><ellipse class="xd54hgj8m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:paprika3" {...props}></Icon>
<style>
:global(.fidw94vsy) {
  fill: none;
  stroke: currentColor;
