...
const content = `<path class="v3w6eabii"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:phone-paused-sharp" {...props}></Icon>
<style>
:global(.v3w6eabii) {
  fill: currentColor;
