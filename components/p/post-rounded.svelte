...
const content = `<path class="ft58iksrl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:post-rounded" {...props}></Icon>
<style>
:global(.ft58iksrl) {
  fill: currentColor;
