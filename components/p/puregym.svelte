...
const content = `<path class="p37v6vqmj"/><circle class="pa_qjch1b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:puregym" {...props}></Icon>
<style>
:global(.p37v6vqmj) {
  fill: none;
  stroke: currentColor;
