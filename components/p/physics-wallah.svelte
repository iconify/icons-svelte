...
const content = `<path class="axj08xfgf"/><path class="e1yq_jbjx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:physics-wallah" {...props}></Icon>
<style>
:global(.axj08xfgf) {
  fill: none;
  stroke: currentColor;
