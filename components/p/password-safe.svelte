...
const content = `<circle class="j60uk5vjx"/><path class="d3hu-g1lq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:password-safe" {...props}></Icon>
<style>
:global(.d3hu-g1lq) {
  fill: none;
  stroke: currentColor;
