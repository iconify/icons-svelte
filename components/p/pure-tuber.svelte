...
const content = `<path class="h3nm9fb1f"/><path class="np---dzum"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:pure-tuber" {...props}></Icon>
<style>
:global(.h3nm9fb1f) {
  fill: none;
  stroke: currentColor;
