...
const content = `<path class="dvqyai_9l"/><path class="y9f0y9b1j"/><path class="i9clfwm2k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:pixels" {...props}></Icon>
<style>
:global(.dvqyai_9l) {
  fill: none;
  stroke: currentColor;
