...
const content = `<path class="of-55_bnc"/><path class="ca_q1pbmu"/><circle class="mek3mhbgb"/><path class="wymuw5w8m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:permissionmanagerx" {...props}></Icon>
<style>
:global(.ca_q1pbmu) {
  fill: none;
  stroke: currentColor;
