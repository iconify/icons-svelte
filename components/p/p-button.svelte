...
const content = `<path class="r9rioofmx"/><path class="j8yjm2x4u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:p-button" {...props}></Icon>
<style>
:global(.j8yjm2x4u) {
