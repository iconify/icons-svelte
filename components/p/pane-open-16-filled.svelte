...
const content = `<g class="ft5dv1b6b"><path class="fd_5co-ex"/><path class="om0m0objv"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:pane-open-16-filled" {...props}></Icon>
<style>
:global(.fd_5co-ex) {
