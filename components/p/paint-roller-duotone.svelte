...
const content = `<g class="cuyn6tgcc"><path class="ufy-_mbdq"/><path class="bx4a6zk9x"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:paint-roller-duotone" {...props}></Icon>
<style>
:global(.bx4a6zk9x) {
