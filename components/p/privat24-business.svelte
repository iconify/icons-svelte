...
const content = `<path class="eqt0vm0yn"/><path class="tv7tv0blv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:privat24-business" {...props}></Icon>
<style>
:global(.eqt0vm0yn) {
  fill: none;
  stroke: currentColor;
