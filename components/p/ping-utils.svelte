...
const content = `<path class="cm0_jkbks"/><path class="btbl76b9o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ping-utils" {...props}></Icon>
<style>
:global(.btbl76b9o) {
  fill: none;
  stroke: currentColor;
