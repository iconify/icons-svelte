...
const content = `<g class="ft5dv1b6b"><path class="dewl0r6id"/><path class="b21vvmbyr"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:pane-open-16-regular" {...props}></Icon>
<style>
:global(.b21vvmbyr) {
