...
const content = `<path class="lv2fqxnsv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:phone-disabled-sharp" {...props}></Icon>
<style>
:global(.lv2fqxnsv) {
  fill: currentColor;
