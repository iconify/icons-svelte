...
const content = `<g class="cuyn6tgcc"><path class="nu4nfo2zt"/><path class="qt2s8ytjz"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:pencil-line-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
