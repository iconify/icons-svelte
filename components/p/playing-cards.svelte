...
const content = `<path class="l7an0_cgm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:playing-cards" {...props}></Icon>
<style>
:global(.l7an0_cgm) {
  fill: currentColor;
