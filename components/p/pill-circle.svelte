...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="zxntrv6jg"/><path class="hdxpysbbn"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:pill-circle" {...props}></Icon>
<style>
:global(.hdxpysbbn) {
