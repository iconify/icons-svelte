...
const content = `<path class="lvzhun--a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:play-circle-hint-16-regular" {...props}></Icon>
<style>
:global(.lvzhun--a) {
  fill: currentColor;
