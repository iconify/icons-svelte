...
const content = `<path class="cr7868b7d"/><path class="e_zjo-bvc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:podcast-republic" {...props}></Icon>
<style>
:global(.cr7868b7d) {
  fill: none;
  stroke: currentColor;
