...
const content = `<path class="ll0g54h-q"/><path class="bpshnu27m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:portscanner" {...props}></Icon>
<style>
:global(.bpshnu27m) {
  fill: none;
  stroke: currentColor;
