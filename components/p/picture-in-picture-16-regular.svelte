...
const content = `<path class="w3azgj4wy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:picture-in-picture-16-regular" {...props}></Icon>
<style>
:global(.w3azgj4wy) {
  fill: currentColor;
