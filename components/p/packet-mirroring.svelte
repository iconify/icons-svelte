...
const content = `<path class="mks06hr5l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:packet-mirroring" {...props}></Icon>
<style>
:global(.mks06hr5l) {
  fill: currentColor;
