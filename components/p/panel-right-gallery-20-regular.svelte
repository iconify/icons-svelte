...
const content = `<path class="i5p7khq3y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-right-gallery-20-regular" {...props}></Icon>
<style>
:global(.i5p7khq3y) {
  fill: currentColor;
