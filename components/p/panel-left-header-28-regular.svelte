...
const content = `<path class="ob-hc_wiz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-left-header-28-regular" {...props}></Icon>
<style>
:global(.ob-hc_wiz) {
  fill: currentColor;
