...
const content = `<g class="cuyn6tgcc"><path class="tfsu_mg8j"/><path class="hdf52db7a"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:paint-brush-household-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
