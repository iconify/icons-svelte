...
const content = `<path class="espmrobbe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:phone-enabled-sharp" {...props}></Icon>
<style>
:global(.espmrobbe) {
  fill: currentColor;
