...
const content = `<path class="m3aq3xbnf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:presence-available-16-filled" {...props}></Icon>
<style>
:global(.m3aq3xbnf) {
  fill: currentColor;
