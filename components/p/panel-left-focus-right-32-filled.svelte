...
const content = `<path class="kgmmdebsf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-left-focus-right-32-filled" {...props}></Icon>
<style>
:global(.kgmmdebsf) {
  fill: currentColor;
