...
const content = `<path class="uzr9v6bnx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:piano-off-sharp" {...props}></Icon>
<style>
:global(.uzr9v6bnx) {
  fill: currentColor;
