...
const content = `<path class="gyhgxsb5b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:pest-control-rodent-outline-rounded" {...props}></Icon>
<style>
:global(.gyhgxsb5b) {
  fill: currentColor;
