...
const content = `<path class="g1ya29duh"/><path class="w6tjgxuyr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:poet-assistant" {...props}></Icon>
<style>
:global(.g1ya29duh) {
  fill: none;
  stroke: currentColor;
