...
const content = `<g class="nrj6p8qat"><path class="b_gf1sbty"/><path class="a6s4ubbfu"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:phone-missed-fill" {...props}></Icon>
<style>
:global(.a6s4ubbfu) {
