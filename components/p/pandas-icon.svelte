...
const content = `<path class="cpkneib0c"/><path class="nmrmcua8j"/><path class="u6arn-b2h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:pandas-icon" {...props}></Icon>
<style>
:global(.cpkneib0c) {
