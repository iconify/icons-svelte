...
const content = `<path class="sif429gbk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:package-2-outline-sharp" {...props}></Icon>
<style>
:global(.sif429gbk) {
  fill: currentColor;
