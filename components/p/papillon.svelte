...
const content = `<path class="cjasns2tp"/><path class="t4i9xbzsd"/><path class="lx02ojbvj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:papillon" {...props}></Icon>
<style>
:global(.cjasns2tp) {
  fill: none;
  stroke: currentColor;
