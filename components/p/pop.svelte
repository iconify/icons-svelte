...
const content = `<rect class="j3s9ivbxi"/><path class="bgi61ybss"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:pop" {...props}></Icon>
<style>
:global(.bgi61ybss) {
  fill: none;
  stroke: currentColor;
