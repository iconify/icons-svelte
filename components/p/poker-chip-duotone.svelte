...
const content = `<g class="cuyn6tgcc"><path class="f8zg4-n7g"/><path class="gc_x9w5-o"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:poker-chip-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
