...
const content = `<path class="n0e73ccqi"/><path class="hy77yab7w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:prey" {...props}></Icon>
<style>
:global(.hy77yab7w) {
  fill: none;
  stroke: currentColor;
