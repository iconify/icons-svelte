...
const content = `<path class="m1-xjnywy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:presence-tentative-10-regular" {...props}></Icon>
<style>
:global(.m1-xjnywy) {
  fill: currentColor;
