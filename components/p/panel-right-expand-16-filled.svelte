...
const content = `<g class="ft5dv1b6b"><path class="khsbed5es"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-right-expand-16-filled" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
