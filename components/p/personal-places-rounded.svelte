...
const content = `<path class="uqquaabfk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:personal-places-rounded" {...props}></Icon>
<style>
:global(.uqquaabfk) {
  fill: currentColor;
