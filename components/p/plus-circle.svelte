...
const content = `<g class="cuyn6tgcc"><path class="i_lialbjv"/><path class="a_fwwub7q"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:plus-circle" {...props}></Icon>
<style>
:global(.a_fwwub7q) {
