...
const content = `<g class="cuyn6tgcc"><path class="s8w1wab4y"/><path class="zmpgrs18j"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:paperclip-horizontal-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
