...
const content = `<path class="s-7xvebkk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:position-bottom-right-rounded" {...props}></Icon>
<style>
:global(.s-7xvebkk) {
  fill: currentColor;
