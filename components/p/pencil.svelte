...
const content = `<defs><path id="SVGG9rYnebu" class="tzg15cchr"/></defs><use href="#SVGG9rYnebu" class="b81j2dl_f"/><clipPath id="SVGf7b5Yc3H"><use href="#SVGG9rYnebu"/></clipPath><path clip-path="url(#SVGf7b5Yc3H)" class="lm6wh85lu"/><path class="tszvcp4kj"/><path class="v371w6biq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:pencil" {...props}></Icon>
<style>
:global(.b81j2dl_f) {
