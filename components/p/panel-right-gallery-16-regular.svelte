...
const content = `<path class="xw2nlccny"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-right-gallery-16-regular" {...props}></Icon>
<style>
:global(.xw2nlccny) {
  fill: currentColor;
