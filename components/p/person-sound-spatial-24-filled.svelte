...
const content = `<path class="ta9ypzb0c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:person-sound-spatial-24-filled" {...props}></Icon>
<style>
:global(.ta9ypzb0c) {
  fill: currentColor;
