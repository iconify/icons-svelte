...
const content = `<path class="gci9zjboy"/><path class="ee56u7b0s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:portarius" {...props}></Icon>
<style>
:global(.ee56u7b0s) {
  fill: none;
  stroke: currentColor;
