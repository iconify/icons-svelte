...
const content = `<path class="nbcmbibfr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-top-gallery-16-filled" {...props}></Icon>
<style>
:global(.nbcmbibfr) {
  fill: currentColor;
