...
const content = `<path class="kwsqasgfr"/><path class="ed757gs9x"/><path class="jwvxl4bxe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:precisevolume" {...props}></Icon>
<style>
:global(.ed757gs9x) {
  fill: none;
  stroke: currentColor;
