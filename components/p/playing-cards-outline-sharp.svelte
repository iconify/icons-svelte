...
const content = `<path class="b3qjs2buu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:playing-cards-outline-sharp" {...props}></Icon>
<style>
:global(.b3qjs2buu) {
  fill: currentColor;
