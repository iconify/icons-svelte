...
const content = `<path class="voxutqb2m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:picture-in-picture-32-light" {...props}></Icon>
<style>
:global(.voxutqb2m) {
  fill: currentColor;
