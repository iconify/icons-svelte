...
const content = `<path class="g3bt-mb2f"/><path class="cgl___bdn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:private-dns-quick-tile-modes" {...props}></Icon>
<style>
:global(.cgl___bdn) {
  fill: none;
  stroke: currentColor;
