...
const content = `<path class="m3b7oab6y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:pixel-9-pro-fold" {...props}></Icon>
<style>
:global(.m3b7oab6y) {
  fill: currentColor;
