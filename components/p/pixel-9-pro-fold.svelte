...
const content = `<path class="wn5u0mb5g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:pixel-9-pro-fold" {...props}></Icon>
<style>
:global(.wn5u0mb5g) {
  fill: currentColor;
