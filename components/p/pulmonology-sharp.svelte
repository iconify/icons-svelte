...
const content = `<path class="zyi786bis"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:pulmonology-sharp" {...props}></Icon>
<style>
:global(.zyi786bis) {
  fill: currentColor;
