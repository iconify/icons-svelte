...
const content = `<path class="v-i5w1bcc"/><path class="k02gnk0ay"/><path class="mlkclge_k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:pretixprint" {...props}></Icon>
<style>
:global(.k02gnk0ay) {
  fill: none;
  stroke: currentColor;
