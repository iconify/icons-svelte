...
const content = `<path class="y0c0kcc1p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-right-gallery-28-filled" {...props}></Icon>
<style>
:global(.y0c0kcc1p) {
  fill: currentColor;
