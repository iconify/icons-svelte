...
const content = `<path class="ndnyck2mv"/><path class="uhhi_-rna"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:play-together" {...props}></Icon>
<style>
:global(.ndnyck2mv) {
  fill: none;
  stroke: currentColor;
