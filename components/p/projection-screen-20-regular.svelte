...
const content = `<path class="h6_111r0a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:projection-screen-20-regular" {...props}></Icon>
<style>
:global(.h6_111r0a) {
  fill: currentColor;
