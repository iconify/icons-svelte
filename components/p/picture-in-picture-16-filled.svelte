...
const content = `<path class="h36l79rey"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:picture-in-picture-16-filled" {...props}></Icon>
<style>
:global(.h36l79rey) {
  fill: currentColor;
