...
const content = `<path class="am9ua5b1w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:pentagon-outline-rounded" {...props}></Icon>
<style>
:global(.am9ua5b1w) {
  fill: currentColor;
