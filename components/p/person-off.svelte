...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="xte972wur"/><path class="p1nc4nb1r"/><path class="xedf9ccsf"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:person-off" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
