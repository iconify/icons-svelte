...
const content = `<path class="eqmzot65y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-left-text-24-regular" {...props}></Icon>
<style>
:global(.eqmzot65y) {
  fill: currentColor;
