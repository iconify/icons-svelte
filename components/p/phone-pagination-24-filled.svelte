...
const content = `<path class="y724mwbyd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:phone-pagination-24-filled" {...props}></Icon>
<style>
:global(.y724mwbyd) {
  fill: currentColor;
