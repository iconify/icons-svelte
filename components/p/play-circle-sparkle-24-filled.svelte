...
const content = `<path class="fyy9m35se"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:play-circle-sparkle-24-filled" {...props}></Icon>
<style>
:global(.fyy9m35se) {
  fill: currentColor;
