...
const content = `<g class="gp_8x1bzb"><path class="fnsafsbbs"/><path class="f_is0r95p"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:plane-takeoff-sharp-fill" {...props}></Icon>
<style>
:global(.f_is0r95p) {
  d: path("M1 20L23 20");
}
