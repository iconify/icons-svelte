...
const content = `<path class="j9xn9crcm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:presence-offline-12-regular" {...props}></Icon>
<style>
:global(.j9xn9crcm) {
  fill: currentColor;
