...
const content = `<path class="nvqgxcehq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:pediatrics-outline-sharp" {...props}></Icon>
<style>
:global(.nvqgxcehq) {
  fill: currentColor;
