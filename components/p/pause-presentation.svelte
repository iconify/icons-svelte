...
const content = `<path class="n06sbgbub"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:pause-presentation" {...props}></Icon>
<style>
:global(.n06sbgbub) {
  fill: currentColor;
