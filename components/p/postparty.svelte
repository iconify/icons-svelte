...
const content = `<path class="o2th2-7fb"/><ellipse class="h3uns0b8n"/><path class="djojoquct"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:postparty" {...props}></Icon>
<style>
:global(.djojoquct) {
  fill: none;
  stroke: currentColor;
