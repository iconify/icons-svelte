...
const content = `<g class="gp_8x1bzb"><path class="tm7w68bld"/><path class="lzd54cadi"/><path class="zsuk8rbci"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:panel-left-close-dashed-sharp-two-tone" {...props}></Icon>
<style>
:global(.gp_8x1bzb) {
  fill: none;
  stroke: currentColor;
