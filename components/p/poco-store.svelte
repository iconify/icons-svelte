...
const content = `<path class="g2wj9jbhp"/><path class="vu590obhd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:poco-store" {...props}></Icon>
<style>
:global(.g2wj9jbhp) {
  fill: none;
  stroke: currentColor;
