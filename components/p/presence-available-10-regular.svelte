...
const content = `<path class="t6q6-piqm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:presence-available-10-regular" {...props}></Icon>
<style>
:global(.t6q6-piqm) {
  fill: currentColor;
