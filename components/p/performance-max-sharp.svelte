...
const content = `<path class="abnxy0pti"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:performance-max-sharp" {...props}></Icon>
<style>
:global(.abnxy0pti) {
  fill: currentColor;
