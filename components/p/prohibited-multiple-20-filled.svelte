...
const content = `<path class="j_dxdcbjk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:prohibited-multiple-20-filled" {...props}></Icon>
<style>
:global(.j_dxdcbjk) {
  fill: currentColor;
