...
const content = `<path class="mty54xbbg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:presence-tentative-24-regular" {...props}></Icon>
<style>
:global(.mty54xbbg) {
  fill: currentColor;
