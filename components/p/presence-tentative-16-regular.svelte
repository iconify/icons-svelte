...
const content = `<path class="pbfc94bso"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:presence-tentative-16-regular" {...props}></Icon>
<style>
:global(.pbfc94bso) {
  fill: currentColor;
