...
const content = `<path class="zrl9fv-ag"/><path class="xzluatb5y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:paypay" {...props}></Icon>
<style>
:global(.xzluatb5y) {
  fill: none;
  stroke: currentColor;
