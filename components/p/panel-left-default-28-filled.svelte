...
const content = `<path class="s4c0buxvf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-left-default-28-filled" {...props}></Icon>
<style>
:global(.s4c0buxvf) {
  fill: currentColor;
