...
const content = `<g class="cuyn6tgcc"><path class="mde1mm8by"/><path class="oz9xro8mw"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:pause-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
