...
const content = `<path class="e2jlw8v5f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:pool-outline-rounded" {...props}></Icon>
<style>
:global(.e2jlw8v5f) {
  fill: currentColor;
