...
const content = `<path class="qh-usac0l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:privacy-screen-outline" {...props}></Icon>
<style>
:global(.qh-usac0l) {
  fill: currentColor;
