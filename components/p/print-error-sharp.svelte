...
const content = `<path class="isai6idtl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:print-error-sharp" {...props}></Icon>
<style>
:global(.isai6idtl) {
  fill: currentColor;
