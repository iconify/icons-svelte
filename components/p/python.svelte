...
const content = `<path class="zmrjf0wih"/><circle class="o8j62sbtn"/><path class="n1949171i"/><circle class="u9ssrlu1o"/><path class="gvc3pacef"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:python" {...props}></Icon>
<style>
:global(.gvc3pacef) {
  fill: none;
  stroke: currentColor;
