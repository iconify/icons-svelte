...
const content = `<path class="u92nuus0w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:personal-bag-sharp" {...props}></Icon>
<style>
:global(.u92nuus0w) {
  fill: currentColor;
