...
const content = `<path class="j2de_abao"/><path class="rsv5dtbsm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:proton-authenticator" {...props}></Icon>
<style>
:global(.j2de_abao) {
  fill: none;
  stroke: currentColor;
