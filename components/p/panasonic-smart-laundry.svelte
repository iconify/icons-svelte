...
const content = `<circle class="x3oj8zuek"/><path class="avswbvzyi"/><circle class="jjjmw9j_i"/><circle class="agidb-rsk"/><circle class="vb6scem3v"/><path class="yc7fbactm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:panasonic-smart-laundry" {...props}></Icon>
<style>
:global(.agidb-rsk) {
  cx: 13.75px;
  cy: 37.5px;
