...
const content = `<g class="nrj6p8qat"><path class="ttdlueb2i"/><path class="kodnftbvm"/><path class="xgkv2fbpx"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:panel-top-close-dashed-two-tone" {...props}></Icon>
<style>
:global(.kodnftbvm) {
