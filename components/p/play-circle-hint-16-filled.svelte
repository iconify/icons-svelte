...
const content = `<path class="gsqnr7bui"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:play-circle-hint-16-filled" {...props}></Icon>
<style>
:global(.gsqnr7bui) {
  fill: currentColor;
