...
const content = `<g class="cuyn6tgcc"><path class="nu4nfo2zt"/><path class="wu3hhhhcj"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:pencil-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
