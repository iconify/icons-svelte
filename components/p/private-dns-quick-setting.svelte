...
const content = `<path class="t9of2fb1l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:private-dns-quick-setting" {...props}></Icon>
<style>
:global(.t9of2fb1l) {
  fill: none;
  stroke: currentColor;
