...
const content = `<path class="tq6921d7o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-right-default-28-filled" {...props}></Icon>
<style>
:global(.tq6921d7o) {
  fill: currentColor;
