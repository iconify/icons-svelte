...
const content = `<path class="utv52wb3g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:phone-header-arrow-up-20-filled" {...props}></Icon>
<style>
:global(.utv52wb3g) {
  fill: currentColor;
