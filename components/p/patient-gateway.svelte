...
const content = `<path class="g63gv0b2r"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:patient-gateway" {...props}></Icon>
<style>
:global(.g63gv0b2r) {
  fill: none;
  stroke: currentColor;
