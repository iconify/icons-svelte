...
const content = `<circle class="kets-x7wy"/><circle class="dkq3jfbum"/><path class="hqzqmicng"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:play-deals" {...props}></Icon>
<style>
:global(.dkq3jfbum) {
  cx: 13.015px;
  cy: 12.471px;
