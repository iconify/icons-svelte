...
const content = `<path class="l2la322mf"/><circle class="zg8gn-bqa"/><path class="ekrh4ibar"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:pleestracker" {...props}></Icon>
<style>
:global(.ekrh4ibar) {
  fill: none;
  stroke: currentColor;
