...
const content = `<path class="fqvlam02a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-left-header-add-16-regular" {...props}></Icon>
<style>
:global(.fqvlam02a) {
  fill: currentColor;
