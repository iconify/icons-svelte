...
const content = `<path class="mej7xt5_t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:phone-status-bar-24-filled" {...props}></Icon>
<style>
:global(.mej7xt5_t) {
  fill: currentColor;
