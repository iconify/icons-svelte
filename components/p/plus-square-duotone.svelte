...
const content = `<g class="cuyn6tgcc"><path class="rl1dq4bco"/><path class="psar0sd8d"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:plus-square-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
