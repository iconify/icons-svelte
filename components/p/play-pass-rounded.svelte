...
const content = `<path class="fjje9kb0i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:play-pass-rounded" {...props}></Icon>
<style>
:global(.fjje9kb0i) {
  fill: currentColor;
