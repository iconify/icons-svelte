...
const content = `<path class="nqt9w4b7i"/><path class="nq9uc18fk"/><path class="w_ot-wbtl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:perplexity" {...props}></Icon>
<style>
:global(.nq9uc18fk) {
  fill: none;
  stroke: currentColor;
