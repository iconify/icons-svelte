...
const content = `<path class="cnrrb2bzp"/><path class="uwqt01bvr"/><path class="dpkxvqb7z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:photochiotte" {...props}></Icon>
<style>
:global(.cnrrb2bzp) {
  fill: none;
  stroke: currentColor;
