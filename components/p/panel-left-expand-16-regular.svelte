...
const content = `<g class="cuyn6tgcc"><path class="gnpikw8xj"/><path class="h732d-kpj"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-left-expand-16-regular" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
