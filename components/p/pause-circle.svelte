...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="ko1h2xe1r"/><path class="hdxpysbbn"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:pause-circle" {...props}></Icon>
<style>
:global(.hdxpysbbn) {
