...
const content = `<path class="ogkoifmcd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:propane-tank-sharp" {...props}></Icon>
<style>
:global(.ogkoifmcd) {
  fill: currentColor;
