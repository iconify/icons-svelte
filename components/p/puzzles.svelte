...
const content = `<rect class="j3s9ivbxi"/><path class="ejtxjks0w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:puzzles" {...props}></Icon>
<style>
:global(.ejtxjks0w) {
  fill: none;
  stroke: currentColor;
