...
const content = `<path class="r5fv0mhth"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:panorama-vertical-outline-sharp" {...props}></Icon>
<style>
:global(.r5fv0mhth) {
  fill: currentColor;
