...
const content = `<g class="nrj6p8qat"><path class="jfp2fyuan"/><path class="z450f3bce"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:panel-left-fill" {...props}></Icon>
<style>
:global(.jfp2fyuan) {
  fill: currentColor;
