...
const content = `<path class="pf_y74bbn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:photo-camera-front-sharp" {...props}></Icon>
<style>
:global(.pf_y74bbn) {
  fill: currentColor;
