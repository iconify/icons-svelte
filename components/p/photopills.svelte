...
const content = `<path class="aoytnkb_p"/><path class="nsggzmbnu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:photopills" {...props}></Icon>
<style>
:global(.aoytnkb_p) {
  fill: none;
  stroke: currentColor;
