...
const content = `<path class="rh5pvqb8c"/><path class="jb4sxxbzc"/><path class="nmg3-j4-z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:plex-photos" {...props}></Icon>
<style>
:global(.jb4sxxbzc) {
  fill: none;
  stroke: currentColor;
