...
const content = `<g class="cuyn6tgcc"><path class="kwvy6wbli"/><path class="ymozgdcam"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:popsicle-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
