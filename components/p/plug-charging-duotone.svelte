...
const content = `<g class="cuyn6tgcc"><path class="vz7bvhe7v"/><path class="x0wsr4awq"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:plug-charging-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
