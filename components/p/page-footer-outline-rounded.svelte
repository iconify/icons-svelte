...
const content = `<path class="clntq1b6y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:page-footer-outline-rounded" {...props}></Icon>
<style>
:global(.clntq1b6y) {
  fill: currentColor;
