...
const content = `<path class="un5xx6bvo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:pentagon-rounded" {...props}></Icon>
<style>
:global(.un5xx6bvo) {
  fill: currentColor;
