...
const content = `<path class="kw42l6_rw"/><path class="k-pm4fwmx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:postfinance" {...props}></Icon>
<style>
:global(.k-pm4fwmx) {
  fill: none;
  stroke: currentColor;
