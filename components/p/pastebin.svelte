...
const content = `<path class="w8rw27ipd"/><circle class="n85hlpbod"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:pastebin" {...props}></Icon>
<style>
:global(.n85hlpbod) {
  cx: 28.08px;
  cy: 12.83px;
