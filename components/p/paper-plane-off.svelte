...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="hybdfpesc"/><path class="lwc5gtlli"/><path class="xedf9ccsf"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:paper-plane-off" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
