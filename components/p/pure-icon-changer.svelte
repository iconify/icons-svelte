...
const content = `<circle class="qqwfmrkwm"/><path class="pmg9edprm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:pure-icon-changer" {...props}></Icon>
<style>
:global(.pmg9edprm) {
  fill: none;
  stroke: currentColor;
