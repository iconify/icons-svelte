...
const content = `<g class="ft5dv1b6b"><path class="b6jnkibms"/><path class="ess-ukmyw"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:ply" {...props}></Icon>
<style>
:global(.b6jnkibms) {
