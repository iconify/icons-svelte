...
const content = `<path class="ya8qi65ts"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-left-header-24-filled" {...props}></Icon>
<style>
:global(.ya8qi65ts) {
  fill: currentColor;
