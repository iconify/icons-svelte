...
const content = `<path class="biqf4wbbj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:personal-places-outline-rounded" {...props}></Icon>
<style>
:global(.biqf4wbbj) {
  fill: currentColor;
