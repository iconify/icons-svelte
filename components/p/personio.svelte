...
const content = `<path class="ku7zfu82r"/><circle class="y0qo7cbil"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:personio" {...props}></Icon>
<style>
:global(.ku7zfu82r) {
  fill: none;
  stroke: currentColor;
