...
const content = `<g class="gp_8x1bzb"><path class="tcv2_6jxj"/><path class="xsa8rjksl"/><path class="q_i5o_bfs"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:panel-right-close-dashed-sharp-two-tone" {...props}></Icon>
<style>
:global(.gp_8x1bzb) {
  fill: none;
  stroke: currentColor;
