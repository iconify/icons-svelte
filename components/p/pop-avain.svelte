...
const content = `<circle class="hc_5wyobp"/><circle class="iz4ladcvf"/><path class="aigfh7b4v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:pop-avain" {...props}></Icon>
<style>
:global(.aigfh7b4v) {
  fill: none;
  stroke: currentColor;
