...
const content = `<path class="m2s663b8a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:person-pin-sharp" {...props}></Icon>
<style>
:global(.m2s663b8a) {
  fill: currentColor;
