...
const content = `<path class="plpeinwhx"/><path class="p1ao_2b3h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:portu" {...props}></Icon>
<style>
:global(.p1ao_2b3h) {
  fill: none;
  stroke: currentColor;
