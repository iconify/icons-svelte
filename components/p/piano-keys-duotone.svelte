...
const content = `<g class="cuyn6tgcc"><path class="cbhb99bpq"/><path class="krw-n5oah"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:piano-keys-duotone" {...props}></Icon>
<style>
:global(.cbhb99bpq) {
