...
const content = `<path class="ov45av1-f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:presence-unknown-10-regular" {...props}></Icon>
<style>
:global(.ov45av1-f) {
  fill: currentColor;
