...
const content = `<path class="iypzy2khj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:priority-rounded" {...props}></Icon>
<style>
:global(.iypzy2khj) {
  fill: currentColor;
