...
const content = `<path class="y9gj-nrrp"/><path class="mrcpzhyuz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:photomath" {...props}></Icon>
<style>
:global(.mrcpzhyuz) {
  fill: none;
  stroke: currentColor;
