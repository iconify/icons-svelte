...
const content = `<path class="w19j_566a"/><path class="wgzi318wz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:proton-wallet" {...props}></Icon>
<style>
:global(.w19j_566a) {
  fill: none;
  stroke: currentColor;
