...
const content = `<path class="d5z9ngbuc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:personal-bag-question-rounded" {...props}></Icon>
<style>
:global(.d5z9ngbuc) {
  fill: currentColor;
