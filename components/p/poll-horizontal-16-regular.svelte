...
const content = `<path class="fvuttbbhd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:poll-horizontal-16-regular" {...props}></Icon>
<style>
:global(.fvuttbbhd) {
  fill: currentColor;
