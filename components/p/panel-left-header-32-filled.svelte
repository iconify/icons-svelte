...
const content = `<path class="r9o4dbj0u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-left-header-32-filled" {...props}></Icon>
<style>
:global(.r9o4dbj0u) {
  fill: currentColor;
