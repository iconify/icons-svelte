...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline-ultimate-color:presentation-projector-screen-budget-analytics" {...props}></Icon>
