...
const content = `<path class="rmnebcc8m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:present-to-all" {...props}></Icon>
<style>
:global(.rmnebcc8m) {
  fill: currentColor;
