...
const content = `<g class="nrj6p8qat"><path class="vyks9vbfn"/><path class="dpqj00aol"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:picture-in-picture-outline-regular" {...props}></Icon>
<style>
:global(.dpqj00aol) {
