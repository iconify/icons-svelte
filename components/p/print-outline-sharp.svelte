...
const content = `<path class="t7v849bqd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:print-outline-sharp" {...props}></Icon>
<style>
:global(.t7v849bqd) {
  fill: currentColor;
