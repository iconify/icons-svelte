...
const content = `<path class="hq-dd7ffv"/><path class="frlf8gb6v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:poshmark" {...props}></Icon>
<style>
:global(.frlf8gb6v) {
  fill: none;
  stroke: currentColor;
