...
const content = `<path class="a-jnqj_9e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:person-sound-spatial-20-regular" {...props}></Icon>
<style>
:global(.a-jnqj_9e) {
  fill: currentColor;
