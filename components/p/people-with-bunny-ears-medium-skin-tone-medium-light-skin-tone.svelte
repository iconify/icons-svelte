...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto:people-with-bunny-ears-medium-skin-tone-medium-light-skin-tone" {...props}></Icon>
<style>
:global(.ad3lljb7d) {
