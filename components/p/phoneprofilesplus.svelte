...
const content = `<path class="yjm1qhb_m"/><path class="w6984xbid"/><path class="azxpwkh4z"/><path class="xqhsnz7-v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:phoneprofilesplus" {...props}></Icon>
<style>
:global(.azxpwkh4z) {
  fill: none;
  stroke: currentColor;
