...
const content = `<path class="zbxpy3bee"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:phonelink-erase-outline-sharp" {...props}></Icon>
<style>
:global(.zbxpy3bee) {
  fill: currentColor;
