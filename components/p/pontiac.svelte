...
const content = `<path class="u7w53sbwj"/><path class="u0metps2m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:pontiac" {...props}></Icon>
<style>
:global(.u0metps2m) {
  fill: none;
  stroke: currentColor;
