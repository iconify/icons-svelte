...
const content = `<path class="xsa_67b2f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:phone-pagination-20-filled" {...props}></Icon>
<style>
:global(.xsa_67b2f) {
  fill: currentColor;
