...
const content = `<circle class="cpk0fnbgt"/><path class="a2aobabww"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:power-marathon" {...props}></Icon>
<style>
:global(.a2aobabww) {
  fill: none;
  stroke: currentColor;
