...
const content = `<g class="cuyn6tgcc"><path class="rmfg5mk6q"/><path class="b4hsfdbrd"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:plus-duotone" {...props}></Icon>
<style>
:global(.b4hsfdbrd) {
