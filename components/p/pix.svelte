...
const content = `<rect class="uhx3m_1tm"/><path class="xjr6vj7gz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:pix" {...props}></Icon>
<style>
:global(.uhx3m_1tm) {
  width: 31px;
  height: 39px;
