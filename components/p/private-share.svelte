...
const content = `<path class="a078x0b7t"/><circle class="uhup1wbuj"/><circle class="w3bgvcbxi"/><circle class="j7vviltzo"/><path class="j3q-1ab4o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:private-share" {...props}></Icon>
<style>
:global(.a078x0b7t) {
  fill: none;
  stroke: currentColor;
