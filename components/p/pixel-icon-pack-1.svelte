...
const content = `<circle class="cpk0fnbgt"/><path class="ynaxux1nd"/><path class="jkn7x_bcl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:pixel-icon-pack-1" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
