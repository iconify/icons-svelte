...
const content = `<path class="dgaydki2p"/><g class="y9tr6bcfx"><path class="fi-8e5b8q"/><rect class="hgh2xyb3u"/><circle class="jn8zzponk"/><path class="xzictkbiv"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:pix-material-you" {...props}></Icon>
<style>
:global(.dgaydki2p) {
  fill: none;
  stroke: currentColor;
