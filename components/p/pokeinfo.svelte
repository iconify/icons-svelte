...
const content = `<circle class="lussfccyh"/><path class="tlrsm2but"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:pokeinfo" {...props}></Icon>
<style>
:global(.lussfccyh) {
  cx: 13.229px;
  cy: 24px;
