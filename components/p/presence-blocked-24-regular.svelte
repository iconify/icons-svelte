...
const content = `<path class="zo_45tb6s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:presence-blocked-24-regular" {...props}></Icon>
<style>
:global(.zo_45tb6s) {
  fill: currentColor;
