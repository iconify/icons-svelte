...
const content = `<path class="x3p_2cbwe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:presence-unknown-20-regular" {...props}></Icon>
<style>
:global(.x3p_2cbwe) {
  fill: currentColor;
