...
const content = `<path class="a_aqnhbtp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:picture-in-picture-mobile-rounded" {...props}></Icon>
<style>
:global(.a_aqnhbtp) {
  fill: currentColor;
