...
const content = `<circle class="cpk0fnbgt"/><path class="bewe4obwz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:polarsteps" {...props}></Icon>
<style>
:global(.bewe4obwz) {
  fill: none;
  stroke: currentColor;
