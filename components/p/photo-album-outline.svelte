...
const content = `<path class="i48xn9jxe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:photo-album-outline" {...props}></Icon>
<style>
:global(.i48xn9jxe) {
  fill: currentColor;
