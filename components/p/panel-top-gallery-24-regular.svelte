...
const content = `<path class="ug8w1fywr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:panel-top-gallery-24-regular" {...props}></Icon>
<style>
:global(.ug8w1fywr) {
  fill: currentColor;
