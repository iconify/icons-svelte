...
const content = `<path class="tu8h7nb7l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:person-head-hint-20-regular" {...props}></Icon>
<style>
:global(.tu8h7nb7l) {
  fill: currentColor;
