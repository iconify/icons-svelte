...
const content = `<path class="xhjky3bhc"/><path class="a511ixfis"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:presently" {...props}></Icon>
<style>
:global(.a511ixfis) {
  fill: none;
  stroke: currentColor;
