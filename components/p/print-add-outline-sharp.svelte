...
const content = `<path class="bnd39bc8e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:print-add-outline-sharp" {...props}></Icon>
<style>
:global(.bnd39bc8e) {
  fill: currentColor;
