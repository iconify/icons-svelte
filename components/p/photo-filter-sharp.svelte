...
const content = `<path class="aje1izkvj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:photo-filter-sharp" {...props}></Icon>
<style>
:global(.aje1izkvj) {
  fill: currentColor;
