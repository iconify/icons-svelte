...
const content = `<path class="ov7be24bo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:presence-available-20-filled" {...props}></Icon>
<style>
:global(.ov7be24bo) {
  fill: currentColor;
