...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent-emoji-high-contrast:person-in-motorized-wheelchair-facing-right" {...props}></Icon>
