...
const content = `<path class="opatfvfap"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:smart-screen-outline-sharp" {...props}></Icon>
<style>
:global(.opatfvfap) {
  fill: currentColor;
