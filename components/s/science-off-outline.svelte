...
const content = `<path class="i14oltdsh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:science-off-outline" {...props}></Icon>
<style>
:global(.i14oltdsh) {
  fill: currentColor;
