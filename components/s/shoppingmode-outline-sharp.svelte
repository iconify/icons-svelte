...
const content = `<path class="kthd73b_m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:shoppingmode-outline-sharp" {...props}></Icon>
<style>
:global(.kthd73b_m) {
  fill: currentColor;
