...
const content = `<path class="fyeffcixn"/><path class="a2k3lob4a"/><path class="i9o4z6bah"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:sundrug" {...props}></Icon>
<style>
:global(.a2k3lob4a) {
  fill: none;
  stroke: currentColor;
