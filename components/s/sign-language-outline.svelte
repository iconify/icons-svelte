...
const content = `<path class="jcbfqgi0z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:sign-language-outline" {...props}></Icon>
<style>
:global(.jcbfqgi0z) {
  fill: currentColor;
