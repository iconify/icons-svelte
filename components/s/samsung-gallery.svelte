...
const content = `<circle class="wly-7hb-l"/><path class="vgb2beb0n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:samsung-gallery" {...props}></Icon>
<style>
:global(.vgb2beb0n) {
  fill: none;
  stroke: currentColor;
