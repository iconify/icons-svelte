...
const content = `<path class="qj77u6b9e"/><circle class="rt_37l3dj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:six-oclock" {...props}></Icon>
<style>
:global(.qj77u6b9e) {
  fill: currentColor;
