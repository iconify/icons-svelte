...
const content = `<path class="kuglf7bgm"/><path class="tyqiojb2v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-app-blocking" {...props}></Icon>
<style>
:global(.kuglf7bgm) {
  fill: currentColor;
