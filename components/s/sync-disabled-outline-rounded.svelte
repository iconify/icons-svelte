...
const content = `<path class="k-d3gp3sa"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:sync-disabled-outline-rounded" {...props}></Icon>
<style>
:global(.k-d3gp3sa) {
  fill: currentColor;
