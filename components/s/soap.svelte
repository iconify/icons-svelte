...
const content = `<rect class="k9m837zmt"/><path class="wnymk0dtn"/><ellipse class="ind1bhbbw"/><ellipse transform="rotate(-25.363 19.675 23.708)" class="k94rlf5pq"/><path class="dteugxsuc"/><ellipse transform="rotate(-50.384 25.853 26.851)" class="phaz9-yda"/><g class="brzn_0bpr"><path class="m7uaaktyk"/><path class="gnv3_xb7x"/><circle class="krbx5chqx"/><path class="d87isib1k"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="openmoji:soap" {...props}></Icon>
