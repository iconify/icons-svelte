...
const content = `<path class="o2p8znbwv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:smartphone-camera-sharp" {...props}></Icon>
<style>
:global(.o2p8znbwv) {
  fill: currentColor;
