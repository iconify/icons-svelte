...
const content = `<g class="cuyn6tgcc"><path class="g1q21ib8z"/><path class="m2c69rbrn"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:shower-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
