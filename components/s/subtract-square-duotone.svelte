...
const content = `<g class="cuyn6tgcc"><path class="gyzn7pp-t"/><path class="nlhxnr71c"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:subtract-square-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
