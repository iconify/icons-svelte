...
const content = `<g class="nrj6p8qat"><path class="zu7ckv_si"/><path class="gu2t7bbiz"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:search-2-plus-two-tone" {...props}></Icon>
<style>
:global(.gu2t7bbiz) {
