...
const content = `<path class="pvg437b1a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:screen-share-sharp" {...props}></Icon>
<style>
:global(.pvg437b1a) {
  fill: currentColor;
