...
const content = `<path class="id601r10a"/><circle class="n7pmbrbkp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:sugarizer" {...props}></Icon>
<style>
:global(.id601r10a) {
  fill: none;
  stroke: currentColor;
