...
const content = `<path class="ymibcc01g"/><path class="s31hdjcbz"/><path class="k4n51fjcs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-20mp" {...props}></Icon>
<style>
:global(.k4n51fjcs) {
  fill: currentColor;
