...
const content = `<path class="hx6wibc_i"/><path class="q3ywikq0d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:stickers" {...props}></Icon>
<style>
:global(.hx6wibc_i) {
  fill: none;
  stroke: currentColor;
