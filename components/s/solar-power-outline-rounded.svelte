...
const content = `<path class="rpr9z7ipk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:solar-power-outline-rounded" {...props}></Icon>
<style>
:global(.rpr9z7ipk) {
  fill: currentColor;
