...
const content = `<g class="cuyn6tgcc"><path class="xvklfxbfy"/><path class="gla2xebkg"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:seatbelt-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
