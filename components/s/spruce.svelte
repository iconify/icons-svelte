...
const content = `<path class="lq_4-nucw"/><path class="cx-5rf6kc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:spruce" {...props}></Icon>
<style>
:global(.cx-5rf6kc) {
  fill: none;
  stroke: currentColor;
