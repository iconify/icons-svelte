...
const content = `<path class="e2-7umr8l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:stylus-pen-outline-sharp" {...props}></Icon>
<style>
:global(.e2-7umr8l) {
  fill: currentColor;
