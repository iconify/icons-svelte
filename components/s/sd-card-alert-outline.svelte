...
const content = `<path class="f_bbs8b8y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:sd-card-alert-outline" {...props}></Icon>
<style>
:global(.f_bbs8b8y) {
  fill: currentColor;
