...
const content = `<path class="psk8w97uc"/><path class="oexvrob8j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:smartnews" {...props}></Icon>
<style>
:global(.oexvrob8j) {
  fill: none;
  stroke: currentColor;
