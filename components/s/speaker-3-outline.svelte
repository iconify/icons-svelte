...
const content = `<path class="i055xxbhj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:speaker-3-outline" {...props}></Icon>
<style>
:global(.i055xxbhj) {
  fill: currentColor;
