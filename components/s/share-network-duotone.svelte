...
const content = `<g class="cuyn6tgcc"><path class="tkrsc0r5j"/><path class="l-b2mxlvx"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:share-network-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
