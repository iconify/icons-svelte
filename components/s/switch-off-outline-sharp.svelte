...
const content = `<path class="zgg70jx_i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:switch-off-outline-sharp" {...props}></Icon>
<style>
:global(.zgg70jx_i) {
  fill: currentColor;
