...
const content = `<g class="cuyn6tgcc"><path class="pl82ehbgs"/><path class="g-wyqlvfb"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:suitcase-rolling-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
