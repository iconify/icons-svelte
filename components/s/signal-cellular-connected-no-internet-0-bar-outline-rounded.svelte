...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:signal-cellular-connected-no-internet-0-bar-outline-rounded" {...props}></Icon>
<style>
:global(.pezs0kumg) {
  fill: currentColor;
