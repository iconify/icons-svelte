...
const content = `<path class="yt3qnbcds"/><path class="umlu0gbvu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:splitwise" {...props}></Icon>
<style>
:global(.umlu0gbvu) {
  fill: none;
  stroke: currentColor;
