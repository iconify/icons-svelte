...
const content = `<g class="cuyn6tgcc"><path class="sj-1a6b7h"/><path class="b2wbhi60j"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:subtitles-slash-duotone" {...props}></Icon>
<style>
:global(.b2wbhi60j) {
