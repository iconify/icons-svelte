...
const content = `<g class="cuyn6tgcc"><path class="ij10vcquj"/><path class="l6f85rb9o"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:sparkle-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
