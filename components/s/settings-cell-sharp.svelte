...
const content = `<path class="wynrskdsw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:settings-cell-sharp" {...props}></Icon>
<style>
:global(.wynrskdsw) {
  fill: currentColor;
