...
const content = `<path class="nxjt6zb8e"/><circle class="soci7ctjl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-attribution" {...props}></Icon>
<style>
:global(.nxjt6zb8e) {
  fill: currentColor;
