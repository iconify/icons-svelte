...
const content = `<path class="ijzf-5x4z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:shield-rounded" {...props}></Icon>
<style>
:global(.ijzf-5x4z) {
  fill: currentColor;
