...
const content = `<path class="btm9xbczx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:stack-off-outline-sharp" {...props}></Icon>
<style>
:global(.btm9xbczx) {
  fill: currentColor;
