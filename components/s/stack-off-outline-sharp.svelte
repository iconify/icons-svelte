...
const content = `<path class="ht609ebqz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:stack-off-outline-sharp" {...props}></Icon>
<style>
:global(.ht609ebqz) {
  fill: currentColor;
