...
const content = `<circle class="h_eald1od"/><path class="o7b_zg4zt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:shop-apotheke-redcare" {...props}></Icon>
<style>
:global(.h_eald1od) {
  cx: 11.419px;
  cy: 36.588px;
