...
const content = `<path clip-rule="evenodd" class="sgig6s6kb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:square-half-sharp-fill" {...props}></Icon>
<style>
:global(.sgig6s6kb) {
  fill: currentColor;
  fill-rule: evenodd;
