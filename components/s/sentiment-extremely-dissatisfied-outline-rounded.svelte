...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:sentiment-extremely-dissatisfied-outline-rounded" {...props}></Icon>
<style>
:global(.t_v80cktg) {
  fill: currentColor;
