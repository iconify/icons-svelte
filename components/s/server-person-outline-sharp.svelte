...
const content = `<path class="kw0qb5bjg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:server-person-outline-sharp" {...props}></Icon>
<style>
:global(.kw0qb5bjg) {
  fill: currentColor;
