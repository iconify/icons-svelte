...
const content = `<path class="k4n51fjcs"/><path class="tml_9tvbb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-15mp" {...props}></Icon>
<style>
:global(.k4n51fjcs) {
  fill: currentColor;
