...
const content = `<path class="vv5bz0aqx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:settop-component" {...props}></Icon>
<style>
:global(.vv5bz0aqx) {
  fill: currentColor;
