...
const content = `<rect class="j3s9ivbxi"/><path class="fi_vsxxkp"/><path class="iw1qjnbeu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:saikou" {...props}></Icon>
<style>
:global(.fi_vsxxkp) {
  fill: none;
  stroke: currentColor;
