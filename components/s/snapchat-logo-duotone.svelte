...
const content = `<g class="cuyn6tgcc"><path class="q6fdq3byd"/><path class="rv03ejbue"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:snapchat-logo-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
