...
const content = `<path class="w15n67biq"/><g class="y9tr6bcfx"><path class="bglp60yyv"/><circle class="mxqmarbxp"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:sparkasse-s-identity" {...props}></Icon>
<style>
:global(.bglp60yyv) {
