...
const content = `<path class="tyd9-5bct"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:sunny-snowing-outline-rounded" {...props}></Icon>
<style>
:global(.tyd9-5bct) {
  fill: currentColor;
