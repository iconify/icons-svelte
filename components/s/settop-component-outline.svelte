...
const content = `<path class="w8ixkzbuu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:settop-component-outline" {...props}></Icon>
<style>
:global(.w8ixkzbuu) {
  fill: currentColor;
