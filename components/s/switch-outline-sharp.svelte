...
const content = `<path class="ol-woebdw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:switch-outline-sharp" {...props}></Icon>
<style>
:global(.ol-woebdw) {
  fill: currentColor;
