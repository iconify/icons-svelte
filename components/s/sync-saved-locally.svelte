...
const content = `<path class="z-xy2_dwd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:sync-saved-locally" {...props}></Icon>
<style>
:global(.z-xy2_dwd) {
  fill: currentColor;
