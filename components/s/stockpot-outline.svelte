...
const content = `<path class="q7ek31buv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:stockpot-outline" {...props}></Icon>
<style>
:global(.q7ek31buv) {
  fill: currentColor;
