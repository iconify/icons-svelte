...
const content = `<path class="bcf3kebdt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:settings-input-component-outline-sharp" {...props}></Icon>
<style>
:global(.bcf3kebdt) {
  fill: currentColor;
