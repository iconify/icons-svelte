...
const content = `<path class="sp6-nrqzl"/><path class="ddlcvx9av"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:stream-vision" {...props}></Icon>
<style>
:global(.ddlcvx9av) {
  fill: none;
  stroke: currentColor;
