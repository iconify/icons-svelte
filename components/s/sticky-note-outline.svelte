...
const content = `<path class="j-_h3o5ha"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:sticky-note-outline" {...props}></Icon>
<style>
:global(.j-_h3o5ha) {
  fill: currentColor;
