...
const content = `<path class="lu0chjbwl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:sword-rose-rounded" {...props}></Icon>
<style>
:global(.lu0chjbwl) {
  fill: currentColor;
