...
const content = `<path class="ouejvjbbz"/><path class="wj299tcct"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:stop-sign" {...props}></Icon>
<style>
:global(.ouejvjbbz) {
