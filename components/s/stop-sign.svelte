...
const content = `<path class="j4tfmqqjn"/><path class="lzdhiubyb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:stop-sign" {...props}></Icon>
<style>
:global(.j4tfmqqjn) {
  fill: currentColor;
