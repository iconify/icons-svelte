...
const content = `<path class="mokozebfj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:share-close-tray-24-filled" {...props}></Icon>
<style>
:global(.mokozebfj) {
  fill: currentColor;
