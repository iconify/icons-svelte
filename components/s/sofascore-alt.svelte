...
const content = `<g class="y9tr6bcfx"><path class="w6xpakq5v"/><path class="u7-t76brg"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:sofascore-alt" {...props}></Icon>
<style>
:global(.u7-t76brg) {
