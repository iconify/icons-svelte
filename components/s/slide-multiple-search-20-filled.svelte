...
const content = `<path class="v3r1hdcoi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:slide-multiple-search-20-filled" {...props}></Icon>
<style>
:global(.v3r1hdcoi) {
  fill: currentColor;
