...
const content = `<circle class="rhvdvboaq"/><g class="nv_n5pb_p"><circle class="f97bvyy1m"/><circle class="fi-bbccoy"/></g><path class="jdzv6p5dq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione:smiling-face-with-smiling-eyes" {...props}></Icon>
<style>
:global(.f97bvyy1m) {
  cx: 50.8px;
  cy: 36px;
