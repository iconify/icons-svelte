...
const content = `<path class="en6bmzobv"/><path class="t6djw337a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-handyman" {...props}></Icon>
<style>
:global(.en6bmzobv) {
  fill: currentColor;
