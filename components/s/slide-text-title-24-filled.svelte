...
const content = `<path class="p86bd2bnm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:slide-text-title-24-filled" {...props}></Icon>
<style>
:global(.p86bd2bnm) {
  fill: currentColor;
