...
const content = `<path class="ojq1czbke"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:supervised-user-circle-off-rounded" {...props}></Icon>
<style>
:global(.ojq1czbke) {
  fill: currentColor;
