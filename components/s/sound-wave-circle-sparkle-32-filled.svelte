...
const content = `<path class="ygfnnubei"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:sound-wave-circle-sparkle-32-filled" {...props}></Icon>
<style>
:global(.ygfnnubei) {
  fill: currentColor;
