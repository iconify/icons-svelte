...
const content = `<circle class="n6xinhc7m"/><path class="ywegumklb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-record-voice-over" {...props}></Icon>
<style>
:global(.n6xinhc7m) {
  cx: 9px;
  cy: 9px;
