...
const content = `<path class="sqhabjbgt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:straighten-outline" {...props}></Icon>
<style>
:global(.sqhabjbgt) {
  fill: currentColor;
