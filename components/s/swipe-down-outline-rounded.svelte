...
const content = `<path class="vuccx8bet"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:swipe-down-outline-rounded" {...props}></Icon>
<style>
:global(.vuccx8bet) {
  fill: currentColor;
