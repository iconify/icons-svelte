...
const content = `<circle class="hq5hau5ws"/><circle class="k4ops4bkt"/><circle class="u7-c5ks7w"/><path class="lstsfzsuq"/><path class="bh-ozpb3p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:snowman-without-snow" {...props}></Icon>
<style>
:global(.bh-ozpb3p) {
  fill: currentColor;
