...
const content = `<g class="cuyn6tgcc"><path class="e0godxbzl"/><path class="nl0n8abhk"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:skip-back-circle-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
