...
const content = `<circle class="ox62ppbtl"/><path class="m2_97d_cb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-plagiarism" {...props}></Icon>
<style>
:global(.m2_97d_cb) {
  fill: currentColor;
