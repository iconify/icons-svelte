...
const content = `<path class="qenpenbrp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:save-as-sharp" {...props}></Icon>
<style>
:global(.qenpenbrp) {
  fill: currentColor;
