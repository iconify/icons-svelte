...
const content = `<path class="polg1ibmx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:slideshow-outline-rounded" {...props}></Icon>
<style>
:global(.polg1ibmx) {
  fill: currentColor;
