...
const content = `<g class="cuyn6tgcc"><path class="fo_gmx7hd"/><path class="o_5x9tkbo"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:stop-circle-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
