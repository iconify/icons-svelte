...
const content = `<path class="alv27gnpw"/><circle class="azhi__bko"/><path class="a-z5fpb6s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:stuff" {...props}></Icon>
<style>
:global(.a-z5fpb6s) {
  fill: none;
  stroke: currentColor;
