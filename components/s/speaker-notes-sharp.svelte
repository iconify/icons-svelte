...
const content = `<path class="dc2d28bam"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:speaker-notes-sharp" {...props}></Icon>
<style>
:global(.dc2d28bam) {
  fill: currentColor;
