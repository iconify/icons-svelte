...
const content = `<path class="k4n51fjcs"/><path class="vqeuqpbcs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-4mp" {...props}></Icon>
<style>
:global(.k4n51fjcs) {
  fill: currentColor;
