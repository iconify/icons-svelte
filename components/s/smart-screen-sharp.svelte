...
const content = `<path class="v9lre6i7s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:smart-screen-sharp" {...props}></Icon>
<style>
:global(.v9lre6i7s) {
  fill: currentColor;
