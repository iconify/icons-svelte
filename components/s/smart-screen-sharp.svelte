...
const content = `<path class="eh700nn6o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:smart-screen-sharp" {...props}></Icon>
<style>
:global(.eh700nn6o) {
  fill: currentColor;
