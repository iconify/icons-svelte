...
const content = `<path class="pw0q6abqj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:service-directory" {...props}></Icon>
<style>
:global(.pw0q6abqj) {
  fill: currentColor;
