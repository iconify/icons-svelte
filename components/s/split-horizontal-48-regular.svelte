...
const content = `<path class="by6c_1b_f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:split-horizontal-48-regular" {...props}></Icon>
<style>
:global(.by6c_1b_f) {
  fill: currentColor;
