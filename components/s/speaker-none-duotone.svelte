...
const content = `<g class="cuyn6tgcc"><path class="d8rkm0b3g"/><path class="g7b5v6bnu"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:speaker-none-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
