...
const content = `<circle class="nep5nrbam"/><path class="m2i31bbje"/><path class="ju91glbwu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:securid" {...props}></Icon>
<style>
:global(.ju91glbwu) {
  fill: none;
  stroke: currentColor;
