...
const content = `<path class="vv9c0wbul"/><path class="u0v559fvc"/><path class="jid99gkka"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:syncme" {...props}></Icon>
<style>
:global(.jid99gkka) {
  fill: none;
  stroke: currentColor;
