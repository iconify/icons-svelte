...
const content = `<path class="fl2wje-dc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:swipe-up-alt-rounded" {...props}></Icon>
<style>
:global(.fl2wje-dc) {
  fill: currentColor;
