...
const content = `<g class="cuyn6tgcc"><path class="kp80x75nx"/><path class="n9c27ybzk"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:stool-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
