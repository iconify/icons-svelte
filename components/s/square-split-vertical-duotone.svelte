...
const content = `<g class="cuyn6tgcc"><path class="a61atdw8z"/><path class="xkk65cb_x"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:square-split-vertical-duotone" {...props}></Icon>
<style>
:global(.a61atdw8z) {
