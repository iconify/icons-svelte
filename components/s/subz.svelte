...
const content = `<path class="wxbme9kle"/><path class="sjxn19_9r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:subz" {...props}></Icon>
<style>
:global(.sjxn19_9r) {
  fill: none;
  stroke: currentColor;
