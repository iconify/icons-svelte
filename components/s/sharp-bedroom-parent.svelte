...
const content = `<path class="unlmzsb6d"/><path class="mqs5lbnim"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-bedroom-parent" {...props}></Icon>
<style>
:global(.mqs5lbnim) {
  fill: currentColor;
