...
const content = `<path class="m_7_ykb4i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:steering-wheel-cool-outline-rounded" {...props}></Icon>
<style>
:global(.m_7_ykb4i) {
  fill: currentColor;
