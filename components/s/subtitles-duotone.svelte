...
const content = `<g class="cuyn6tgcc"><path class="sj-1a6b7h"/><path class="rnk1gub9c"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:subtitles-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
