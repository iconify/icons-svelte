...
const content = `<path class="woj2g-bcw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:specific-gravity-rounded" {...props}></Icon>
<style>
:global(.woj2g-bcw) {
  fill: currentColor;
