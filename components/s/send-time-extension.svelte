...
const content = `<path class="lxfrt_b1f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:send-time-extension" {...props}></Icon>
<style>
:global(.lxfrt_b1f) {
  fill: currentColor;
