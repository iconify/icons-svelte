...
const content = `<path class="ekdfz3b2d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:subtract-square-multiple-20-filled" {...props}></Icon>
<style>
:global(.ekdfz3b2d) {
  fill: currentColor;
