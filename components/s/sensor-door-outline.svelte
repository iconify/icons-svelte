...
const content = `<path class="nkdyjm5mn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:sensor-door-outline" {...props}></Icon>
<style>
:global(.nkdyjm5mn) {
  fill: currentColor;
