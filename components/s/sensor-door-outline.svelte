...
const content = `<path class="yso0yo6pz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:sensor-door-outline" {...props}></Icon>
<style>
:global(.yso0yo6pz) {
  fill: currentColor;
