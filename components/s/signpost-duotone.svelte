...
const content = `<g class="cuyn6tgcc"><path class="w9yal4bar"/><path class="f6k2f9btx"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:signpost-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
