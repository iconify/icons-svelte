...
const content = `<path class="o646ci6-o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:sheets-rtl-outline-sharp" {...props}></Icon>
<style>
:global(.o646ci6-o) {
  fill: currentColor;
