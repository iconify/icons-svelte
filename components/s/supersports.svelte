...
const content = `<path class="ofu66bc2h"/><path class="ml64twbpq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:supersports" {...props}></Icon>
<style>
:global(.ml64twbpq) {
  fill: none;
  stroke: currentColor;
