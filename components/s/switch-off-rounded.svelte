...
const content = `<path class="okj4k6btb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:switch-off-rounded" {...props}></Icon>
<style>
:global(.okj4k6btb) {
  fill: currentColor;
