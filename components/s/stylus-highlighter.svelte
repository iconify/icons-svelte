...
const content = `<path class="e-9y27bjk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:stylus-highlighter" {...props}></Icon>
<style>
:global(.e-9y27bjk) {
  fill: currentColor;
