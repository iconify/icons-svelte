...
const content = `<path class="guq7n-k9s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:stylus-highlighter" {...props}></Icon>
<style>
:global(.guq7n-k9s) {
  fill: currentColor;
