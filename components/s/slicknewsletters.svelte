...
const content = `<path class="f9_mikb3k"/><path class="ckm2ambrr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:slicknewsletters" {...props}></Icon>
<style>
:global(.ckm2ambrr) {
  fill: none;
  stroke: currentColor;
