...
const content = `<path class="b05-znbow"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:sdk-outline-sharp" {...props}></Icon>
<style>
:global(.b05-znbow) {
  fill: currentColor;
