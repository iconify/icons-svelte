...
const content = `<path class="hc564h_bz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:sim-card-download-outline" {...props}></Icon>
<style>
:global(.hc564h_bz) {
  fill: currentColor;
