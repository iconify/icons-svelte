...
const content = `<path class="p8-lgrbjx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:settings-cell-outline-sharp" {...props}></Icon>
<style>
:global(.p8-lgrbjx) {
  fill: currentColor;
