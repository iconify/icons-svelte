...
const content = `<g class="gp_8x1bzb"><path class="wu4br8bxj"/><path class="fjhmvebfg"/><path class="r0sazqbgm"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:server-zap-sharp-two-tone" {...props}></Icon>
<style>
:global(.fjhmvebfg) {
