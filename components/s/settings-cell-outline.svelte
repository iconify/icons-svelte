...
const content = `<path class="eru3ubclo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:settings-cell-outline" {...props}></Icon>
<style>
:global(.eru3ubclo) {
  fill: currentColor;
