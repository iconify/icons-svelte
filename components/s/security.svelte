...
const content = `<path class="vb_uuxzdb"/><path class="vx6l80h8o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:security" {...props}></Icon>
<style>
:global(.vb_uuxzdb) {
  fill: none;
  stroke: currentColor;
