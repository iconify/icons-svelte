...
const content = `<path class="mpjea5wpc"/><path class="hzpqnlmob"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:snaptick" {...props}></Icon>
<style>
:global(.hzpqnlmob) {
  fill: none;
  stroke: currentColor;
