...
const content = `<path class="lys-q0yio"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:steering-wheel-heat-outline-sharp" {...props}></Icon>
<style>
:global(.lys-q0yio) {
  fill: currentColor;
