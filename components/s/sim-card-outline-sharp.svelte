...
const content = `<path class="rt1kjcbmt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:sim-card-outline-sharp" {...props}></Icon>
<style>
:global(.rt1kjcbmt) {
  fill: currentColor;
