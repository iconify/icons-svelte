...
const content = `<path class="y6ggye-ao"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:slab-serif-outline-sharp" {...props}></Icon>
<style>
:global(.y6ggye-ao) {
  fill: currentColor;
