...
const content = `<path class="uv0367b0k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:sport-cricket-ball-16-regular" {...props}></Icon>
<style>
:global(.uv0367b0k) {
  fill: currentColor;
