...
const content = `<path class="fkzou3b6j"/><circle class="mmbi6vbhk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:sound-search" {...props}></Icon>
<style>
:global(.fkzou3b6j) {
  fill: none;
  stroke: currentColor;
