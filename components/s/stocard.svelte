...
const content = `<path class="g_ijb_b9l"/><path class="p0xlkp_sm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:stocard" {...props}></Icon>
<style>
:global(.g_ijb_b9l) {
  fill: none;
  stroke: currentColor;
