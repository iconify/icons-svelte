...
const content = `<path class="m83h07bzo"/><circle class="v4i2ew1ke"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-control-camera" {...props}></Icon>
<style>
:global(.m83h07bzo) {
  fill: currentColor;
