...
const content = `<path class="d31r29bfb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:smart-ventilation-outline" {...props}></Icon>
<style>
:global(.d31r29bfb) {
  fill: currentColor;
