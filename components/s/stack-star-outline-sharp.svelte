...
const content = `<path class="v74sbm72o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:stack-star-outline-sharp" {...props}></Icon>
<style>
:global(.v74sbm72o) {
  fill: currentColor;
