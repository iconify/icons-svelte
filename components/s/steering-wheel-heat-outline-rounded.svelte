...
const content = `<path class="h9r27qbsl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:steering-wheel-heat-outline-rounded" {...props}></Icon>
<style>
:global(.h9r27qbsl) {
  fill: currentColor;
