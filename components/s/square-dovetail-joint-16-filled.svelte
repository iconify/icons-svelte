...
const content = `<path class="urht61w7e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:square-dovetail-joint-16-filled" {...props}></Icon>
<style>
:global(.urht61w7e) {
  fill: currentColor;
