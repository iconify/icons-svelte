...
const content = `<path class="b-th3ib7g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:split-horizontal-16-regular" {...props}></Icon>
<style>
:global(.b-th3ib7g) {
  fill: currentColor;
