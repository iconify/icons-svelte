...
const content = `<path class="f402w085x"/><path class="w9naqb3ng"/><path class="ive_uzb7y"/><path class="j5-kzf53g"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:smiles" {...props}></Icon>
<style>
:global(.f402w085x) {
  fill: none;
  stroke: currentColor;
