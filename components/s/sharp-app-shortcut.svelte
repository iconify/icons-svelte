...
const content = `<path class="ltufvmsdc"/><path class="kpizqibwl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-app-shortcut" {...props}></Icon>
<style>
:global(.kpizqibwl) {
  fill: currentColor;
