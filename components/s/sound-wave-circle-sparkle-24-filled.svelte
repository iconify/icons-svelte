...
const content = `<path class="rcvz68ucz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:sound-wave-circle-sparkle-24-filled" {...props}></Icon>
<style>
:global(.rcvz68ucz) {
  fill: currentColor;
