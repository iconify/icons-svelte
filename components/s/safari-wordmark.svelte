...
const content = `<path class="aq40pabsu"/><linearGradient id="SVGeswNDb6j" x1="295.835" x2="295.835" y1="124.728" y2="123.889" gradientTransform="matrix(112 0 0 -112 -33069.5 13971)" gradientUnits="userSpaceOnUse"><stop offset="0" class="r309-c0lg"/><stop offset="1" class="er4xdd6kj"/></linearGradient><circle fill="url(#SVGeswNDb6j)" class="guxtyxb2y"/><path class="vf8oukbgm"/><path class="w9rnoibmy"/><path class="mwo7e2b8w"/><path class="go6gv7ejv"/><path class="vxpl28bkd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="devicon:safari-wordmark" {...props}></Icon>
