...
const content = `<path class="uiheizesp"/><path class="yxqjyfhtk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:sicoob" {...props}></Icon>
<style>
:global(.uiheizesp) {
  fill: none;
  stroke: currentColor;
