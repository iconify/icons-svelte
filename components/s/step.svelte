...
const content = `<path class="hels24b_z"/><path class="mrkqhkbsu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:step" {...props}></Icon>
<style>
:global(.hels24b_z) {
  fill: none;
  stroke: currentColor;
