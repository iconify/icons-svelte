...
const content = `<path clip-rule="evenodd" class="yshfbp1mf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:sai" {...props}></Icon>
<style>
:global(.yshfbp1mf) {
