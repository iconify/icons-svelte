...
const content = `<circle class="cpk0fnbgt"/><path class="m54-_3yjg"/><circle class="ow08pwbqt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:sectograph" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
