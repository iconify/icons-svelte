...
const content = `<circle class="k4o_yjbkq"/><circle class="cpk0fnbgt"/><path class="scircabmk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:seeder" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
