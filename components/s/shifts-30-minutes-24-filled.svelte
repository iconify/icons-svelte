...
const content = `<path class="jy0kkccfb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:shifts-30-minutes-24-filled" {...props}></Icon>
<style>
:global(.jy0kkccfb) {
  fill: currentColor;
