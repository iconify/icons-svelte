...
const content = `<g class="nrj6p8qat"><path class="lwaj0vjwi"/><path class="i5lvicvhn"/><path class="er1p0-brb"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:square-more-horizontal-two-tone" {...props}></Icon>
<style>
:global(.er1p0-brb) {
  fill: currentColor;
