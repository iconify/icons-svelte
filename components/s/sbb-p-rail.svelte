...
const content = `<path class="njvb1ibbs"/><circle class="cpk0fnbgt"/><path class="ww6z_4c0i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:sbb-p-rail" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
