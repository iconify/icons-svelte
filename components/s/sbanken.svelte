...
const content = `<path class="tdnpssb8x"/><path class="q0vmbubqv"/><circle class="ux5xnzb2o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:sbanken" {...props}></Icon>
<style>
:global(.q0vmbubqv) {
  fill: none;
  stroke: currentColor;
