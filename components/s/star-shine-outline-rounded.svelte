...
const content = `<path class="jvkd61bgr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:star-shine-outline-rounded" {...props}></Icon>
<style>
:global(.jvkd61bgr) {
  fill: currentColor;
