...
const content = `<path class="rn2q7qijp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:square-arrow-forward-28-filled" {...props}></Icon>
<style>
:global(.rn2q7qijp) {
  fill: currentColor;
