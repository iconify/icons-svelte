...
const content = `<path class="a1urw2bkn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:straighten" {...props}></Icon>
<style>
:global(.a1urw2bkn) {
  fill: currentColor;
