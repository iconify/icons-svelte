...
const content = `<path class="u_fd4xu0b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:stop-circle-rounded" {...props}></Icon>
<style>
:global(.u_fd4xu0b) {
  fill: currentColor;
