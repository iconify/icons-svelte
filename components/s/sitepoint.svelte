...
const content = `<g class="bi12bsetm"><path class="rfgm5wfky"/><path class="zv5jzbpac"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:sitepoint" {...props}></Icon>
<style>
:global(.bi12bsetm) {
  fill: none;
  fill-rule: evenodd;
