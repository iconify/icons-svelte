...
const content = `<path class="aw-mpcbsl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:settings-motion-mode-outline-sharp" {...props}></Icon>
<style>
:global(.aw-mpcbsl) {
  fill: currentColor;
