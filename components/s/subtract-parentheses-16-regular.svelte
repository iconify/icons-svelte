...
const content = `<path class="vepkob5yf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:subtract-parentheses-16-regular" {...props}></Icon>
<style>
:global(.vepkob5yf) {
  fill: currentColor;
