...
const content = `<path class="zyf1uvbvl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:settings-brightness-outline-sharp" {...props}></Icon>
<style>
:global(.zyf1uvbvl) {
  fill: currentColor;
