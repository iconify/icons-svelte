...
const content = `<path class="oyskbej9b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:splitscreen-portrait-outline-rounded" {...props}></Icon>
<style>
:global(.oyskbej9b) {
  fill: currentColor;
