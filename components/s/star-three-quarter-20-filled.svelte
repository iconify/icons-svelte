...
const content = `<path class="acj3vedku"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:star-three-quarter-20-filled" {...props}></Icon>
<style>
:global(.acj3vedku) {
  fill: currentColor;
