...
const content = `<path class="g8mscwr8r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:specific-gravity-sharp" {...props}></Icon>
<style>
:global(.g8mscwr8r) {
  fill: currentColor;
