...
const content = `<path class="mq-doe4nz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:specific-gravity-sharp" {...props}></Icon>
<style>
:global(.mq-doe4nz) {
  fill: currentColor;
