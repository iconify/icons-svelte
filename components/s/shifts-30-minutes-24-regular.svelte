...
const content = `<path class="e2tj4obzi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:shifts-30-minutes-24-regular" {...props}></Icon>
<style>
:global(.e2tj4obzi) {
  fill: currentColor;
