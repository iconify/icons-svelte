...
const content = `<path class="i54p5fvmn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:sentiment-stressed-outline-rounded" {...props}></Icon>
<style>
:global(.i54p5fvmn) {
  fill: currentColor;
