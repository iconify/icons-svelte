...
const content = `<path class="vad2gho8l"/><path class="nf-6ef8wy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:sleepcycle" {...props}></Icon>
<style>
:global(.nf-6ef8wy) {
  fill: none;
  stroke: currentColor;
