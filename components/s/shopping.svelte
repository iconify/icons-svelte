...
const content = `<path class="ybwxp8b_n"/><path class="wypt4abus"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:shopping" {...props}></Icon>
<style>
:global(.wypt4abus) {
  fill: none;
  stroke: currentColor;
