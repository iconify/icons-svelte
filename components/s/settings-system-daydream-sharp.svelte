...
const content = `<path class="n9pkm-9bs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:settings-system-daydream-sharp" {...props}></Icon>
<style>
:global(.n9pkm-9bs) {
  fill: currentColor;
