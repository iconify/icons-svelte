...
const content = `<path class="ubojjgnen"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:settings-system-daydream-sharp" {...props}></Icon>
<style>
:global(.ubojjgnen) {
  fill: currentColor;
