...
const content = `<path class="myhyqybmy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:sport-cricket-bat-20-filled" {...props}></Icon>
<style>
:global(.myhyqybmy) {
  fill: currentColor;
