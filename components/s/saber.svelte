...
const content = `<path class="ppx2-xbhb"/><path class="agtiik0ly"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:saber" {...props}></Icon>
<style>
:global(.agtiik0ly) {
  fill: none;
  stroke: currentColor;
