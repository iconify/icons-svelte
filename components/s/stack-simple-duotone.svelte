...
const content = `<g class="cuyn6tgcc"><path class="o__-ilb4s"/><path class="skmgcwhgy"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:stack-simple-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
