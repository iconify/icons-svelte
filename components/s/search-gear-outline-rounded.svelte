...
const content = `<path class="xjigbt0yb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:search-gear-outline-rounded" {...props}></Icon>
<style>
:global(.xjigbt0yb) {
  fill: currentColor;
