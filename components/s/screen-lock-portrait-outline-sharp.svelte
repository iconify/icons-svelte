...
const content = `<path class="er3i_e_qy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:screen-lock-portrait-outline-sharp" {...props}></Icon>
<style>
:global(.er3i_e_qy) {
  fill: currentColor;
