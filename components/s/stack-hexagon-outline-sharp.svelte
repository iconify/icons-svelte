...
const content = `<path class="amxb2nbzt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:stack-hexagon-outline-sharp" {...props}></Icon>
<style>
:global(.amxb2nbzt) {
  fill: currentColor;
