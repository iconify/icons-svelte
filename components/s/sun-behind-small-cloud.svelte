...
const content = `<path class="w8idfru1h"/><circle class="nyg1cc8-h"/><path class="aiyfz8a7l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:sun-behind-small-cloud" {...props}></Icon>
<style>
:global(.aiyfz8a7l) {
