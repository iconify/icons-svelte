...
const content = `<rect class="j3s9ivbxi"/><path class="h-zmakb0v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:simple-opengles-info" {...props}></Icon>
<style>
:global(.h-zmakb0v) {
  fill: none;
  stroke: currentColor;
