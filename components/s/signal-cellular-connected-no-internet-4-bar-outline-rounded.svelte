...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:signal-cellular-connected-no-internet-4-bar-outline-rounded" {...props}></Icon>
<style>
:global(.tfh8n5bom) {
  fill: currentColor;
