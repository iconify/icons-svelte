...
const content = `<path class="waeawgs5q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:share-close-tray-20-regular" {...props}></Icon>
<style>
:global(.waeawgs5q) {
  fill: currentColor;
