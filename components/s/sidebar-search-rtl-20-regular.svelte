...
const content = `<path class="l40pskauk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:sidebar-search-rtl-20-regular" {...props}></Icon>
<style>
:global(.l40pskauk) {
  fill: currentColor;
