...
const content = `<path class="ztch775aa"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:smartphone-outline" {...props}></Icon>
<style>
:global(.ztch775aa) {
  fill: currentColor;
