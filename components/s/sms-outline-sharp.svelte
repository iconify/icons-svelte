...
const content = `<path class="ffdhr2xjq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:sms-outline-sharp" {...props}></Icon>
<style>
:global(.ffdhr2xjq) {
  fill: currentColor;
