...
const content = `<path class="rxc536b5v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:share-screen-person-overlay-inside-20-filled" {...props}></Icon>
<style>
:global(.rxc536b5v) {
  fill: currentColor;
