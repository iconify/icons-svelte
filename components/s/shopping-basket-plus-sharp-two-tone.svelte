...
const content = `<g class="gp_8x1bzb"><path class="jcfycjb4c"/><path class="rtpw0fbpc"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:shopping-basket-plus-sharp-two-tone" {...props}></Icon>
<style>
:global(.gp_8x1bzb) {
  fill: none;
  stroke: currentColor;
