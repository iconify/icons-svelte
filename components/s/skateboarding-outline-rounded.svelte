...
const content = `<path class="ytvz98bfx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:skateboarding-outline-rounded" {...props}></Icon>
<style>
:global(.ytvz98bfx) {
  fill: currentColor;
