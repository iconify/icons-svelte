...
const content = `<g class="cuyn6tgcc"><path class="tm3vqw7ob"/><path class="whh0r6loe"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:shopping-bag-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
