...
const content = `<path class="uph2ylfok"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:signal-wifi-bad-outline-sharp" {...props}></Icon>
<style>
:global(.uph2ylfok) {
  fill: currentColor;
