...
const content = `<path class="g2wj9jbhp"/><path class="rc6kf1v5g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:spph-connect" {...props}></Icon>
<style>
:global(.g2wj9jbhp) {
  fill: none;
  stroke: currentColor;
