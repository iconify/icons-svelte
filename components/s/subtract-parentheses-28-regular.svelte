...
const content = `<path class="k4l5n8a2v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:subtract-parentheses-28-regular" {...props}></Icon>
<style>
:global(.k4l5n8a2v) {
  fill: currentColor;
