...
const content = `<path class="tj78l5nqd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:settings-night-sight-rounded" {...props}></Icon>
<style>
:global(.tj78l5nqd) {
  fill: currentColor;
