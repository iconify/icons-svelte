...
const content = `<g class="cuyn6tgcc"><path class="vmruz2bfs"/><path class="y_im9hail"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:sunglasses-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
