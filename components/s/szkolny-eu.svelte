...
const content = `<path class="wklvjyxyu"/><circle class="e-q1bpood"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:szkolny-eu" {...props}></Icon>
<style>
:global(.e-q1bpood) {
  cx: 23.912px;
  cy: 25.745px;
