...
const content = `<path class="kj2kf2u4u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:sport-cricket-ball-24-filled" {...props}></Icon>
<style>
:global(.kj2kf2u4u) {
  fill: currentColor;
