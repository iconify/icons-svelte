...
const content = `<g class="cuyn6tgcc"><path class="ek-_0pbeq"/><path class="pqe85qrvv"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:stairs-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
