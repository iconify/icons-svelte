...
const content = `<g class="cuyn6tgcc"><path class="k9589jyde"/><path class="yo088lcno"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:shield-checkered-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
