...
const content = `<path class="pcyyhibmg"/><path class="c3342844d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:saveto" {...props}></Icon>
<style>
:global(.c3342844d) {
  fill: none;
  stroke: currentColor;
