...
const content = `<circle class="b5n5-jbxp"/><circle class="d4cuz1s8g"/><path class="pqmfx-b-l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:satisfyer" {...props}></Icon>
<style>
:global(.b5n5-jbxp) {
  cx: 19.733px;
  cy: 14.231px;
