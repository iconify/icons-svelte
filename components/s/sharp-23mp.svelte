...
const content = `<path class="bj1f5fbpw"/><path class="k4n51fjcs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-23mp" {...props}></Icon>
<style>
:global(.bj1f5fbpw) {
  fill: currentColor;
