...
const content = `<path class="o1u2c-bcj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:splitscreen-vertical-add-sharp" {...props}></Icon>
<style>
:global(.o1u2c-bcj) {
  fill: currentColor;
