...
const content = `<path class="wvvvvlb-u"/><path class="v3i3q32ia"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:showly-oss" {...props}></Icon>
<style>
:global(.v3i3q32ia) {
  fill: none;
  stroke: currentColor;
