...
const content = `<path class="ms-3yr14h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:sound-wave-circle-24-regular" {...props}></Icon>
<style>
:global(.ms-3yr14h) {
  fill: currentColor;
