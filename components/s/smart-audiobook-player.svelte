...
const content = `<circle class="cpk0fnbgt"/><path class="k3okqnbic"/><path class="qfo5gq_iy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:smart-audiobook-player" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
