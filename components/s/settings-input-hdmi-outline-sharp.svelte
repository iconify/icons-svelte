...
const content = `<path class="h09mfibom"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:settings-input-hdmi-outline-sharp" {...props}></Icon>
<style>
:global(.h09mfibom) {
  fill: currentColor;
