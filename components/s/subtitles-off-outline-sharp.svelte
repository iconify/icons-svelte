...
const content = `<path class="n12jqcnfy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:subtitles-off-outline-sharp" {...props}></Icon>
<style>
:global(.n12jqcnfy) {
  fill: currentColor;
