...
const content = `<path class="p1ogj50oh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:smartphone-camera-outline-sharp" {...props}></Icon>
<style>
:global(.p1ogj50oh) {
  fill: currentColor;
