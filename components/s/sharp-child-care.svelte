...
const content = `<circle class="vhr2lj4be"/><circle class="ifds6hbbc"/><path class="rbvv96b6e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-child-care" {...props}></Icon>
<style>
:global(.ifds6hbbc) {
  cx: 9.5px;
  cy: 10.5px;
