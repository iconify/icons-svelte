...
const content = `<circle class="scfsvuyqo"/><path class="rxfphkb7t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:smartwatch" {...props}></Icon>
<style>
:global(.rxfphkb7t) {
  fill: none;
  stroke: currentColor;
