...
const content = `<g class="cuyn6tgcc"><path class="zm5wl-1qw"/><path class="twz9azb4b"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:square-logo-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
