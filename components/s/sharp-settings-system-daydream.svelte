...
const content = `<path class="wlk80nbrs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-settings-system-daydream" {...props}></Icon>
<style>
:global(.wlk80nbrs) {
  fill: currentColor;
