...
const content = `<path class="p18ycs30f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:straighten-rounded" {...props}></Icon>
<style>
:global(.p18ycs30f) {
  fill: currentColor;
