...
const content = `<path class="tdpg9q0zc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:straighten-rounded" {...props}></Icon>
<style>
:global(.tdpg9q0zc) {
  fill: currentColor;
