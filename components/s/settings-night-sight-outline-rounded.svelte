...
const content = `<path class="p26eyccpq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:settings-night-sight-outline-rounded" {...props}></Icon>
<style>
:global(.p26eyccpq) {
  fill: currentColor;
