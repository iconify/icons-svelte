...
const content = `<path class="unpxk9b0z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:settings-account-box-rounded" {...props}></Icon>
<style>
:global(.unpxk9b0z) {
  fill: currentColor;
