...
const content = `<path class="clsr428zp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:sound-wave-circle-16-filled" {...props}></Icon>
<style>
:global(.clsr428zp) {
  fill: currentColor;
