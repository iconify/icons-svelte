...
const content = `<path class="txdn8bbsk"/><path class="a_t6e-vht"/><path class="h1v4hr_7b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:spike-email" {...props}></Icon>
<style>
:global(.a_t6e-vht) {
  fill: none;
  stroke: currentColor;
