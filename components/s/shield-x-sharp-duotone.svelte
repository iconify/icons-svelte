...
const content = `<g class="gp_8x1bzb"><path class="fvd42ib4r"/><path class="w5-w_sbbd"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:shield-x-sharp-duotone" {...props}></Icon>
<style>
:global(.fvd42ib4r) {
  fill: currentColor;
