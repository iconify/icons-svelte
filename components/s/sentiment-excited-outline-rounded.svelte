...
const content = `<path class="vbwemeb5v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:sentiment-excited-outline-rounded" {...props}></Icon>
<style>
:global(.vbwemeb5v) {
  fill: currentColor;
