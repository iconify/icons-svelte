...
const content = `<g class="nrj6p8qat"><path class="t7mqi5p0u"/><path class="r0sazqbgm"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:server-zap" {...props}></Icon>
<style>
:global(.nrj6p8qat) {
  fill: none;
  stroke: currentColor;
