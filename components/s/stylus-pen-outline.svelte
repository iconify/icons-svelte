...
const content = `<path class="zupvatb6y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:stylus-pen-outline" {...props}></Icon>
<style>
:global(.zupvatb6y) {
  fill: currentColor;
