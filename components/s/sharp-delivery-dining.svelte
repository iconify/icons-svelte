...
const content = `<path class="wonq14b-m"/><path class="bdaznj-fp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-delivery-dining" {...props}></Icon>
<style>
:global(.bdaznj-fp) {
  fill: currentColor;
