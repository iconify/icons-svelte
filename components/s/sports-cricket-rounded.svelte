...
const content = `<path class="p2g7l8b2y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:sports-cricket-rounded" {...props}></Icon>
<style>
:global(.p2g7l8b2y) {
  fill: currentColor;
