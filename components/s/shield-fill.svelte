...
const content = `<path clip-rule="evenodd" class="cg198ngpw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:shield-fill" {...props}></Icon>
<style>
:global(.cg198ngpw) {
  fill: currentColor;
  fill-rule: evenodd;
