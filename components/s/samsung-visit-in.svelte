...
const content = `<path class="rg7kgmbdx"/><path class="yatrnmb9z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:samsung-visit-in" {...props}></Icon>
<style>
:global(.rg7kgmbdx) {
  fill: none;
  stroke: currentColor;
