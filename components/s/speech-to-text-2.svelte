...
const content = `<path class="ugwx4tb4h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:speech-to-text-2" {...props}></Icon>
<style>
:global(.ugwx4tb4h) {
  fill: currentColor;
