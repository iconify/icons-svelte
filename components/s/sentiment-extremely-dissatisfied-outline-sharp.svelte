...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:sentiment-extremely-dissatisfied-outline-sharp" {...props}></Icon>
<style>
:global(.rzqhjtb3q) {
  fill: currentColor;
