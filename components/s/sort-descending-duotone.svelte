...
const content = `<g class="cuyn6tgcc"><path class="kehrv6bjc"/><path class="hf0da8bxt"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:sort-descending-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
