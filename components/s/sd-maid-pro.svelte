...
const content = `<path class="r8yo86o1v"/><path class="rt1yb1liv"/><circle class="b7zbuj9kt"/><path class="pkb7zz_3f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:sd-maid-pro" {...props}></Icon>
<style>
:global(.b7zbuj9kt) {
  cx: 37.895px;
  cy: 35.641px;
