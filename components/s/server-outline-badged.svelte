...
const content = `<path class="clr-i-outline--badged clr-i-outline-path-1--badged wyio3f53g"/><path class="clr-i-outline--badged clr-i-outline-path-2--badged i-6ptsbat"/><path class="clr-i-outline--badged clr-i-outline-path-3--badged ff938qbsv"/><path class="clr-i-outline--badged clr-i-outline-path-4--badged mkxsbib5h"/><path class="clr-i-outline--badged clr-i-outline-path-5--badged pe07zqb4w"/><circle class="clr-i-badge clr-i-outline--badged clr-i-outline-path-6--badged lmf0ecbhq"/><path class="m2o3sh-9c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="clarity:server-outline-badged" {...props}></Icon>
