...
const content = `<g class="nrj6p8qat"><path class="k79gm2b1n"/><path class="xtgv3ibid"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:search-x-duotone" {...props}></Icon>
<style>
:global(.k79gm2b1n) {
  fill: currentColor;
