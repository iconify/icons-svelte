...
const content = `<g class="y9tr6bcfx"><path class="pgrfo3g0l"/><path class="namzwubhg"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:sterna-mail" {...props}></Icon>
<style>
:global(.namzwubhg) {
