...
const content = `<defs><linearGradient id="SVGVWpGHclM" x1="47.165%" x2="47.165%" y1="1.316%" y2="81.579%"><stop offset="0%" class="bpa8sbo_m"/><stop offset="100%" class="lozaskbno"/></linearGradient></defs><path fill="url(#SVGVWpGHclM)" class="xhkveub_c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:stylis" {...props}></Icon>
<style>
:global(.bpa8sbo_m) {
