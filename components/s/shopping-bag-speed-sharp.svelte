...
const content = `<path class="z7ghj0bbw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:shopping-bag-speed-sharp" {...props}></Icon>
<style>
:global(.z7ghj0bbw) {
  fill: currentColor;
