...
const content = `<path class="yejj0fbgj"/><path class="gqaprdb3u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:swipefy" {...props}></Icon>
<style>
:global(.gqaprdb3u) {
  fill: none;
  stroke: currentColor;
