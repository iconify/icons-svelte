...
const content = `<path class="r-cauib-c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:stack-group" {...props}></Icon>
<style>
:global(.r-cauib-c) {
  fill: currentColor;
