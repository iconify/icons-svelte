...
const content = `<path class="sntbf5bno"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:slide-text-title-16-regular" {...props}></Icon>
<style>
:global(.sntbf5bno) {
  fill: currentColor;
