...
const content = `<path class="nlbrz7b0i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:subtract-parentheses-20-regular" {...props}></Icon>
<style>
:global(.nlbrz7b0i) {
  fill: currentColor;
