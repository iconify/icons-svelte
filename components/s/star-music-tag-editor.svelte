...
const content = `<path class="zkbiozn1v"/><path class="dt6h75bpd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:star-music-tag-editor" {...props}></Icon>
<style>
:global(.dt6h75bpd) {
  fill: none;
  stroke: currentColor;
