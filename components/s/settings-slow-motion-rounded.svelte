...
const content = `<path class="mjab5xbdw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:settings-slow-motion-rounded" {...props}></Icon>
<style>
:global(.mjab5xbdw) {
  fill: currentColor;
