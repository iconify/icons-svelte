...
const content = `<path class="zp-x_64_b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:splitscreen-landscape" {...props}></Icon>
<style>
:global(.zp-x_64_b) {
  fill: currentColor;
