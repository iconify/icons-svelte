...
const content = `<path class="mo2x3vb4k"/><path class="k4n51fjcs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-11mp" {...props}></Icon>
<style>
:global(.k4n51fjcs) {
  fill: currentColor;
