...
const content = `<path class="nlh3b6xpn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:stack-star-sharp" {...props}></Icon>
<style>
:global(.nlh3b6xpn) {
  fill: currentColor;
