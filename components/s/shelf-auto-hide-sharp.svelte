...
const content = `<path class="ref1upjfh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:shelf-auto-hide-sharp" {...props}></Icon>
<style>
:global(.ref1upjfh) {
  fill: currentColor;
