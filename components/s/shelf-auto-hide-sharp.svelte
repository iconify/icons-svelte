...
const content = `<path class="lmaksbcyk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:shelf-auto-hide-sharp" {...props}></Icon>
<style>
:global(.lmaksbcyk) {
  fill: currentColor;
