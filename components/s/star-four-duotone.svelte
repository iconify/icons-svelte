...
const content = `<g class="cuyn6tgcc"><path class="mq7jfjbzf"/><path class="uz5lfdckj"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:star-four-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
