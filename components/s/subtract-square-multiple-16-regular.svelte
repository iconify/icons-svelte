...
const content = `<path class="zm_8673gz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:subtract-square-multiple-16-regular" {...props}></Icon>
<style>
:global(.zm_8673gz) {
  fill: currentColor;
