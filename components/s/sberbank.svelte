...
const content = `<path class="b8rvnc51q"/><path class="q8ro0ub9b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:sberbank" {...props}></Icon>
<style>
:global(.b8rvnc51q) {
  fill: none;
  stroke: currentColor;
