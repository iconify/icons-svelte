...
const content = `<path class="gqdxtjftk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:shift-rounded" {...props}></Icon>
<style>
:global(.gqdxtjftk) {
  fill: currentColor;
