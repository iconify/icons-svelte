...
const content = `<path class="f57gb6bny"/><path class="i744c0dwj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-sip" {...props}></Icon>
<style>
:global(.f57gb6bny) {
  fill: currentColor;
