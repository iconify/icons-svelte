...
const content = `<circle class="cpk0fnbgt"/><path class="y7i094tms"/><circle class="edi79mb8h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:supertuxkart" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
