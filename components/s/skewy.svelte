...
const content = `<g class="y9tr6bcfx"><rect class="pth7gz5zl"/><path class="uuau9ybtk"/><path class="k7tfx8bqk"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:skewy" {...props}></Icon>
<style>
:global(.k7tfx8bqk) {
