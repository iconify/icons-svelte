...
const content = `<path class="yeh6hvbqm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:skip-forward-30-20-regular" {...props}></Icon>
<style>
:global(.yeh6hvbqm) {
  fill: currentColor;
