...
const content = `<path class="cw-j3lv_b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:sim-card-lock-outline-rounded" {...props}></Icon>
<style>
:global(.cw-j3lv_b) {
  fill: currentColor;
