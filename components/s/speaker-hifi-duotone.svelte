...
const content = `<g class="cuyn6tgcc"><path class="crabvebhu"/><path class="u_l4wccwt"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:speaker-hifi-duotone" {...props}></Icon>
<style>
:global(.crabvebhu) {
