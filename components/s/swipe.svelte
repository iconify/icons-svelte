...
const content = `<path class="fp1e-i5cx"/><path class="g2wj9jbhp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:swipe" {...props}></Icon>
<style>
:global(.fp1e-i5cx) {
  fill: none;
  stroke: currentColor;
