...
const content = `<path class="ji3siccqm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:style-outline-sharp" {...props}></Icon>
<style>
:global(.ji3siccqm) {
  fill: currentColor;
