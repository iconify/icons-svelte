...
const content = `<path class="a0ftn9pps"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:speaker-notes-outline-sharp" {...props}></Icon>
<style>
:global(.a0ftn9pps) {
  fill: currentColor;
