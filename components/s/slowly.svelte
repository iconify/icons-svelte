...
const content = `<circle class="cpk0fnbgt"/><path class="gu-4a4vtg"/><path class="s3_4mebvt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:slowly" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
