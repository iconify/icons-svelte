...
const content = `<path class="ov4x-iwjx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:smartphone-arrow-in-up-right" {...props}></Icon>
<style>
:global(.ov4x-iwjx) {
  fill: none;
  stroke: currentColor;
