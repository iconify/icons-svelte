...
const content = `<path class="qmjta5k8f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:sensor-door-rounded" {...props}></Icon>
<style>
:global(.qmjta5k8f) {
  fill: currentColor;
