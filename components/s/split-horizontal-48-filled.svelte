...
const content = `<path class="ru-jo4b2p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:split-horizontal-48-filled" {...props}></Icon>
<style>
:global(.ru-jo4b2p) {
  fill: currentColor;
