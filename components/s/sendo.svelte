...
const content = `<circle class="jqyms83vg"/><circle class="dbtmipl6y"/><path class="jhkgzvbnb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:sendo" {...props}></Icon>
<style>
:global(.dbtmipl6y) {
  cx: 28.627px;
  cy: 40.122px;
