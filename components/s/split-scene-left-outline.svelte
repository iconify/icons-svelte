...
const content = `<path class="dhy0g_t-n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:split-scene-left-outline" {...props}></Icon>
<style>
:global(.dhy0g_t-n) {
  fill: currentColor;
