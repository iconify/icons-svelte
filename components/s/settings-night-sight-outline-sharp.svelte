...
const content = `<path class="cwylalg7n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:settings-night-sight-outline-sharp" {...props}></Icon>
<style>
:global(.cwylalg7n) {
  fill: currentColor;
