...
const content = `<g class="cuyn6tgcc"><path class="odotykcst"/><path class="yo15zpb8w"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:sort-ascending-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
