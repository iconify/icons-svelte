...
const content = `<path class="crgmwxb_y"/><path class="r0z246bsy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:sram-axs" {...props}></Icon>
<style>
:global(.crgmwxb_y) {
  fill: none;
  stroke: currentColor;
