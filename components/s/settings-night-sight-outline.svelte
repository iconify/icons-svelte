...
const content = `<path class="mhsbkpmov"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:settings-night-sight-outline" {...props}></Icon>
<style>
:global(.mhsbkpmov) {
  fill: currentColor;
