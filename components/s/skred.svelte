...
const content = `<path class="wmmso3_ob"/><path class="z5wlr6bty"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:skred" {...props}></Icon>
<style>
:global(.wmmso3_ob) {
  fill: none;
  stroke: currentColor;
