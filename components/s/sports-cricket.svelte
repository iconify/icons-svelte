...
const content = `<path class="yyy2bx0hb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:sports-cricket" {...props}></Icon>
<style>
:global(.yyy2bx0hb) {
  fill: currentColor;
