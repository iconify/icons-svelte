...
const content = `<g class="ft5dv1b6b"><path class="ro0cx8bfd"/><path class="cd_b8vjfu"/><path class="eqwdt5bic"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:speaker-48-regular" {...props}></Icon>
<style>
:global(.cd_b8vjfu) {
