...
const content = `<path class="cqun6ht2z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:settings-overscan-outline-rounded" {...props}></Icon>
<style>
:global(.cqun6ht2z) {
  fill: currentColor;
