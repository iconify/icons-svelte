...
const content = `<path class="jn_hc_byd"/><path class="e7vta_3ro"/><path class="rok-6lm0o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:smarteggtimer" {...props}></Icon>
<style>
:global(.e7vta_3ro) {
  fill: currentColor;
