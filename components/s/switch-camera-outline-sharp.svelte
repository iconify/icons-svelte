...
const content = `<path class="x5pl_8i8k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:switch-camera-outline-sharp" {...props}></Icon>
<style>
:global(.x5pl_8i8k) {
  fill: currentColor;
