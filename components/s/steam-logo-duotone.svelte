...
const content = `<g class="cuyn6tgcc"><path class="y-ee2ib5t"/><path class="ev7pw4v3l"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:steam-logo-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
