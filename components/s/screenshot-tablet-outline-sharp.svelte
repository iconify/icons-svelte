...
const content = `<path class="jz-232hcz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:screenshot-tablet-outline-sharp" {...props}></Icon>
<style>
:global(.jz-232hcz) {
  fill: currentColor;
