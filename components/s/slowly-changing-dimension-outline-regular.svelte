...
const content = `<g class="nrj6p8qat"><path class="jfvoq9bhn"/><path class="zdgvfxbbv"/><path class="slz7u0oyn"/><path class="uea_ybysx"/><path class="it83nbbll"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:slowly-changing-dimension-outline-regular" {...props}></Icon>
<style>
:global(.it83nbbll) {
