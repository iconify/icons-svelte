...
const content = `<path class="q10hsmivv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:straighten-outline-rounded" {...props}></Icon>
<style>
:global(.q10hsmivv) {
  fill: currentColor;
