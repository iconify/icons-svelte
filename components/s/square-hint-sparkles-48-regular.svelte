...
const content = `<path class="c86ku_67m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:square-hint-sparkles-48-regular" {...props}></Icon>
<style>
:global(.c86ku_67m) {
  fill: currentColor;
