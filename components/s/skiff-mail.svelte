...
const content = `<path class="ed2dvjbsg"/><path class="kqs4rcmpp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:skiff-mail" {...props}></Icon>
<style>
:global(.ed2dvjbsg) {
  fill: none;
  stroke: currentColor;
