...
const content = `<path class="zzskni6tb"/><path class="r3cfn-biu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:speaker-low-volume" {...props}></Icon>
<style>
:global(.r3cfn-biu) {
