...
const content = `<path class="e9c5mft3y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:slide-text-cursor-24-regular" {...props}></Icon>
<style>
:global(.e9c5mft3y) {
  fill: currentColor;
