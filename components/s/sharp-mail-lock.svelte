...
const content = `<path class="yw2rj7a9a"/><path class="den27bbpl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-mail-lock" {...props}></Icon>
<style>
:global(.den27bbpl) {
  fill: currentColor;
