...
const content = `<path class="dygi7ocjg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:stylus-brush-outline-sharp" {...props}></Icon>
<style>
:global(.dygi7ocjg) {
  fill: currentColor;
