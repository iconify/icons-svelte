...
const content = `<path class="a_wml8hwt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:split-horizontal-12-regular" {...props}></Icon>
<style>
:global(.a_wml8hwt) {
  fill: currentColor;
