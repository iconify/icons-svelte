...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:signal-wifi-statusbar-not-connected-outline-rounded" {...props}></Icon>
<style>
:global(.qq_iswbjy) {
  fill: currentColor;
