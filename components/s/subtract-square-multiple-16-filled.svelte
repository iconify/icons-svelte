...
const content = `<path class="kj96k6fch"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:subtract-square-multiple-16-filled" {...props}></Icon>
<style>
:global(.kj96k6fch) {
  fill: currentColor;
