...
const content = `<circle class="j_-2hxbof"/><path class="b2wt062ro"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:sharp-hot-tub" {...props}></Icon>
<style>
:global(.b2wt062ro) {
  fill: currentColor;
