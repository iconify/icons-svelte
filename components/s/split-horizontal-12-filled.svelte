...
const content = `<path class="yk2b9g0iz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:split-horizontal-12-filled" {...props}></Icon>
<style>
:global(.yk2b9g0iz) {
  fill: currentColor;
