...
const content = `<path class="dkkmkjbat"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:switch-access-outline-rounded" {...props}></Icon>
<style>
:global(.dkkmkjbat) {
  fill: currentColor;
