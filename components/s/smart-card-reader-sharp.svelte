...
const content = `<path class="vi5n_lb7m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:smart-card-reader-sharp" {...props}></Icon>
<style>
:global(.vi5n_lb7m) {
  fill: currentColor;
