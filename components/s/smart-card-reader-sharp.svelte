...
const content = `<path class="cjk5cze9x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:smart-card-reader-sharp" {...props}></Icon>
<style>
:global(.cjk5cze9x) {
  fill: currentColor;
