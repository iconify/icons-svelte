...
const content = `<path class="oxg9c0ban"/><path class="pfndhyobm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:sughool" {...props}></Icon>
<style>
:global(.oxg9c0ban) {
  fill: none;
  stroke: currentColor;
