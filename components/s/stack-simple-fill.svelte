...
const content = `<g class="cuyn6tgcc"><path class="c5vr70bhb"/><path class="pi1wcd4wl"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:stack-simple-fill" {...props}></Icon>
<style>
:global(.c5vr70bhb) {
