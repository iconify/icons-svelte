...
const content = `<path class="rgn8rxb3f"/><circle class="wkxw5hbfm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:sam-helper" {...props}></Icon>
<style>
:global(.rgn8rxb3f) {
  fill: none;
  stroke: currentColor;
