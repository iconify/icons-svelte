...
const content = `<g class="cuyn6tgcc"><path class="ox6xxkvjv"/><path class="kngv55veg"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:scooter-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
