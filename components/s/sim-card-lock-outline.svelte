...
const content = `<path class="fpqnno5bi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:sim-card-lock-outline" {...props}></Icon>
<style>
:global(.fpqnno5bi) {
  fill: currentColor;
