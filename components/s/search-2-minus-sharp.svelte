...
const content = `<path class="v6h7q7wkx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:search-2-minus-sharp" {...props}></Icon>
<style>
:global(.v6h7q7wkx) {
  fill: none;
  stroke: currentColor;
