...
const content = `<path class="d6bmo9b7x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:settings-b-roll-outline-rounded" {...props}></Icon>
<style>
:global(.d6bmo9b7x) {
  fill: currentColor;
