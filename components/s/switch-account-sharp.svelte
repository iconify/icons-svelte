...
const content = `<path class="pv4otbcbx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:switch-account-sharp" {...props}></Icon>
<style>
:global(.pv4otbcbx) {
  fill: currentColor;
