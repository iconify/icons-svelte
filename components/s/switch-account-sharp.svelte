...
const content = `<path class="bu3sk1b5v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:switch-account-sharp" {...props}></Icon>
<style>
:global(.bu3sk1b5v) {
  fill: currentColor;
