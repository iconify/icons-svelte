...
const content = `<g class="cuyn6tgcc"><path class="rmfg5mk6q"/><path class="w1e4r9boe"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:scribble-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
