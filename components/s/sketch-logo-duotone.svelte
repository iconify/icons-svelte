...
const content = `<g class="cuyn6tgcc"><path class="uh0s7ob8j"/><path class="jligoeacw"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:sketch-logo-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
