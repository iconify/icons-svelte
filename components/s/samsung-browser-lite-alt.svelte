...
const content = `<path class="wgt30wbbl"/><path class="tj6i46bqg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:samsung-browser-lite-alt" {...props}></Icon>
<style>
:global(.tj6i46bqg) {
  fill: none;
  stroke: currentColor;
