...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGTLVUNcXw)" clip-rule="evenodd" class="nv-rvd64x"/><path class="lfc4etv_j"/><path class="urku4ebgg"/><path class="abv7so2wl"/><path class="fw9aupjzw"/><path class="yyeaykr2g"/><path class="yg0003bmx"/><path class="t0p7bvt6a"/><path class="o6xcyj8ex"/><path class="n59cqac-m"/><path class="t0yu8-b2h"/><defs><linearGradient id="SVGTLVUNcXw" x1="12" x2="12" y1="2.999" y2="20.999" gradientUnits="userSpaceOnUse"><stop class="oq_zbz6lw"/><stop offset="1" class="zkj7swbow"/></linearGradient></defs></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:sun" {...props}></Icon>
<style>
:global(.abv7so2wl) {
  fill: var(--svg-color--f0f3fa, #f0f3fa);
  d: path("M11.967 18.11a6.144 6.144 0 1 0 0-12.288a6.144 6.144 0 0 0 0 12.288");
}
