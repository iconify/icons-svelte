...
const content = `<path class="ro4275o-y"/><circle class="nyg1cc8-h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:sun" {...props}></Icon>
<style>
:global(.nyg1cc8-h) {
  cx: 18px;
  cy: 18px;
