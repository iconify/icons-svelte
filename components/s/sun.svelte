...
const content = `<path class="jeveu9tyt"/><path class="ng003nbdw"/><path class="trxul0b9x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto:sun" {...props}></Icon>
<style>
:global(.jeveu9tyt) {
