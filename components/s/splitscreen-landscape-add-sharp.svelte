...
const content = `<path class="wjaqihmtf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:splitscreen-landscape-add-sharp" {...props}></Icon>
<style>
:global(.wjaqihmtf) {
  fill: currentColor;
