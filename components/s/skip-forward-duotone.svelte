...
const content = `<g class="cuyn6tgcc"><path class="qr0zmu7-y"/><path class="kz1zrxb2z"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:skip-forward-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
