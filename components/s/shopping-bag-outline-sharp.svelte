...
const content = `<path class="ic7arub7a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:shopping-bag-outline-sharp" {...props}></Icon>
<style>
:global(.ic7arub7a) {
  fill: currentColor;
