...
const content = `<g class="cuyn6tgcc"><path class="icps4mb-p"/><path class="jk-rmmbdp"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:speaker-simple-low-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
