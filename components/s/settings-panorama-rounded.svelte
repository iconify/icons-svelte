...
const content = `<path class="w72b-qznm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:settings-panorama-rounded" {...props}></Icon>
<style>
:global(.w72b-qznm) {
  fill: currentColor;
