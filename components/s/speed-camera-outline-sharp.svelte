...
const content = `<path class="qg3450iko"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:speed-camera-outline-sharp" {...props}></Icon>
<style>
:global(.qg3450iko) {
  fill: currentColor;
