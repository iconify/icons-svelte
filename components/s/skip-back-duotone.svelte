...
const content = `<g class="cuyn6tgcc"><path class="vdmf-5_tq"/><path class="rs6y1caey"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:skip-back-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
