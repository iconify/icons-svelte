...
const content = `<path class="vxj4hkczo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:subscriptions" {...props}></Icon>
<style>
:global(.vxj4hkczo) {
  fill: currentColor;
