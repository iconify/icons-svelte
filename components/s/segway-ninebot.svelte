...
const content = `<circle class="tcaoxxgtd"/><path class="cdn60dbmr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:segway-ninebot" {...props}></Icon>
<style>
:global(.cdn60dbmr) {
  fill: none;
  stroke: currentColor;
