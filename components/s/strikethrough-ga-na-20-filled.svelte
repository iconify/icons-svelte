...
const content = `<g class="ft5dv1b6b"><path class="voxg8ltjl"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:strikethrough-ga-na-20-filled" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
