...
const content = `<g class="cuyn6tgcc"><path class="hbb5s2p4j"/><path class="q691oufgg"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:vector-two-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
