...
const content = `<path class="gfmj7abgv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:vignette-2-outline-sharp" {...props}></Icon>
<style>
:global(.gfmj7abgv) {
  fill: currentColor;
