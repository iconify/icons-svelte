...
const content = `<path class="jtuq0gbgu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:video-camera-front-off-outline-sharp" {...props}></Icon>
<style>
:global(.jtuq0gbgu) {
  fill: currentColor;
