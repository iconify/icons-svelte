...
const content = `<rect class="j3s9ivbxi"/><path class="bevgj9b9f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:vatan" {...props}></Icon>
<style>
:global(.bevgj9b9f) {
  fill: none;
  stroke: currentColor;
