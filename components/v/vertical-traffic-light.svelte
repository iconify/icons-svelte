...
const content = `<path class="dshwbobrv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:vertical-traffic-light" {...props}></Icon>
<style>
:global(.dshwbobrv) {
  fill: currentColor;
