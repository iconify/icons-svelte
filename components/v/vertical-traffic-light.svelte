...
const content = `<path class="sjnetq-bv"/><path class="xc7po1b3o"/><path class="gk4mkzbxd"/><path class="rasheccro"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:vertical-traffic-light" {...props}></Icon>
<style>
:global(.gk4mkzbxd) {
