...
const content = `<path class="hkmgyrb8h"/><path class="sg1oan86x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:vivo-i-manager" {...props}></Icon>
<style>
:global(.hkmgyrb8h) {
  fill: none;
  stroke: currentColor;
