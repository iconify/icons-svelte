...
const content = `<path class="mnhc0ebpw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:variable-remove-outline-rounded" {...props}></Icon>
<style>
:global(.mnhc0ebpw) {
  fill: currentColor;
