...
const content = `<path class="ajyrj0bom"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:videogame-asset-off-sharp" {...props}></Icon>
<style>
:global(.ajyrj0bom) {
  fill: currentColor;
