...
const content = `<g class="y9tr6bcfx"><rect class="brxpxfbzn"/><path class="a7y8ympkn"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:vban-receptor" {...props}></Icon>
<style>
:global(.a7y8ympkn) {
