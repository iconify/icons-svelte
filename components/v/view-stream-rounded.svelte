...
const content = `<path class="kdyz5_b_u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:view-stream-rounded" {...props}></Icon>
<style>
:global(.kdyz5_b_u) {
  fill: currentColor;
