...
const content = `<path class="kooqmxbsy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:view-stream-rounded" {...props}></Icon>
<style>
:global(.kooqmxbsy) {
  fill: currentColor;
