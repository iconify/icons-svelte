...
const content = `<path class="f64q9cbsx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:videocam-rounded" {...props}></Icon>
<style>
:global(.f64q9cbsx) {
  fill: currentColor;
