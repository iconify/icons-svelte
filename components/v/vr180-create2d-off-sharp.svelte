...
const content = `<path class="jkjv35bvv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:vr180-create2d-off-sharp" {...props}></Icon>
<style>
:global(.jkjv35bvv) {
  fill: currentColor;
