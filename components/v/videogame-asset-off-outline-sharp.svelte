...
const content = `<path class="d7uk9nb5e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:videogame-asset-off-outline-sharp" {...props}></Icon>
<style>
:global(.d7uk9nb5e) {
  fill: currentColor;
