...
const content = `<path class="v9qsv8dtp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:verified-off-outline-rounded" {...props}></Icon>
<style>
:global(.v9qsv8dtp) {
  fill: currentColor;
