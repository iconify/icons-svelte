...
const content = `<path class="ttgkzhe4v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:videocam-off-outline-sharp" {...props}></Icon>
<style>
:global(.ttgkzhe4v) {
  fill: currentColor;
