...
const content = `<path class="kwn8oravu"/><path class="b_tliwbzd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:valv" {...props}></Icon>
<style>
:global(.b_tliwbzd) {
  fill: none;
  stroke: currentColor;
