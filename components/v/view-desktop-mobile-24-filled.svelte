...
const content = `<path class="b1xu3-eih"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:view-desktop-mobile-24-filled" {...props}></Icon>
<style>
:global(.b1xu3-eih) {
  fill: currentColor;
