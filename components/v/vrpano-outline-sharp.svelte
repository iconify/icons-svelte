...
const content = `<path class="mn8a-hbib"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:vrpano-outline-sharp" {...props}></Icon>
<style>
:global(.mn8a-hbib) {
  fill: currentColor;
