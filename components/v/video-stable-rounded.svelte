...
const content = `<path class="x2ebm_9dm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:video-stable-rounded" {...props}></Icon>
<style>
:global(.x2ebm_9dm) {
  fill: currentColor;
