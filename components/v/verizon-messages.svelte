...
const content = `<path class="cts2d6cvv"/><path class="ada4hwb1v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:verizon-messages" {...props}></Icon>
<style>
:global(.ada4hwb1v) {
  fill: none;
  stroke: currentColor;
