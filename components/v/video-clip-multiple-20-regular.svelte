...
const content = `<path class="u3rkyjb0z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:video-clip-multiple-20-regular" {...props}></Icon>
<style>
:global(.u3rkyjb0z) {
  fill: currentColor;
