...
const content = `<path class="c-c3f6bbj"/><path class="idm4svlov"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:video-wallpapers" {...props}></Icon>
<style>
:global(.c-c3f6bbj) {
  fill: none;
  stroke: currentColor;
