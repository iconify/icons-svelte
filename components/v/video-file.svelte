...
const content = `<path class="ey35ltbhg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:video-file" {...props}></Icon>
<style>
:global(.ey35ltbhg) {
  fill: currentColor;
