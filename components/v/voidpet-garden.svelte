...
const content = `<path class="e2f-7db_z"/><circle class="biy_ji_lg"/><circle class="sm6rfywoo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:voidpet-garden" {...props}></Icon>
<style>
:global(.biy_ji_lg) {
  cx: 29.505px;
  cy: 18.017px;
