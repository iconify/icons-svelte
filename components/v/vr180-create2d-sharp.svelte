...
const content = `<path class="ijniofbjy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:vr180-create2d-sharp" {...props}></Icon>
<style>
:global(.ijniofbjy) {
  fill: currentColor;
