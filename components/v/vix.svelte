...
const content = `<path class="wefbopjdk"/><circle class="z_bn-6bko"/><path class="gfemqbbvl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:vix" {...props}></Icon>
<style>
:global(.gfemqbbvl) {
  fill: none;
  stroke: currentColor;
