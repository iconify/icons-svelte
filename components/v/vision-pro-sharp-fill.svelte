...
const content = `<path clip-rule="evenodd" class="chzbq8n6j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:vision-pro-sharp-fill" {...props}></Icon>
<style>
:global(.chzbq8n6j) {
  fill: currentColor;
  fill-rule: evenodd;
