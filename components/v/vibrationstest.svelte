...
const content = `<circle class="xav3-zbdm"/><path class="tda6r_bmc"/><path class="ik38q9tds"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:vibrationstest" {...props}></Icon>
<style>
:global(.ik38q9tds) {
  fill: none;
  stroke: currentColor;
