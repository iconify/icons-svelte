...
const content = `<path class="owh5yqsjc"/><path class="yjm1qhb_m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:vivocom" {...props}></Icon>
<style>
:global(.owh5yqsjc) {
  fill: none;
  stroke: currentColor;
