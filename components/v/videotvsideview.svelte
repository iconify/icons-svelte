...
const content = `<path class="zl6rn2spx"/><path class="vdxw4_bee"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:videotvsideview" {...props}></Icon>
<style>
:global(.vdxw4_bee) {
  fill: none;
  stroke: currentColor;
