...
const content = `<path class="eyp-3fvso"/><path class="oe8h0tb6z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:vivo-vivo" {...props}></Icon>
<style>
:global(.eyp-3fvso) {
  fill: none;
  stroke: currentColor;
