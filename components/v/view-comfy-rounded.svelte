...
const content = `<path class="ru5lciblm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:view-comfy-rounded" {...props}></Icon>
<style>
:global(.ru5lciblm) {
  fill: currentColor;
