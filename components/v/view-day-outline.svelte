...
const content = `<path class="w32c3p1sz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:view-day-outline" {...props}></Icon>
<style>
:global(.w32c3p1sz) {
  fill: currentColor;
