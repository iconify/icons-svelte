...
const content = `<path class="qwdjwbbrc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:vertical-shades-outline-rounded" {...props}></Icon>
<style>
:global(.qwdjwbbrc) {
  fill: currentColor;
