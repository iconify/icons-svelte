...
const content = `<path class="f6xgi0bmv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:video-camera-back" {...props}></Icon>
<style>
:global(.f6xgi0bmv) {
  fill: currentColor;
