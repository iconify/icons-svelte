...
const content = `<path class="ftzhrcb6b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:videogame-asset-sharp" {...props}></Icon>
<style>
:global(.ftzhrcb6b) {
  fill: currentColor;
