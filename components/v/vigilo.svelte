...
const content = `<path class="t-im65oqs"/><path class="osmo_tb1y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:vigilo" {...props}></Icon>
<style>
:global(.osmo_tb1y) {
  fill: none;
  stroke: currentColor;
