...
const content = `<path class="lz7k8bb2z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:view-list-outline" {...props}></Icon>
<style>
:global(.lz7k8bb2z) {
  fill: currentColor;
