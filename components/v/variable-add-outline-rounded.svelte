...
const content = `<path class="qp39zno0z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:variable-add-outline-rounded" {...props}></Icon>
<style>
:global(.qp39zno0z) {
  fill: currentColor;
