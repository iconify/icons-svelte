...
const content = `<path class="oq_v9fb_l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:view-list-rounded" {...props}></Icon>
<style>
:global(.oq_v9fb_l) {
  fill: currentColor;
