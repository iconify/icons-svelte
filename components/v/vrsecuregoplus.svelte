...
const content = `<path class="yowqqmi9x"/><circle class="lvfbl6-sz"/><path class="pbtl-mbfd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:vrsecuregoplus" {...props}></Icon>
<style>
:global(.lvfbl6-sz) {
  cx: 10.293px;
  cy: 31.902px;
