...
const content = `<path class="kh1-nfb1j"/><path class="lq-m5_wgo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:vpbank-neo" {...props}></Icon>
<style>
:global(.kh1-nfb1j) {
  fill: none;
  stroke: currentColor;
