...
const content = `<path class="o2uwhp26h"/><path class="f2_-pbbip"/><path class="gi830-zil"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:verdaccio-icon" {...props}></Icon>
<style>
:global(.f2_-pbbip) {
