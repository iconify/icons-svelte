...
const content = `<path class="if6l8ebrz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:video-library-outline" {...props}></Icon>
<style>
:global(.if6l8ebrz) {
  fill: currentColor;
