...
const content = `<path class="wifxswydx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:view-module-outline-sharp" {...props}></Icon>
<style>
:global(.wifxswydx) {
  fill: currentColor;
