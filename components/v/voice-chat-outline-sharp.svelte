...
const content = `<path class="i_znzubpf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:voice-chat-outline-sharp" {...props}></Icon>
<style>
:global(.i_znzubpf) {
  fill: currentColor;
