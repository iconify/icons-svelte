...
const content = `<rect class="j3s9ivbxi"/><path class="gn9g6qb_o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:v2raytun" {...props}></Icon>
<style>
:global(.gn9g6qb_o) {
  fill: none;
  stroke: currentColor;
