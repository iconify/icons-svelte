...
const content = `<path class="uq_lxvlam"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:view-compact-alt" {...props}></Icon>
<style>
:global(.uq_lxvlam) {
  fill: currentColor;
