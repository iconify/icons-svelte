...
const content = `<rect class="mejnhzb5l"/><path class="brbvblb1e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:vsim-2" {...props}></Icon>
<style>
:global(.brbvblb1e) {
  fill: none;
  stroke: currentColor;
