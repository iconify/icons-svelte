...
const content = `<path class="o6i2yccpo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:volunteer-activism-sharp" {...props}></Icon>
<style>
:global(.o6i2yccpo) {
  fill: currentColor;
