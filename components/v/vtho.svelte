...
const content = `<g class="ft5dv1b6b"><path class="wph_fybml"/><path class="e2vpf0b8u"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:vtho" {...props}></Icon>
<style>
:global(.e2vpf0b8u) {
