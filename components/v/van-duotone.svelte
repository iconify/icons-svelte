...
const content = `<g class="cuyn6tgcc"><path class="n34ihl8om"/><path class="f_3yqacci"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:van-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
