...
const content = `<path class="juh6-0b-v"/><path class="j-dlzibql"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:vtmgo" {...props}></Icon>
<style>
:global(.j-dlzibql) {
  fill: none;
  stroke: currentColor;
