...
const content = `<circle class="iv34yub_k"/><path class="yred2ccsw"/><path class="ims7c753b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:video-downloader" {...props}></Icon>
<style>
:global(.ims7c753b) {
  fill: none;
  stroke: currentColor;
