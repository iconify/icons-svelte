...
const content = `<path class="px391abcr"/><path class="u-aul108h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:vrnetarif" {...props}></Icon>
<style>
:global(.px391abcr) {
  fill: none;
  stroke: currentColor;
