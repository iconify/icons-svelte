...
const content = `<path class="f67_eacmv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:vertical-split" {...props}></Icon>
<style>
:global(.f67_eacmv) {
  fill: currentColor;
