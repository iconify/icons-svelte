...
const content = `<g class="cuyn6tgcc"><path class="rv04hs9mh"/><path class="adu42kbdr"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:voicemail-duotone" {...props}></Icon>
<style>
:global(.adu42kbdr) {
