...
const content = `<path class="zs_2libwq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:vrpano-sharp" {...props}></Icon>
<style>
:global(.zs_2libwq) {
  fill: currentColor;
