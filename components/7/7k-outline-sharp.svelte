...
const content = `<path class="w_9mtlblo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:7k-outline-sharp" {...props}></Icon>
<style>
:global(.w_9mtlblo) {
  fill: currentColor;
