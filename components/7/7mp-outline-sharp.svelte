...
const content = `<path class="dyv-ywbau"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:7mp-outline-sharp" {...props}></Icon>
<style>
:global(.dyv-ywbau) {
  fill: currentColor;
