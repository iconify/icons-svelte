...
const content = `<circle class="cpk0fnbgt"/><path class="g6dkrcn8b"/><path class="xonmevo2m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:jlab" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
