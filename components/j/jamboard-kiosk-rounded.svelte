...
const content = `<path class="utchwybyo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:jamboard-kiosk-rounded" {...props}></Icon>
<style>
:global(.utchwybyo) {
  fill: currentColor;
