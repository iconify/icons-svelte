...
const content = `<path class="r9rioofmx"/><path class="tncprvuaa"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:japanese-service-charge-button" {...props}></Icon>
<style>
:global(.r9rioofmx) {
