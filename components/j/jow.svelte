...
const content = `<circle class="gj8zvdbrw"/><path class="w0tsaub-s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:jow" {...props}></Icon>
<style>
:global(.gj8zvdbrw) {
  cx: 24.539px;
  cy: 6.795px;
