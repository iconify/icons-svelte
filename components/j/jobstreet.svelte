...
const content = `<path class="i9clfwm2k"/><path class="o9s4sebes"/><rect class="toh6o6bdc"/><path class="utvam1b2y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:jobstreet" {...props}></Icon>
<style>
:global(.i9clfwm2k) {
  fill: none;
  stroke: currentColor;
