...
const content = `<rect class="j3s9ivbxi"/><path class="dga87kbqi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:jins" {...props}></Icon>
<style>
:global(.dga87kbqi) {
  fill: none;
  stroke: currentColor;
