...
const content = `<g class="cuyn6tgcc"><path class="i7ghkhrql"/><path class="rb8ygzbqn"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:jeep-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
