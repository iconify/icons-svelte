...
const content = `<g class="y9tr6bcfx"><path class="jlyultbfy"/><path class="ozvbkmb5u"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:jiaoguan12123" {...props}></Icon>
<style>
:global(.jlyultbfy) {
