...
const content = `<rect class="osbn6ha0r"/><path class="ciwekkant"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:journal" {...props}></Icon>
<style>
:global(.ciwekkant) {
  fill: none;
  stroke: currentColor;
