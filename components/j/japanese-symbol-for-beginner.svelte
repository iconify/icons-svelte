...
const content = `<path class="h-0xfxbxb"/><path class="aj9fryn-n"/><path class="n1yb49bkn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:japanese-symbol-for-beginner" {...props}></Icon>
<style>
:global(.aj9fryn-n) {
