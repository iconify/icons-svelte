...
const content = `<path class="lm3xcm3_i"/><path class="ll_ogpufg"/><path class="h8s3lnnkv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione:japanese-symbol-for-beginner" {...props}></Icon>
<style>
:global(.h8s3lnnkv) {
  fill: none;
