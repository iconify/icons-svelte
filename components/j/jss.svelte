...
const content = `<g class="ft5dv1b6b"><path class="ugaqt6lro"/><path class="szna3abyq"/><path class="wj9e6kb9h"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:jss" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
