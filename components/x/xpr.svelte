...
const content = `<g class="xvlaghbkc"><path clip-rule="evenodd" class="t9r777bqp"/><path class="vx0de17_m"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:xpr" {...props}></Icon>
<style>
:global(.t9r777bqp) {
  fill-rule: evenodd;
