...
const content = `<g class="cuyn6tgcc"><path class="rmfg5mk6q"/><path class="ke7zm1kpt"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:x-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
