...
const content = `<path class="l-ihhqc3r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:xbox-controller-24-regular" {...props}></Icon>
<style>
:global(.l-ihhqc3r) {
  fill: currentColor;
