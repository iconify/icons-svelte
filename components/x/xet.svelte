...
const content = `<g class="bjc53bb5t"><path class="arovj1ana"/><path class="yg_akiqng"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:xet" {...props}></Icon>
<style>
:global(.arovj1ana) {
