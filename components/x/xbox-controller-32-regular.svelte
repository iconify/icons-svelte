...
const content = `<path class="rwrdysbtf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:xbox-controller-32-regular" {...props}></Icon>
<style>
:global(.rwrdysbtf) {
  fill: currentColor;
