...
const content = `<path class="uti539_cb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:xbox-controller-20-regular" {...props}></Icon>
<style>
:global(.uti539_cb) {
  fill: currentColor;
