...
const content = `<path class="ecjrlrbtw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:xbox-controller-28-regular" {...props}></Icon>
<style>
:global(.ecjrlrbtw) {
  fill: currentColor;
