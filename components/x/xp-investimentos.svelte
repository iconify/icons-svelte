...
const content = `<path class="em9o_c-lg"/><path class="b5n032bas"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:xp-investimentos" {...props}></Icon>
<style>
:global(.b5n032bas) {
  fill: none;
  stroke: currentColor;
