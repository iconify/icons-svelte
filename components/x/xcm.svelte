...
const content = `<g class="dsmn_x3kh"><path class="lej4i3b-l"/><path class="e6cqrpacs"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:xcm" {...props}></Icon>
<style>
:global(.dsmn_x3kh) {
