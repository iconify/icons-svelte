...
const content = `<path class="b767a7rrt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:xbox-one-console-20-filled" {...props}></Icon>
<style>
:global(.b767a7rrt) {
  fill: currentColor;
