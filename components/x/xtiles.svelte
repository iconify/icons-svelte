...
const content = `<path class="g2wj9jbhp"/><path class="e2j4w8brk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:xtiles" {...props}></Icon>
<style>
:global(.e2j4w8brk) {
  fill: none;
  stroke: currentColor;
