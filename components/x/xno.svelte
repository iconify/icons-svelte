...
const content = `<g class="s4qt-zk6l"><path class="rjmt6qmfp"/><path clip-rule="evenodd" class="btv_1cc6h"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:xno" {...props}></Icon>
<style>
:global(.btv_1cc6h) {
  fill-rule: evenodd;
