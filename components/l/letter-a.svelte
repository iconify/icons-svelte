...
const content = `<path class="key3jebrh"/><path class="n-wyo_bsn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:letter-a" {...props}></Icon>
<style>
:global(.key3jebrh) {
  fill: currentColor;
