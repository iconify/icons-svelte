...
const content = `<path class="fm50yjbtr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-row-two-split-bottom-focus-top-16-filled" {...props}></Icon>
<style>
:global(.fm50yjbtr) {
  fill: currentColor;
