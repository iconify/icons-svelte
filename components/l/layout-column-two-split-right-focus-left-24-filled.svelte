...
const content = `<path class="kucxl_qmy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-two-split-right-focus-left-24-filled" {...props}></Icon>
<style>
:global(.kucxl_qmy) {
  fill: currentColor;
