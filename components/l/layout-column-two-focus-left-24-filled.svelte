...
const content = `<path class="tdm6mv3zo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-two-focus-left-24-filled" {...props}></Icon>
<style>
:global(.tdm6mv3zo) {
  fill: currentColor;
