...
const content = `<path class="frq6y4qfk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:local-see-rounded" {...props}></Icon>
<style>
:global(.frq6y4qfk) {
  fill: currentColor;
