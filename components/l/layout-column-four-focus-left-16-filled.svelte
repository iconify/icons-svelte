...
const content = `<path class="l1xdndvvn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-four-focus-left-16-filled" {...props}></Icon>
<style>
:global(.l1xdndvvn) {
  fill: currentColor;
