...
const content = `<path class="te4vrp61p"/><path class="y72pm3b8k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:linkedin-learning" {...props}></Icon>
<style>
:global(.te4vrp61p) {
  fill: none;
  stroke: currentColor;
