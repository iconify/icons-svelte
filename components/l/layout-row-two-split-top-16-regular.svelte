...
const content = `<path class="g33dgwb0x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-row-two-split-top-16-regular" {...props}></Icon>
<style>
:global(.g33dgwb0x) {
  fill: currentColor;
