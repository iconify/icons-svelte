...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="bw1pvkb1e"/><path class="slorjqbuy"/><path class="rd9culn5u"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:lock-closed" {...props}></Icon>
<style>
:global(.bw1pvkb1e) {
