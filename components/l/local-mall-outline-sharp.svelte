...
const content = `<path class="brrbxackc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:local-mall-outline-sharp" {...props}></Icon>
<style>
:global(.brrbxackc) {
  fill: currentColor;
