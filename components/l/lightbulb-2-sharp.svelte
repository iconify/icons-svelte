...
const content = `<path class="qmudjrg8b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:lightbulb-2-sharp" {...props}></Icon>
<style>
:global(.qmudjrg8b) {
  fill: currentColor;
