...
const content = `<path class="hbck4sluk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:lunch-dining-sharp" {...props}></Icon>
<style>
:global(.hbck4sluk) {
  fill: currentColor;
