...
const content = `<path class="nq5pnpz6u"/><path class="jqp0uybgr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:librofm" {...props}></Icon>
<style>
:global(.jqp0uybgr) {
  fill: none;
  stroke: currentColor;
