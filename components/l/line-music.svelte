...
const content = `<path class="ty_mt_5op"/><circle class="p0v8zgbsu"/><circle class="rjt9k9bfk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:line-music" {...props}></Icon>
<style>
:global(.p0v8zgbsu) {
  cx: 11.946px;
  cy: 38.553px;
