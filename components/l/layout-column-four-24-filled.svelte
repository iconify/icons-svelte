...
const content = `<path class="b11cxkb2r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-four-24-filled" {...props}></Icon>
<style>
:global(.b11cxkb2r) {
  fill: currentColor;
