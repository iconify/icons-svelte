...
const content = `<path class="v9ohk5b3s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:link-simple-horizontal-break-fill" {...props}></Icon>
<style>
:global(.v9ohk5b3s) {
  fill: currentColor;
