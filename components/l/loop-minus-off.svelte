...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="ki2vueivy"/><path class="q16qzj1ip"/><path class="xedf9ccsf"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:loop-minus-off" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
