...
const content = `<path class="g5w9hdcbr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-row-two-split-bottom-20-regular" {...props}></Icon>
<style>
:global(.g5w9hdcbr) {
  fill: currentColor;
