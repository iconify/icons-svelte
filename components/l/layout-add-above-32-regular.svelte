...
const content = `<path class="ex75zsm6f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-add-above-32-regular" {...props}></Icon>
<style>
:global(.ex75zsm6f) {
  fill: currentColor;
