...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="g34_8ybkq"/><path class="hdxpysbbn"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:line-slant-down-circle" {...props}></Icon>
<style>
:global(.g34_8ybkq) {
