...
const content = `<path class="pspx45b8j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:line-end-square-rounded" {...props}></Icon>
<style>
:global(.pspx45b8j) {
  fill: currentColor;
