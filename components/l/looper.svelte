...
const content = `<path class="cs03lyz4k"/><circle class="xz15mjbca"/><circle class="uayj8bcjb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:looper" {...props}></Icon>
<style>
:global(.cs03lyz4k) {
  fill: none;
  stroke: currentColor;
