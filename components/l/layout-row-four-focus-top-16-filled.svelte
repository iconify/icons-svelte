...
const content = `<path class="njt_m6mzx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-row-four-focus-top-16-filled" {...props}></Icon>
<style>
:global(.njt_m6mzx) {
  fill: currentColor;
