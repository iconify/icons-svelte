...
const content = `<path class="txi2z8bap"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:light-mode-outline-rounded" {...props}></Icon>
<style>
:global(.txi2z8bap) {
  fill: currentColor;
