...
const content = `<path class="nqnwq1rgr"/><path class="j3_x6r5xa"/><circle class="jyczl8bji"/><path class="x4-j7eg3k"/><path class="bjcf95bza"/><circle class="jg-fcvo0q"/><circle class="dk2uog6xi"/><circle class="wcredvb9p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:linwood-butterfly-alt" {...props}></Icon>
<style>
:global(.bjcf95bza) {
  fill: none;
  stroke: currentColor;
