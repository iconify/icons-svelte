...
const content = `<path class="k91rbrbar"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:line-horizontal-4-20-filled" {...props}></Icon>
<style>
:global(.k91rbrbar) {
  fill: currentColor;
