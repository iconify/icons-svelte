...
const content = `<g class="y9tr6bcfx"><path class="fytel3bzn"/><ellipse class="w4d4x4krx"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:llolu" {...props}></Icon>
<style>
:global(.fytel3bzn) {
