...
const content = `<path class="x-kz1kb7j"/><path class="fj_lrl_tp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:letter-l" {...props}></Icon>
<style>
:global(.fj_lrl_tp) {
