...
const content = `<path class="vjld341st"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:language-korean-latin-outline-rounded" {...props}></Icon>
<style>
:global(.vjld341st) {
  fill: currentColor;
