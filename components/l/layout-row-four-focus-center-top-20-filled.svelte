...
const content = `<path class="r1rgu-bue"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-row-four-focus-center-top-20-filled" {...props}></Icon>
<style>
:global(.r1rgu-bue) {
  fill: currentColor;
