...
const content = `<path class="ef82j2b_w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:local-activity-sharp" {...props}></Icon>
<style>
:global(.ef82j2b_w) {
  fill: currentColor;
