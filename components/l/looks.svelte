...
const content = `<g clip-rule="evenodd" class="bi12bsetm"><path class="il06fxbjb"/><path class="f6hy16cbx"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:looks" {...props}></Icon>
<style>
:global(.bi12bsetm) {
  fill: none;
  fill-rule: evenodd;
