...
const content = `<path class="uf71zzb8g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:lightbulb-sparkle-20-filled" {...props}></Icon>
<style>
:global(.uf71zzb8g) {
  fill: currentColor;
