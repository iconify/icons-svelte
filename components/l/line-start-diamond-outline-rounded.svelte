...
const content = `<path class="wzq9zma-h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:line-start-diamond-outline-rounded" {...props}></Icon>
<style>
:global(.wzq9zma-h) {
  fill: currentColor;
