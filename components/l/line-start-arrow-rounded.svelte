...
const content = `<path class="b336m4obz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:line-start-arrow-rounded" {...props}></Icon>
<style>
:global(.b336m4obz) {
  fill: currentColor;
