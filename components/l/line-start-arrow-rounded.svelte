...
const content = `<path class="shjt2_bxd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:line-start-arrow-rounded" {...props}></Icon>
<style>
:global(.shjt2_bxd) {
  fill: currentColor;
