...
const content = `<path class="f0coyab8t"/><path class="ymyxxybgh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:left-arrow-curving-right" {...props}></Icon>
<style>
:global(.f0coyab8t) {
