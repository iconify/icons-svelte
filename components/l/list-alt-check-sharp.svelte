...
const content = `<path class="q4q4lrb9g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:list-alt-check-sharp" {...props}></Icon>
<style>
:global(.q4q4lrb9g) {
  fill: currentColor;
