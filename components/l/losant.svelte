...
const content = `<path class="a2qdbt_-g"/><path class="k11hisbro"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:losant" {...props}></Icon>
<style>
:global(.a2qdbt_-g) {
