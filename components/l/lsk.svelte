...
const content = `<g class="uypib39ja"><path class="o8zmn15jc"/><path class="gcklmmv2f"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:lsk" {...props}></Icon>
<style>
:global(.gcklmmv2f) {
