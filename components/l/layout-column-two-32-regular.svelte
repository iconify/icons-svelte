...
const content = `<path class="x0oeyc-5s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-two-32-regular" {...props}></Icon>
<style>
:global(.x0oeyc-5s) {
  fill: currentColor;
