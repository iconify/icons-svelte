...
const content = `<path class="gpygv0vhw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:linked-services-outline-rounded" {...props}></Icon>
<style>
:global(.gpygv0vhw) {
  fill: currentColor;
