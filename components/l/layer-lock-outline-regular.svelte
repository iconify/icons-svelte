...
const content = `<g class="nrj6p8qat"><path class="eywlytabr"/><path class="jgql0jyyx"/><path class="ypui4ib8n"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:layer-lock-outline-regular" {...props}></Icon>
<style>
:global(.eywlytabr) {
