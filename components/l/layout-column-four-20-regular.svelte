...
const content = `<path class="vnw8e9c8b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-four-20-regular" {...props}></Icon>
<style>
:global(.vnw8e9c8b) {
  fill: currentColor;
