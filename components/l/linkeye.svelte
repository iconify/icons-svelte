...
const content = `<path class="omohucbxt"/><path class="ao-i57bkn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:linkeye" {...props}></Icon>
<style>
:global(.ao-i57bkn) {
  fill: none;
  stroke: currentColor;
