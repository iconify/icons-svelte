...
const content = `<path class="cazkzjtqe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:local-mall-sharp" {...props}></Icon>
<style>
:global(.cazkzjtqe) {
  fill: currentColor;
