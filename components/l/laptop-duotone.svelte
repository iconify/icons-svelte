...
const content = `<g class="cuyn6tgcc"><path class="qosdsgb9e"/><path class="ci5o7pb2x"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:laptop-duotone" {...props}></Icon>
<style>
:global(.ci5o7pb2x) {
