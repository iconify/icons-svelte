...
const content = `<path class="w3hfhpbyb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-three-24-filled" {...props}></Icon>
<style>
:global(.w3hfhpbyb) {
  fill: currentColor;
