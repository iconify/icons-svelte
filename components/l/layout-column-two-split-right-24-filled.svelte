...
const content = `<path class="i0-q-0b3t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-two-split-right-24-filled" {...props}></Icon>
<style>
:global(.i0-q-0b3t) {
  fill: currentColor;
