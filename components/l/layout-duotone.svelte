...
const content = `<g class="cuyn6tgcc"><path class="s9fjjhdqu"/><path class="ncg03rbnq"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:layout-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
