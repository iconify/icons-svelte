...
const content = `<path class="w__2vmbmo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:library-books-outline" {...props}></Icon>
<style>
:global(.w__2vmbmo) {
  fill: currentColor;
