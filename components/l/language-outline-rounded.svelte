...
const content = `<path class="texqcc3pe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:language-outline-rounded" {...props}></Icon>
<style>
:global(.texqcc3pe) {
  fill: currentColor;
