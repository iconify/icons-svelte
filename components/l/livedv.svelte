...
const content = `<circle class="gxpg2acir"/><path class="sc2snj5nn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:livedv" {...props}></Icon>
<style>
:global(.gxpg2acir) {
  cx: 36.992px;
  cy: 12.863px;
