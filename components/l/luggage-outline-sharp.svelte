...
const content = `<path class="wq1-vvbac"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:luggage-outline-sharp" {...props}></Icon>
<style>
:global(.wq1-vvbac) {
  fill: currentColor;
