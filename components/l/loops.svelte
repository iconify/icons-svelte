...
const content = `<path class="i5uxdbcbw"/><path class="f8e19zxki"/><path class="rrzd2ebxk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:loops" {...props}></Icon>
<style>
:global(.f8e19zxki) {
  fill: none;
  stroke: currentColor;
