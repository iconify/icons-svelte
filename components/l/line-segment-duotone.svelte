...
const content = `<g class="cuyn6tgcc"><path class="fv0ml70ng"/><path class="xhk12rmjp"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:line-segment-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
