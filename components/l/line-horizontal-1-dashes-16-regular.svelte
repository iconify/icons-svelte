...
const content = `<path class="af2obl-3u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:line-horizontal-1-dashes-16-regular" {...props}></Icon>
<style>
:global(.af2obl-3u) {
  fill: currentColor;
