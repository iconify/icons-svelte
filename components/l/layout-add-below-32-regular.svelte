...
const content = `<path class="iyglhogsp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-add-below-32-regular" {...props}></Icon>
<style>
:global(.iyglhogsp) {
  fill: currentColor;
