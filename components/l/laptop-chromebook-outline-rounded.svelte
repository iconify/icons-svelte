...
const content = `<path class="lids7k6bv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:laptop-chromebook-outline-rounded" {...props}></Icon>
<style>
:global(.lids7k6bv) {
  fill: currentColor;
