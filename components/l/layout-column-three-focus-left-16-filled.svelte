...
const content = `<path class="gv54_7bya"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-three-focus-left-16-filled" {...props}></Icon>
<style>
:global(.gv54_7bya) {
  fill: currentColor;
