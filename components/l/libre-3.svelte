...
const content = `<path class="y8_9yrfrm"/><path class="auti8tbmp"/><path class="tmany-bhj"/><circle class="vi_nxfq0r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:libre-3" {...props}></Icon>
<style>
:global(.auti8tbmp) {
  fill: none;
  stroke: currentColor;
