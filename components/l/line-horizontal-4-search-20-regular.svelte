...
const content = `<path class="g2rz7ibpw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:line-horizontal-4-search-20-regular" {...props}></Icon>
<style>
:global(.g2rz7ibpw) {
  fill: currentColor;
