...
const content = `<path class="w90gaebqt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:line-horizontal-1-dashes-24-regular" {...props}></Icon>
<style>
:global(.w90gaebqt) {
  fill: currentColor;
