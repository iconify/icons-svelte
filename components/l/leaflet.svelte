...
const content = `<path class="p3b29h63s"/><path class="lddtv9lum"/><path class="aw-51dblw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:leaflet" {...props}></Icon>
<style>
:global(.aw-51dblw) {
  fill: none;
  stroke: currentColor;
