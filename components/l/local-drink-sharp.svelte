...
const content = `<path class="lbn7drffw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:local-drink-sharp" {...props}></Icon>
<style>
:global(.lbn7drffw) {
  fill: currentColor;
