...
const content = `<path class="yhaqh90io"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-row-two-split-top-24-filled" {...props}></Icon>
<style>
:global(.yhaqh90io) {
  fill: currentColor;
