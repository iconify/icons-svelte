...
const content = `<g class="cuyn6tgcc"><path class="vnvh7hmbi"/><path class="pd7neg04v"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:lighthouse-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
