...
const content = `<path class="kz8cmjbvk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:laptop-briefcase-20-filled" {...props}></Icon>
<style>
:global(.kz8cmjbvk) {
  fill: currentColor;
