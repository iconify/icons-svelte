...
const content = `<path class="nv4w0y2uv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:list-alt-outline-sharp" {...props}></Icon>
<style>
:global(.nv4w0y2uv) {
  fill: currentColor;
