...
const content = `<path class="g_t5_2bgn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-two-split-left-24-filled" {...props}></Icon>
<style>
:global(.g_t5_2bgn) {
  fill: currentColor;
