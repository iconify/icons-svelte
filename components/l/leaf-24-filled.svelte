...
const content = `<g class="ft5dv1b6b"><path class="i5idx6h8i"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:leaf-24-filled" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
