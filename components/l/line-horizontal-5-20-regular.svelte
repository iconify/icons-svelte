...
const content = `<path class="dxkkfcbbn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:line-horizontal-5-20-regular" {...props}></Icon>
<style>
:global(.dxkkfcbbn) {
  fill: currentColor;
