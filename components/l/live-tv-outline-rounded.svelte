...
const content = `<path class="extymeb0l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:live-tv-outline-rounded" {...props}></Icon>
<style>
:global(.extymeb0l) {
  fill: currentColor;
