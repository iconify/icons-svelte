...
const content = `<path class="exo7_tbos"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-row-four-20-regular" {...props}></Icon>
<style>
:global(.exo7_tbos) {
  fill: currentColor;
