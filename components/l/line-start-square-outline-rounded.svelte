...
const content = `<path class="t2iqfkfmh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:line-start-square-outline-rounded" {...props}></Icon>
<style>
:global(.t2iqfkfmh) {
  fill: currentColor;
