...
const content = `<path class="okp3czn4a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:line-start-square-outline-rounded" {...props}></Icon>
<style>
:global(.okp3czn4a) {
  fill: currentColor;
