...
const content = `<path class="ogeud_cio"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-two-split-right-focus-left-16-filled" {...props}></Icon>
<style>
:global(.ogeud_cio) {
  fill: currentColor;
