...
const content = `<path class="o1j01kbtb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-one-third-right-16-regular" {...props}></Icon>
<style>
:global(.o1j01kbtb) {
  fill: currentColor;
