...
const content = `<path class="ojd_08beb"/><circle class="w24qzsbdg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:lost-places" {...props}></Icon>
<style>
:global(.ojd_08beb) {
  fill: none;
  stroke: currentColor;
