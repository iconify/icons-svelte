...
const content = `<path class="lxixb-bng"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-four-focus-right-16-filled" {...props}></Icon>
<style>
:global(.lxixb-bng) {
  fill: currentColor;
