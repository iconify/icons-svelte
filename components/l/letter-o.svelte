...
const content = `<path class="x-kz1kb7j"/><path class="gtqgabcol"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:letter-o" {...props}></Icon>
<style>
:global(.gtqgabcol) {
