...
const content = `<path class="nygn6pb_z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:line-start-square-rounded" {...props}></Icon>
<style>
:global(.nygn6pb_z) {
  fill: currentColor;
