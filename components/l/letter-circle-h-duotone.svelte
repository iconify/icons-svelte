...
const content = `<g class="cuyn6tgcc"><path class="goeug6bgp"/><path class="j-o794pdw"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:letter-circle-h-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
