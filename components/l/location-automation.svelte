...
const content = `<path class="u0waytfra"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:location-automation" {...props}></Icon>
<style>
:global(.u0waytfra) {
  fill: currentColor;
