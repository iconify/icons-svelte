...
const content = `<path class="g3mj-_bvi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-add-above-24-filled" {...props}></Icon>
<style>
:global(.g3mj-_bvi) {
  fill: currentColor;
