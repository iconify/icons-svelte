...
const content = `<path class="ku5s67b0g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-three-focus-center-16-filled" {...props}></Icon>
<style>
:global(.ku5s67b0g) {
  fill: currentColor;
