...
const content = `<path class="u9s8a2bgq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:lda-outline-sharp" {...props}></Icon>
<style>
:global(.u9s8a2bgq) {
  fill: currentColor;
