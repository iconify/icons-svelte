...
const content = `<path class="ce9iq2bet"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-two-split-left-16-regular" {...props}></Icon>
<style>
:global(.ce9iq2bet) {
  fill: currentColor;
