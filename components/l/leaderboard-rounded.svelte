...
const content = `<path class="eztjz6bmc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:leaderboard-rounded" {...props}></Icon>
<style>
:global(.eztjz6bmc) {
  fill: currentColor;
