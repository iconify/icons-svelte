...
const content = `<path class="oa-1rkmpb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-add-above-16-regular" {...props}></Icon>
<style>
:global(.oa-1rkmpb) {
  fill: currentColor;
