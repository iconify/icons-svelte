...
const content = `<path class="ofln4dlhm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:line-end-diamond-outline-rounded" {...props}></Icon>
<style>
:global(.ofln4dlhm) {
  fill: currentColor;
