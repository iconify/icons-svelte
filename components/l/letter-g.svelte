...
const content = `<path class="x-kz1kb7j"/><path class="jsbc67uyh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:letter-g" {...props}></Icon>
<style>
:global(.jsbc67uyh) {
