...
const content = `<g class="cuyn6tgcc"><path class="j0bmeel3n"/><path class="b-bbu9b3a"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:lock-duotone" {...props}></Icon>
<style>
:global(.b-bbu9b3a) {
