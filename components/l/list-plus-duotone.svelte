...
const content = `<g class="cuyn6tgcc"><path class="sjkqsmvve"/><path class="jsncbqaja"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:list-plus-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
