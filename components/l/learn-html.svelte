...
const content = `<g class="y9tr6bcfx"><path class="e712uubjt"/><path class="g1zhw3tqy"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:learn-html" {...props}></Icon>
<style>
:global(.e712uubjt) {
