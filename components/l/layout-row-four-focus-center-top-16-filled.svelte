...
const content = `<path class="ga7midhzr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-row-four-focus-center-top-16-filled" {...props}></Icon>
<style>
:global(.ga7midhzr) {
  fill: currentColor;
