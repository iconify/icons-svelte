...
const content = `<path class="et50xhhvt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:line-horizontal-4-20-regular" {...props}></Icon>
<style>
:global(.et50xhhvt) {
  fill: currentColor;
