...
const content = `<path class="vhgelnb6v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-row-three-focus-center-16-filled" {...props}></Icon>
<style>
:global(.vhgelnb6v) {
  fill: currentColor;
