...
const content = `<path class="x-kz1kb7j"/><path class="xdprb6bso"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:letter-k" {...props}></Icon>
<style>
:global(.x-kz1kb7j) {
