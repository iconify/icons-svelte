...
const content = `<path class="pgp8x4-7g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-cell-four-focus-top-right-20-filled" {...props}></Icon>
<style>
:global(.pgp8x4-7g) {
  fill: currentColor;
