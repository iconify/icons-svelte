...
const content = `<path class="kfx2a4b4p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:laptop-car-sharp" {...props}></Icon>
<style>
:global(.kfx2a4b4p) {
  fill: currentColor;
