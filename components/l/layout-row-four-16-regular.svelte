...
const content = `<path class="g-kbwbbzf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-row-four-16-regular" {...props}></Icon>
<style>
:global(.g-kbwbbzf) {
  fill: currentColor;
