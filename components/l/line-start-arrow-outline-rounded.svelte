...
const content = `<path class="x0nyvcowu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:line-start-arrow-outline-rounded" {...props}></Icon>
<style>
:global(.x0nyvcowu) {
  fill: currentColor;
