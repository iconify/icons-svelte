...
const content = `<path class="imdububqm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-cell-four-16-filled" {...props}></Icon>
<style>
:global(.imdububqm) {
  fill: currentColor;
