...
const content = `<path class="g8-wi-b2l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:list-alt-check-outline-sharp" {...props}></Icon>
<style>
:global(.g8-wi-b2l) {
  fill: currentColor;
