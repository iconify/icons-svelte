...
const content = `<g class="cuyn6tgcc"><path class="ptsgpjzid"/><path class="y_3rezxmf"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:list-magnifying-glass-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
