...
const content = `<path class="ksp_1rz7i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:location-ripple-24-regular" {...props}></Icon>
<style>
:global(.ksp_1rz7i) {
  fill: currentColor;
