...
const content = `<circle class="f0f4r9n8l"/><path class="sc9jr3bxk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione:leo" {...props}></Icon>
<style>
:global(.f0f4r9n8l) {
  cx: 32px;
  cy: 32px;
