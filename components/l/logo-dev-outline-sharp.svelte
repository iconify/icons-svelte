...
const content = `<path class="m2hx0hb6o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:logo-dev-outline-sharp" {...props}></Icon>
<style>
:global(.m2hx0hb6o) {
  fill: currentColor;
