...
const content = `<path class="d1n_y_tdd"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:led-scroller" {...props}></Icon>
<style>
:global(.d1n_y_tdd) {
  fill: none;
  stroke: currentColor;
