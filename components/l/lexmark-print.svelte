...
const content = `<path class="y0aaimb9v"/><path class="w5noq2x9u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:lexmark-print" {...props}></Icon>
<style>
:global(.w5noq2x9u) {
  fill: none;
  stroke: currentColor;
