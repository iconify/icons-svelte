...
const content = `<path class="q-dqpdb7q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-row-two-focus-top-32-light" {...props}></Icon>
<style>
:global(.q-dqpdb7q) {
  fill: currentColor;
