...
const content = `<path class="gda061y_o"/><circle class="ro87aobsg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:life-fits-into-home" {...props}></Icon>
<style>
:global(.gda061y_o) {
  fill: none;
  stroke: currentColor;
