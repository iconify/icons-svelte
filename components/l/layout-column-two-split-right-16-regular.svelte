...
const content = `<path class="cw8lvmpov"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-two-split-right-16-regular" {...props}></Icon>
<style>
:global(.cw8lvmpov) {
  fill: currentColor;
