...
const content = `<path class="vh1ft1gip"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-two-focus-left-32-filled" {...props}></Icon>
<style>
:global(.vh1ft1gip) {
  fill: currentColor;
