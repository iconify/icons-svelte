...
const content = `<path class="r8a0141pv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-three-focus-right-16-filled" {...props}></Icon>
<style>
:global(.r8a0141pv) {
  fill: currentColor;
