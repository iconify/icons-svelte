...
const content = `<path class="b0nyedkcd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:line-horizontal-2-dashes-solid-20-filled" {...props}></Icon>
<style>
:global(.b0nyedkcd) {
  fill: currentColor;
