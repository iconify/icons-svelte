...
const content = `<path class="a1teb_b_y"/><path class="s96ag5l8q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:lux-gold-icon-pack" {...props}></Icon>
<style>
:global(.a1teb_b_y) {
  fill: none;
  stroke: currentColor;
