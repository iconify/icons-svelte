...
const content = `<path class="yzo69o-0e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:la-banque-postale-business" {...props}></Icon>
<style>
:global(.yzo69o-0e) {
  fill: none;
  stroke: currentColor;
