...
const content = `<g class="cuyn6tgcc"><path class="j0bmeel3n"/><path class="ruu1qzcmj"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:lock-simple-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
