...
const content = `<path class="jkhn1rbbu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:location-target-square-24-filled" {...props}></Icon>
<style>
:global(.jkhn1rbbu) {
  fill: currentColor;
