...
const content = `<path class="g7mz4bc9x"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:log28" {...props}></Icon>
<style>
:global(.g7mz4bc9x) {
  fill: none;
  stroke: currentColor;
