...
const content = `<path class="w_cf2j2rt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-two-focus-left-32-light" {...props}></Icon>
<style>
:global(.w_cf2j2rt) {
  fill: currentColor;
