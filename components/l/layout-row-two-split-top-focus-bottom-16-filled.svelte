...
const content = `<path class="zdnllab6v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-row-two-split-top-focus-bottom-16-filled" {...props}></Icon>
<style>
:global(.zdnllab6v) {
  fill: currentColor;
