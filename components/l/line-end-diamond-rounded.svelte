...
const content = `<path class="g5e6slict"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:line-end-diamond-rounded" {...props}></Icon>
<style>
:global(.g5e6slict) {
  fill: currentColor;
