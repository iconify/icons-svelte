...
const content = `<path class="nspbyt1xm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-row-two-split-top-focus-top-left-16-filled" {...props}></Icon>
<style>
:global(.nspbyt1xm) {
  fill: currentColor;
