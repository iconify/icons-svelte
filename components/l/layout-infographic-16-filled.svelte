...
const content = `<path class="a7y5oabpo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-infographic-16-filled" {...props}></Icon>
<style>
:global(.a7y5oabpo) {
  fill: currentColor;
