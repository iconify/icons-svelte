...
const content = `<path class="yv2gr5b8s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:line-horizontal-4-search-20-filled" {...props}></Icon>
<style>
:global(.yv2gr5b8s) {
  fill: currentColor;
