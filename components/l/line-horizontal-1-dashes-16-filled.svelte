...
const content = `<path class="qpy5ivb6f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:line-horizontal-1-dashes-16-filled" {...props}></Icon>
<style>
:global(.qpy5ivb6f) {
  fill: currentColor;
