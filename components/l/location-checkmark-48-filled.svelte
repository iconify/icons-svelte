...
const content = `<path class="v-woklbgx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:location-checkmark-48-filled" {...props}></Icon>
<style>
:global(.v-woklbgx) {
  fill: currentColor;
