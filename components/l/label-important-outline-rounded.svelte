...
const content = `<path class="k4r6ow5vt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:label-important-outline-rounded" {...props}></Icon>
<style>
:global(.k4r6ow5vt) {
  fill: currentColor;
