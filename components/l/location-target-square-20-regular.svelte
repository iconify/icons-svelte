...
const content = `<path class="ksm7zph2a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:location-target-square-20-regular" {...props}></Icon>
<style>
:global(.ksm7zph2a) {
  fill: currentColor;
