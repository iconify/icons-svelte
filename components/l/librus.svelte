...
const content = `<path class="a444elp8k"/><path class="y48qwuo3c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:librus" {...props}></Icon>
<style>
:global(.a444elp8k) {
  fill: none;
  stroke: currentColor;
