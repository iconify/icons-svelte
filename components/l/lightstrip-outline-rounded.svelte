...
const content = `<path class="zfo06-b5l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:lightstrip-outline-rounded" {...props}></Icon>
<style>
:global(.zfo06-b5l) {
  fill: currentColor;
