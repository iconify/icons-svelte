...
const content = `<path class="k5xtr1b2a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:lightstrip-outline-rounded" {...props}></Icon>
<style>
:global(.k5xtr1b2a) {
  fill: currentColor;
