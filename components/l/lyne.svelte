...
const content = `<path class="q8yl-8buz"/><path class="yw21qn6dh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:lyne" {...props}></Icon>
<style>
:global(.q8yl-8buz) {
  fill: none;
  stroke: currentColor;
