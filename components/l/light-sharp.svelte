...
const content = `<path class="hw-blabjk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:light-sharp" {...props}></Icon>
<style>
:global(.hw-blabjk) {
  fill: currentColor;
