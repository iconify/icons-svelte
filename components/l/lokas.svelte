...
const content = `<path class="sa0256ilo"/><path class="usi0msb6x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:lokas" {...props}></Icon>
<style>
:global(.sa0256ilo) {
  fill: none;
  stroke: currentColor;
