...
const content = `<path class="x228d5b5u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:label-off-rounded" {...props}></Icon>
<style>
:global(.x228d5b5u) {
  fill: currentColor;
