...
const content = `<path class="ww8b0fbjy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:link-simple-horizontal-break-light" {...props}></Icon>
<style>
:global(.ww8b0fbjy) {
  fill: currentColor;
