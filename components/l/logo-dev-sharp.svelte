...
const content = `<path class="w9269-bvf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:logo-dev-sharp" {...props}></Icon>
<style>
:global(.w9269-bvf) {
  fill: currentColor;
