...
const content = `<path class="goe_ipb0l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-row-two-split-bottom-focus-bottom-right-16-filled" {...props}></Icon>
<style>
:global(.goe_ipb0l) {
  fill: currentColor;
