...
const content = `<path class="uexdphlsj"/><path class="edij8pk2x"/><path class="rd4f0h00b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:limbo-x86" {...props}></Icon>
<style>
:global(.edij8pk2x) {
  fill: none;
  stroke: currentColor;
