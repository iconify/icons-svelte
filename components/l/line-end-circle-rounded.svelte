...
const content = `<path class="h_blm5b1u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:line-end-circle-rounded" {...props}></Icon>
<style>
:global(.h_blm5b1u) {
  fill: currentColor;
