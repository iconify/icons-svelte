...
const content = `<path class="k-95ypbqb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:label-outline" {...props}></Icon>
<style>
:global(.k-95ypbqb) {
  fill: currentColor;
