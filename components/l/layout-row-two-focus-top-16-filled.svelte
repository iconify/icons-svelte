...
const content = `<path class="d0w4rodsr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-row-two-focus-top-16-filled" {...props}></Icon>
<style>
:global(.d0w4rodsr) {
  fill: currentColor;
