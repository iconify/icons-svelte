...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="qd0_j1bvi"/><path class="o_9cyhf-j"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:loop" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
