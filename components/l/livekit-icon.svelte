...
const content = `<path class="ecdi7zimw"/><path class="ip64_16bk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:livekit-icon" {...props}></Icon>
<style>
:global(.ecdi7zimw) {
