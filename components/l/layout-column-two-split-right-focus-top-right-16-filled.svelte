...
const content = `<path class="x9myg1b2h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:layout-column-two-split-right-focus-top-right-16-filled" {...props}></Icon>
<style>
:global(.x9myg1b2h) {
  fill: currentColor;
