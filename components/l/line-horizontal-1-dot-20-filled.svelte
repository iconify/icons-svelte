...
const content = `<path class="ipb0p6bhs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:line-horizontal-1-dot-20-filled" {...props}></Icon>
<style>
:global(.ipb0p6bhs) {
  fill: currentColor;
