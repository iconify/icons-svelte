...
const content = `<path class="vbj5imbts"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:4k-outline-sharp" {...props}></Icon>
<style>
:global(.vbj5imbts) {
  fill: currentColor;
