...
const content = `<path class="i63ptbc8z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:4k-outline-sharp" {...props}></Icon>
<style>
:global(.i63ptbc8z) {
  fill: currentColor;
