...
const content = `<path class="so08sbcqs"/><path class="kjupx_efe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:harmonic" {...props}></Icon>
<style>
:global(.kjupx_efe) {
  fill: none;
  stroke: currentColor;
