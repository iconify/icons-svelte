...
const content = `<path class="fis863b7z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:home-repair-service-outline" {...props}></Icon>
<style>
:global(.fis863b7z) {
  fill: currentColor;
