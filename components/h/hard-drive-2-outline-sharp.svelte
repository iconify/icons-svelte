...
const content = `<path class="trsotdwtc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:hard-drive-2-outline-sharp" {...props}></Icon>
<style>
:global(.trsotdwtc) {
  fill: currentColor;
