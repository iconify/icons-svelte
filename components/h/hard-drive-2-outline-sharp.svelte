...
const content = `<path class="r2mt24avt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:hard-drive-2-outline-sharp" {...props}></Icon>
<style>
:global(.r2mt24avt) {
  fill: currentColor;
