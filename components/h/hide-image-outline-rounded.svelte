...
const content = `<path class="kr0y5hbib"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:hide-image-outline-rounded" {...props}></Icon>
<style>
:global(.kr0y5hbib) {
  fill: currentColor;
