...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="xjbbdxber"/><path class="ohxybgb-l"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:hand-grab" {...props}></Icon>
<style>
:global(.n1lsf0bnc) {
  fill: currentColor;
  fill-rule: evenodd;
