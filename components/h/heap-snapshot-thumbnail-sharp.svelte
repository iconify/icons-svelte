...
const content = `<path class="y_zg1dbei"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:heap-snapshot-thumbnail-sharp" {...props}></Icon>
<style>
:global(.y_zg1dbei) {
  fill: currentColor;
