...
const content = `<path class="dn8qgdbga"/><path class="zpnwkbbmt"/><path class="gkvz8plob"/><path class="mj7mxeamc"/><path class="a0m57qbpo"/><path class="bg4ztcuex"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:hibiscus" {...props}></Icon>
<style>
:global(.a0m57qbpo) {
