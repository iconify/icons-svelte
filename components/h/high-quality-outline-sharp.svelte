...
const content = `<path class="oyejujtbd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:high-quality-outline-sharp" {...props}></Icon>
<style>
:global(.oyejujtbd) {
  fill: currentColor;
