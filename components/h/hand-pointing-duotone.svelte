...
const content = `<g class="cuyn6tgcc"><path class="znayxybec"/><path class="f8fys7_9u"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:hand-pointing-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
