...
const content = `<path class="cisgj5drz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:headphones-sound-wave-12-regular" {...props}></Icon>
<style>
:global(.cisgj5drz) {
  fill: currentColor;
