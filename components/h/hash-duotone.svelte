...
const content = `<g class="cuyn6tgcc"><path class="dcqdgpbzm"/><path class="hbpf12bjd"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:hash-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
