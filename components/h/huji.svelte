...
const content = `<path class="m_4brrtfn"/><path class="d2r3264na"/><path class="jkj5crzzs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:huji" {...props}></Icon>
<style>
:global(.d2r3264na) {
  fill: none;
  stroke: currentColor;
