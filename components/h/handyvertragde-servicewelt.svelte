...
const content = `<path class="wg97h6mas"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:handyvertragde-servicewelt" {...props}></Icon>
<style>
:global(.wg97h6mas) {
  fill: none;
  stroke: currentColor;
