...
const content = `<path class="sukj6gb5m"/><path class="q9r31vbyh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:hamrah-e-aval" {...props}></Icon>
<style>
:global(.q9r31vbyh) {
  fill: none;
  stroke: currentColor;
