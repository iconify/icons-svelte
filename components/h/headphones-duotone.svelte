...
const content = `<g class="nrj6p8qat"><path class="w9_kthb0l"/><path class="iny7mab4a"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:headphones-duotone" {...props}></Icon>
<style>
:global(.iny7mab4a) {
  stroke-opacity: 0.4;
