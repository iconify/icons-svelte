...
const content = `<g class="cuyn6tgcc"><path class="i9ovbdbpk"/><path class="p5-tc56tu"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:headphones-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
