...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="t_vb2bc_v"/><path class="tjy-4lbwr"/><path class="hdxpysbbn"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:hand-point-open-circle" {...props}></Icon>
<style>
:global(.hdxpysbbn) {
