...
const content = `<path class="t-au54b-z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:home-repair-service-outline-rounded" {...props}></Icon>
<style>
:global(.t-au54b-z) {
  fill: currentColor;
