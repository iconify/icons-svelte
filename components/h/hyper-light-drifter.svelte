...
const content = `<path class="j0e22pbwd"/><path class="nt1ig3fjq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:hyper-light-drifter" {...props}></Icon>
<style>
:global(.j0e22pbwd) {
  fill: none;
  stroke: currentColor;
