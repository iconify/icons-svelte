...
const content = `<g class="cuyn6tgcc"><path class="h5o_89o6z"/><path class="qqa077bda"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:hard-drives-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
