...
const content = `<path class="ezvc76bnj"/><path class="zm59urmer"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:huawei-gameassistant" {...props}></Icon>
<style>
:global(.ezvc76bnj) {
  fill: none;
  stroke: currentColor;
