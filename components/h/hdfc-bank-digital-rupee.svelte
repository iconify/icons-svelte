...
const content = `<path class="aux49m2hr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:hdfc-bank-digital-rupee" {...props}></Icon>
<style>
:global(.aux49m2hr) {
  fill: none;
  stroke: currentColor;
