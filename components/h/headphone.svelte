...
const content = `<path class="o2lh2sb_f"/><path class="k_2kwnygd"/><path class="gsv1jzi0u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:headphone" {...props}></Icon>
<style>
:global(.gsv1jzi0u) {
