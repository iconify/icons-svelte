...
const content = `<path class="r79otkm6l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:help-clinic-rounded" {...props}></Icon>
<style>
:global(.r79otkm6l) {
  fill: currentColor;
