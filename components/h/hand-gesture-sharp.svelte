...
const content = `<path class="vuwaywzzt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:hand-gesture-sharp" {...props}></Icon>
<style>
:global(.vuwaywzzt) {
  fill: currentColor;
