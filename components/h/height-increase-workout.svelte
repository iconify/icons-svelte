...
const content = `<path class="loqw_5acf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:height-increase-workout" {...props}></Icon>
<style>
:global(.loqw_5acf) {
  fill: none;
  stroke: currentColor;
