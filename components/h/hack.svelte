...
const content = `<path class="iyanq_bel"/><path class="id_t-lbqe"/><path class="attl0qbwc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:hack" {...props}></Icon>
<style>
:global(.attl0qbwc) {
