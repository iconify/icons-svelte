...
const content = `<rect class="j3s9ivbxi"/><path class="hge0_7zrf"/><path class="dt-i-ebag"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:hmal" {...props}></Icon>
<style>
:global(.dt-i-ebag) {
  fill: none;
  stroke: currentColor;
