...
const content = `<path class="z35_tcb0m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:hand-gesture-off-rounded" {...props}></Icon>
<style>
:global(.z35_tcb0m) {
  fill: currentColor;
