...
const content = `<path class="ml0-h9ycb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:hangout-video" {...props}></Icon>
<style>
:global(.ml0-h9ycb) {
  fill: currentColor;
