...
const content = `<path class="wq6mupb6g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:hov-rounded" {...props}></Icon>
<style>
:global(.wq6mupb6g) {
  fill: currentColor;
