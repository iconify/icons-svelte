...
const content = `<path class="k0a27ccsl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:hearing-aid-disabled-outline-sharp" {...props}></Icon>
<style>
:global(.k0a27ccsl) {
  fill: currentColor;
