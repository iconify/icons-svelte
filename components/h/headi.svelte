...
const content = `<path class="u-lqk-bdv"/><path class="b438kv4_o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:headi" {...props}></Icon>
<style>
:global(.b438kv4_o) {
  fill: none;
  stroke: currentColor;
