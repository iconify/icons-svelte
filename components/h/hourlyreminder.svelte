...
const content = `<path class="r6ie1_o-e"/><path class="g2alxtbek"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:hourlyreminder" {...props}></Icon>
<style>
:global(.g2alxtbek) {
  fill: none;
  stroke: currentColor;
