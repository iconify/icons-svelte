...
const content = `<path class="xx0unqb4j"/><circle class="ayy31cbrt"/><path class="vohn0_9zp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:hedgecam-2" {...props}></Icon>
<style>
:global(.ayy31cbrt) {
  cx: 24.037px;
  cy: 26.295px;
