...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="n0lwyub-i"/><path class="l6h7k98sk"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:hands-clapping-checkmark" {...props}></Icon>
<style>
:global(.l6h7k98sk) {
