...
const content = `<path class="lizxz1tot"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:hard-drive-2-sharp" {...props}></Icon>
<style>
:global(.lizxz1tot) {
  fill: currentColor;
