...
const content = `<path class="j3uxzoypk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:heart-circle-hint-16-filled" {...props}></Icon>
<style>
:global(.j3uxzoypk) {
  fill: currentColor;
