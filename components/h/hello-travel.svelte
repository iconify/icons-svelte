...
const content = `<path class="btwkgac1g"/><path class="d51dwybfz"/><path class="c1btu5bil"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:hello-travel" {...props}></Icon>
<style>
:global(.btwkgac1g) {
  fill: none;
  stroke: currentColor;
