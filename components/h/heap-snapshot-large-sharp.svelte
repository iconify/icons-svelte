...
const content = `<path class="wbqmoxbjo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:heap-snapshot-large-sharp" {...props}></Icon>
<style>
:global(.wbqmoxbjo) {
  fill: currentColor;
