...
const content = `<path class="w5habcb4m"/><circle class="cpk0fnbgt"/><path class="qogmuzbeb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:host" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
