...
const content = `<g class="gp_8x1bzb"><path class="x_n1ipavl"/><path class="dabf_d2bk"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:heart-plus-sharp-fill" {...props}></Icon>
<style>
:global(.dabf_d2bk) {
