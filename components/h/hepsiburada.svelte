...
const content = `<circle class="cpk0fnbgt"/><path class="h8z9qo28r"/><circle class="y2immvofm"/><path class="uu9thnb0c"/><path class="ds6r8yu4s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:hepsiburada" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
