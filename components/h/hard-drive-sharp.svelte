...
const content = `<path class="udg71s4rn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:hard-drive-sharp" {...props}></Icon>
<style>
:global(.udg71s4rn) {
  fill: currentColor;
