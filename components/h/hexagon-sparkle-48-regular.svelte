...
const content = `<path class="qvywd-46a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:hexagon-sparkle-48-regular" {...props}></Icon>
<style>
:global(.qvywd-46a) {
  fill: currentColor;
