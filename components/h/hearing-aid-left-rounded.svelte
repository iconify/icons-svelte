...
const content = `<path class="ceo0eqbwo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:hearing-aid-left-rounded" {...props}></Icon>
<style>
:global(.ceo0eqbwo) {
  fill: currentColor;
