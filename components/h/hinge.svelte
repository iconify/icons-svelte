...
const content = `<path class="ou_pblb2j"/><path class="nn-po-p7y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:hinge" {...props}></Icon>
<style>
:global(.nn-po-p7y) {
  fill: none;
  stroke: currentColor;
