...
const content = `<g class="cuyn6tgcc"><path class="l31x2johq"/><path class="em-8dfbuv"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:hourglass-low-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
