...
const content = `<path class="ceqznqnng"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:headphones-sound-wave-12-filled" {...props}></Icon>
<style>
:global(.ceqznqnng) {
  fill: currentColor;
