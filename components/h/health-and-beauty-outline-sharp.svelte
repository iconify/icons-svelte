...
const content = `<path class="gskjo6_7b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:health-and-beauty-outline-sharp" {...props}></Icon>
<style>
:global(.gskjo6_7b) {
  fill: currentColor;
