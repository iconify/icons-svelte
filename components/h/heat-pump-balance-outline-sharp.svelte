...
const content = `<path class="u132lbbpg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:heat-pump-balance-outline-sharp" {...props}></Icon>
<style>
:global(.u132lbbpg) {
  fill: currentColor;
