...
const content = `<path class="aw5_fqbiz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:home-storage-gear-outline-rounded" {...props}></Icon>
<style>
:global(.aw5_fqbiz) {
  fill: currentColor;
