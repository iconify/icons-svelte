...
const content = `<path class="tndv68f6j"/><path class="r2iik92ow"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:hak" {...props}></Icon>
<style>
:global(.r2iik92ow) {
  fill: none;
  stroke: currentColor;
