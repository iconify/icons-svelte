...
const content = `<path class="z5ejmvb0m"/><path class="rcydelkar"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:http-custom" {...props}></Icon>
<style>
:global(.rcydelkar) {
  fill: none;
  stroke: currentColor;
