...
const content = `<path class="ugwy7tbwv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:home-storage" {...props}></Icon>
<style>
:global(.ugwy7tbwv) {
  fill: currentColor;
