...
const content = `<path class="df-0t6ggo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:history-toggle-off-outline-sharp" {...props}></Icon>
<style>
:global(.df-0t6ggo) {
  fill: currentColor;
