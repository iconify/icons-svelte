...
const content = `<g class="cuyn6tgcc"><path class="df6162oqu"/><path class="k-0igbbak"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:hard-drive-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
