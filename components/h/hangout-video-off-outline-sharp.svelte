...
const content = `<path class="ojpot1bme"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:hangout-video-off-outline-sharp" {...props}></Icon>
<style>
:global(.ojpot1bme) {
  fill: currentColor;
