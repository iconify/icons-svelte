...
const content = `<path class="t9q24pbhk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:heap-snapshot-large-outline-sharp" {...props}></Icon>
<style>
:global(.t9q24pbhk) {
  fill: currentColor;
