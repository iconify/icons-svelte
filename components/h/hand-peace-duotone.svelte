...
const content = `<g class="cuyn6tgcc"><path class="vg9nt6bqf"/><path class="fkjhbcd5h"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:hand-peace-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
