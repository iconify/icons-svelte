...
const content = `<path class="xkgxd-bct"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:high-quality-off-sharp" {...props}></Icon>
<style>
:global(.xkgxd-bct) {
  fill: currentColor;
