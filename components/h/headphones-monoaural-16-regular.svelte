...
const content = `<path class="bo_ua7ubz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:headphones-monoaural-16-regular" {...props}></Icon>
<style>
:global(.bo_ua7ubz) {
  fill: currentColor;
