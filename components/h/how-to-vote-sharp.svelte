...
const content = `<path class="kahdv9bch"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:how-to-vote-sharp" {...props}></Icon>
<style>
:global(.kahdv9bch) {
  fill: currentColor;
