...
const content = `<path class="qwo-lbclm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:how-to-vote-sharp" {...props}></Icon>
<style>
:global(.qwo-lbclm) {
  fill: currentColor;
