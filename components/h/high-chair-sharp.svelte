...
const content = `<path class="bv3a3944i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:high-chair-sharp" {...props}></Icon>
<style>
:global(.bv3a3944i) {
  fill: currentColor;
