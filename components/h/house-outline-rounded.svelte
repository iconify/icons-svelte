...
const content = `<path class="dze4npowg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:house-outline-rounded" {...props}></Icon>
<style>
:global(.dze4npowg) {
  fill: currentColor;
