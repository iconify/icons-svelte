...
const content = `<path class="w1voitbgb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:home-storage-gear-rounded" {...props}></Icon>
<style>
:global(.w1voitbgb) {
  fill: currentColor;
