...
const content = `<g class="cuyn6tgcc"><path class="jl3n3_bjv"/><path class="gpsi6mbox"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:hockey-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
