...
const content = `<g class="cuyn6tgcc"><path class="k6d5flbfg"/><path class="l7ekplb1n"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:house-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
