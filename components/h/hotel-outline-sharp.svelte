...
const content = `<path class="bs5ngx46m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:hotel-outline-sharp" {...props}></Icon>
<style>
:global(.bs5ngx46m) {
  fill: currentColor;
