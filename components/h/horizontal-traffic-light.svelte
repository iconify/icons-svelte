...
const content = `<path class="dn7v39b6n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:horizontal-traffic-light" {...props}></Icon>
<style>
:global(.dn7v39b6n) {
  fill: currentColor;
