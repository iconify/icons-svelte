...
const content = `<path class="g-3_n1c0v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:health-cross-outline-rounded" {...props}></Icon>
<style>
:global(.g-3_n1c0v) {
  fill: currentColor;
