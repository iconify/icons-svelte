...
const content = `<g class="nrj6p8qat"><path class="cj7-b7bdm"/><path class="j7ophtquh"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:home-plus-duotone" {...props}></Icon>
<style>
:global(.cj7-b7bdm) {
  fill: currentColor;
