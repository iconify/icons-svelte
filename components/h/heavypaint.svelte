...
const content = `<path class="g2wj9jbhp"/><path class="bimsi3l4y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:heavypaint" {...props}></Icon>
<style>
:global(.bimsi3l4y) {
  fill: none;
  stroke: currentColor;
