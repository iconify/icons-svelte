...
const content = `<g class="kysm70bca"><path class="lxsk2_iux"/><path class="i6ebjftfx"/><path class="tea5bvbbv"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:hxd" {...props}></Icon>
<style>
:global(.i6ebjftfx) {
