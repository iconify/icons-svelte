...
const content = `<path class="uz8p2-hmn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:hearing-aid-rounded" {...props}></Icon>
<style>
:global(.uz8p2-hmn) {
  fill: currentColor;
