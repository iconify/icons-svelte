...
const content = `<path class="w1w2hdcao"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:hearing-aid-disabled-sharp" {...props}></Icon>
<style>
:global(.w1w2hdcao) {
  fill: currentColor;
