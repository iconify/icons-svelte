...
const content = `<path class="j_oj9uecm"/><path class="kabd0hl4j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:fortnite" {...props}></Icon>
<style>
:global(.j_oj9uecm) {
  fill: none;
  stroke: currentColor;
