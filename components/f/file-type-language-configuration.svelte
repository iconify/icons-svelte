...
const content = `<path class="b9s3zgkdp"/><path class="njpga5bnu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-language-configuration" {...props}></Icon>
<style>
:global(.b9s3zgkdp) {
