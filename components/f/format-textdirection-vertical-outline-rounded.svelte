...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:format-textdirection-vertical-outline-rounded" {...props}></Icon>
<style>
:global(.ebf8sqjcm) {
  fill: currentColor;
