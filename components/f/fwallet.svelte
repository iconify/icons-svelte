...
const content = `<path class="s3uvwy5gu"/><path class="vv2em8bfa"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:fwallet" {...props}></Icon>
<style>
:global(.s3uvwy5gu) {
  fill: none;
  stroke: currentColor;
