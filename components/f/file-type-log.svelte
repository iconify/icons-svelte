...
const content = `<path class="gm6wlrb9k"/><path class="ezn96ea8w"/><path class="nb4rxibew"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-log" {...props}></Icon>
<style>
:global(.ezn96ea8w) {
