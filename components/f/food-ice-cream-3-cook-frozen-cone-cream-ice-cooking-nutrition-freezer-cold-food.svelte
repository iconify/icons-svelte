...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline:food-ice-cream-3-cook-frozen-cone-cream-ice-cooking-nutrition-freezer-cold-food" {...props}></Icon>
