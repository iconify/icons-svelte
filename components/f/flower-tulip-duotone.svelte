...
const content = `<g class="cuyn6tgcc"><path class="igifs5bqg"/><path class="n6tmk_bap"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:flower-tulip-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
