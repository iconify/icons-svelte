...
const content = `<path class="dter5fhtk"/><path class="m3d5oybbj"/><path class="w4qd-obeu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:flight-dark" {...props}></Icon>
<style>
:global(.dter5fhtk) {
  fill: none;
  stroke: currentColor;
