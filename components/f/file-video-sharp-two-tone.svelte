...
const content = `<g class="gp_8x1bzb"><path class="vpyvtnijy"/><path class="b9qesibqt"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:file-video-sharp-two-tone" {...props}></Icon>
<style>
:global(.b9qesibqt) {
