...
const content = `<path class="dywv8abul"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-light-codeclimate" {...props}></Icon>
<style>
:global(.dywv8abul) {
