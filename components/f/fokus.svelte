...
const content = `<path class="i2-ojrhtu"/><path class="jv592ccpe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:fokus" {...props}></Icon>
<style>
:global(.i2-ojrhtu) {
  fill: none;
  stroke: currentColor;
