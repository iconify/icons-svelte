...
const content = `<path class="mgbqw72th"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:folder-special" {...props}></Icon>
<style>
:global(.mgbqw72th) {
  fill: currentColor;
