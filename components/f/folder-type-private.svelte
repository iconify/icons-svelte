...
const content = `<path class="ef9_wqb0d"/><path class="s-q22x7dx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:folder-type-private" {...props}></Icon>
<style>
:global(.ef9_wqb0d) {
