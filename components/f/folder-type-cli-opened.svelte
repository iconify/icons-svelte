...
const content = `<path class="kqg603bna"/><path class="nab_hkb_r"/><path class="ldnyk_qcf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:folder-type-cli-opened" {...props}></Icon>
<style>
:global(.kqg603bna) {
