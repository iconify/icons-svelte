...
const content = `<g class="nrj6p8qat"><path class="kftuk7bvi"/><path class="b5kf5wb7v"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:filter-two-tone" {...props}></Icon>
<style>
:global(.b5kf5wb7v) {
