...
const content = `<g class="cuyn6tgcc"><path class="hk7oorbvv"/><path class="k2qyxh6qq"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:flag-banner-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
