...
const content = `<g class="cuyn6tgcc"><path class="nvjq80alh"/><path class="dkri8eb1z"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:file-arrow-down-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
