...
const content = `<path class="jcl1uzb8y"/><path class="dc759bcnj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-ttcn" {...props}></Icon>
<style>
:global(.dc759bcnj) {
