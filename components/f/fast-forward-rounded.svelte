...
const content = `<path class="oomr__bjy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:fast-forward-rounded" {...props}></Icon>
<style>
:global(.oomr__bjy) {
  fill: currentColor;
