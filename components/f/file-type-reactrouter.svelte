...
const content = `<path class="z-42b4bkz"/><path class="anr0pobrv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-reactrouter" {...props}></Icon>
<style>
:global(.anr0pobrv) {
