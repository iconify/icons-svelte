...
const content = `<path class="byj2o0bhh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:fire-truck-outline-rounded" {...props}></Icon>
<style>
:global(.byj2o0bhh) {
  fill: currentColor;
