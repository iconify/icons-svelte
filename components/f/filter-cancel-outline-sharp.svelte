...
const content = `<path class="p7syljm8d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:filter-cancel-outline-sharp" {...props}></Icon>
<style>
:global(.p7syljm8d) {
  fill: currentColor;
