...
const content = `<path class="jb65wu89i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:filter-cancel-outline-sharp" {...props}></Icon>
<style>
:global(.jb65wu89i) {
  fill: currentColor;
