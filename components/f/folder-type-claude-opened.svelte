...
const content = `<path class="hhu2qsg0t"/><path class="zqej89tfc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:folder-type-claude-opened" {...props}></Icon>
<style>
:global(.hhu2qsg0t) {
