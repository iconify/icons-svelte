...
const content = `<circle class="yo43fuw7d"/><path class="irmkv5bux"/><path class="eoec02mau"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:foodie" {...props}></Icon>
<style>
:global(.eoec02mau) {
  fill: none;
  stroke: currentColor;
