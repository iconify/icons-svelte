...
const content = `<path class="wd8xhjwhw"/><path class="htd3y-blf"/><circle class="zerg3u0jp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:francetv" {...props}></Icon>
<style>
:global(.htd3y-blf) {
  fill: none;
  stroke: currentColor;
