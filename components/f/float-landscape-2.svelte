...
const content = `<path class="trjs_3bbx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:float-landscape-2" {...props}></Icon>
<style>
:global(.trjs_3bbx) {
  fill: currentColor;
