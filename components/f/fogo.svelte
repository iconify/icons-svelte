...
const content = `<g class="ft5dv1b6b"><path class="zvd63uj5o"/><path class="rs2ctkjrn"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:fogo" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
