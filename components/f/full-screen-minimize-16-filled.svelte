...
const content = `<path class="nted08b4e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:full-screen-minimize-16-filled" {...props}></Icon>
<style>
:global(.nted08b4e) {
  fill: currentColor;
