...
const content = `<path class="p2_o2pvrc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:file-save-off-outline-sharp" {...props}></Icon>
<style>
:global(.p2_o2pvrc) {
  fill: currentColor;
