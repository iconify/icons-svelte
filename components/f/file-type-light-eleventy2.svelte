...
const content = `<path class="w9mu7ib4t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-light-eleventy2" {...props}></Icon>
<style>
:global(.w9mu7ib4t) {
