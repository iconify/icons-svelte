...
const content = `<path class="qk_wzobet"/><circle class="rt_37l3dj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:four-oclock" {...props}></Icon>
<style>
:global(.qk_wzobet) {
  fill: currentColor;
