...
const content = `<circle class="cpk0fnbgt"/><path class="v1jzh7b7k"/><path class="h-7pzibqg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:fetchit" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
