...
const content = `<g class="dm0uzs1-f"><path class="sseulijiw"/><path class="h-a9u-plz"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-buf" {...props}></Icon>
<style>
:global(.dm0uzs1-f) {
