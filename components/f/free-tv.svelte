...
const content = `<path class="nojghdcxp"/><path class="r_lpty4dt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:free-tv" {...props}></Icon>
<style>
:global(.nojghdcxp) {
  fill: none;
  stroke: currentColor;
