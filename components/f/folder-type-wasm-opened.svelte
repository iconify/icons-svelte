...
const content = `<path class="wz11u_bcj"/><path class="pvf-b3but"/><path class="pp87r2b7s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:folder-type-wasm-opened" {...props}></Icon>
<style>
:global(.pp87r2b7s) {
