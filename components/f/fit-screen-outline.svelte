...
const content = `<path class="pvf1fkbzj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:fit-screen-outline" {...props}></Icon>
<style>
:global(.pvf1fkbzj) {
  fill: currentColor;
