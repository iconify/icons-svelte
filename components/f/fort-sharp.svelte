...
const content = `<path class="so-tf9xcs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:fort-sharp" {...props}></Icon>
<style>
:global(.so-tf9xcs) {
  fill: currentColor;
