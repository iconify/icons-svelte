...
const content = `<path class="bjuavhbxp"/><path class="vcuo19zqw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:foot-mercato" {...props}></Icon>
<style>
:global(.bjuavhbxp) {
  fill: none;
  stroke: currentColor;
