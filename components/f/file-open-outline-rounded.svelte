...
const content = `<path class="bjqda37gw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:file-open-outline-rounded" {...props}></Icon>
<style>
:global(.bjqda37gw) {
  fill: currentColor;
