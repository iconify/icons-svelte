...
const content = `<path class="tedeb43cf"/><path class="uz4iqrbqv"/><path class="mfd4lndmq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:freedcamviewer" {...props}></Icon>
<style>
:global(.mfd4lndmq) {
  fill: none;
  stroke: currentColor;
