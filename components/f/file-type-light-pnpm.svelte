...
const content = `<path class="nfkr24opq"/><path class="jg1nbpm8h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-light-pnpm" {...props}></Icon>
<style>
:global(.jg1nbpm8h) {
