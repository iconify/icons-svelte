...
const content = `<path class="eapltw7xn"/><path class="uhk-qqbzw"/><path class="h6z9iabyb"/><path class="fcvh4q7kh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-appsemble" {...props}></Icon>
<style>
:global(.eapltw7xn) {
