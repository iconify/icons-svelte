...
const content = `<path class="z9jxt_bwq"/><path class="iz4b3nb1m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-mdx" {...props}></Icon>
<style>
:global(.iz4b3nb1m) {
