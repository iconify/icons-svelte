...
const content = `<path class="rn7je3bil"/><path class="a9429mbjd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-san" {...props}></Icon>
<style>
:global(.a9429mbjd) {
