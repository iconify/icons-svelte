...
const content = `<path class="rg14honrb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:fast-rewind-rounded" {...props}></Icon>
<style>
:global(.rg14honrb) {
  fill: currentColor;
