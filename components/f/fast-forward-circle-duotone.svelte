...
const content = `<g class="cuyn6tgcc"><path class="dbyq3obxo"/><path class="s9jb2dbez"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:fast-forward-circle-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
