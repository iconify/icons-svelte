...
const content = `<path class="axap8bb_t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:forward-to-inbox-outline" {...props}></Icon>
<style>
:global(.axap8bb_t) {
  fill: currentColor;
