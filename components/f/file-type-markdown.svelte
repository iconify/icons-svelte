...
const content = `<path class="kw5uikb2l"/><path class="t0ox62biv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-markdown" {...props}></Icon>
<style>
:global(.kw5uikb2l) {
  fill: none;
