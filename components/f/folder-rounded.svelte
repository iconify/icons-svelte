...
const content = `<path class="bjb2yq4ho"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:folder-rounded" {...props}></Icon>
<style>
:global(.bjb2yq4ho) {
  fill: currentColor;
