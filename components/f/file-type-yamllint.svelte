...
const content = `<path class="xxuuzrxyx"/><path class="jzw388bmc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-yamllint" {...props}></Icon>
<style>
:global(.jzw388bmc) {
