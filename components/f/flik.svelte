...
const content = `<circle class="cpk0fnbgt"/><path class="ck1gqpt9p"/><circle class="lcxhuq6_e"/><path class="lf5i7u4-c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:flik" {...props}></Icon>
<style>
:global(.ck1gqpt9p) {
  fill: none;
  stroke: currentColor;
