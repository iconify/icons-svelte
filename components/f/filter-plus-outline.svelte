...
const content = `<path class="dniywe9ew"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:filter-plus-outline" {...props}></Icon>
<style>
:global(.dniywe9ew) {
  fill: currentColor;
