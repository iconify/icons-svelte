...
const content = `<path class="qd0u_bc0n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:fullscreen-portrait-rounded" {...props}></Icon>
<style>
:global(.qd0u_bc0n) {
  fill: currentColor;
