...
const content = `<path class="m7_rh8bwd"/><path class="w_md5qbvy"/><path class="awtt9sbwi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:folder-type-buildkite" {...props}></Icon>
<style>
:global(.awtt9sbwi) {
