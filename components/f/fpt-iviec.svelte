...
const content = `<path class="qkfjxubwk"/><path class="vee2y-d2d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:fpt-iviec" {...props}></Icon>
<style>
:global(.qkfjxubwk) {
  fill: none;
  stroke: currentColor;
