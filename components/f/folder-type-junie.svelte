...
const content = `<path class="rwa05hbab"/><path class="u6xminppf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:folder-type-junie" {...props}></Icon>
<style>
:global(.rwa05hbab) {
