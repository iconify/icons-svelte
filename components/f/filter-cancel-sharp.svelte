...
const content = `<path class="oz5wri42l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:filter-cancel-sharp" {...props}></Icon>
<style>
:global(.oz5wri42l) {
  fill: currentColor;
