...
const content = `<path class="b6qzq_d4v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:folder-supervised-sharp" {...props}></Icon>
<style>
:global(.b6qzq_d4v) {
  fill: currentColor;
