...
const content = `<circle class="q1m2erv2p"/><circle class="i9i44z3-b"/><circle class="s2-a01xcc"/><path class="jkw7_vxjd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:face-with-rolling-eyes" {...props}></Icon>
<style>
:global(.i9i44z3-b) {
  cx: 24.5px;
  cy: 13.5px;
