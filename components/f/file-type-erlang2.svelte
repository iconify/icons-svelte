...
const content = `<path class="uq9h0r48c"/><path class="qa_1u-j9r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-erlang2" {...props}></Icon>
<style>
:global(.qa_1u-j9r) {
