...
const content = `<path class="jv0rn2smi"/><path class="ekxdchyro"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:fortuneo" {...props}></Icon>
<style>
:global(.ekxdchyro) {
  fill: none;
  stroke: currentColor;
