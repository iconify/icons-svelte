...
const content = `<g class="cuyn6tgcc"><path class="m5rk6bbod"/><path class="jgo_q_zqk"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:figma-logo-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
