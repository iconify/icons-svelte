...
const content = `<path class="zwyafxbdp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:full-screen-maximize-20-filled" {...props}></Icon>
<style>
:global(.zwyafxbdp) {
  fill: currentColor;
