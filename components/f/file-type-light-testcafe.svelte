...
const content = `<path class="lsljf5b6l"/><path class="j9olvcbsq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-light-testcafe" {...props}></Icon>
<style>
:global(.j9olvcbsq) {
