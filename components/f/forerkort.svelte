...
const content = `<path class="tcofksbvb"/><path class="rs-jd5b6u"/><circle class="tl6kt9nzo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:forerkort" {...props}></Icon>
<style>
:global(.rs-jd5b6u) {
  fill: none;
  stroke: currentColor;
