...
const content = `<path class="f9rjpcc3b"/><path class="h2jstwvvh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-yaml-official" {...props}></Icon>
<style>
:global(.f9rjpcc3b) {
