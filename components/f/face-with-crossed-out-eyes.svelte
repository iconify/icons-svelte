...
const content = `<path class="tg31urbgg"/><ellipse class="wt7dtpb1h"/><path class="mo811lbzm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:face-with-crossed-out-eyes" {...props}></Icon>
<style>
:global(.mo811lbzm) {
