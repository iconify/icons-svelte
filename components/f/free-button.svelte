...
const content = `<path class="x-kz1kb7j"/><path class="u-zd9-5nf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:free-button" {...props}></Icon>
<style>
:global(.u-zd9-5nf) {
