...
const content = `<path class="g8ivzlboy"/><path class="kg4ghsblu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:fsecure-for-true" {...props}></Icon>
<style>
:global(.g8ivzlboy) {
  fill: none;
  stroke: currentColor;
