...
const content = `<path class="n8qupvb2w"/><path class="cbznf35ej"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-light-spin" {...props}></Icon>
<style>
:global(.cbznf35ej) {
