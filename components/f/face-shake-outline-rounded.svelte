...
const content = `<path class="xekd4_byd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:face-shake-outline-rounded" {...props}></Icon>
<style>
:global(.xekd4_byd) {
  fill: currentColor;
