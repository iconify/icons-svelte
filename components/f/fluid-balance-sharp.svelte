...
const content = `<path class="i26im4b7i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:fluid-balance-sharp" {...props}></Icon>
<style>
:global(.i26im4b7i) {
  fill: currentColor;
