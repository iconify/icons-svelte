...
const content = `<circle class="mitiddbvf"/><path class="qaz1mcc3d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:foreca" {...props}></Icon>
<style>
:global(.mitiddbvf) {
  cx: 24.008px;
  cy: 23.899px;
