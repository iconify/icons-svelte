...
const content = `<path class="axfq_wb5v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:flood-rounded" {...props}></Icon>
<style>
:global(.axfq_wb5v) {
  fill: currentColor;
