...
const content = `<path class="h0qgeuwow"/><path class="xdymujbsm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:folder-home" {...props}></Icon>
<style>
:global(.h0qgeuwow) {
  fill: none;
  stroke: currentColor;
