...
const content = `<g class="u1zbfcosm"><path class="mi35jcc2h"/><path class="eyhf34bbj"/><path class="z1odc6eoe"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-unocss" {...props}></Icon>
<style>
:global(.eyhf34bbj) {
