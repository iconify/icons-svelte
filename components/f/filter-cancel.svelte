...
const content = `<path class="ragk3hvhw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:filter-cancel" {...props}></Icon>
<style>
:global(.ragk3hvhw) {
  fill: currentColor;
