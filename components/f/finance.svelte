...
const content = `<g class="y9tr6bcfx"><path class="byx51ydes"/><path class="vj_4sfbqi"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:finance" {...props}></Icon>
<style>
:global(.byx51ydes) {
