...
const content = `<path class="qc1vmsbgn"/><path class="ntuumre2a"/><path class="k8qxfilja"/><path class="imk-hfbnk"/><path class="g98vaobit"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:folder-type-bloc" {...props}></Icon>
<style>
:global(.g98vaobit) {
