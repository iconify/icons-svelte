...
const content = `<path class="zt45q0bti"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:folder-shared-sharp" {...props}></Icon>
<style>
:global(.zt45q0bti) {
  fill: currentColor;
