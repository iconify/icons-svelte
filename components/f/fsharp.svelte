...
const content = `<path class="v-lrgd2hc"/><path class="r9liddcwh"/><path class="j45wgnboo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:fsharp" {...props}></Icon>
<style>
:global(.j45wgnboo) {
