...
const content = `<path class="hi0x7tb9a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:float-portrait-2" {...props}></Icon>
<style>
:global(.hi0x7tb9a) {
  fill: currentColor;
