...
const content = `<path class="kz20b4e-j"/><path class="npjlly27w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:fallen-leaf" {...props}></Icon>
<style>
:global(.kz20b4e-j) {
