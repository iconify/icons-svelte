...
const content = `<path class="wfoh7qbpo"/><path class="qpg4oeblx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-blitzbasic" {...props}></Icon>
<style>
:global(.qpg4oeblx) {
