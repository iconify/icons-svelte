...
const content = `<path class="h-1f88bhr"/><path class="oijkx8qiv"/><path class="oeaykpxwa"/><path class="kwmz4jboz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:flag-bahamas" {...props}></Icon>
<style>
:global(.h-1f88bhr) {
