...
const content = `<path class="ms2lb6u_u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:font-space-tracking-out-28-filled" {...props}></Icon>
<style>
:global(.ms2lb6u_u) {
  fill: currentColor;
