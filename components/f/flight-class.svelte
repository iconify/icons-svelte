...
const content = `<path class="rtrhc3bno"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:flight-class" {...props}></Icon>
<style>
:global(.rtrhc3bno) {
  fill: currentColor;
