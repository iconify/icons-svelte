...
const content = `<path class="a4neo9fvu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:folder-zip" {...props}></Icon>
<style>
:global(.a4neo9fvu) {
  fill: currentColor;
