...
const content = `<path class="pl1pjnbdm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:floor-lamp-outline" {...props}></Icon>
<style>
:global(.pl1pjnbdm) {
  fill: currentColor;
