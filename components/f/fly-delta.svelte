...
const content = `<path class="reapv0bav"/><path class="k-bg8nb3a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:fly-delta" {...props}></Icon>
<style>
:global(.k-bg8nb3a) {
  fill: none;
  stroke: currentColor;
