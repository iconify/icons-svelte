...
const content = `<path class="x1ip7u_1u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:flip-horizontal-24-regular" {...props}></Icon>
<style>
:global(.x1ip7u_1u) {
  fill: currentColor;
