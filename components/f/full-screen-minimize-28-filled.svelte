...
const content = `<path class="b3i3y1bhk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:full-screen-minimize-28-filled" {...props}></Icon>
<style>
:global(.b3i3y1bhk) {
  fill: currentColor;
