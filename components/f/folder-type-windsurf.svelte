...
const content = `<path class="ff50gtb7w"/><path class="dv9l-wjfg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:folder-type-windsurf" {...props}></Icon>
<style>
:global(.dv9l-wjfg) {
