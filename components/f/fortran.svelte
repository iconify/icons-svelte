...
const content = `<path class="s7fu8g--m"/><path class="c61gpx7aa"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:fortran" {...props}></Icon>
<style>
:global(.c61gpx7aa) {
