...
const content = `<path class="uy7labdlj"/><path class="gi1zz02ea"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:feedflow" {...props}></Icon>
<style>
:global(.gi1zz02ea) {
  fill: none;
  stroke: currentColor;
