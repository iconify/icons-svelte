...
const content = `<path class="kf2_n1u_f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:fast-acceleration-20-filled" {...props}></Icon>
<style>
:global(.kf2_n1u_f) {
  fill: currentColor;
