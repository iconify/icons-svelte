...
const content = `<g class="nrj6p8qat"><path class="qlfij9bif"/><path class="lt11x1blj"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:flask-conical-off-fill" {...props}></Icon>
<style>
:global(.lt11x1blj) {
