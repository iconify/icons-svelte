...
const content = `<path class="z-42b4bkz"/><path class="kaq0fibbj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-light-reactrouter" {...props}></Icon>
<style>
:global(.kaq0fibbj) {
