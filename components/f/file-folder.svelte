...
const content = `<path class="p2ywf7bii"/><path class="elf7ro1xo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:file-folder" {...props}></Icon>
<style>
:global(.elf7ro1xo) {
