...
const content = `<path class="r4h1y5b9l"/><path class="an_0dcczg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:file-folder" {...props}></Icon>
<style>
:global(.an_0dcczg) {
  fill: none;
  stroke: currentColor;
