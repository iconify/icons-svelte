...
const content = `<path class="h5p9x7edi"/><path class="avaboxb8b"/><path class="s0h5_lbuh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-genstat" {...props}></Icon>
<style>
:global(.avaboxb8b) {
