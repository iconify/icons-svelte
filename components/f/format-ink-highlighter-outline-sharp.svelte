...
const content = `<path class="m4ipr0skc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:format-ink-highlighter-outline-sharp" {...props}></Icon>
<style>
:global(.m4ipr0skc) {
  fill: currentColor;
