...
const content = `<path class="i-t-cccgt"/><path class="k86n8x8hw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:flag-qatar" {...props}></Icon>
<style>
:global(.i-t-cccgt) {
