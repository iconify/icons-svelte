...
const content = `<path class="h0qgeuwow"/><path class="kj_slxm2h"/><circle class="zypxg1zux"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:folder-lock" {...props}></Icon>
<style>
:global(.h0qgeuwow) {
  fill: none;
  stroke: currentColor;
