...
const content = `<g class="cuyn6tgcc"><path class="yfmh_wrgi"/><path class="h6zalwbsx"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:faders-horizontal-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
