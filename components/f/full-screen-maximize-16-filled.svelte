...
const content = `<path class="u3hv7yxjb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:full-screen-maximize-16-filled" {...props}></Icon>
<style>
:global(.u3hv7yxjb) {
  fill: currentColor;
