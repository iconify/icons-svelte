...
const content = `<rect class="urlsyf_bb"/><path class="wml-7lc8o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:freereels" {...props}></Icon>
<style>
:global(.urlsyf_bb) {
  width: 21.748px;
  height: 33.645px;
