...
const content = `<path class="bv2g70b9o"/><path class="ntuumre2a"/><path class="k8qxfilja"/><path class="imk-hfbnk"/><path class="g98vaobit"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:folder-type-bloc-opened" {...props}></Icon>
<style>
:global(.bv2g70b9o) {
