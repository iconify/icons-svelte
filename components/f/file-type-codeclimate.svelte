...
const content = `<path class="knxee6jiw"/><path class="lrdf2bc4f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-codeclimate" {...props}></Icon>
<style>
:global(.knxee6jiw) {
