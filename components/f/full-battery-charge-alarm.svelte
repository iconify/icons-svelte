...
const content = `<path class="dtkjyh0dj"/><path class="muuaolarw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:full-battery-charge-alarm" {...props}></Icon>
<style>
:global(.dtkjyh0dj) {
  fill: none;
  stroke: currentColor;
