...
const content = `<path class="yn-ypxjqs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:folder-managed-outline-rounded" {...props}></Icon>
<style>
:global(.yn-ypxjqs) {
  fill: currentColor;
