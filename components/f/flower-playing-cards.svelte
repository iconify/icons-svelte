...
const content = `<path class="u55udyb2u"/><path class="v10it4bzm"/><circle class="b8p-1wb_q"/><path class="y_wx04bbm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione:flower-playing-cards" {...props}></Icon>
<style>
:global(.b8p-1wb_q) {
  cx: 25px;
  cy: 19px;
