...
const content = `<path class="q3uja5isj"/><path class="kpquoccif"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:flags" {...props}></Icon>
<style>
:global(.kpquoccif) {
  fill: none;
  stroke: currentColor;
