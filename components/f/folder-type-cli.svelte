...
const content = `<path class="sct5u5bus"/><path class="nab_hkb_r"/><path class="ldnyk_qcf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:folder-type-cli" {...props}></Icon>
<style>
:global(.ldnyk_qcf) {
