...
const content = `<path class="zut58gbmm"/><path class="lc9tbs6rs"/><path class="lboj7_b5t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:flag-honduras" {...props}></Icon>
<style>
:global(.lboj7_b5t) {
