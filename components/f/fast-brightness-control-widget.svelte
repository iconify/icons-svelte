...
const content = `<circle class="lck00867x"/><path class="hu3xlobnw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:fast-brightness-control-widget" {...props}></Icon>
<style>
:global(.hu3xlobnw) {
  fill: none;
  stroke: currentColor;
