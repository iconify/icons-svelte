...
const content = `<path class="d8bjtn7sr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:flip-horizontal-28-regular" {...props}></Icon>
<style>
:global(.d8bjtn7sr) {
  fill: currentColor;
