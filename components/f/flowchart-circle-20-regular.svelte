...
const content = `<path class="sm4tlub6z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:flowchart-circle-20-regular" {...props}></Icon>
<style>
:global(.sm4tlub6z) {
  fill: currentColor;
