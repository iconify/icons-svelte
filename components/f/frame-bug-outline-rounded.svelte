...
const content = `<path class="k7h45_6cg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:frame-bug-outline-rounded" {...props}></Icon>
<style>
:global(.k7h45_6cg) {
  fill: currentColor;
