...
const content = `<path class="x5s47feon"/><rect class="mi4ibbc8w"/><circle class="irm9u67wy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:finddevice" {...props}></Icon>
<style>
:global(.irm9u67wy) {
  cx: 24px;
  cy: 32.23px;
