...
const content = `<path class="ju6ul5bvt"/><path class="x0cm0e3hd"/><path class="u7w3_2x8e"/><circle class="y3t7ncckd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:flag-for-flag-taiwan" {...props}></Icon>
<style>
:global(.ju6ul5bvt) {
