...
const content = `<path class="gmcsn4b_u"/><circle class="i6riehb3u"/><path class="ukvflgenn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-cvs" {...props}></Icon>
<style>
:global(.gmcsn4b_u) {
