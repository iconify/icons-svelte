...
const content = `<path class="qszw-dbbc"/><path class="u6xminppf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:folder-type-junie-opened" {...props}></Icon>
<style>
:global(.qszw-dbbc) {
