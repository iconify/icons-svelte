...
const content = `<path class="tdge34b3k"/><path class="irgveczxy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:flickr-icon" {...props}></Icon>
<style>
:global(.irgveczxy) {
