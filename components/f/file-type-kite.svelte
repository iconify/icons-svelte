...
const content = `<path class="icf6k-vie"/><path class="jn3u7ub4z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-kite" {...props}></Icon>
<style>
:global(.icf6k-vie) {
