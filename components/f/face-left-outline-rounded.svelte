...
const content = `<path class="y_pmkso2v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:face-left-outline-rounded" {...props}></Icon>
<style>
:global(.y_pmkso2v) {
  fill: currentColor;
