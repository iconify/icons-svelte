...
const content = `<path class="w1nu9b2sm"/><path class="u209hwb5y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:foxtail-coffee" {...props}></Icon>
<style>
:global(.u209hwb5y) {
  fill: none;
  stroke: currentColor;
