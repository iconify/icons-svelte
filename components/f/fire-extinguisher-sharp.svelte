...
const content = `<path class="olcam2bce"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:fire-extinguisher-sharp" {...props}></Icon>
<style>
:global(.olcam2bce) {
  fill: currentColor;
