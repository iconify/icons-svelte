...
const content = `<path class="pu5p_cboh"/><path class="bds5-kbrp"/><circle class="irpodniek"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:fake-gps-2" {...props}></Icon>
<style>
:global(.bds5-kbrp) {
  fill: none;
  stroke: currentColor;
