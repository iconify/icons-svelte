...
const content = `<path class="kkdfg-bnp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:foot-bones-rounded" {...props}></Icon>
<style>
:global(.kkdfg-bnp) {
  fill: currentColor;
