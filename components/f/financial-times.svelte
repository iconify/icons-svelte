...
const content = `<rect class="j3s9ivbxi"/><path class="eutcjaczc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:financial-times" {...props}></Icon>
<style>
:global(.eutcjaczc) {
  fill: none;
  stroke: currentColor;
