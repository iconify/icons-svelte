...
const content = `<path class="lwv42f7en"/><path clip-rule="evenodd" class="kxmy7wu1n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-knip" {...props}></Icon>
<style>
:global(.kxmy7wu1n) {
