...
const content = `<rect class="b17rqyumr"/><path class="hlqkn15pv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:freezer" {...props}></Icon>
<style>
:global(.b17rqyumr) {
  width: 28.19px;
  height: 36.58px;
