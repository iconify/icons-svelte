...
const content = `<path class="iicx13b3r"/><path class="oqiqno76k"/><path class="n3wxoacoi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:folder-type-yarn-opened" {...props}></Icon>
<style>
:global(.iicx13b3r) {
