...
const content = `<path class="m6y3elbzm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:file-json-rounded" {...props}></Icon>
<style>
:global(.m6y3elbzm) {
  fill: currentColor;
