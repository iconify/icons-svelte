...
const content = `<path class="vnrqkgbam"/><path class="ep66k5i6j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-commitizen" {...props}></Icon>
<style>
:global(.ep66k5i6j) {
