...
const content = `<path class="gfkqa2b0p"/><path class="i26hz5b5d"/><path class="u01jo0bvo"/><path class="aflk2ou_p"/><path class="a0vbcybdh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:folder-type-dart" {...props}></Icon>
<style>
:global(.a0vbcybdh) {
