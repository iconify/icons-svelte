...
const content = `<path class="h0qgeuwow"/><circle class="n21z2cehg"/><path class="w42-93o0o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:folder-9" {...props}></Icon>
<style>
:global(.h0qgeuwow) {
  fill: none;
  stroke: currentColor;
