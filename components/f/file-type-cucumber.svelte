...
const content = `<path class="bp7uc9irw"/><path class="kl97y0bvu"/><path class="r10zrq_dk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-cucumber" {...props}></Icon>
<style>
:global(.bp7uc9irw) {
