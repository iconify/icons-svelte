...
const content = `<path class="y2doxf54g"/><path class="yow591but"/><path class="qw9g2wkti"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-csslint" {...props}></Icon>
<style>
:global(.qw9g2wkti) {
