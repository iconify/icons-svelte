...
const content = `<g class="gp_8x1bzb"><path class="v8hgvi38z"/><path class="e5p0yik2q"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:film-sharp-duotone" {...props}></Icon>
<style>
:global(.e5p0yik2q) {
