...
const content = `<path class="z5--n1ird"/><path class="hs1kpibjx"/><path class="wgwysibsl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:folder-type-light-mysql-opened" {...props}></Icon>
<style>
:global(.hs1kpibjx) {
