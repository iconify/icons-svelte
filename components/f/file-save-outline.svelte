...
const content = `<path class="okfwh9bxk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:file-save-outline" {...props}></Icon>
<style>
:global(.okfwh9bxk) {
  fill: currentColor;
