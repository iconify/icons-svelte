...
const content = `<g class="nrj6p8qat"><path class="zl16vzbgk"/><path class="y6b-2ywbl"/><path class="clpojkoko"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:flamegraph-outline-regular" {...props}></Icon>
<style>
:global(.clpojkoko) {
