...
const content = `<path class="we5iqbc6s"/><path class="aa_ebgivs"/><path class="vhxcorb8f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:formula-1" {...props}></Icon>
<style>
:global(.aa_ebgivs) {
  fill: none;
  stroke: currentColor;
