...
const content = `<path class="xj5sywyym"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:filter-center-focus-outline-sharp" {...props}></Icon>
<style>
:global(.xj5sywyym) {
  fill: currentColor;
