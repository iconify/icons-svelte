...
const content = `<path class="dia_yga2c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:filter-center-focus-outline-sharp" {...props}></Icon>
<style>
:global(.dia_yga2c) {
  fill: currentColor;
