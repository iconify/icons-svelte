...
const content = `<path class="e-si2ocwh"/><path class="rofzymbyf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:freebox-files" {...props}></Icon>
<style>
:global(.e-si2ocwh) {
  fill: none;
  stroke: currentColor;
