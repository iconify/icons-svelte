...
const content = `<path class="yl4vabc8y"/><g transform="translate(.025 .025)"><rect class="z63nuqb8y"/><rect class="s_a35rtzc"/><circle class="hcgfnpc0v"/><rect class="ne49f5ifo"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:folder-type-mobile-opened" {...props}></Icon>
<style>
:global(.hcgfnpc0v) {
  cx: 23.802px;
  cy: 28.652px;
