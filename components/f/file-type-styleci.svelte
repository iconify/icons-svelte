...
const content = `<g class="d2kvgvbvc"><path class="rt4e10b2r"/><path class="gqwn3jbzw"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-styleci" {...props}></Icon>
<style>
:global(.d2kvgvbvc) {
  fill-rule: evenodd;
}
