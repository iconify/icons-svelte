...
const content = `<path class="tcrjgpbey"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:floor-lamp" {...props}></Icon>
<style>
:global(.tcrjgpbey) {
  fill: currentColor;
