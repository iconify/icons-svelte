...
const content = `<path class="rvohuybli"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:fast-reverse-button" {...props}></Icon>
<style>
:global(.rvohuybli) {
  fill: currentColor;
