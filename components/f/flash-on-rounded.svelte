...
const content = `<path class="nb91p8bln"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:flash-on-rounded" {...props}></Icon>
<style>
:global(.nb91p8bln) {
  fill: currentColor;
