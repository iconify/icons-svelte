...
const content = `<path class="rjf2bzb-b"/><path class="l9x72pb9o"/><path class="o6usuegte"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-gradle2" {...props}></Icon>
<style>
:global(.l9x72pb9o) {
