...
const content = `<g class="cuyn6tgcc"><path class="e3064-r1c"/><path class="s_b6zxbwb"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:folder-simple-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
