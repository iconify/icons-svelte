...
const content = `<path class="cuu9-1duc"/><path class="uyb4qvihi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-shell" {...props}></Icon>
<style>
:global(.cuu9-1duc) {
