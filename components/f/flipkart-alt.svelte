...
const content = `<path class="l2krg2b3t"/><path class="zdkaw-w4x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:flipkart-alt" {...props}></Icon>
<style>
:global(.l2krg2b3t) {
  fill: none;
  stroke: currentColor;
