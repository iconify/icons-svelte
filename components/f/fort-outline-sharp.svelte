...
const content = `<path class="br98y2bep"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:fort-outline-sharp" {...props}></Icon>
<style>
:global(.br98y2bep) {
  fill: currentColor;
