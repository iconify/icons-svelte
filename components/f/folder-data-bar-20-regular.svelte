...
const content = `<path class="rv2ydnbjz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:folder-data-bar-20-regular" {...props}></Icon>
<style>
:global(.rv2ydnbjz) {
  fill: currentColor;
