...
const content = `<g class="ft5dv1b6b"><path class="k-h76sbmj"/><path class="e65-1ibek"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-livekit" {...props}></Icon>
<style>
:global(.e65-1ibek) {
