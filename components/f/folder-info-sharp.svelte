...
const content = `<path class="j2u3kct8e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:folder-info-sharp" {...props}></Icon>
<style>
:global(.j2u3kct8e) {
  fill: currentColor;
