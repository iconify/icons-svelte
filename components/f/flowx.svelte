...
const content = `<g class="y9tr6bcfx"><path class="cw0u2587h"/><path class="ld_kvm2sf"/><path class="wzlnelb3n"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:flowx" {...props}></Icon>
<style>
:global(.cw0u2587h) {
