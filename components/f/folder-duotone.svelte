...
const content = `<g class="cuyn6tgcc"><path class="px4la-y5q"/><path class="u48uw9bil"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:folder-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
