...
const content = `<g class="hntgybcog"><path class="yhswpf2nj"/><path class="qarcjib7d"/><path class="z1gyoabnz"/><path class="c_vx4nbon"/><path class="t04j2mb6v"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:fleet-cluster-outline-thin" {...props}></Icon>
<style>
:global(.c_vx4nbon) {
