...
const content = `<path class="x1cd2-baa"/><circle class="wzg4aubzr"/><path class="cuw9pbbsc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:fe-clock" {...props}></Icon>
<style>
:global(.cuw9pbbsc) {
  fill: none;
  stroke: currentColor;
