...
const content = `<g class="cuyn6tgcc"><path class="nvjq80alh"/><path class="bmehlh09n"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:file-ini-duotone" {...props}></Icon>
<style>
:global(.bmehlh09n) {
