...
const content = `<path class="zur9jh-tn"/><path class="p0dcn-oes"/><path class="gf4zuacjp"/><path class="l5hu3qbie"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:forest" {...props}></Icon>
<style>
:global(.gf4zuacjp) {
  fill: none;
  stroke: currentColor;
