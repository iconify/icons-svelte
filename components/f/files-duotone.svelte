...
const content = `<g class="cuyn6tgcc"><path class="xy12cpb1p"/><path class="v5w19z6bz"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:files-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
