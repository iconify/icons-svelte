...
const content = `<path class="grv7j-bde"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:full-screen-minimize-16-regular" {...props}></Icon>
<style>
:global(.grv7j-bde) {
  fill: currentColor;
