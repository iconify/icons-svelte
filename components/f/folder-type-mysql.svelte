...
const content = `<path class="i1cp45b8v"/><path class="cljgjlbge"/><path class="hfx5gt0rf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:folder-type-mysql" {...props}></Icon>
<style>
:global(.cljgjlbge) {
