...
const content = `<path class="m5k6mccwu"/><path class="hrll78j7d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:files" {...props}></Icon>
<style>
:global(.hrll78j7d) {
  fill: none;
  stroke: currentColor;
