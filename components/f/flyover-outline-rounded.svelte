...
const content = `<path class="jrtvc-b2o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:flyover-outline-rounded" {...props}></Icon>
<style>
:global(.jrtvc-b2o) {
  fill: currentColor;
