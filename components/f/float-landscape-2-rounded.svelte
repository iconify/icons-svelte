...
const content = `<path class="evwnfu4qy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:float-landscape-2-rounded" {...props}></Icon>
<style>
:global(.evwnfu4qy) {
  fill: currentColor;
