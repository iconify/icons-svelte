...
const content = `<path class="de8bpibhm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-light-font" {...props}></Icon>
<style>
:global(.de8bpibhm) {
