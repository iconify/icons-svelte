...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="z6uq8wbjl"/><path class="divmul-dt"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:floppy-disk" {...props}></Icon>
<style>
:global(.divmul-dt) {
