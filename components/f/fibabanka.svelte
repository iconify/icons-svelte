...
const content = `<circle class="cpk0fnbgt"/><path class="gx33wbb5n"/><path class="vj56mxbev"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:fibabanka" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
