...
const content = `<path class="ddkxhlb0d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:file-map-stack-outline-sharp" {...props}></Icon>
<style>
:global(.ddkxhlb0d) {
  fill: currentColor;
