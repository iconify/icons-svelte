...
const content = `<path class="y3p-j3x9x"/><path class="qdt_x-bhc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-diff" {...props}></Icon>
<style>
:global(.qdt_x-bhc) {
