...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="iz6dm_5_u"/><path class="guwsg7bmw"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:flag-straight" {...props}></Icon>
<style>
:global(.guwsg7bmw) {
