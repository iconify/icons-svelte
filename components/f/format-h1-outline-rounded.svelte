...
const content = `<path class="r36l7qb4b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:format-h1-outline-rounded" {...props}></Icon>
<style>
:global(.r36l7qb4b) {
  fill: currentColor;
