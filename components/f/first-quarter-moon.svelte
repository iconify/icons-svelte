...
const content = `<path class="a-ubeebba"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:first-quarter-moon" {...props}></Icon>
<style>
:global(.a-ubeebba) {
  fill: currentColor;
