...
const content = `<path class="pa7v1s--s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:face-expressionless-sharp" {...props}></Icon>
<style>
:global(.pa7v1s--s) {
  fill: none;
  stroke: currentColor;
