...
const content = `<path class="j2lw1wbru"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:face-neutral-sharp-fill" {...props}></Icon>
<style>
:global(.j2lw1wbru) {
  fill: currentColor;
