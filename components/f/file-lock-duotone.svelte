...
const content = `<g class="cuyn6tgcc"><path class="hjl1ssh0z"/><path class="jk1j45bez"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:file-lock-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
