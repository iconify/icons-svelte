...
const content = `<path class="c-vam9bwc"/><path class="g0r_3g__a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:finshell-pay" {...props}></Icon>
<style>
:global(.c-vam9bwc) {
  fill: none;
  stroke: currentColor;
