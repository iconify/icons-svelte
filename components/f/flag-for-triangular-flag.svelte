...
const content = `<path class="dgxk2fbvs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:flag-for-triangular-flag" {...props}></Icon>
<style>
:global(.dgxk2fbvs) {
  fill: currentColor;
