...
const content = `<path class="t_ieb-b9f"/><path class="za-cxxbxu"/><path class="pxil1abnu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="vscode-icons:file-type-solidity" {...props}></Icon>
<style>
:global(.pxil1abnu) {
