...
const content = `<path class="ll0g54h-q"/><circle class="bfrydubaa"/><path class="og7ovw1sl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:fi" {...props}></Icon>
<style>
:global(.bfrydubaa) {
  cx: 27.97px;
  cy: 16.163px;
