...
const content = `<path class="ebb-pdgwp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:folder-special-outline-sharp" {...props}></Icon>
<style>
:global(.ebb-pdgwp) {
  fill: currentColor;
