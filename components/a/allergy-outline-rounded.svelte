...
const content = `<path class="b-psp3boe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:allergy-outline-rounded" {...props}></Icon>
<style>
:global(.b-psp3boe) {
  fill: currentColor;
