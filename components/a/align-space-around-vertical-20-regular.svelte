...
const content = `<path class="bxyub9bbl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:align-space-around-vertical-20-regular" {...props}></Icon>
<style>
:global(.bxyub9bbl) {
  fill: currentColor;
