...
const content = `<path class="avcqmhbux"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-circle-left-16-filled" {...props}></Icon>
<style>
:global(.avcqmhbux) {
  fill: currentColor;
