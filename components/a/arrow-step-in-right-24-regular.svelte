...
const content = `<path class="xtxkmzkfx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-step-in-right-24-regular" {...props}></Icon>
<style>
:global(.xtxkmzkfx) {
  fill: currentColor;
