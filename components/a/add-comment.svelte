...
const content = `<path class="bjuhs48_x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:add-comment" {...props}></Icon>
<style>
:global(.bjuhs48_x) {
  fill: currentColor;
