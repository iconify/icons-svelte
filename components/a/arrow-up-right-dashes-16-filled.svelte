...
const content = `<path class="ofvzv86ty"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-up-right-dashes-16-filled" {...props}></Icon>
<style>
:global(.ofvzv86ty) {
  fill: currentColor;
