...
const content = `<path class="n6t__ib5d"/><path class="qwpzspgct"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:airplay-server" {...props}></Icon>
<style>
:global(.n6t__ib5d) {
  fill: none;
  stroke: currentColor;
