...
const content = `<path class="ujr2zljve"/><circle class="hnjz5absn"/><path class="gkz3yac-t"/><circle class="g9487ubqx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:automation" {...props}></Icon>
<style>
:global(.g9487ubqx) {
  cx: 32.95px;
  cy: 17.68px;
