...
const content = `<path class="ytzqwrbnj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-between-down-24-filled" {...props}></Icon>
<style>
:global(.ytzqwrbnj) {
  fill: currentColor;
