...
const content = `<path class="i0z79mbiv"/><path class="cwd-q1ibg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:akachan-honpo" {...props}></Icon>
<style>
:global(.cwd-q1ibg) {
  fill: none;
  stroke: currentColor;
