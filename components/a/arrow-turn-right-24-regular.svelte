...
const content = `<path class="yp00b2b8v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-right-24-regular" {...props}></Icon>
<style>
:global(.yp00b2b8v) {
  fill: currentColor;
