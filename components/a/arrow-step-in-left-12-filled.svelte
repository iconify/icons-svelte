...
const content = `<path class="nbths4b4h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-step-in-left-12-filled" {...props}></Icon>
<style>
:global(.nbths4b4h) {
  fill: currentColor;
