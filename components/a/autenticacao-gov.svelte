...
const content = `<path class="sl4ekoghj"/><path class="ukdrnccrp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:autenticacao-gov" {...props}></Icon>
<style>
:global(.sl4ekoghj) {
  fill: none;
  stroke: currentColor;
