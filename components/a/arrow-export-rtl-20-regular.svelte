...
const content = `<path class="riwr3ojjt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-export-rtl-20-regular" {...props}></Icon>
<style>
:global(.riwr3ojjt) {
  fill: currentColor;
