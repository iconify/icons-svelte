...
const content = `<path class="eu4iy0b3d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:audio-file" {...props}></Icon>
<style>
:global(.eu4iy0b3d) {
  fill: currentColor;
