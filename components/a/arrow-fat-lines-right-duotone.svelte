...
const content = `<g class="cuyn6tgcc"><path class="jtuoc5b-g"/><path class="x2j7uwbre"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-fat-lines-right-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
