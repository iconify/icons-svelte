...
const content = `<path class="m6joozgyz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrows-out-line-horizontal-bold" {...props}></Icon>
<style>
:global(.m6joozgyz) {
  fill: currentColor;
