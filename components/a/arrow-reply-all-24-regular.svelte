...
const content = `<path class="bxoqgrqzy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-reply-all-24-regular" {...props}></Icon>
<style>
:global(.bxoqgrqzy) {
  fill: currentColor;
