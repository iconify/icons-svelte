...
const content = `<path class="gb3s7_bph"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-rotate-counterclockwise-20-regular" {...props}></Icon>
<style>
:global(.gb3s7_bph) {
  fill: currentColor;
