...
const content = `<path class="ztgg9hnql"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:arrow-circle-right-rounded" {...props}></Icon>
<style>
:global(.ztgg9hnql) {
  fill: currentColor;
