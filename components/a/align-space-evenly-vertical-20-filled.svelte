...
const content = `<path class="wpshey4lj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:align-space-evenly-vertical-20-filled" {...props}></Icon>
<style>
:global(.wpshey4lj) {
  fill: currentColor;
