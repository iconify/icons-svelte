...
const content = `<path class="ae2hobhik"/><circle class="yutizl0lm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:auchan" {...props}></Icon>
<style>
:global(.ae2hobhik) {
  fill: none;
  stroke: currentColor;
