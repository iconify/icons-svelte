...
const content = `<path class="y9jcl5byt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-counterclockwise-dashes-24-regular" {...props}></Icon>
<style>
:global(.y9jcl5byt) {
  fill: currentColor;
