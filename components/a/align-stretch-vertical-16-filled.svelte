...
const content = `<path class="x3o7nzbvg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:align-stretch-vertical-16-filled" {...props}></Icon>
<style>
:global(.x3o7nzbvg) {
  fill: currentColor;
