...
const content = `<path class="ctwagt0jk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-circle-left-48-filled" {...props}></Icon>
<style>
:global(.ctwagt0jk) {
  fill: currentColor;
