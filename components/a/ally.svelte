...
const content = `<path class="w4nvobbtg"/><path class="mnwi_p2um"/><path class="r1tryf-4c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ally" {...props}></Icon>
<style>
:global(.mnwi_p2um) {
  fill: none;
  stroke: currentColor;
