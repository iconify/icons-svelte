...
const content = `<path class="aw91inw9o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-left-right-48-regular" {...props}></Icon>
<style>
:global(.aw91inw9o) {
  fill: currentColor;
