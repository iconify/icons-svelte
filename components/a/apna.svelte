...
const content = `<path class="c7n5sub8u"/><path class="tuted2bmm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:apna" {...props}></Icon>
<style>
:global(.c7n5sub8u) {
  fill: none;
  stroke: currentColor;
