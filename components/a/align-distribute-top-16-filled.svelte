...
const content = `<path class="l39soabmh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:align-distribute-top-16-filled" {...props}></Icon>
<style>
:global(.l39soabmh) {
  fill: currentColor;
