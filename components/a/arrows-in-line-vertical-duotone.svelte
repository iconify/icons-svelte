...
const content = `<g class="cuyn6tgcc"><path class="ftcj0fkzg"/><path class="brjjxf9sm"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrows-in-line-vertical-duotone" {...props}></Icon>
<style>
:global(.brjjxf9sm) {
