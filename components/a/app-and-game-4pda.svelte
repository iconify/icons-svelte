...
const content = `<path class="f2h22kbsz"/><path class="xrj_4ib6k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:app-and-game-4pda" {...props}></Icon>
<style>
:global(.f2h22kbsz) {
  fill: none;
  stroke: currentColor;
