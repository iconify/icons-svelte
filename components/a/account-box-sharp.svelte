...
const content = `<path class="shjmunbnl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:account-box-sharp" {...props}></Icon>
<style>
:global(.shjmunbnl) {
  fill: currentColor;
