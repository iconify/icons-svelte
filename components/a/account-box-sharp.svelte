...
const content = `<path class="cqwytublu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:account-box-sharp" {...props}></Icon>
<style>
:global(.cqwytublu) {
  fill: currentColor;
