...
const content = `<path class="j2-1-_b4k"/><path class="rf-m-rbys"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:au-wifi-access" {...props}></Icon>
<style>
:global(.j2-1-_b4k) {
  fill: none;
  stroke: currentColor;
