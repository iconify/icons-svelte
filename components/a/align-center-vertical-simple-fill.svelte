...
const content = `<path class="oqorqniqm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:align-center-vertical-simple-fill" {...props}></Icon>
<style>
:global(.oqorqniqm) {
  fill: currentColor;
