...
const content = `<path class="x1nuevtha"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-export-rtl-20-filled" {...props}></Icon>
<style>
:global(.x1nuevtha) {
  fill: currentColor;
