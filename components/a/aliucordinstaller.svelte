...
const content = `<path class="hki_ddbyx"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:aliucordinstaller" {...props}></Icon>
<style>
:global(.hki_ddbyx) {
  fill: none;
  stroke: currentColor;
