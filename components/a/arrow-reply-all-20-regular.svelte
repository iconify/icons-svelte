...
const content = `<path class="fos3k79lr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-reply-all-20-regular" {...props}></Icon>
<style>
:global(.fos3k79lr) {
  fill: currentColor;
