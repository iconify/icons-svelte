...
const content = `<path class="a3mpkvpjo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-bidirectional-down-right-20-filled" {...props}></Icon>
<style>
:global(.a3mpkvpjo) {
  fill: currentColor;
