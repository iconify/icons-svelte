...
const content = `<path class="brrtjdb9o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-move-inward-20-regular" {...props}></Icon>
<style>
:global(.brrtjdb9o) {
  fill: currentColor;
