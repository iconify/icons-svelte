...
const content = `<path class="nj8lq6bot"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:apps-outage-outline-rounded" {...props}></Icon>
<style>
:global(.nj8lq6bot) {
  fill: currentColor;
