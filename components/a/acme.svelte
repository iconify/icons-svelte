...
const content = `<path class="qdp_rwz5z"/><rect class="jc1oydeao"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:acme" {...props}></Icon>
<style>
:global(.jc1oydeao) {
  width: 39px;
  height: 31px;
