...
const content = `<path class="usfhwgjxi"/><path class="oc3183vvk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:aha" {...props}></Icon>
<style>
:global(.oc3183vvk) {
  fill: none;
  stroke: currentColor;
