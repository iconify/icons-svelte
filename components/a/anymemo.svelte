...
const content = `<path class="qv2xtygpq"/><path class="tfv0blbio"/><path class="oto5mz67w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:anymemo" {...props}></Icon>
<style>
:global(.oto5mz67w) {
  fill: none;
  stroke: currentColor;
