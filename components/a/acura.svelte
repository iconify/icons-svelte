...
const content = `<path class="apjplfblw"/><path class="m2j3tacfd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:acura" {...props}></Icon>
<style>
:global(.apjplfblw) {
  fill: none;
  stroke: currentColor;
