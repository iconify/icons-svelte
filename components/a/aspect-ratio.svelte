...
const content = `<path class="ew9azobco"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:aspect-ratio" {...props}></Icon>
<style>
:global(.ew9azobco) {
  fill: currentColor;
