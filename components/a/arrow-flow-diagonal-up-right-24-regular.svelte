...
const content = `<path class="n0o5pz08x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-flow-diagonal-up-right-24-regular" {...props}></Icon>
<style>
:global(.n0o5pz08x) {
  fill: currentColor;
