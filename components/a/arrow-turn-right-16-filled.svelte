...
const content = `<path class="ciqx2ge2y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-right-16-filled" {...props}></Icon>
<style>
:global(.ciqx2ge2y) {
  fill: currentColor;
