...
const content = `<g class="cuyn6tgcc"><path class="vziog9bmd"/><path class="q9b7nwxtc"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-u-right-up-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
