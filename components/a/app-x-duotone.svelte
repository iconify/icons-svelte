...
const content = `<g class="nrj6p8qat"><path class="r63fawbfm"/><path class="j9vsk2b8a"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:app-x-duotone" {...props}></Icon>
<style>
:global(.j9vsk2b8a) {
