...
const content = `<path class="gn4f9zb0n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-export-up-24-regular" {...props}></Icon>
<style>
:global(.gn4f9zb0n) {
  fill: currentColor;
