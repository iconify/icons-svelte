...
const content = `<circle class="qmdopnbar"/><path class="whx5a-b3w"/><path class="fnsgndo3z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:adlmidi-player" {...props}></Icon>
<style>
:global(.fnsgndo3z) {
  fill: none;
  stroke: currentColor;
