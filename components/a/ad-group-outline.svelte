...
const content = `<path class="dfucg7bij"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:ad-group-outline" {...props}></Icon>
<style>
:global(.dfucg7bij) {
  fill: currentColor;
