...
const content = `<g class="cuyn6tgcc"><path class="wbgid6bvv"/><path class="t7ja2u1tu"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:align-top-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
