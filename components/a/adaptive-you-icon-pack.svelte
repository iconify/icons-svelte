...
const content = `<circle class="se66zddwp"/><circle class="j3_4z0nsi"/><circle class="y31kldbhd"/><path class="ylzjbvbax"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:adaptive-you-icon-pack" {...props}></Icon>
<style>
:global(.j3_4z0nsi) {
  cx: 15.433px;
  cy: 24px;
