...
const content = `<path class="nd-jhuj5y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-hook-down-right-32-filled" {...props}></Icon>
<style>
:global(.nd-jhuj5y) {
  fill: currentColor;
