...
const content = `<path class="xn5sx0d9j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-clockwise-dashes-28-filled" {...props}></Icon>
<style>
:global(.xn5sx0d9j) {
  fill: currentColor;
