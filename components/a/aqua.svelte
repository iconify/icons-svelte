...
const content = `<path class="atu4i7pnh"/><path class="rkghxybjr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:aqua" {...props}></Icon>
<style>
:global(.atu4i7pnh) {
  fill: none;
  stroke: currentColor;
