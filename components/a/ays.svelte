...
const content = `<path class="eot4t9bck"/><path class="n0s8u5b3j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ays" {...props}></Icon>
<style>
:global(.eot4t9bck) {
  fill: none;
  stroke: currentColor;
