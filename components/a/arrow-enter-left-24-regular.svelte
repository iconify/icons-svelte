...
const content = `<path class="d_7py-b9r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-enter-left-24-regular" {...props}></Icon>
<style>
:global(.d_7py-b9r) {
  fill: currentColor;
