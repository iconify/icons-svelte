...
const content = `<path class="xee4e3zgg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-clockwise-12-regular" {...props}></Icon>
<style>
:global(.xee4e3zgg) {
  fill: currentColor;
