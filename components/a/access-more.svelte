...
const content = `<path class="x45u9bcqe"/><path class="iuszg328t"/><path class="wxnbxy_tm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:access-more" {...props}></Icon>
<style>
:global(.iuszg328t) {
  fill: none;
  stroke: currentColor;
