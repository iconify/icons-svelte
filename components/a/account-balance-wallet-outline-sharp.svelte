...
const content = `<path class="o-skpc_6n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:account-balance-wallet-outline-sharp" {...props}></Icon>
<style>
:global(.o-skpc_6n) {
  fill: currentColor;
