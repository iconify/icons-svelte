...
const content = `<path class="w76biv3af"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-trending-down-20-filled" {...props}></Icon>
<style>
:global(.w76biv3af) {
  fill: currentColor;
