...
const content = `<path class="q-l9gdxld"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-expand-all-16-filled" {...props}></Icon>
<style>
:global(.q-l9gdxld) {
  fill: currentColor;
