...
const content = `<path class="nji08ztfs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:approval-delegation-sharp" {...props}></Icon>
<style>
:global(.nji08ztfs) {
  fill: currentColor;
