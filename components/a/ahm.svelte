...
const content = `<rect class="cim_5vaxq"/><path class="mb69qetzm"/><path class="p7nfk8baj"/><circle class="urpifhb6k"/><path class="zrotd0bcw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ahm" {...props}></Icon>
<style>
:global(.cim_5vaxq) {
  width: 33.7px;
  height: 26.7px;
