...
const content = `<g class="cuyn6tgcc"><path class="iw2gxwbiu"/><path class="fde7k68my"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:angular-logo-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
