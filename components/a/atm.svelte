...
const content = `<g class="ft5dv1b6b"><path class="yenjs5bwx"/><path class="qnnva4bjw"/><path class="r6tq3p9nd"/><path class="l4p759sbi"/><path class="iusnjzvop"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:atm" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
