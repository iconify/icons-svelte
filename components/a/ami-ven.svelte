...
const content = `<path class="vpojnzbdc"/><path class="ez1_f8bdg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ami-ven" {...props}></Icon>
<style>
:global(.ez1_f8bdg) {
  fill: none;
  stroke: currentColor;
