...
const content = `<path class="uan-_y6gx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-left-up-48-filled" {...props}></Icon>
<style>
:global(.uan-_y6gx) {
  fill: currentColor;
