...
const content = `<g class="cuyn6tgcc"><path class="b-j0neche"/><path class="ph-v66btv"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-line-down-duotone" {...props}></Icon>
<style>
:global(.b-j0neche) {
