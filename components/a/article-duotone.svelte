...
const content = `<g class="cuyn6tgcc"><path class="tm3vqw7ob"/><path class="yk_k85yvi"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:article-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
