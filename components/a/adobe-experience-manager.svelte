...
const content = `<rect class="j3s9ivbxi"/><path class="glkfk8bhf"/><path class="vrtbnabls"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:adobe-experience-manager" {...props}></Icon>
<style>
:global(.glkfk8bhf) {
  fill: none;
  stroke: currentColor;
