...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="rvkxepbjw"/><path class="jxosxcckr"/><path class="cthwv6vsn"/><path class="hdxpysbbn"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:arrow-up-left-circle" {...props}></Icon>
<style>
:global(.cthwv6vsn) {
