...
const content = `<rect class="j3s9ivbxi"/><path class="eti3crb1s"/><path class="p871z-gxj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:adobe-connect" {...props}></Icon>
<style>
:global(.eti3crb1s) {
  fill: none;
  stroke: currentColor;
