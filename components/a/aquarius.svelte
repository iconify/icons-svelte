...
const content = `<circle class="z535ym25t"/><path class="torvvrzat"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione:aquarius" {...props}></Icon>
<style>
:global(.torvvrzat) {
