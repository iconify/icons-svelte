...
const content = `<path class="elfw_d1mk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-right-20-filled" {...props}></Icon>
<style>
:global(.elfw_d1mk) {
  fill: currentColor;
