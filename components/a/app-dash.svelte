...
const content = `<path class="ty_e5jdlc"/><path class="a_6y8dtiu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:app-dash" {...props}></Icon>
<style>
:global(.a_6y8dtiu) {
  fill: none;
  stroke: currentColor;
