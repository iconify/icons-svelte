...
const content = `<path class="qdn8ots_i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-circle-up-right-20-filled" {...props}></Icon>
<style>
:global(.qdn8ots_i) {
  fill: currentColor;
