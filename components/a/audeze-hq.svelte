...
const content = `<path class="knf8uec4m"/><path class="c_yummbzp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:audeze-hq" {...props}></Icon>
<style>
:global(.c_yummbzp) {
  fill: none;
  stroke: currentColor;
