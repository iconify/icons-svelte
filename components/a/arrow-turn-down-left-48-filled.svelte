...
const content = `<path class="iadiydzyj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-down-left-48-filled" {...props}></Icon>
<style>
:global(.iadiydzyj) {
  fill: currentColor;
