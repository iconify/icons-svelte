...
const content = `<path class="jf42qf41q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-counterclockwise-28-regular" {...props}></Icon>
<style>
:global(.jf42qf41q) {
  fill: currentColor;
