...
const content = `<path class="h7sqmebzw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:align-space-evenly-horizontal-24-filled" {...props}></Icon>
<style>
:global(.h7sqmebzw) {
  fill: currentColor;
