...
const content = `<g class="cuyn6tgcc"><path class="uu9v0obbo"/><path class="ntm2hngll"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-elbow-up-right-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
