...
const content = `<path class="z_6o32b9m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-up-down-20-filled" {...props}></Icon>
<style>
:global(.z_6o32b9m) {
  fill: currentColor;
