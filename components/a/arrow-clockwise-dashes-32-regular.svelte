...
const content = `<path class="veionob9u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-clockwise-dashes-32-regular" {...props}></Icon>
<style>
:global(.veionob9u) {
  fill: currentColor;
