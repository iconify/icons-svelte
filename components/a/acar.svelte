...
const content = `<path class="m5am5nbgd"/><path class="g4rl4qbvf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:acar" {...props}></Icon>
<style>
:global(.g4rl4qbvf) {
  fill: none;
  stroke: currentColor;
