...
const content = `<g class="cuyn6tgcc"><path class="q24l8nwqa"/><path class="v3po3p-5o"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:air-traffic-control-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
