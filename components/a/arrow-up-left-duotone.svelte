...
const content = `<g class="cuyn6tgcc"><path class="d01-lsa-n"/><path class="ulebtznia"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-up-left-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
