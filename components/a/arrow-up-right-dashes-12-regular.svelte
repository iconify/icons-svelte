...
const content = `<path class="s4p8mbb0x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-up-right-dashes-12-regular" {...props}></Icon>
<style>
:global(.s4p8mbb0x) {
  fill: currentColor;
