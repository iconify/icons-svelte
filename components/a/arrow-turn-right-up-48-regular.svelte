...
const content = `<path class="o9-apbb3u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-right-up-48-regular" {...props}></Icon>
<style>
:global(.o9-apbb3u) {
  fill: currentColor;
