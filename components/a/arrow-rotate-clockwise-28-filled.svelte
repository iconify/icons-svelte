...
const content = `<path class="ed56wjb2r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-rotate-clockwise-28-filled" {...props}></Icon>
<style>
:global(.ed56wjb2r) {
  fill: currentColor;
