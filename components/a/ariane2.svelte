...
const content = `<path class="i9clfwm2k"/><path class="bl4v1ybiu"/><circle class="vs0g8db5u"/><path class="ix2zevlfa"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ariane2" {...props}></Icon>
<style>
:global(.bl4v1ybiu) {
  fill: none;
  stroke: currentColor;
