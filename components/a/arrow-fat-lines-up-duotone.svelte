...
const content = `<g class="cuyn6tgcc"><path class="z9t2hmbap"/><path class="q8ghynb5j"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-fat-lines-up-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
