...
const content = `<path class="bdilonbnn"/><circle class="mrd8l1eft"/><circle class="q5udh4w6y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:adobescan" {...props}></Icon>
<style>
:global(.bdilonbnn) {
  fill: none;
  stroke: currentColor;
