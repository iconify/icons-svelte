...
const content = `<path class="l5f67zb4v"/><path class="uwa6zeb6g"/><path class="mi8r95d2t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:abbanoa" {...props}></Icon>
<style>
:global(.l5f67zb4v) {
  fill: none;
  stroke: currentColor;
