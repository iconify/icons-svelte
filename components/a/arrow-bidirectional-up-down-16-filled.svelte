...
const content = `<path class="ve51gmn1a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-bidirectional-up-down-16-filled" {...props}></Icon>
<style>
:global(.ve51gmn1a) {
  fill: currentColor;
