...
const content = `<path class="yhkny2mlp"/><path class="hlte9dbpo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:adm" {...props}></Icon>
<style>
:global(.hlte9dbpo) {
  fill: none;
  stroke: currentColor;
