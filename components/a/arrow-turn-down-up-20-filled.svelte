...
const content = `<path class="seu368bsh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-down-up-20-filled" {...props}></Icon>
<style>
:global(.seu368bsh) {
  fill: currentColor;
