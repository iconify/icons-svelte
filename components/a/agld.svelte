...
const content = `<path clip-rule="evenodd" class="mft894bck"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:agld" {...props}></Icon>
<style>
:global(.mft894bck) {
