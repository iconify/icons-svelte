...
const content = `<circle class="t238zrbfy"/><path class="r_t0apbfp"/><circle class="opmzw43jn"/><path class="dn4ni2rgh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:autonotification" {...props}></Icon>
<style>
:global(.dn4ni2rgh) {
  fill: none;
  stroke: currentColor;
