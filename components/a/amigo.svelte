...
const content = `<circle class="qt-qjicjs"/><path class="e8jgrbb7c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:amigo" {...props}></Icon>
<style>
:global(.e8jgrbb7c) {
  fill: none;
  stroke: currentColor;
