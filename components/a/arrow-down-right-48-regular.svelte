...
const content = `<path class="j4ecn-4-e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-down-right-48-regular" {...props}></Icon>
<style>
:global(.j4ecn-4-e) {
  fill: currentColor;
