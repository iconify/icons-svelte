...
const content = `<path class="a077vr0gn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-rotate-counterclockwise-24-filled" {...props}></Icon>
<style>
:global(.a077vr0gn) {
  fill: currentColor;
