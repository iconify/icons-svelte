...
const content = `<path class="q1gtk8b-k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-bidirectional-left-right-16-filled" {...props}></Icon>
<style>
:global(.q1gtk8b-k) {
  fill: currentColor;
