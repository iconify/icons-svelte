...
const content = `<path class="mslpx_7ni"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:align-space-evenly-vertical-24-filled" {...props}></Icon>
<style>
:global(.mslpx_7ni) {
  fill: currentColor;
