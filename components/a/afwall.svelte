...
const content = `<path class="a80wrjb_t"/><path class="g-8g8_b-y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:afwall" {...props}></Icon>
<style>
:global(.a80wrjb_t) {
  fill: none;
  stroke: currentColor;
