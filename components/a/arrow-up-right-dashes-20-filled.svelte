...
const content = `<path class="hm-1wubfc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-up-right-dashes-20-filled" {...props}></Icon>
<style>
:global(.hm-1wubfc) {
  fill: currentColor;
