...
const content = `<path class="c7txd-bof"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-hook-up-right-32-light" {...props}></Icon>
<style>
:global(.c7txd-bof) {
  fill: currentColor;
