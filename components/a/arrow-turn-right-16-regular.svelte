...
const content = `<path class="zyj6afbto"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-right-16-regular" {...props}></Icon>
<style>
:global(.zyj6afbto) {
  fill: currentColor;
