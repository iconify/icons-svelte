...
const content = `<rect class="e4x41wbpn"/><path class="ml6je83sf"/><path class="relldpw5b"/><path class="awgs1sbzm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:allcast" {...props}></Icon>
<style>
:global(.awgs1sbzm) {
  fill: none;
  stroke: currentColor;
