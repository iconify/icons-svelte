...
const content = `<path class="afhptwb_j"/><path class="p9z5p6uod"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:arte" {...props}></Icon>
<style>
:global(.afhptwb_j) {
  fill: none;
  stroke: currentColor;
