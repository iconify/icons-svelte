...
const content = `<path class="kphqkcbjx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-step-in-right-12-regular" {...props}></Icon>
<style>
:global(.kphqkcbjx) {
  fill: currentColor;
