...
const content = `<g class="cuyn6tgcc"><path class="goeug6bgp"/><path class="aok2r5l6h"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:at-duotone" {...props}></Icon>
<style>
:global(.aok2r5l6h) {
