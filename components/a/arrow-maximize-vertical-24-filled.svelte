...
const content = `<path class="qgaps7syd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-maximize-vertical-24-filled" {...props}></Icon>
<style>
:global(.qgaps7syd) {
  fill: currentColor;
