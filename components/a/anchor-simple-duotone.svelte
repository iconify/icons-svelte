...
const content = `<g class="cuyn6tgcc"><path class="ppno4e0fk"/><path class="i17w4zqyu"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:anchor-simple-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
