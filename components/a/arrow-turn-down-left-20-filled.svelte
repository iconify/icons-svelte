...
const content = `<path class="lkoa06szi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-down-left-20-filled" {...props}></Icon>
<style>
:global(.lkoa06szi) {
  fill: currentColor;
