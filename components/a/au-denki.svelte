...
const content = `<path class="xsi4x_ywi"/><path class="aukuub-qe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:au-denki" {...props}></Icon>
<style>
:global(.aukuub-qe) {
  fill: none;
  stroke: currentColor;
