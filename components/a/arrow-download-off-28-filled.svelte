...
const content = `<path class="t53kz5bhs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-download-off-28-filled" {...props}></Icon>
<style>
:global(.t53kz5bhs) {
  fill: currentColor;
