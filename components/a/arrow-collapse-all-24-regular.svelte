...
const content = `<path class="yygz53u-l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-collapse-all-24-regular" {...props}></Icon>
<style>
:global(.yygz53u-l) {
  fill: currentColor;
