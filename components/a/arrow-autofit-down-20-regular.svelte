...
const content = `<path class="i0hf5mbdn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-autofit-down-20-regular" {...props}></Icon>
<style>
:global(.i0hf5mbdn) {
  fill: currentColor;
