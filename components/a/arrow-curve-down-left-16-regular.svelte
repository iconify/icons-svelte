...
const content = `<path class="x1ifeubhv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-curve-down-left-16-regular" {...props}></Icon>
<style>
:global(.x1ifeubhv) {
  fill: currentColor;
