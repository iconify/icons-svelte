...
const content = `<path class="i3dwb1gcw"/><path class="j98an1bqd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:apkmirror-installer" {...props}></Icon>
<style>
:global(.i3dwb1gcw) {
  fill: none;
  stroke: currentColor;
