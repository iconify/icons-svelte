...
const content = `<rect class="tfn4sbcdo"/><path class="xtzdk3bjo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:adobe-animate" {...props}></Icon>
<style>
:global(.tfn4sbcdo) {
  width: 256px;
  height: 249.6px;
