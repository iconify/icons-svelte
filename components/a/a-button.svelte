...
const content = `<path class="n0ety7t8h"/><path class="nkpvjgn8z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:a-button" {...props}></Icon>
<style>
:global(.n0ety7t8h) {
  fill: currentColor;
