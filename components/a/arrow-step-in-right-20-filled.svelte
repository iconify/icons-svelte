...
const content = `<path class="r1wtk5bnz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-step-in-right-20-filled" {...props}></Icon>
<style>
:global(.r1wtk5bnz) {
  fill: currentColor;
