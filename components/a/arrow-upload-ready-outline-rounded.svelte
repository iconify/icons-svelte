...
const content = `<path class="yy6_cmnct"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:arrow-upload-ready-outline-rounded" {...props}></Icon>
<style>
:global(.yy6_cmnct) {
  fill: currentColor;
