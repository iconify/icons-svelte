...
const content = `<path class="vp8w92dlw"/><path class="w57la6bby"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:acloset" {...props}></Icon>
<style>
:global(.vp8w92dlw) {
  fill: none;
  stroke: currentColor;
