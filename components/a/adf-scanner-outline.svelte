...
const content = `<path class="cz3zo3n7c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:adf-scanner-outline" {...props}></Icon>
<style>
:global(.cz3zo3n7c) {
  fill: currentColor;
