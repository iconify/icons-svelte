...
const content = `<path class="pyhif0hsv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:align-center-horizontal-20-filled" {...props}></Icon>
<style>
:global(.pyhif0hsv) {
  fill: currentColor;
