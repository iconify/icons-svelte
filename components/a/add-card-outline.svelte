...
const content = `<path class="x7-cw2h3b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:add-card-outline" {...props}></Icon>
<style>
:global(.x7-cw2h3b) {
  fill: currentColor;
