...
const content = `<path class="upur-bttk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:audio-video-receiver-outline-sharp" {...props}></Icon>
<style>
:global(.upur-bttk) {
  fill: currentColor;
