...
const content = `<path class="zv8cobbnt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-bend-double-up-left-bold" {...props}></Icon>
<style>
:global(.zv8cobbnt) {
  fill: currentColor;
