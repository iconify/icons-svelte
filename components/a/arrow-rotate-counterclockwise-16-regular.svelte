...
const content = `<path class="t-2rdh-1m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-rotate-counterclockwise-16-regular" {...props}></Icon>
<style>
:global(.t-2rdh-1m) {
  fill: currentColor;
