...
const content = `<g class="y9tr6bcfx"><circle class="f_v_dfbgn"/><path class="s9mkbvbgw"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:abha" {...props}></Icon>
<style>
:global(.f_v_dfbgn) {
  cx: 24px;
  cy: 24px;
