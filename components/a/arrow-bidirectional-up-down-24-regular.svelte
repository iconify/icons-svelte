...
const content = `<path class="mhy7p_bbp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-bidirectional-up-down-24-regular" {...props}></Icon>
<style>
:global(.mhy7p_bbp) {
  fill: currentColor;
