...
const content = `<path class="u64vi6b7n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:app-promo-outline-sharp" {...props}></Icon>
<style>
:global(.u64vi6b7n) {
  fill: currentColor;
