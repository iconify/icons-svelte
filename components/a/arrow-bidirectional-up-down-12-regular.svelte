...
const content = `<path class="a0x2p9z6e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-bidirectional-up-down-12-regular" {...props}></Icon>
<style>
:global(.a0x2p9z6e) {
  fill: currentColor;
