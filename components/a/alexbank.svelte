...
const content = `<rect class="j3s9ivbxi"/><path class="fme43nbbq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:alexbank" {...props}></Icon>
<style>
:global(.fme43nbbq) {
  fill: none;
  stroke: currentColor;
