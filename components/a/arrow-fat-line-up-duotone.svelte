...
const content = `<g class="cuyn6tgcc"><path class="u8m7_5qws"/><path class="ifhaxr7hi"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-fat-line-up-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
