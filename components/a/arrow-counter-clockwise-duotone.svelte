...
const content = `<g class="cuyn6tgcc"><path class="fw_-f4u_a"/><path class="imu11ac7r"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-counter-clockwise-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
