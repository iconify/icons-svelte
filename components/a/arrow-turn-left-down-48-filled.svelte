...
const content = `<path class="tmkkkzbro"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-left-down-48-filled" {...props}></Icon>
<style>
:global(.tmkkkzbro) {
  fill: currentColor;
