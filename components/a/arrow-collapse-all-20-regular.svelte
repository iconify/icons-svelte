...
const content = `<path class="ixkncpbes"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-collapse-all-20-regular" {...props}></Icon>
<style>
:global(.ixkncpbes) {
  fill: currentColor;
