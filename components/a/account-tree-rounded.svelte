...
const content = `<path class="jbi4bkc-f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:account-tree-rounded" {...props}></Icon>
<style>
:global(.jbi4bkc-f) {
  fill: currentColor;
