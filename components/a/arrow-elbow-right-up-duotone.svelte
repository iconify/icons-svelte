...
const content = `<g class="cuyn6tgcc"><path class="andqlfogi"/><path class="ak_p5sw8j"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-elbow-right-up-duotone" {...props}></Icon>
<style>
:global(.ak_p5sw8j) {
