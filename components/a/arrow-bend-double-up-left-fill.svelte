...
const content = `<path class="i64cj8d_h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-bend-double-up-left-fill" {...props}></Icon>
<style>
:global(.i64cj8d_h) {
  fill: currentColor;
