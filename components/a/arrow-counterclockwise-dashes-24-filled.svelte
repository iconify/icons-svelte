...
const content = `<path class="l9383vb2y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-counterclockwise-dashes-24-filled" {...props}></Icon>
<style>
:global(.l9383vb2y) {
  fill: currentColor;
