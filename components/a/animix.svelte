...
const content = `<path class="avbrndb2x"/><path class="y2ak00_js"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:animix" {...props}></Icon>
<style>
:global(.avbrndb2x) {
  fill: none;
  stroke: currentColor;
