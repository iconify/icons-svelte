...
const content = `<path class="b0l9vbbtl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:amp-stories-rounded" {...props}></Icon>
<style>
:global(.b0l9vbbtl) {
  fill: currentColor;
