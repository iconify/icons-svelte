...
const content = `<path class="o-mhdrisf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-circle-down-28-filled" {...props}></Icon>
<style>
:global(.o-mhdrisf) {
  fill: currentColor;
