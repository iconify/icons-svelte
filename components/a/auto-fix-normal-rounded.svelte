...
const content = `<path class="xqv-nkl7u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:auto-fix-normal-rounded" {...props}></Icon>
<style>
:global(.xqv-nkl7u) {
  fill: currentColor;
