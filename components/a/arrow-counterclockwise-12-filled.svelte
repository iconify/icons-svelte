...
const content = `<path class="ex670ex1v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-counterclockwise-12-filled" {...props}></Icon>
<style>
:global(.ex670ex1v) {
  fill: currentColor;
