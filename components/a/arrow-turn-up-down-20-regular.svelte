...
const content = `<path class="h7c1bnbug"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-up-down-20-regular" {...props}></Icon>
<style>
:global(.h7c1bnbug) {
  fill: currentColor;
