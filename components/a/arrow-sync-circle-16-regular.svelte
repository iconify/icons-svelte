...
const content = `<path class="nlhkzlh5y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-sync-circle-16-regular" {...props}></Icon>
<style>
:global(.nlhkzlh5y) {
  fill: currentColor;
