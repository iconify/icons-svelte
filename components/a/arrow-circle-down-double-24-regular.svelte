...
const content = `<path class="i12nq_73f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-circle-down-double-24-regular" {...props}></Icon>
<style>
:global(.i12nq_73f) {
  fill: currentColor;
