...
const content = `<path class="caigzjn8n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:auto-awesome-motion" {...props}></Icon>
<style>
:global(.caigzjn8n) {
  fill: currentColor;
