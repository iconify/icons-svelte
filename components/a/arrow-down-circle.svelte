...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="kvddbzdha"/><path class="wgfmlvbwg"/><path class="oml4dqbmk"/><path class="hdxpysbbn"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:arrow-down-circle" {...props}></Icon>
<style>
:global(.hdxpysbbn) {
