...
const content = `<path class="lyy48fmnf"/><path class="wzh1_nbge"/><path class="c1qqw1byb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:adventure-lab" {...props}></Icon>
<style>
:global(.c1qqw1byb) {
  fill: none;
  stroke: currentColor;
