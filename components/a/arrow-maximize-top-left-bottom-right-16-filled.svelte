...
const content = `<path class="mg9f9k5er"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-maximize-top-left-bottom-right-16-filled" {...props}></Icon>
<style>
:global(.mg9f9k5er) {
  fill: currentColor;
