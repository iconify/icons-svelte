...
const content = `<path class="nrffvyb4t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrows-in-line-horizontal-bold" {...props}></Icon>
<style>
:global(.nrffvyb4t) {
  fill: currentColor;
