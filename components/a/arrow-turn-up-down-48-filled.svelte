...
const content = `<path class="idubya14c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-up-down-48-filled" {...props}></Icon>
<style>
:global(.idubya14c) {
  fill: currentColor;
