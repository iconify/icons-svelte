...
const content = `<path class="rw_b7ob0c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:airline-seat-individual-suite-outline-sharp" {...props}></Icon>
<style>
:global(.rw_b7ob0c) {
  fill: currentColor;
