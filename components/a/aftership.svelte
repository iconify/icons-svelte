...
const content = `<path class="f4sfjxddc"/><path class="m49pvabxw"/><path class="hyw5of31j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:aftership" {...props}></Icon>
<style>
:global(.f4sfjxddc) {
  fill: none;
  stroke: currentColor;
