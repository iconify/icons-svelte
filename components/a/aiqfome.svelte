...
const content = `<path class="xfp5o8bwc"/><ellipse class="r7m55shcr"/><ellipse class="wv7k8sbhv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:aiqfome" {...props}></Icon>
<style>
:global(.r7m55shcr) {
  cx: 13.256px;
  cy: 23.985px;
