...
const content = `<path class="rdwcm3bhq"/><path class="w0w4vqbtr"/><path class="kwv375b8x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:assembly-line" {...props}></Icon>
<style>
:global(.kwv375b8x) {
  fill: none;
  stroke: currentColor;
