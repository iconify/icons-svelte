...
const content = `<g class="cuyn6tgcc"><path class="ffuuqgbcs"/><path class="vzqwcxblq"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrows-down-up-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
