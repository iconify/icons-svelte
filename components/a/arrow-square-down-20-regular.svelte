...
const content = `<path class="tgyh9uwzz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-square-down-20-regular" {...props}></Icon>
<style>
:global(.tgyh9uwzz) {
  fill: currentColor;
