...
const content = `<path class="h2jn7k01r"/><path class="hp8b2gbwy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:assoluto-racing" {...props}></Icon>
<style>
:global(.h2jn7k01r) {
  fill: none;
  stroke: currentColor;
