...
const content = `<path class="o2s_udb8e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:airline-seat-flat" {...props}></Icon>
<style>
:global(.o2s_udb8e) {
  fill: currentColor;
