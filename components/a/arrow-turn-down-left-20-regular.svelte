...
const content = `<path class="bru-8sbxb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-down-left-20-regular" {...props}></Icon>
<style>
:global(.bru-8sbxb) {
  fill: currentColor;
