...
const content = `<path class="t5f1gacgk"/><circle class="kg0ykm4in"/><path class="o1idtrbqu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:acastusphoton" {...props}></Icon>
<style>
:global(.kg0ykm4in) {
  cx: 19px;
  cy: 19px;
