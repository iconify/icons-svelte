...
const content = `<path class="bc1sjubsm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:auto-fix-normal-sharp" {...props}></Icon>
<style>
:global(.bc1sjubsm) {
  fill: currentColor;
