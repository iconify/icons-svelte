...
const content = `<path class="d5mvvuqoo"/><path class="b8kl0-b-q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:appcloner" {...props}></Icon>
<style>
:global(.b8kl0-b-q) {
  fill: none;
  stroke: currentColor;
