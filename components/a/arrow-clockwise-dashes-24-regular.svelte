...
const content = `<path class="nm0c9wbzb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-clockwise-dashes-24-regular" {...props}></Icon>
<style>
:global(.nm0c9wbzb) {
  fill: currentColor;
