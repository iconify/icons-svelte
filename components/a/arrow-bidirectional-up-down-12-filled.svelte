...
const content = `<path class="majoqybcv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-bidirectional-up-down-12-filled" {...props}></Icon>
<style>
:global(.majoqybcv) {
  fill: currentColor;
