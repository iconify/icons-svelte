...
const content = `<path class="loijgk-5u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-autofit-up-20-regular" {...props}></Icon>
<style>
:global(.loijgk-5u) {
  fill: currentColor;
