...
const content = `<circle class="cpk0fnbgt"/><path class="zmrmqowos"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:android-2-linux-notifications" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
