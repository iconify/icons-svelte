...
const content = `<path class="hhonbjoff"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-minimize-vertical-20-filled" {...props}></Icon>
<style>
:global(.hhonbjoff) {
  fill: currentColor;
