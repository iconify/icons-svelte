...
const content = `<path class="l061w5bxm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-up-left-20-regular" {...props}></Icon>
<style>
:global(.l061w5bxm) {
  fill: currentColor;
