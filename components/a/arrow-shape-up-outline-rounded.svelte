...
const content = `<path class="ij2x18b_x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:arrow-shape-up-outline-rounded" {...props}></Icon>
<style>
:global(.ij2x18b_x) {
  fill: currentColor;
