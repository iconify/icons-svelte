...
const content = `<path class="t4nhs1b2a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:apps-list-detail-20-filled" {...props}></Icon>
<style>
:global(.t4nhs1b2a) {
  fill: currentColor;
