...
const content = `<circle class="cpk0fnbgt"/><path class="ebrge6b7k"/><ellipse class="axgyiobon"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:avast-passwords" {...props}></Icon>
<style>
:global(.axgyiobon) {
  cx: 17.913px;
  cy: 17.79px;
