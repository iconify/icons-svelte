...
const content = `<path class="mvaf7qbbt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-circle-left-12-filled" {...props}></Icon>
<style>
:global(.mvaf7qbbt) {
  fill: currentColor;
