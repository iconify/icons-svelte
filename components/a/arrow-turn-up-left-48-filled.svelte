...
const content = `<path class="b8bjh6b3u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-up-left-48-filled" {...props}></Icon>
<style>
:global(.b8bjh6b3u) {
  fill: currentColor;
