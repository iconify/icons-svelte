...
const content = `<path class="h2_0jnb9h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:align-space-between-vertical-20-regular" {...props}></Icon>
<style>
:global(.h2_0jnb9h) {
  fill: currentColor;
