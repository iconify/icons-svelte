...
const content = `<path class="zqwdpu1as"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-step-over-16-regular" {...props}></Icon>
<style>
:global(.zqwdpu1as) {
  fill: currentColor;
