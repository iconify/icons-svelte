...
const content = `<path class="jhokbqb3k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-bidirectional-down-right-24-regular" {...props}></Icon>
<style>
:global(.jhokbqb3k) {
  fill: currentColor;
