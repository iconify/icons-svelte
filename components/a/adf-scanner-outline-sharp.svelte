...
const content = `<path class="sfy_3jb9s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:adf-scanner-outline-sharp" {...props}></Icon>
<style>
:global(.sfy_3jb9s) {
  fill: currentColor;
