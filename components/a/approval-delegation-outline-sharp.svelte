...
const content = `<path class="zoa5qxt6q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:approval-delegation-outline-sharp" {...props}></Icon>
<style>
:global(.zoa5qxt6q) {
  fill: currentColor;
