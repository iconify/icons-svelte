...
const content = `<path class="erv5e199t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-curve-down-left-28-filled" {...props}></Icon>
<style>
:global(.erv5e199t) {
  fill: currentColor;
