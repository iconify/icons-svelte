...
const content = `<path class="qk1a6_4kv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-circle-up-right-20-regular" {...props}></Icon>
<style>
:global(.qk1a6_4kv) {
  fill: currentColor;
