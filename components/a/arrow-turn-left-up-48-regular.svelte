...
const content = `<path class="lk3eqezva"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-left-up-48-regular" {...props}></Icon>
<style>
:global(.lk3eqezva) {
  fill: currentColor;
