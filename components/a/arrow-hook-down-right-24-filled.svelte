...
const content = `<path class="sbcjvkb0f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-hook-down-right-24-filled" {...props}></Icon>
<style>
:global(.sbcjvkb0f) {
  fill: currentColor;
