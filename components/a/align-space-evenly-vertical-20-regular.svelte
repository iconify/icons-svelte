...
const content = `<path class="ydl3r6cgi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:align-space-evenly-vertical-20-regular" {...props}></Icon>
<style>
:global(.ydl3r6cgi) {
  fill: currentColor;
