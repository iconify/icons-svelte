...
const content = `<path class="o71_ctbfx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-circle-down-right-20-filled" {...props}></Icon>
<style>
:global(.o71_ctbfx) {
  fill: currentColor;
