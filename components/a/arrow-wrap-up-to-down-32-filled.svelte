...
const content = `<path class="wna675bid"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-wrap-up-to-down-32-filled" {...props}></Icon>
<style>
:global(.wna675bid) {
  fill: currentColor;
