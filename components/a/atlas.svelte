...
const content = `<g class="ft5dv1b6b"><path class="uh2ak3vlm"/><path class="wtd1eevdu"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:atlas" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
