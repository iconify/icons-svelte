...
const content = `<g class="cuyn6tgcc"><path class="dbyvelfqp"/><path class="m73j0qy1p"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrows-in-line-horizontal-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
