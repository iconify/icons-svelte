...
const content = `<g class="cuyn6tgcc"><path class="rl1dq4bco"/><path class="buuy_sgxe"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-square-left-duotone" {...props}></Icon>
<style>
:global(.buuy_sgxe) {
