...
const content = `<path class="jn3rssbjv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-hook-down-left-32-filled" {...props}></Icon>
<style>
:global(.jn3rssbjv) {
  fill: currentColor;
