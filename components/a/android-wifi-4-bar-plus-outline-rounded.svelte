...
const content = `<path class="js8vfbc0a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:android-wifi-4-bar-plus-outline-rounded" {...props}></Icon>
<style>
:global(.js8vfbc0a) {
  fill: currentColor;
