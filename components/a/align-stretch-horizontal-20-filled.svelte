...
const content = `<path class="irr6-5bwm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:align-stretch-horizontal-20-filled" {...props}></Icon>
<style>
:global(.irr6-5bwm) {
  fill: currentColor;
