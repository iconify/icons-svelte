...
const content = `<g class="cuyn6tgcc"><path class="kbgxg_7rn"/><path class="rrz4x2byk"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrows-in-simple-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
