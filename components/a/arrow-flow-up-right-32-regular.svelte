...
const content = `<path class="ldndmkxms"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-flow-up-right-32-regular" {...props}></Icon>
<style>
:global(.ldndmkxms) {
  fill: currentColor;
