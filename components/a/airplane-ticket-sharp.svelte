...
const content = `<path class="ji6x2_z6b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:airplane-ticket-sharp" {...props}></Icon>
<style>
:global(.ji6x2_z6b) {
  fill: currentColor;
