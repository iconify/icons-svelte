...
const content = `<path class="p57oy4cdw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:airplane-ticket-sharp" {...props}></Icon>
<style>
:global(.p57oy4cdw) {
  fill: currentColor;
