...
const content = `<g class="cuyn6tgcc"><path class="d0rpw2w8k"/><path class="s9yzyavfp"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-fat-line-right-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
