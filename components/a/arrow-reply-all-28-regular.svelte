...
const content = `<path class="nszkq7pfl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-reply-all-28-regular" {...props}></Icon>
<style>
:global(.nszkq7pfl) {
  fill: currentColor;
