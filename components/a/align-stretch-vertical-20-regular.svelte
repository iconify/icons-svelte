...
const content = `<path class="v9__4jbgp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:align-stretch-vertical-20-regular" {...props}></Icon>
<style>
:global(.v9__4jbgp) {
  fill: currentColor;
