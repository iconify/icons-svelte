...
const content = `<path class="vgu_sy6od"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:add-subtract-circle-20-filled" {...props}></Icon>
<style>
:global(.vgu_sy6od) {
  fill: currentColor;
