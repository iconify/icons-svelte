...
const content = `<path class="pni9ih9yg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-hook-up-right-24-filled" {...props}></Icon>
<style>
:global(.pni9ih9yg) {
  fill: currentColor;
