...
const content = `<g class="cuyn6tgcc"><path class="cj6rvqbix"/><path class="r4kdcvjzr"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-elbow-down-right-duotone" {...props}></Icon>
<style>
:global(.cj6rvqbix) {
