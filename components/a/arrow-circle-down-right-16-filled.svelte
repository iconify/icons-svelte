...
const content = `<path class="gvqgx9x9j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-circle-down-right-16-filled" {...props}></Icon>
<style>
:global(.gvqgx9x9j) {
  fill: currentColor;
