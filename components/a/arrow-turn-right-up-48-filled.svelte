...
const content = `<path class="nd9lv6bdt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-right-up-48-filled" {...props}></Icon>
<style>
:global(.nd9lv6bdt) {
  fill: currentColor;
