...
const content = `<path class="vbadqictn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-down-right-16-filled" {...props}></Icon>
<style>
:global(.vbadqictn) {
  fill: currentColor;
