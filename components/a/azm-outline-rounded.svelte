...
const content = `<path class="h9yhx_h2s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:azm-outline-rounded" {...props}></Icon>
<style>
:global(.h9yhx_h2s) {
  fill: currentColor;
