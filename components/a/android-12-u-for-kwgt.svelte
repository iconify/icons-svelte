...
const content = `<circle class="cpk0fnbgt"/><rect class="yi_-_1bee"/><path class="ev-agq82t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:android-12-u-for-kwgt" {...props}></Icon>
<style>
:global(.cpk0fnbgt) {
  cx: 24px;
  cy: 24px;
