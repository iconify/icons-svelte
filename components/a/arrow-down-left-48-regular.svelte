...
const content = `<path class="c8gdpqbjw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-down-left-48-regular" {...props}></Icon>
<style>
:global(.c8gdpqbjw) {
  fill: currentColor;
