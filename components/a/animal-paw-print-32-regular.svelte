...
const content = `<path class="ad54r4bzl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:animal-paw-print-32-regular" {...props}></Icon>
<style>
:global(.ad54r4bzl) {
  fill: currentColor;
