...
const content = `<path class="vd6yibbmz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-export-ltr-28-filled" {...props}></Icon>
<style>
:global(.vd6yibbmz) {
  fill: currentColor;
