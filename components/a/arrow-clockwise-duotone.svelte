...
const content = `<g class="cuyn6tgcc"><path class="fw_-f4u_a"/><path class="pqj_s8bcb"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-clockwise-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
