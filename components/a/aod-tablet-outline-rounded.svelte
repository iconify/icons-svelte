...
const content = `<path class="nzlbarbff"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:aod-tablet-outline-rounded" {...props}></Icon>
<style>
:global(.nzlbarbff) {
  fill: currentColor;
