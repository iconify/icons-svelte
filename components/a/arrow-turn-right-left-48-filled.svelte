...
const content = `<path class="fa2n_sm6b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-right-left-48-filled" {...props}></Icon>
<style>
:global(.fa2n_sm6b) {
  fill: currentColor;
