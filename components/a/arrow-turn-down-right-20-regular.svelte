...
const content = `<path class="yn1plibrk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-down-right-20-regular" {...props}></Icon>
<style>
:global(.yn1plibrk) {
  fill: currentColor;
