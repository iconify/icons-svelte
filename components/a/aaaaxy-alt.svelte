...
const content = `<path class="yxom3cput"/><path class="plqbgebtp"/><path class="ydy9kac4u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:aaaaxy-alt" {...props}></Icon>
<style>
:global(.plqbgebtp) {
  fill: none;
  stroke: currentColor;
