...
const content = `<path class="ep6m4wbhe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-sort-down-lines-16-regular" {...props}></Icon>
<style>
:global(.ep6m4wbhe) {
  fill: currentColor;
