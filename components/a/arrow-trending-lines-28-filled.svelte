...
const content = `<path class="ct5e31_uv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-trending-lines-28-filled" {...props}></Icon>
<style>
:global(.ct5e31_uv) {
  fill: currentColor;
