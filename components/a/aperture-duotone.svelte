...
const content = `<g class="cuyn6tgcc"><path class="npfrxrb2t"/><path class="klirv07oh"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:aperture-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
