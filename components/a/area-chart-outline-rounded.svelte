...
const content = `<path class="vexu9sb8v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:area-chart-outline-rounded" {...props}></Icon>
<style>
:global(.vexu9sb8v) {
  fill: currentColor;
