...
const content = `<path class="j152v6d-t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:area-chart-outline-rounded" {...props}></Icon>
<style>
:global(.j152v6d-t) {
  fill: currentColor;
