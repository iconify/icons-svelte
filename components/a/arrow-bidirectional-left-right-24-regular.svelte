...
const content = `<path class="cco0px37v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-bidirectional-left-right-24-regular" {...props}></Icon>
<style>
:global(.cco0px37v) {
  fill: currentColor;
