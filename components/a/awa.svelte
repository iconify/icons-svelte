...
const content = `<rect class="j3s9ivbxi"/><path class="g_yatib-r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:awa" {...props}></Icon>
<style>
:global(.g_yatib-r) {
  fill: none;
  stroke: currentColor;
