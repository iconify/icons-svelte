...
const content = `<path class="cnjvksb4j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:appmanager-muntashirakon" {...props}></Icon>
<style>
:global(.cnjvksb4j) {
  fill: none;
  stroke: currentColor;
