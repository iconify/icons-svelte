...
const content = `<path class="io1x901dm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-wrap-up-to-down-20-filled" {...props}></Icon>
<style>
:global(.io1x901dm) {
  fill: currentColor;
