...
const content = `<path class="uxp0x2bbs"/><path class="ek287wbtl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:awork" {...props}></Icon>
<style>
:global(.ek287wbtl) {
  fill: none;
  stroke: currentColor;
