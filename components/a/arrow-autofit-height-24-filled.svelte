...
const content = `<path class="gftkyvo7b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-autofit-height-24-filled" {...props}></Icon>
<style>
:global(.gftkyvo7b) {
  fill: currentColor;
