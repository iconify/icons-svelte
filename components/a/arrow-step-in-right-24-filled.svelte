...
const content = `<path class="gtmoqe2id"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-step-in-right-24-filled" {...props}></Icon>
<style>
:global(.gtmoqe2id) {
  fill: currentColor;
