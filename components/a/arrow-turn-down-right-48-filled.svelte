...
const content = `<path class="yd44w6bte"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-down-right-48-filled" {...props}></Icon>
<style>
:global(.yd44w6bte) {
  fill: currentColor;
