...
const content = `<path class="a3r7898st"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-rotate-counterclockwise-28-filled" {...props}></Icon>
<style>
:global(.a3r7898st) {
  fill: currentColor;
