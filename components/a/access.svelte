...
const content = `<path class="o0ofsw4ai"/><path class="g1je52bft"/><path class="fd-k-sbvi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:access" {...props}></Icon>
<style>
:global(.fd-k-sbvi) {
  fill: none;
  stroke: currentColor;
