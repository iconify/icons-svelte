...
const content = `<path class="wjxy9ukcl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-circle-down-32-filled" {...props}></Icon>
<style>
:global(.wjxy9ukcl) {
  fill: currentColor;
