...
const content = `<g class="cuyn6tgcc"><path class="nhzs2m1kk"/><path class="o3fn5qbsn"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-arc-right-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
