...
const content = `<path class="u0orcsdpn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:app-shortcut-outline-sharp" {...props}></Icon>
<style>
:global(.u0orcsdpn) {
  fill: currentColor;
