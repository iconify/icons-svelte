...
const content = `<path class="owl83ac6y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:align-center-horizontal-28-filled" {...props}></Icon>
<style>
:global(.owl83ac6y) {
  fill: currentColor;
