...
const content = `<path class="lyyk5rb4s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-collapse-all-20-filled" {...props}></Icon>
<style>
:global(.lyyk5rb4s) {
  fill: currentColor;
