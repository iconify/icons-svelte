...
const content = `<g class="cuyn6tgcc"><path class="ped31yqbt"/><path class="cjlyp0ble"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:align-top-simple-duotone" {...props}></Icon>
<style>
:global(.cjlyp0ble) {
