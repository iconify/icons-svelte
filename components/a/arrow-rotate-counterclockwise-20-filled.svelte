...
const content = `<path class="dd96ecbff"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-rotate-counterclockwise-20-filled" {...props}></Icon>
<style>
:global(.dd96ecbff) {
  fill: currentColor;
