...
const content = `<path class="x66qzacar"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-circle-right-12-regular" {...props}></Icon>
<style>
:global(.x66qzacar) {
  fill: currentColor;
