...
const content = `<path class="j14hsxblk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-clockwise-dashes-16-filled" {...props}></Icon>
<style>
:global(.j14hsxblk) {
  fill: currentColor;
