...
const content = `<g class="kuiy7mb2v"><path class="i6ljr2bxz"/><path class="fqtpnu0hu"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:aave" {...props}></Icon>
<style>
:global(.fqtpnu0hu) {
