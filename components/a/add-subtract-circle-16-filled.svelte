...
const content = `<path class="wqi86pgfw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:add-subtract-circle-16-filled" {...props}></Icon>
<style>
:global(.wqi86pgfw) {
  fill: currentColor;
