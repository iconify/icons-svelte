...
const content = `<path class="x2bki6bwm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-expand-all-20-regular" {...props}></Icon>
<style>
:global(.x2bki6bwm) {
  fill: currentColor;
