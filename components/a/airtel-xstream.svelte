...
const content = `<path class="x699ewbqd"/><path class="seujh6qpm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:airtel-xstream" {...props}></Icon>
<style>
:global(.seujh6qpm) {
  fill: none;
  stroke: currentColor;
