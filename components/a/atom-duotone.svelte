...
const content = `<g class="cuyn6tgcc"><path class="p3q3gsmos"/><path class="mhx_lnb5m"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:atom-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
