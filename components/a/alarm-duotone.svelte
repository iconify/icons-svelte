...
const content = `<g class="cuyn6tgcc"><path class="qa0d2tb3n"/><path class="tdp8u1bxy"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:alarm-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
