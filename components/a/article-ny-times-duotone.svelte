...
const content = `<g class="cuyn6tgcc"><path class="au2rcutys"/><path class="x136nvb7p"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:article-ny-times-duotone" {...props}></Icon>
<style>
:global(.au2rcutys) {
