...
const content = `<path class="wl9mjtb1g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-collapse-all-24-filled" {...props}></Icon>
<style>
:global(.wl9mjtb1g) {
  fill: currentColor;
