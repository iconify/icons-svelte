...
const content = `<path class="jtjsf8bpi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-circle-right-28-filled" {...props}></Icon>
<style>
:global(.jtjsf8bpi) {
  fill: currentColor;
