...
const content = `<path class="h_-vckb6u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:align-center-horizontal-24-regular" {...props}></Icon>
<style>
:global(.h_-vckb6u) {
  fill: currentColor;
