...
const content = `<path class="qibu3ib6l"/><path class="d6kt9nbvl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:arena-of-valor" {...props}></Icon>
<style>
:global(.d6kt9nbvl) {
  fill: none;
  stroke: currentColor;
