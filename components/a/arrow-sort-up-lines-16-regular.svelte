...
const content = `<path class="x2_l8ebxm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-sort-up-lines-16-regular" {...props}></Icon>
<style>
:global(.x2_l8ebxm) {
  fill: currentColor;
