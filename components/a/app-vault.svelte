...
const content = `<path class="e7y5q50za"/><path class="uficjmb1w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:app-vault" {...props}></Icon>
<style>
:global(.e7y5q50za) {
  fill: none;
  stroke: currentColor;
