...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:airline-seat-legroom-reduced-outline-rounded" {...props}></Icon>
<style>
:global(.e1xl6jvxq) {
  fill: currentColor;
