...
const content = `<path class="gp51dacwl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-curve-down-right-20-filled" {...props}></Icon>
<style>
:global(.gp51dacwl) {
  fill: currentColor;
