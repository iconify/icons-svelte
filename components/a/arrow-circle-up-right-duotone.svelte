...
const content = `<g class="cuyn6tgcc"><path class="goeug6bgp"/><path class="bty6v1b5j"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-circle-up-right-duotone" {...props}></Icon>
<style>
:global(.bty6v1b5j) {
