...
const content = `<g class="gp_8x1bzb"><path class="d9n7g7e8t"/><path class="rj2y4vkzd"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:airpods-sharp" {...props}></Icon>
<style>
:global(.d9n7g7e8t) {
