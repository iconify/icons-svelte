...
const content = `<path class="i6x4-lbsb"/><path class="pgt5-4bav"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:asda-rewards" {...props}></Icon>
<style>
:global(.i6x4-lbsb) {
  fill: none;
  stroke: currentColor;
