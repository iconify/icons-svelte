...
const content = `<path class="g-frixucj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:audio-spectrum-analyzer" {...props}></Icon>
<style>
:global(.g-frixucj) {
  fill: none;
  stroke: currentColor;
