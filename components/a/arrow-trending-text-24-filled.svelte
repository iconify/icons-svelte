...
const content = `<path class="a1hn96rel"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-trending-text-24-filled" {...props}></Icon>
<style>
:global(.a1hn96rel) {
  fill: currentColor;
