...
const content = `<path class="eq-0wopby"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:archive-outline-sharp" {...props}></Icon>
<style>
:global(.eq-0wopby) {
  fill: currentColor;
