...
const content = `<path class="ig6fbytbj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-counterclockwise-20-filled" {...props}></Icon>
<style>
:global(.ig6fbytbj) {
  fill: currentColor;
