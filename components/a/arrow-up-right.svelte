...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="obqrtcb_a"/><path class="ral10pb0v"/><path class="i9t-mwyqn"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:arrow-up-right" {...props}></Icon>
<style>
:global(.i9t-mwyqn) {
