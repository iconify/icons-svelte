...
const content = `<path class="tatnxz5su"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-counterclockwise-48-filled" {...props}></Icon>
<style>
:global(.tatnxz5su) {
  fill: currentColor;
