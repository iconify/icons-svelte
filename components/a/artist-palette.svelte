...
const content = `<path class="btnnu3b4e"/><circle class="uqkidhbid"/><circle class="t3a1mi49j"/><circle class="r9dsrlegt"/><circle class="ca-7brbpz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="twemoji:artist-palette" {...props}></Icon>
<style>
:global(.btnnu3b4e) {
