...
const content = `<path class="edy8ek0dv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-circle-right-12-filled" {...props}></Icon>
<style>
:global(.edy8ek0dv) {
  fill: currentColor;
