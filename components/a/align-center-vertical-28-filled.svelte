...
const content = `<path class="ncug-_bso"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:align-center-vertical-28-filled" {...props}></Icon>
<style>
:global(.ncug-_bso) {
  fill: currentColor;
