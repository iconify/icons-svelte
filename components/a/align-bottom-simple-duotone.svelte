...
const content = `<g class="cuyn6tgcc"><path class="bakffdbbf"/><path class="p7b6tsbvg"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:align-bottom-simple-duotone" {...props}></Icon>
<style>
:global(.bakffdbbf) {
