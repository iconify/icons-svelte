...
const content = `<path class="yrj42z84s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-circle-left-28-filled" {...props}></Icon>
<style>
:global(.yrj42z84s) {
  fill: currentColor;
