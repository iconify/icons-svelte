...
const content = `<path class="xyiym1box"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:adf-scanner-outline-rounded" {...props}></Icon>
<style>
:global(.xyiym1box) {
  fill: currentColor;
