...
const content = `<path class="defvn1bgv"/><path class="i9clfwm2k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:adbmanager" {...props}></Icon>
<style>
:global(.defvn1bgv) {
  fill: none;
  stroke: currentColor;
