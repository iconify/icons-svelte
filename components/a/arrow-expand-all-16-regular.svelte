...
const content = `<path class="tjix63i5n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-expand-all-16-regular" {...props}></Icon>
<style>
:global(.tjix63i5n) {
  fill: currentColor;
