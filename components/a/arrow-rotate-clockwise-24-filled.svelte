...
const content = `<path class="apn7cqu0c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-rotate-clockwise-24-filled" {...props}></Icon>
<style>
:global(.apn7cqu0c) {
  fill: currentColor;
