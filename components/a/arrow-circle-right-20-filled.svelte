...
const content = `<path class="gn4z1bcxf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-circle-right-20-filled" {...props}></Icon>
<style>
:global(.gn4z1bcxf) {
  fill: currentColor;
