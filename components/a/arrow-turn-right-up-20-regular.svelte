...
const content = `<path class="g5h7ze7vw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-turn-right-up-20-regular" {...props}></Icon>
<style>
:global(.g5h7ze7vw) {
  fill: currentColor;
