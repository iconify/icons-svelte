...
const content = `<path class="yzlvrcctl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:align-space-evenly-horizontal-20-regular" {...props}></Icon>
<style>
:global(.yzlvrcctl) {
  fill: currentColor;
