...
const content = `<path class="gv_b_nb_m"/><path class="wqp61tb8w"/><path class="f_rk0cb1h"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:aurora-kino" {...props}></Icon>
<style>
:global(.f_rk0cb1h) {
  fill: none;
  stroke: currentColor;
