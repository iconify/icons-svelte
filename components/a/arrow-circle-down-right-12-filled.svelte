...
const content = `<path class="gw-ju3bgc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-circle-down-right-12-filled" {...props}></Icon>
<style>
:global(.gw-ju3bgc) {
  fill: currentColor;
