...
const content = `<path class="id18h52ud"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-maximize-top-left-bottom-right-20-filled" {...props}></Icon>
<style>
:global(.id18h52ud) {
  fill: currentColor;
