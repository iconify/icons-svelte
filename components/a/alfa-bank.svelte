...
const content = `<path class="nax8x9e-k"/><path class="fly1p5bsi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:alfa-bank" {...props}></Icon>
<style>
:global(.fly1p5bsi) {
  fill: none;
  stroke: currentColor;
