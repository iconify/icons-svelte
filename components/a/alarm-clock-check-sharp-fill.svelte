...
const content = `<g class="gp_8x1bzb"><path clip-rule="evenodd" class="vndk8uiaj"/><path class="ztp2ojn_h"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="keyline-icons:alarm-clock-check-sharp-fill" {...props}></Icon>
<style>
:global(.gp_8x1bzb) {
  fill: none;
  stroke: currentColor;
