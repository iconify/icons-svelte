...
const content = `<path class="d-16ckbbq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:apps-bullet-list-20-filled" {...props}></Icon>
<style>
:global(.d-16ckbbq) {
  fill: currentColor;
