...
const content = `<g class="ft5dv1b6b"><path class="ne_5t3atc"/><path class="hshinubbk"/><path class="xx22s488r"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:area" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
