...
const content = `<path class="gj-r-1bay"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:adf-scanner" {...props}></Icon>
<style>
:global(.gj-r-1bay) {
  fill: currentColor;
