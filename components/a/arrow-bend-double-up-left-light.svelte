...
const content = `<path class="eluc2_bbu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-bend-double-up-left-light" {...props}></Icon>
<style>
:global(.eluc2_bbu) {
  fill: currentColor;
