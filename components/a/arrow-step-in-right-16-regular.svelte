...
const content = `<path class="flxq52s0r"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-step-in-right-16-regular" {...props}></Icon>
<style>
:global(.flxq52s0r) {
  fill: currentColor;
