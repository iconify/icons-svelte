...
const content = `<path class="j4bw00bye"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-up-right-dashes-28-regular" {...props}></Icon>
<style>
:global(.j4bw00bye) {
  fill: currentColor;
