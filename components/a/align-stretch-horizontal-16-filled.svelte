...
const content = `<path class="blb4sacys"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:align-stretch-horizontal-16-filled" {...props}></Icon>
<style>
:global(.blb4sacys) {
  fill: currentColor;
