...
const content = `<path class="blo_t4fuf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:apps-list-detail-32-regular" {...props}></Icon>
<style>
:global(.blo_t4fuf) {
  fill: currentColor;
