...
const content = `<path class="ss7f7x4xq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-hook-down-left-32-light" {...props}></Icon>
<style>
:global(.ss7f7x4xq) {
  fill: currentColor;
