...
const content = `<path class="hwzh1sb_j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-circle-right-24-regular" {...props}></Icon>
<style>
:global(.hwzh1sb_j) {
  fill: currentColor;
