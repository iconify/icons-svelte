...
const content = `<path class="qbu_rqk0k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-up-right-dashes-12-filled" {...props}></Icon>
<style>
:global(.qbu_rqk0k) {
  fill: currentColor;
