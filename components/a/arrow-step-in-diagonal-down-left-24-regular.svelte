...
const content = `<path class="dwkgy9bql"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-step-in-diagonal-down-left-24-regular" {...props}></Icon>
<style>
:global(.dwkgy9bql) {
  fill: currentColor;
