...
const content = `<path class="dukuflg6j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:arrow-flow-diagonal-up-right-48-filled" {...props}></Icon>
<style>
:global(.dukuflg6j) {
  fill: currentColor;
