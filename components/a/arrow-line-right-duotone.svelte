...
const content = `<g class="cuyn6tgcc"><path class="fal8w6bqh"/><path class="dnq8z02sa"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrow-line-right-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
