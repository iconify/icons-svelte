...
const content = `<path class="vyj9fbbec"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:assistant-on-hub-sharp" {...props}></Icon>
<style>
:global(.vyj9fbbec) {
  fill: currentColor;
