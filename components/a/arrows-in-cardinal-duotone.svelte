...
const content = `<g class="cuyn6tgcc"><path class="kbgxg_7rn"/><path class="kagqseb0j"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:arrows-in-cardinal-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
