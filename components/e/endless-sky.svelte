...
const content = `<path class="uoqtcxeiw"/><path class="yam2s2bdw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:endless-sky" {...props}></Icon>
<style>
:global(.uoqtcxeiw) {
  fill: none;
  stroke: currentColor;
