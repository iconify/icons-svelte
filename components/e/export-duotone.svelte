...
const content = `<g class="cuyn6tgcc"><path class="jtbal-1xz"/><path class="hxvo23c5g"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:export-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
