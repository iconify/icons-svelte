...
const content = `<path class="kb51-lmwd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-face-expressionless" {...props}></Icon>
<style>
:global(.kb51-lmwd) {
  fill: none;
  stroke: currentColor;
