...
const content = `<rect class="j3s9ivbxi"/><path class="oo9xtihkq"/><circle class="kdin81byz"/><path class="e3j71l_oc"/><rect class="zmbunhmsp"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:elife-on" {...props}></Icon>
<style>
:global(.e3j71l_oc) {
  fill: none;
  stroke: currentColor;
