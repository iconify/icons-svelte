...
const content = `<path class="w4fovi9ld"/><circle class="t0m74_5yy"/><path class="hfxy5pbcj"/><path class="g4f4yla7d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:esis" {...props}></Icon>
<style>
:global(.g4f4yla7d) {
  fill: none;
  stroke: currentColor;
