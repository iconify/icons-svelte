...
const content = `<rect class="j3s9ivbxi"/><path class="d3xv-tm0u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:elementary" {...props}></Icon>
<style>
:global(.d3xv-tm0u) {
  fill: none;
  stroke: currentColor;
