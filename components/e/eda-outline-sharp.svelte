...
const content = `<path class="gia4jdzmy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:eda-outline-sharp" {...props}></Icon>
<style>
:global(.gia4jdzmy) {
  fill: currentColor;
