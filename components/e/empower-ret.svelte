...
const content = `<path class="xadce_bny"/><path class="h3nmj145b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:empower-ret" {...props}></Icon>
<style>
:global(.h3nmj145b) {
  fill: none;
  stroke: currentColor;
