...
const content = `<path class="huql0wbjw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-clock-face-eight-oclock" {...props}></Icon>
<style>
:global(.huql0wbjw) {
  fill: none;
  stroke: currentColor;
