...
const content = `<g class="cuyn6tgcc"><path class="gs-i6-9yy"/><path class="v6g7w9acv"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:envelope-simple-open-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
