...
const content = `<path class="l_wxmtbbz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:eight-spoked-asterisk" {...props}></Icon>
<style>
:global(.l_wxmtbbz) {
  fill: currentColor;
