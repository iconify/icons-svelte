...
const content = `<path class="yi6wgc79s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:emoji-language-sharp" {...props}></Icon>
<style>
:global(.yi6wgc79s) {
  fill: currentColor;
