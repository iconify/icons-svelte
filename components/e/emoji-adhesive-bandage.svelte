...
const content = `<path class="qw973rbfj"/><path class="u43vatbdk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-adhesive-bandage" {...props}></Icon>
<style>
:global(.qw973rbfj) {
  fill: none;
  stroke: currentColor;
