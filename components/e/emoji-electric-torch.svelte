...
const content = `<path class="qcnqbgb6k"/><path class="ojoh1n-vi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-electric-torch" {...props}></Icon>
<style>
:global(.ojoh1n-vi) {
  fill: none;
  stroke: currentColor;
