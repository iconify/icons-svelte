...
const content = `<path class="q_-o38ibr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:earbud-right-outline-sharp" {...props}></Icon>
<style>
:global(.q_-o38ibr) {
  fill: currentColor;
