...
const content = `<circle class="fh8ajacvs"/><path class="f7akfhg-w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-v1:expressionless-face" {...props}></Icon>
<style>
:global(.f7akfhg-w) {
