...
const content = `<path class="kr2i49omi"/><path class="lqizd2bjw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:expressionless-face" {...props}></Icon>
<style>
:global(.kr2i49omi) {
  fill: currentColor;
