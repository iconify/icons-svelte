...
const content = `<path class="e1bqx3beu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-clock-face-six-thirty" {...props}></Icon>
<style>
:global(.e1bqx3beu) {
  fill: none;
  stroke: currentColor;
