...
const content = `<path class="rg3fvdb0g"/><path class="c4-65vb-e"/><path class="d0o0abh2d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-books" {...props}></Icon>
<style>
:global(.c4-65vb-e) {
  fill: none;
  stroke: currentColor;
