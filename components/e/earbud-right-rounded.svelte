...
const content = `<path class="gtro-by8s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:earbud-right-rounded" {...props}></Icon>
<style>
:global(.gtro-by8s) {
  fill: currentColor;
