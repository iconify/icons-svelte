...
const content = `<g clip-rule="evenodd" class="utxjc7b5q"><path class="dik4fnb4o"/><path class="qs3u73ecq"/></g><path class="wjt81_bcx"/><path clip-rule="evenodd" class="n3xyxfdpd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:e-mail" {...props}></Icon>
<style>
:global(.dik4fnb4o) {
