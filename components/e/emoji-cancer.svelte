...
const content = `<path class="f-8e6obab"/><path class="njmq7xbhb"/><path class="b7naesbox"/><path class="i9clfwm2k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-cancer" {...props}></Icon>
<style>
:global(.b7naesbox) {
  fill: none;
  stroke: currentColor;
