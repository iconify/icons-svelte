...
const content = `<path class="vs0295bgk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:expand-more-rounded" {...props}></Icon>
<style>
:global(.vs0295bgk) {
  fill: currentColor;
