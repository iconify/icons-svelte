...
const content = `<path class="ulcp3no1z"/><path class="utlt7t7vn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:elsa" {...props}></Icon>
<style>
:global(.ulcp3no1z) {
  fill: none;
  stroke: currentColor;
