...
const content = `<path class="lwadrb7ks"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:edit-line-outline-sharp" {...props}></Icon>
<style>
:global(.lwadrb7ks) {
  fill: currentColor;
