...
const content = `<path class="j0rig9bpy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:edit-line-outline-sharp" {...props}></Icon>
<style>
:global(.j0rig9bpy) {
  fill: currentColor;
