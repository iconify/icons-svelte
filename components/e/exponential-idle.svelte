...
const content = `<path class="bn-n-gbxz"/><path class="p41c-eeyf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:exponential-idle" {...props}></Icon>
<style>
:global(.bn-n-gbxz) {
  fill: none;
  stroke: currentColor;
