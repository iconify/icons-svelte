...
const content = `<path class="h31is259c"/><circle class="rt_37l3dj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:eleven-thirty" {...props}></Icon>
<style>
:global(.h31is259c) {
  fill: currentColor;
