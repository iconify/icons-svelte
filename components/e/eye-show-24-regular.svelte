...
const content = `<g class="ft5dv1b6b"><path class="b5ij206tt"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:eye-show-24-regular" {...props}></Icon>
<style>
:global(.b5ij206tt) {
