...
const content = `<path class="en1ojy54p"/><path class="cvtr89xqq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:expense-manager" {...props}></Icon>
<style>
:global(.cvtr89xqq) {
  fill: none;
  stroke: currentColor;
