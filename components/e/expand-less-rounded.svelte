...
const content = `<path class="hthefgdlq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:expand-less-rounded" {...props}></Icon>
<style>
:global(.hthefgdlq) {
  fill: currentColor;
