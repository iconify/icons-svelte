...
const content = `<path class="l1rd1eddx"/><circle class="s4ggnublm"/><circle class="r_nlxzkjd"/><path class="jyflouxzu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="noto-v1:eye-in-speech-bubble" {...props}></Icon>
<style>
:global(.jyflouxzu) {
