...
const content = `<path clip-rule="evenodd" class="qy6mjv50d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:eqb" {...props}></Icon>
<style>
:global(.qy6mjv50d) {
