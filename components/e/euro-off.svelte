...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="tja41nltg"/><path clip-rule="evenodd" class="dzb5a9bzw"/><path class="xedf9ccsf"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:euro-off" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
