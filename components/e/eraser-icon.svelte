...
const content = `<path class="mp2wqsbih"/><path class="r_ggsrbcy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:eraser-icon" {...props}></Icon>
<style>
:global(.mp2wqsbih) {
