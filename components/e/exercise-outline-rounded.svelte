...
const content = `<path class="a7kn5_bwg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:exercise-outline-rounded" {...props}></Icon>
<style>
:global(.a7kn5_bwg) {
  fill: currentColor;
