...
const content = `<path class="izrv_bcns"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:e911-emergency-outline-sharp" {...props}></Icon>
<style>
:global(.izrv_bcns) {
  fill: currentColor;
