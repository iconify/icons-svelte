...
const content = `<path class="q-rd_1bxd"/><path class="ibv4yjbyu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:elapse" {...props}></Icon>
<style>
:global(.ibv4yjbyu) {
  fill: none;
  stroke: currentColor;
