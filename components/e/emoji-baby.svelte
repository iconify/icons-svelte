...
const content = `<path class="a-wcklbfj"/><path class="m413n1bnf"/><path class="knfp8wb8o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-baby" {...props}></Icon>
<style>
:global(.a-wcklbfj) {
  fill: none;
  stroke: currentColor;
