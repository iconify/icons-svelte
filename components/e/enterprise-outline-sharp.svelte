...
const content = `<path class="l03zihsaj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:enterprise-outline-sharp" {...props}></Icon>
<style>
:global(.l03zihsaj) {
  fill: currentColor;
