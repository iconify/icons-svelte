...
const content = `<path class="vwae12bzm"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:edit-road-sharp" {...props}></Icon>
<style>
:global(.vwae12bzm) {
  fill: currentColor;
