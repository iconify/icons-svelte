...
const content = `<path class="h696n-bxq"/><path class="v1z4sobvj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-banana" {...props}></Icon>
<style>
:global(.h696n-bxq) {
  fill: none;
  stroke: currentColor;
