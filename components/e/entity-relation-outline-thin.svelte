...
const content = `<g class="hntgybcog"><path class="ztwbs-b3m"/><path class="bb7inz33j"/><path class="e_3sagvyd"/><path class="wjt99f33m"/><path class="l8l7-n69m"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="iconmind:entity-relation-outline-thin" {...props}></Icon>
<style>
:global(.bb7inz33j) {
