...
const content = `<path class="s9l5wbc3q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:ear-sound-outline-rounded" {...props}></Icon>
<style>
:global(.s9l5wbc3q) {
  fill: currentColor;
