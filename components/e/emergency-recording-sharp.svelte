...
const content = `<path class="on4gyrb4g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:emergency-recording-sharp" {...props}></Icon>
<style>
:global(.on4gyrb4g) {
  fill: currentColor;
