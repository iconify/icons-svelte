...
const content = `<path class="km5rm0mcg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:ev-mobiledata-badge" {...props}></Icon>
<style>
:global(.km5rm0mcg) {
  fill: currentColor;
