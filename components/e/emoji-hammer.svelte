...
const content = `<path class="pwcx76vrn"/><path class="rz8dms_zy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-hammer" {...props}></Icon>
<style>
:global(.pwcx76vrn) {
  fill: none;
  stroke: currentColor;
