...
const content = `<path class="k66l_cctl"/><path class="amo_f6b4b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-ballot-box-with-check" {...props}></Icon>
<style>
:global(.amo_f6b4b) {
  fill: none;
  stroke: currentColor;
