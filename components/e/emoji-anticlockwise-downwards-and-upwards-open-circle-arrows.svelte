...
const content = `<path class="i_v-wcbyk"/><path class="bzh84tb8m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-anticlockwise-downwards-and-upwards-open-circle-arrows" {...props}></Icon>
<style>
:global(.bzh84tb8m) {
  fill: none;
  stroke: currentColor;
