...
const content = `<path class="fhkwzabvm"/><path class="pwwm56cdd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-video-game" {...props}></Icon>
<style>
:global(.fhkwzabvm) {
  fill: none;
  stroke: currentColor;
