...
const content = `<path class="dbv6zko2g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:earbud-left-outline" {...props}></Icon>
<style>
:global(.dbv6zko2g) {
  fill: currentColor;
