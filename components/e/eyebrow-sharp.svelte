...
const content = `<path class="vsxqedq0x"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:eyebrow-sharp" {...props}></Icon>
<style>
:global(.vsxqedq0x) {
  fill: currentColor;
