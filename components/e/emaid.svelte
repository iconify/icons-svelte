...
const content = `<g class="ft5dv1b6b"><path class="q6k7psgur"/><path class="yfn42xsqa"/><path class="x_61pfv7s"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:emaid" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
