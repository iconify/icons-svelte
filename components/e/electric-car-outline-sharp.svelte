...
const content = `<path class="cem8h9gun"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:electric-car-outline-sharp" {...props}></Icon>
<style>
:global(.cem8h9gun) {
  fill: currentColor;
