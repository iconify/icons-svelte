...
const content = `<path class="nkst98wbu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:edit-document-outline-sharp" {...props}></Icon>
<style>
:global(.nkst98wbu) {
  fill: currentColor;
