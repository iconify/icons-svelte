...
const content = `<path class="idxg9vovs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:explosion-outline-rounded" {...props}></Icon>
<style>
:global(.idxg9vovs) {
  fill: currentColor;
