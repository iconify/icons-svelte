...
const content = `<path class="v-v_qtrae"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:eye-tracking-off-24-filled" {...props}></Icon>
<style>
:global(.v-v_qtrae) {
  fill: currentColor;
