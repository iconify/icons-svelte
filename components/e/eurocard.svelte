...
const content = `<path class="crzqoew7p"/><path class="qbng31rtl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:eurocard" {...props}></Icon>
<style>
:global(.crzqoew7p) {
  fill: none;
  stroke: currentColor;
