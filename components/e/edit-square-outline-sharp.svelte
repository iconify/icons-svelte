...
const content = `<path class="e8q12bo5p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:edit-square-outline-sharp" {...props}></Icon>
<style>
:global(.e8q12bo5p) {
  fill: currentColor;
