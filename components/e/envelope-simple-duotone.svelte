...
const content = `<g class="cuyn6tgcc"><path class="irtov08ks"/><path class="t9st6qbdl"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:envelope-simple-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
