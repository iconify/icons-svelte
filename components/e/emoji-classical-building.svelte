...
const content = `<path class="riwc11bre"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-classical-building" {...props}></Icon>
<style>
:global(.riwc11bre) {
  fill: none;
  stroke: currentColor;
