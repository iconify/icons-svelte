...
const content = `<path class="pm1ez0bic"/><path class="wchbghbcy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-mate-drink" {...props}></Icon>
<style>
:global(.pm1ez0bic) {
  fill: none;
  stroke: currentColor;
