...
const content = `<circle class="h6xgfc01c"/><path class="qfdi99wyy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:episteme" {...props}></Icon>
<style>
:global(.h6xgfc01c) {
  cx: 33.689px;
  cy: 33.395px;
