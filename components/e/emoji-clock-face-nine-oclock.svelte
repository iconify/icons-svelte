...
const content = `<path class="up04qr5jv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-clock-face-nine-oclock" {...props}></Icon>
<style>
:global(.up04qr5jv) {
  fill: none;
  stroke: currentColor;
