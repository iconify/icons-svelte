...
const content = `<path class="p7_vtebrs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:edit-line-outline" {...props}></Icon>
<style>
:global(.p7_vtebrs) {
  fill: currentColor;
