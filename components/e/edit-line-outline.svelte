...
const content = `<path class="l3vj-pbhj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:edit-line-outline" {...props}></Icon>
<style>
:global(.l3vj-pbhj) {
  fill: currentColor;
