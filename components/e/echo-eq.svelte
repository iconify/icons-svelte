...
const content = `<path class="f2fbp5q8r"/><path class="os137tbqe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:echo-eq" {...props}></Icon>
<style>
:global(.f2fbp5q8r) {
  fill: none;
  stroke: currentColor;
