...
const content = `<path class="w87mdfbiz"/><path class="byjlb63dh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-admission-tickets" {...props}></Icon>
<style>
:global(.byjlb63dh) {
  fill: none;
  stroke: currentColor;
