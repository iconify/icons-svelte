...
const content = `<path class="j8jg-ob5f"/><path class="kav8xqbqa"/><circle class="u7xelli0s"/><circle class="ntp77mbgr"/><path class="b7ellfvow"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:elektrichki" {...props}></Icon>
<style>
:global(.b7ellfvow) {
  fill: none;
  stroke: currentColor;
