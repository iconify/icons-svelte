...
const content = `<g class="cdauidgco"><path class="b9tp89bqs"/><path class="g7it7gb8y"/><path class="y0e-g4b7f"/><path class="lcumayeoa"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:elm" {...props}></Icon>
<style>
:global(.b9tp89bqs) {
