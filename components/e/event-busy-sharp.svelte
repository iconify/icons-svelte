...
const content = `<path class="e3gep2bnj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:event-busy-sharp" {...props}></Icon>
<style>
:global(.e3gep2bnj) {
  fill: currentColor;
