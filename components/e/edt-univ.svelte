...
const content = `<path class="wdt8s1baf"/><path class="rmkygjd_q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:edt-univ" {...props}></Icon>
<style>
:global(.rmkygjd_q) {
  fill: none;
  stroke: currentColor;
