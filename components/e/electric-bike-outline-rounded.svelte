...
const content = `<path class="my1l-s69p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:electric-bike-outline-rounded" {...props}></Icon>
<style>
:global(.my1l-s69p) {
  fill: currentColor;
