...
const content = `<rect class="gmjinsb0j"/><path class="fyv6n3ptt"/><path class="mqx4myb4e"/><path class="zvw75npai"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:edge-card-launcher" {...props}></Icon>
<style>
:global(.fyv6n3ptt) {
  fill: none;
  stroke: currentColor;
