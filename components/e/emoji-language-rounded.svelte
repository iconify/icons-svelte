...
const content = `<path class="ezh60_wfs"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:emoji-language-rounded" {...props}></Icon>
<style>
:global(.ezh60_wfs) {
  fill: currentColor;
