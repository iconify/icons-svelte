...
const content = `<path class="oc_tz0b1m"/><path class="nzszbiy_u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:expensify" {...props}></Icon>
<style>
:global(.nzszbiy_u) {
  fill: none;
  stroke: currentColor;
