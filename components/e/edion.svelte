...
const content = `<rect class="j3s9ivbxi"/><path class="cnc-cgc_o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:edion" {...props}></Icon>
<style>
:global(.cnc-cgc_o) {
  fill: none;
  stroke: currentColor;
