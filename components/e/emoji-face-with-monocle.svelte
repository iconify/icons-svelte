...
const content = `<path class="vaios3b8m"/><path class="amiffdbug"/><circle class="l6cd208_p"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-face-with-monocle" {...props}></Icon>
<style>
:global(.amiffdbug) {
  fill: none;
  stroke: currentColor;
