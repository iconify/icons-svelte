...
const content = `<circle class="pdgal68-s"/><path class="jg4r9tbst"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:eventbrite-icon" {...props}></Icon>
<style>
:global(.jg4r9tbst) {
