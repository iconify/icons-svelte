...
const content = `<path class="j65l1-b5v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:emoji-clock-face-nine-thirty" {...props}></Icon>
<style>
:global(.j65l1-b5v) {
  fill: none;
  stroke: currentColor;
