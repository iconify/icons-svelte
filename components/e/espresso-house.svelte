...
const content = `<circle class="cpk0fnbgt"/><circle class="c0s01yjaw"/><path class="l_4ldhbjj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:espresso-house" {...props}></Icon>
<style>
:global(.c0s01yjaw) {
  cx: 24px;
  cy: 24px;
