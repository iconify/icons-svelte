...
const content = `<g class="cuyn6tgcc"><g clip-rule="evenodd" class="d2kvgvbvc"><path class="c440bubqs"/><path class="wc3s_ujig"/><path class="w-ow18bux"/></g><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="pepicons-pop:earth-asia-circle-off" {...props}></Icon>
<style>
:global(.c440bubqs) {
