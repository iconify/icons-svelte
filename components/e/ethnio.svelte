...
const content = `<path class="p-yvubc1z"/><path class="sih4usz_l"/><path class="gr9v9sqoe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:ethnio" {...props}></Icon>
<style>
:global(.gr9v9sqoe) {
