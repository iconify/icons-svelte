...
const content = `<g class="y9tr6bcfx"><path class="jlyultbfy"/><path class="cg10xkwmo"/><path class="wyzusvs_f"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:eduvulcan" {...props}></Icon>
<style>
:global(.cg10xkwmo) {
