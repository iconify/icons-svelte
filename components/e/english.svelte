...
const content = `<path class="mvq8bpyhp"/><path class="xzye_6bow"/><path class="fi_ybpbki"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:english" {...props}></Icon>
<style>
:global(.fi_ybpbki) {
  fill: none;
  stroke: currentColor;
