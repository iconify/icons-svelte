...
const content = `<path class="pivwhss5n"/><path class="gvh3r1b-j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:elucid" {...props}></Icon>
<style>
:global(.gvh3r1b-j) {
  fill: none;
  stroke: currentColor;
