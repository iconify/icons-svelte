...
const content = `<path class="hkxi55b8m"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:empty-dashboard-outline-sharp" {...props}></Icon>
<style>
:global(.hkxi55b8m) {
  fill: currentColor;
