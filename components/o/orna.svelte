...
const content = `<path class="eoma9u2lw"/><path class="jhknwn9kx"/><circle class="kguly92mf"/><path class="wjno9kgsj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:orna" {...props}></Icon>
<style>
:global(.eoma9u2lw) {
  fill: none;
  stroke: currentColor;
