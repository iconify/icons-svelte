...
const content = `<path class="tspydm7fo"/><circle class="xyka2mboc"/><path class="nrod_x3zg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:outline-recent-actors" {...props}></Icon>
<style>
:global(.nrod_x3zg) {
  fill: currentColor;
