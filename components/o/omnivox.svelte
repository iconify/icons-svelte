...
const content = `<circle class="anu0k9b3t"/><path class="kf6obtowj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:omnivox" {...props}></Icon>
<style>
:global(.anu0k9b3t) {
  cx: 24px;
  cy: 25.266px;
