...
const content = `<circle class="n6p3_zbiq"/><path class="epyxv7bcj"/><path class="rdpskkbzr"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:opensignal" {...props}></Icon>
<style>
:global(.epyxv7bcj) {
  fill: none;
  stroke: currentColor;
