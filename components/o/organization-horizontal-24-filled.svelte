...
const content = `<path class="es7bteg7z"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:organization-horizontal-24-filled" {...props}></Icon>
<style>
:global(.es7bteg7z) {
  fill: currentColor;
