...
const content = `<path class="ci3a-5baq"/><path class="guvt6o97o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:openwort" {...props}></Icon>
<style>
:global(.ci3a-5baq) {
  fill: none;
  stroke: currentColor;
