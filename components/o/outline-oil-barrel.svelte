...
const content = `<path class="lv8n9xbye"/><path class="agbbkkx9a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:outline-oil-barrel" {...props}></Icon>
<style>
:global(.agbbkkx9a) {
  fill: currentColor;
