...
const content = `<path class="lc6_1d49w"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:order-approve-outline-rounded" {...props}></Icon>
<style>
:global(.lc6_1d49w) {
  fill: currentColor;
