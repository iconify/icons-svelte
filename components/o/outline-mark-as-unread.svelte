...
const content = `<path class="d3ciaunii"/><path class="nvz5vg2ir"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:outline-mark-as-unread" {...props}></Icon>
<style>
:global(.d3ciaunii) {
  fill: currentColor;
