...
const content = `<path class="zratz2i3o"/><path class="b-8w_g1hq"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:onecall" {...props}></Icon>
<style>
:global(.b-8w_g1hq) {
  fill: none;
  stroke: currentColor;
