...
const content = `<path class="bf9ybuz0y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:outline-perm-device-information" {...props}></Icon>
<style>
:global(.bf9ybuz0y) {
  fill: currentColor;
