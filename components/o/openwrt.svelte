...
const content = `<path class="s8eajpbrl"/><path class="kwhzuubbu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:openwrt" {...props}></Icon>
<style>
:global(.kwhzuubbu) {
  fill: none;
  stroke: currentColor;
