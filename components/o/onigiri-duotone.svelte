...
const content = `<g class="cuyn6tgcc"><path class="nbu74sbed"/><path class="m7g-nrbii"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:onigiri-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
