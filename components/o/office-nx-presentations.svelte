...
const content = `<rect class="owr_4mwof"/><path class="q8p-l4boe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:office-nx-presentations" {...props}></Icon>
<style>
:global(.owr_4mwof) {
  width: 22.5px;
  height: 22.5px;
