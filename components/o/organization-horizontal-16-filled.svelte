...
const content = `<path class="pg2w95bni"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:organization-horizontal-16-filled" {...props}></Icon>
<style>
:global(.pg2w95bni) {
  fill: currentColor;
