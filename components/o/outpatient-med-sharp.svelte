...
const content = `<path class="cx9tgqb0v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:outpatient-med-sharp" {...props}></Icon>
<style>
:global(.cx9tgqb0v) {
  fill: currentColor;
