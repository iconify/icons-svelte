...
const content = `<path class="bsadcx1ki"/><path class="j98an1bqd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:one" {...props}></Icon>
<style>
:global(.bsadcx1ki) {
  fill: none;
  stroke: currentColor;
