...
const content = `<path class="ocd99yb9j"/><path class="ll0g54h-q"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:openscale" {...props}></Icon>
<style>
:global(.ll0g54h-q) {
  fill: none;
  stroke: currentColor;
