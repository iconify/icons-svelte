...
const content = `<path class="lkx9ztb_j"/><circle class="v4i2ew1ke"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:outline-control-camera" {...props}></Icon>
<style>
:global(.lkx9ztb_j) {
  fill: currentColor;
