...
const content = `<rect class="j3s9ivbxi"/><path class="tiv42jt8v"/><path class="b7ypiyfsi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ocrenger" {...props}></Icon>
<style>
:global(.b7ypiyfsi) {
  fill: none;
  stroke: currentColor;
