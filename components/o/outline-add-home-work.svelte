...
const content = `<path class="klahzjslt"/><path class="vr60o2_9k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:outline-add-home-work" {...props}></Icon>
<style>
:global(.klahzjslt) {
  fill: currentColor;
