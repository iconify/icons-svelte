...
const content = `<path class="bn6ebpb5p"/><path class="dwy51obuf"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:outline-6k" {...props}></Icon>
<style>
:global(.bn6ebpb5p) {
  fill: currentColor;
