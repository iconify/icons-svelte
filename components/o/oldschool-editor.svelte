...
const content = `<path class="gqzutib3e"/><path class="y5nd7v_zw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:oldschool-editor" {...props}></Icon>
<style>
:global(.gqzutib3e) {
  fill: none;
  stroke: currentColor;
