...
const content = `<g class="cuyn6tgcc"><path class="wa1ojwbgv"/><path class="waruxkbpl"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:oven-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
