...
const content = `<path class="s8sgzzb0x"/><path class="jzdbkrbti"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:outline-inventory" {...props}></Icon>
<style>
:global(.jzdbkrbti) {
  fill: currentColor;
