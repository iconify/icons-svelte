...
const content = `<path class="f_n3kzbpn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:outbox-sharp" {...props}></Icon>
<style>
:global(.f_n3kzbpn) {
  fill: currentColor;
