...
const content = `<path class="b4hzekukw"/><path class="ccnsmqbtl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:office-reader" {...props}></Icon>
<style>
:global(.b4hzekukw) {
  fill: none;
  stroke: currentColor;
