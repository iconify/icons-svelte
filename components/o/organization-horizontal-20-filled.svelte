...
const content = `<path class="iwwnq4buv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:organization-horizontal-20-filled" {...props}></Icon>
<style>
:global(.iwwnq4buv) {
  fill: currentColor;
