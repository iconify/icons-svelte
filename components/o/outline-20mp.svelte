...
const content = `<path class="xietzojdi"/><path class="bn6ebpb5p"/><path class="bpzm4jenn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:outline-20mp" {...props}></Icon>
<style>
:global(.bn6ebpb5p) {
  fill: currentColor;
