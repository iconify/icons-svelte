...
const content = `<path class="vkhdwpbny"/><path class="k--td0b5u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ou-study" {...props}></Icon>
<style>
:global(.k--td0b5u) {
  fill: none;
  stroke: currentColor;
