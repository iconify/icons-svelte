...
const content = `<path class="m4wtzfb5v"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:oven-outline-sharp" {...props}></Icon>
<style>
:global(.m4wtzfb5v) {
  fill: currentColor;
