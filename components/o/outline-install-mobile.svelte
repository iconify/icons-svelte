...
const content = `<path class="pm2p8eb-o"/><path class="he_sxxb4l"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:outline-install-mobile" {...props}></Icon>
<style>
:global(.he_sxxb4l) {
  fill: currentColor;
