...
const content = `<path class="ifi9bmy0b"/><path class="pljig0b1n"/><path class="quyl-rp3f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:outline-8k-plus" {...props}></Icon>
<style>
:global(.ifi9bmy0b) {
  fill: currentColor;
