...
const content = `<path class="di26sdb5y"/><circle class="a0k960bkz"/><path class="ptymqf9lw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:opn2-midi-player" {...props}></Icon>
<style>
:global(.a0k960bkz) {
  cx: 31.882px;
  cy: 29.876px;
