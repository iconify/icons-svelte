...
const content = `<path class="so3kgfb0j"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:outbox-alt-rounded" {...props}></Icon>
<style>
:global(.so3kgfb0j) {
  fill: currentColor;
