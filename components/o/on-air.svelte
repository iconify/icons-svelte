...
const content = `<path class="m83jqzbjq"/><path class="yzdaaubhd"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:on-air" {...props}></Icon>
<style>
:global(.m83jqzbjq) {
  fill: none;
  stroke: currentColor;
