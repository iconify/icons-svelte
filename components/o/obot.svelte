...
const content = `<path clip-rule="evenodd" class="m613uvbqw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:obot" {...props}></Icon>
<style>
:global(.m613uvbqw) {
