...
const content = `<path class="nd14yh-rd"/><path class="a8y1v4b-s"/><path class="i9clfwm2k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:oitube" {...props}></Icon>
<style>
:global(.a8y1v4b-s) {
  fill: none;
  stroke: currentColor;
