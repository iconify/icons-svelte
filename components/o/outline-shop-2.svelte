...
const content = `<path class="vcg6jsbkc"/><path class="wssbh_b2d"/><path class="nca-s0bis"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:outline-shop-2" {...props}></Icon>
<style>
:global(.nca-s0bis) {
  fill: currentColor;
