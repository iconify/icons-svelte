...
const content = `<circle class="j_-2hxbof"/><path class="a76jhtfko"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:outline-hot-tub" {...props}></Icon>
<style>
:global(.a76jhtfko) {
  fill: currentColor;
