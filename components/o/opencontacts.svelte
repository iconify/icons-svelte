...
const content = `<path class="fhw3vczax"/><path class="vb_uuxzdb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:opencontacts" {...props}></Icon>
<style>
:global(.fhw3vczax) {
  fill: none;
  stroke: currentColor;
