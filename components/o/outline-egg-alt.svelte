...
const content = `<path class="j-tisonbz"/><circle class="zaponzdgz"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:outline-egg-alt" {...props}></Icon>
<style>
:global(.j-tisonbz) {
  fill: currentColor;
