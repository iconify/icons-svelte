...
const content = `<rect class="owr_4mwof"/><path class="jnkd6rbbe"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:office-nx-textmaker" {...props}></Icon>
<style>
:global(.jnkd6rbbe) {
  fill: none;
  stroke: currentColor;
