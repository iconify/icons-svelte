...
const content = `<path class="g8jpjsbyu"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:onecalendar" {...props}></Icon>
<style>
:global(.g8jpjsbyu) {
  fill: none;
  stroke: currentColor;
