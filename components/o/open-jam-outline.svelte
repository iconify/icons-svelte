...
const content = `<path class="vrgqqkkwu"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:open-jam-outline" {...props}></Icon>
<style>
:global(.vrgqqkkwu) {
  fill: currentColor;
