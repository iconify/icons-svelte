...
const content = `<path class="v11bajbyn"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:ods-outline-rounded" {...props}></Icon>
<style>
:global(.v11bajbyn) {
  fill: currentColor;
