...
const content = `<path class="cksk272yo"/><circle class="yzo5plbsh"/><path class="e5s4ytouy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:outline-video-camera-front" {...props}></Icon>
<style>
:global(.cksk272yo) {
  fill: currentColor;
