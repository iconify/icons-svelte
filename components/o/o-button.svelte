...
const content = `<path class="ttdo8acwz"/><path class="vf4d7ebea"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:o-button" {...props}></Icon>
<style>
:global(.ttdo8acwz) {
  fill: currentColor;
