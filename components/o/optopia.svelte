...
const content = `<path clip-rule="evenodd" class="xj7otfbam"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:optopia" {...props}></Icon>
<style>
:global(.xj7otfbam) {
