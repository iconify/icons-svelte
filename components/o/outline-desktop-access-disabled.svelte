...
const content = `<path class="zmdfmibkl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:outline-desktop-access-disabled" {...props}></Icon>
<style>
:global(.zmdfmibkl) {
  fill: currentColor;
