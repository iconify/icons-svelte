...
const content = `<path class="eev9s1buu"/><ellipse class="pbkq5husi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="emojione-monotone:oil-drum" {...props}></Icon>
<style>
:global(.eev9s1buu) {
  fill: currentColor;
