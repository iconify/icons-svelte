...
const content = `<path class="f3dg35b7o"/><path class="fr8djqb8g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:ov-plus" {...props}></Icon>
<style>
:global(.f3dg35b7o) {
  fill: none;
  stroke: currentColor;
