...
const content = `<path class="s14494bvk"/><circle class="wdk07ew5o"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:openanime" {...props}></Icon>
<style>
:global(.s14494bvk) {
  fill: none;
  stroke: currentColor;
