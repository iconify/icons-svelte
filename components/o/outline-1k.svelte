...
const content = `<path class="bn6ebpb5p"/><path class="dw9wdnb0s"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ic:outline-1k" {...props}></Icon>
<style>
:global(.bn6ebpb5p) {
  fill: currentColor;
