...
const content = `<g class="cuyn6tgcc"><path class="sz04-kb9c"/><path class="slvg6rb6z"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:octagon-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
