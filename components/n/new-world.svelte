...
const content = `<g class="y9tr6bcfx"><path class="jpb2feb0e"/><path class="qj3xvgbyr"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:new-world" {...props}></Icon>
<style>
:global(.jpb2feb0e) {
