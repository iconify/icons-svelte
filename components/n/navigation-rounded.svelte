...
const content = `<path class="yhv5_ybjv"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:navigation-rounded" {...props}></Icon>
<style>
:global(.yhv5_ybjv) {
  fill: currentColor;
