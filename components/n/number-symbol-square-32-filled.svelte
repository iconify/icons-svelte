...
const content = `<path class="mtj1alr2n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:number-symbol-square-32-filled" {...props}></Icon>
<style>
:global(.mtj1alr2n) {
  fill: currentColor;
