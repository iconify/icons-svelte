...
const content = `<g class="ft5dv1b6b"><g clip-path="url(#SVGHcSWxdhd)"><path class="qp_-5s9wa"/><path class="pl2jcfd-f"/><path class="lt3bw_bqo"/></g><defs><clipPath id="SVGHcSWxdhd"><path class="py7ktqbvf"/></clipPath></defs></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:nom-background" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
