...
const content = `<path clip-rule="evenodd" class="ki24w_bkh"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:noia" {...props}></Icon>
<style>
:global(.ki24w_bkh) {
