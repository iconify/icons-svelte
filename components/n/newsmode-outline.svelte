...
const content = `<path class="mprzdxbqg"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:newsmode-outline" {...props}></Icon>
<style>
:global(.mprzdxbqg) {
  fill: currentColor;
