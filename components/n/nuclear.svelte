...
const content = `<circle class="f-5wm485e"/><path class="bm4i4_bjb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:nuclear" {...props}></Icon>
<style>
:global(.bm4i4_bjb) {
  fill: none;
  stroke: currentColor;
