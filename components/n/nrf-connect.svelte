...
const content = `<path class="ye7y7d_5b"/><path class="awc7-pbgk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:nrf-connect" {...props}></Icon>
<style>
:global(.awc7-pbgk) {
  fill: none;
  stroke: currentColor;
