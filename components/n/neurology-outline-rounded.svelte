...
const content = `<path class="hpbo8_bzt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:neurology-outline-rounded" {...props}></Icon>
<style>
:global(.hpbo8_bzt) {
  fill: currentColor;
