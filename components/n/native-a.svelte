...
const content = `<path class="wew5m6bfr"/><path class="izj36mb4t"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:native-a" {...props}></Icon>
<style>
:global(.izj36mb4t) {
  fill: none;
  stroke: currentColor;
