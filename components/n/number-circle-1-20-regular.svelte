...
const content = `<path class="ow7tcubhy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:number-circle-1-20-regular" {...props}></Icon>
<style>
:global(.ow7tcubhy) {
  fill: currentColor;
