...
const content = `<path class="h5410ntbj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:notification-settings-rounded" {...props}></Icon>
<style>
:global(.h5410ntbj) {
  fill: currentColor;
