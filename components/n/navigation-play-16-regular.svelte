...
const content = `<path class="rmjtaxb4d"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:navigation-play-16-regular" {...props}></Icon>
<style>
:global(.rmjtaxb4d) {
  fill: currentColor;
