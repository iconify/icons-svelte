...
const content = `<path clip-rule="evenodd" class="ixd1fcbsk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:nls" {...props}></Icon>
<style>
:global(.ixd1fcbsk) {
