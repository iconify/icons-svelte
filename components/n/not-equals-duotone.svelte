...
const content = `<g class="cuyn6tgcc"><path class="rmfg5mk6q"/><path class="yg10bfbno"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:not-equals-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
