...
const content = `<g class="y9tr6bcfx"><path class="cnuosl17d"/><path class="i899t7bye"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:noteit" {...props}></Icon>
<style>
:global(.cnuosl17d) {
