...
const content = `<path class="i31kw8kbj"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:notepad-sparkle-24-regular" {...props}></Icon>
<style>
:global(.i31kw8kbj) {
  fill: currentColor;
