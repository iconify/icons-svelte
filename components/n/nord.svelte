...
const content = `<g class="ft5dv1b6b"><path class="idkde_bzl"/><path class="blgo49tzr"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:nord" {...props}></Icon>
<style>
:global(.blgo49tzr) {
