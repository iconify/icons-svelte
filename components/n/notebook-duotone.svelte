...
const content = `<g class="cuyn6tgcc"><path class="zyu4c_buk"/><path class="fv11s41bx"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:notebook-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
