...
const content = `<g class="ft5dv1b6b"><path class="uekg2eekl"/><path class="pi5rlybqa"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="token-branded:neo" {...props}></Icon>
<style>
:global(.ft5dv1b6b) {
  fill: none;
}
