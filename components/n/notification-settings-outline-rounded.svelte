...
const content = `<path class="dyc7h2b-g"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:notification-settings-outline-rounded" {...props}></Icon>
<style>
:global(.dyc7h2b-g) {
  fill: currentColor;
