...
const content = `<path class="bkh455zxo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:no-sim-outline-sharp" {...props}></Icon>
<style>
:global(.bkh455zxo) {
  fill: currentColor;
