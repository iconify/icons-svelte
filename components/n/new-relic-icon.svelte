...
const content = `<path class="p23co8mne"/><path class="m73451bht"/><path class="mp9ucpbao"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="logos:new-relic-icon" {...props}></Icon>
<style>
:global(.m73451bht) {
