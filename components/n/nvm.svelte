...
const content = `<path class="o00gimb9c"/><path class="hc77isnme"/><rect class="j3s9ivbxi"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:nvm" {...props}></Icon>
<style>
:global(.hc77isnme) {
  fill: none;
  stroke: currentColor;
