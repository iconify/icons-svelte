...
const content = `<g class="cuyn6tgcc"><path class="labcfzbqf"/><path class="da6n1w1ru"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:notepad-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
