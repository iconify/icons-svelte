...
const content = `<circle class="axh5y9bab"/><path class="ma6shyo7b"/><path class="ydqthzbbt"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:nfc-reader" {...props}></Icon>
<style>
:global(.axh5y9bab) {
  cx: 24px;
  cy: 24px;
