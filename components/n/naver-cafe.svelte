...
const content = `<path class="poo40skbv"/><path class="jod9mpw5f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:naver-cafe" {...props}></Icon>
<style>
:global(.jod9mpw5f) {
  fill: none;
  stroke: currentColor;
