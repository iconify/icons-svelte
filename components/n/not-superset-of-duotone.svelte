...
const content = `<g class="cuyn6tgcc"><path class="mh517eb7p"/><path class="c29fi2xlc"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:not-superset-of-duotone" {...props}></Icon>
<style>
:global(.c29fi2xlc) {
