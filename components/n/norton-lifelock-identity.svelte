...
const content = `<path class="gghe05b5o"/><path class="ai9s8sb_e"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:norton-lifelock-identity" {...props}></Icon>
<style>
:global(.ai9s8sb_e) {
  fill: none;
  stroke: currentColor;
