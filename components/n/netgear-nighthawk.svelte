...
const content = `<path class="ffx0q340q"/><path class="ds64m8b6c"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:netgear-nighthawk" {...props}></Icon>
<style>
:global(.ds64m8b6c) {
  fill: none;
  stroke: currentColor;
