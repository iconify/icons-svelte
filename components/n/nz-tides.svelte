...
const content = `<path class="q8kqfbk9w"/><path class="h0n3ghd1u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:nz-tides" {...props}></Icon>
<style>
:global(.h0n3ghd1u) {
  fill: none;
  stroke: currentColor;
