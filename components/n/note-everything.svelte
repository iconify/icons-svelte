...
const content = `<g class="y9tr6bcfx"><path class="rkey3t-zs"/><path class="w4l4vnbqt"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:note-everything" {...props}></Icon>
<style>
:global(.rkey3t-zs) {
