...
const content = `<path class="fp_jgpn5i"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:nephrology-rounded" {...props}></Icon>
<style>
:global(.fp_jgpn5i) {
  fill: currentColor;
