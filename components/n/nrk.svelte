...
const content = `<path class="tpvq6zt1l"/><circle class="xv9xeibjl"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:nrk" {...props}></Icon>
<style>
:global(.tpvq6zt1l) {
  fill: none;
  stroke: currentColor;
