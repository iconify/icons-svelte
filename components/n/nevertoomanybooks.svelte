...
const content = `<path class="ye0ye-6ag"/><path class="n-mm3qbkp"/><path class="r2fn6bb-a"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:nevertoomanybooks" {...props}></Icon>
<style>
:global(.n-mm3qbkp) {
  fill: none;
  stroke: currentColor;
