...
const content = `<path class="i9clfwm2k"/><path class="gw5qy0b6n"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:newsasfacts" {...props}></Icon>
<style>
:global(.gw5qy0b6n) {
  fill: none;
  stroke: currentColor;
