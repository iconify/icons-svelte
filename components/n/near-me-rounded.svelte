...
const content = `<path class="f3-gchbny"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:near-me-rounded" {...props}></Icon>
<style>
:global(.f3-gchbny) {
  fill: currentColor;
