...
const content = `<path class="h9s5cmxzo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="fluent:navigation-unread-24-filled" {...props}></Icon>
<style>
:global(.h9s5cmxzo) {
  fill: currentColor;
