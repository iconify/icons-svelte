...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline:nature-ecology-rainbow-arch-rain-colorful-rainbow-curve-half-circle" {...props}></Icon>
