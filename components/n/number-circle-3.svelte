...
const content = `<circle class="cpk0fnbgt"/><path class="bss894joo"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:number-circle-3" {...props}></Icon>
<style>
:global(.bss894joo) {
  fill: none;
  stroke: currentColor;
