...
const content = `<path class="f8us19bzc"/><path class="uhqgh8hde"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:nperf" {...props}></Icon>
<style>
:global(.f8us19bzc) {
  fill: none;
  stroke: currentColor;
