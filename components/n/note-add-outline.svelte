...
const content = `<path class="ld22hhb6u"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:note-add-outline" {...props}></Icon>
<style>
:global(.ld22hhb6u) {
  fill: currentColor;
