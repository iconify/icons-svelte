...
const content = `<path class="oa0b_20-k"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:network-locked-outline-sharp" {...props}></Icon>
<style>
:global(.oa0b_20-k) {
  fill: currentColor;
