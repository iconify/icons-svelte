...
const content = `<g class="cuyn6tgcc"><path class="hoi13hbph"/><path class="y21suls4f"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:newspaper-clipping-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
