...
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="streamline:natrue-ecology-recycle-1-sign-environment-protect-save-arrows" {...props}></Icon>
