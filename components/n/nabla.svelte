...
const content = `<path class="l3xw66b6n"/><path class="rz5fyzc3f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:nabla" {...props}></Icon>
<style>
:global(.l3xw66b6n) {
  fill: none;
  stroke: currentColor;
