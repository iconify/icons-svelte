...
const content = `<g class="cuyn6tgcc"><path class="goeug6bgp"/><path class="bl7n86tae"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:number-circle-four-duotone" {...props}></Icon>
<style>
:global(.bl7n86tae) {
