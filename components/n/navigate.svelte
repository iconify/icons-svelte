...
const content = `<path class="b101edwzr"/><path class="t45u9qbdb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:navigate" {...props}></Icon>
<style>
:global(.b101edwzr) {
  fill: none;
  stroke: currentColor;
