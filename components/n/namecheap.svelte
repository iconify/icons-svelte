...
const content = `<path class="bullqbc4n"/><path class="s4lb-9isk"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:namecheap" {...props}></Icon>
<style>
:global(.bullqbc4n) {
  fill: none;
  stroke: currentColor;
