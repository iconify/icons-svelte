...
const content = `<path class="actnic0_y"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:no-flash-outline-rounded" {...props}></Icon>
<style>
:global(.actnic0_y) {
  fill: currentColor;
