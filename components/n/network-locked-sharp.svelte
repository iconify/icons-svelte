...
const content = `<path class="y4-xg2b4b"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:network-locked-sharp" {...props}></Icon>
<style>
:global(.y4-xg2b4b) {
  fill: currentColor;
