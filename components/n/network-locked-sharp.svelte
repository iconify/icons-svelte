...
const content = `<path class="xspokgfgx"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:network-locked-sharp" {...props}></Icon>
<style>
:global(.xspokgfgx) {
  fill: currentColor;
