...
const content = `<path class="ccb7q_cnc"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols:no-meeting-room-outline-rounded" {...props}></Icon>
<style>
:global(.ccb7q_cnc) {
  fill: currentColor;
