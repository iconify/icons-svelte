...
const content = `<g class="cuyn6tgcc"><path class="eu_696b5l"/><path class="jry7u0bpo"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:note-blank-duotone" {...props}></Icon>
<style>
:global(.cuyn6tgcc) {
  fill: currentColor;
}
