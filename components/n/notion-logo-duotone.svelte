...
const content = `<g class="cuyn6tgcc"><path class="a37qc8bpe"/><path class="a3pi8_bav"/></g>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="ph:notion-logo-duotone" {...props}></Icon>
<style>
:global(.a37qc8bpe) {
