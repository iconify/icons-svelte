...
const content = `<path class="wvx0s7pcw"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="material-symbols-light:no-crash-sharp" {...props}></Icon>
<style>
:global(.wvx0s7pcw) {
  fill: currentColor;
