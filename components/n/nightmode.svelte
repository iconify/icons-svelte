...
const content = `<path class="azhokyywl"/><path class="fmpeqxkcy"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:nightmode" {...props}></Icon>
<style>
:global(.azhokyywl) {
  fill: none;
  stroke: currentColor;
