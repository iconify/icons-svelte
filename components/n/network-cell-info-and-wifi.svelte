...
const content = `<path class="k7n5kzb0f"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:network-cell-info-and-wifi" {...props}></Icon>
<style>
:global(.k7n5kzb0f) {
  fill: none;
  stroke: currentColor;
