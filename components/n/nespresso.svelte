...
const content = `<path class="h7nrtjboc"/><path class="agmh66bwb"/>`;
</script>
<Icon width={width} height={height} viewBox={viewBox} content={content} fallback="arcticons:nespresso" {...props}></Icon>
<style>
:global(.agmh66bwb) {
  fill: none;
  stroke: currentColor;
